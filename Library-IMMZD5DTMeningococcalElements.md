...
| Draft as of 2025-11-14 | *Computable Name*:IMMZD5DTMeningococcalElements |

 
This library defines context-independent elements for Meningococcal used throughout the Immunization CPG 

* * **Content:**application/elm+xml: ````Encoded data (12784 characters)````: **Id:**
  * ?: IMMZD5DTMeningococcalElements
* * **Content:**application/elm+xml: ````Encoded data (12784 characters)````: **Version:**
  * ?: 0.2.0
* * **Content:**application/elm+xml: ````Encoded data (12784 characters)````: **Url:**
  * ?: [IMMZD5DTMeningococcalElements](Library-IMMZD5DTMeningococcalElements.md)
* * **Content:**application/elm+xml: ````Encoded data (12784 characters)````: **Status:**
  * ?: draft
* * **Content:**application/elm+xml: ````Encoded data (12784 characters)````: **Date:**
  * ?: 2025-11-14 22:57:55+0000
* * **Content:**application/elm+xml: ````Encoded data (12784 characters)````: **Publisher:**
  * ?: WHO
* * **Content:**application/elm+xml: ````Encoded data (12784 characters)````: **Description:**
  * ?: This library defines context-independent elements for Meningococcal used throughout the Immunization CPG
