...
| Draft as of 2025-11-25 | *Computable Name*:IMMZD5DTDTPEncounterElements |

 
This library defines encounter-based elements for DTP used throughout the Immunization CPG 

* * **Content:**application/elm+xml: ````Encoded data (20996 characters)````: **Id:**
  * ?: IMMZD5DTDTPEncounterElements
* * **Content:**application/elm+xml: ````Encoded data (20996 characters)````: **Version:**
  * ?: 0.2.0
* * **Content:**application/elm+xml: ````Encoded data (20996 characters)````: **Url:**
  * ?: [IMMZD5DTDTPEncounterElements](Library-IMMZD5DTDTPEncounterElements.md)
* * **Content:**application/elm+xml: ````Encoded data (20996 characters)````: **Status:**
  * ?: draft
* * **Content:**application/elm+xml: ````Encoded data (20996 characters)````: **Date:**
  * ?: 2025-11-25 19:41:02+0000
* * **Content:**application/elm+xml: ````Encoded data (20996 characters)````: **Publisher:**
  * ?: WHO
* * **Content:**application/elm+xml: ````Encoded data (20996 characters)````: **Description:**
  * ?: This library defines encounter-based elements for DTP used throughout the Immunization CPG
