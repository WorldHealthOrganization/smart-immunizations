...
| Draft as of 2025-11-25 | *Computable Name*:IMMZD5DTHepatitisAEncounterElements |

 
This library defines encounter-based elements for Hepatitis A used throughout the Immunization CPG 

* * **Content:**application/elm+xml: ````Encoded data (19012 characters)````: **Id:**
  * ?: IMMZD5DTHepatitisAEncounterElements
* * **Content:**application/elm+xml: ````Encoded data (19012 characters)````: **Version:**
  * ?: 0.2.0
* * **Content:**application/elm+xml: ````Encoded data (19012 characters)````: **Url:**
  * ?: [IMMZD5DTHepatitisAEncounterElements](Library-IMMZD5DTHepatitisAEncounterElements.md)
* * **Content:**application/elm+xml: ````Encoded data (19012 characters)````: **Status:**
  * ?: draft
* * **Content:**application/elm+xml: ````Encoded data (19012 characters)````: **Date:**
  * ?: 2025-11-25 19:41:02+0000
* * **Content:**application/elm+xml: ````Encoded data (19012 characters)````: **Publisher:**
  * ?: WHO
* * **Content:**application/elm+xml: ````Encoded data (19012 characters)````: **Description:**
  * ?: This library defines encounter-based elements for Hepatitis A used throughout the Immunization CPG
