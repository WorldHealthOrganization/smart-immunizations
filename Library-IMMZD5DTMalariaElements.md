...
| Draft as of 2025-11-25 | *Computable Name*:IMMZD5DTMalariaElements |

 
This library defines context-independent elements for Malaria used throughout the Immunization CPG 

* * **Content:**application/elm+xml: ````Encoded data (13112 characters)````: **Id:**
  * ?: IMMZD5DTMalariaElements
* * **Content:**application/elm+xml: ````Encoded data (13112 characters)````: **Version:**
  * ?: 0.2.0
* * **Content:**application/elm+xml: ````Encoded data (13112 characters)````: **Url:**
  * ?: [IMMZD5DTMalariaElements](Library-IMMZD5DTMalariaElements.md)
* * **Content:**application/elm+xml: ````Encoded data (13112 characters)````: **Status:**
  * ?: draft
* * **Content:**application/elm+xml: ````Encoded data (13112 characters)````: **Date:**
  * ?: 2025-11-25 19:41:02+0000
* * **Content:**application/elm+xml: ````Encoded data (13112 characters)````: **Publisher:**
  * ?: WHO
* * **Content:**application/elm+xml: ````Encoded data (13112 characters)````: **Description:**
  * ?: This library defines context-independent elements for Malaria used throughout the Immunization CPG
