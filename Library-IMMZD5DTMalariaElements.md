...
| Draft as of 2025-11-21 | *Computable Name*:IMMZD5DTMalariaElements |

 
This library defines context-independent elements for Malaria used throughout the Immunization CPG 

* * **Content:**application/elm+xml: ````Encoded data (12848 characters)````: **Id:**
  * ?: IMMZD5DTMalariaElements
* * **Content:**application/elm+xml: ````Encoded data (12848 characters)````: **Version:**
  * ?: 0.2.0
* * **Content:**application/elm+xml: ````Encoded data (12848 characters)````: **Url:**
  * ?: [IMMZD5DTMalariaElements](Library-IMMZD5DTMalariaElements.md)
* * **Content:**application/elm+xml: ````Encoded data (12848 characters)````: **Status:**
  * ?: draft
* * **Content:**application/elm+xml: ````Encoded data (12848 characters)````: **Date:**
  * ?: 2025-11-21 17:14:08+0000
* * **Content:**application/elm+xml: ````Encoded data (12848 characters)````: **Publisher:**
  * ?: WHO
* * **Content:**application/elm+xml: ````Encoded data (12848 characters)````: **Description:**
  * ?: This library defines context-independent elements for Malaria used throughout the Immunization CPG
