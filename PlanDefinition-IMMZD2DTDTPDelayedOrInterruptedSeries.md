...
| Draft as of 2025-11-25 | *Computable Name*:IMMZD2DTDTPDelayedOrInterruptedSeries |
...
```json
{
  ...
  "library" : [
    "http://smart.who.int/immunizations/Library/IMMZD2DTDTPDelayedOrInterruptedSeriesLogic"
  ],
  "action" : [
    {
      "extension" : [
