...
| Draft as of 2026-07-07 | *Computable Name*:IMMZD5DTTBEElements |

 
This library defines context-independent elements for TBE used throughout the Immunization CPG 

* * **Content: **application/elm+xml: ````Encoded data (14556 characters)````: **Id: **
  * ?: IMMZD5DTTBEElements
* * **Content: **application/elm+xml: ````Encoded data (14556 characters)````: **Version: **
  * ?: 0.2.0
* * **Content: **application/elm+xml: ````Encoded data (14556 characters)````: **Url: **
  * ?: [IMMZD5DTTBEElements](Library-IMMZD5DTTBEElements.md)
* * **Content: **application/elm+xml: ````Encoded data (14556 characters)````: **Status: **
  * ?: draft
* * **Content: **application/elm+xml: ````Encoded data (14556 characters)````: **Date: **
  * ?: 2026-07-07 22:08:04+0000
* * **Content: **application/elm+xml: ````Encoded data (14556 characters)````: **Publisher: **
  * ?: WHO
* * **Content: **application/elm+xml: ````Encoded data (14556 characters)````: **Description: **
  * ?: This library defines context-independent elements for TBE used throughout the Immunization CPG
