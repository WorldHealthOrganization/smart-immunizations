...
| Draft as of 2025-11-25 | *Computable Name*:IMMZD5DTHPVElements |

 
This library defines context-independent elements for HPV used throughout the Immunization CPG 

* * **Content:**application/elm+xml: ````Encoded data (14664 characters)````: **Id:**
  * ?: IMMZD5DTHPVElements
* * **Content:**application/elm+xml: ````Encoded data (14664 characters)````: **Version:**
  * ?: 0.2.0
* * **Content:**application/elm+xml: ````Encoded data (14664 characters)````: **Url:**
  * ?: [IMMZD5DTHPVElements](Library-IMMZD5DTHPVElements.md)
* * **Content:**application/elm+xml: ````Encoded data (14664 characters)````: **Status:**
  * ?: draft
* * **Content:**application/elm+xml: ````Encoded data (14664 characters)````: **Date:**
  * ?: 2025-11-25 19:41:02+0000
* * **Content:**application/elm+xml: ````Encoded data (14664 characters)````: **Publisher:**
  * ?: WHO
* * **Content:**application/elm+xml: ````Encoded data (14664 characters)````: **Description:**
  * ?: This library defines context-independent elements for HPV used throughout the Immunization CPG
