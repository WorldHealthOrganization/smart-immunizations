...
| Draft as of 2026-07-07 | *Computable Name*:IMMZD5DTHPVElements |

 
This library defines context-independent elements for HPV used throughout the Immunization CPG 

* * **Content: **application/elm+xml: ````Encoded data (14688 characters)````: **Id: **
  * ?: IMMZD5DTHPVElements
* * **Content: **application/elm+xml: ````Encoded data (14688 characters)````: **Version: **
  * ?: 0.2.0
* * **Content: **application/elm+xml: ````Encoded data (14688 characters)````: **Url: **
  * ?: [IMMZD5DTHPVElements](Library-IMMZD5DTHPVElements.md)
* * **Content: **application/elm+xml: ````Encoded data (14688 characters)````: **Status: **
  * ?: draft
* * **Content: **application/elm+xml: ````Encoded data (14688 characters)````: **Date: **
  * ?: 2026-07-07 22:08:04+0000
* * **Content: **application/elm+xml: ````Encoded data (14688 characters)````: **Publisher: **
  * ?: WHO
* * **Content: **application/elm+xml: ````Encoded data (14688 characters)````: **Description: **
  * ?: This library defines context-independent elements for HPV used throughout the Immunization CPG
