...
| Draft as of 2025-11-25 | *Computable Name*:IMMZD2DTHepatitisAInactivatedHAV2Doses |
...
```json
{
  ...
  "library" : [
    "http://smart.who.int/immunizations/Library/IMMZD2DTHepatitisAInactivatedHAV2DosesLogic"
  ],
  "action" : [
    {
      "extension" : [
