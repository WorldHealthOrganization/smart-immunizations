# IMMZD2DTHPVSingleDose ValueSet for Decision Table - WHO Immunization Implementation Guide v0.2.0

* [**Table of Contents**](toc.md)
* [**Indices**](indices.md)
* [**Artifact Index**](artifacts.md)
* **IMMZD2DTHPVSingleDose ValueSet for Decision Table**

## ValueSet: IMMZD2DTHPVSingleDose ValueSet for Decision Table 

| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/ValueSet/IMMZD2DTHPVSingleDoseVS | *Version*:0.2.0 |
| Active as of 2026-07-07 | *Computable Name*:IMMZD2DTHPVSingleDoseVS |

 
ValueSet IMMZD2DTHPVSingleDose for IMMZ.D2.DT.HPV.Single dose. Business rule: Determine if the client is due for a human papillomavirus (HPV) vaccination according to the national immunization schedule Trigger: IMMZ.D2 Determine required vaccination(s) if any Table: Alternative single-dose schedule 
...
##### IMMZD2DTHPVSingleDose ValueSet for Decision Table Schema API
...
### GET /ValueSet-IMMZD2DTHPVSingleDoseVS.schema.json

#### JSON Schema definition for the enumeration ValueSet-IMMZD2DTHPVSingleDoseVS

This endpoint serves the JSON Schema definition for the enumeration ValueSet-IMMZD2DTHPVSingleDoseVS.

## Schema Definition

### ValueSet-IMMZD2DTHPVSingleDoseVS

**Description:** JSON Schema for IMMZD2DTHPVSingleDose ValueSet for Decision Table ValueSet codes. Generated from FHIR expansions using IRI format.
...
```json
{
  ...
  "id" : "IMMZD2DTHPVSingleDoseVS",
  "url" : "http://smart.who.int/immunizations/ValueSet/IMMZD2DTHPVSingleDoseVS",
  "version" : "0.2.0",
  "name" : "IMMZD2DTHPVSingleDoseVS",
  "title" : "IMMZD2DTHPVSingleDose ValueSet for Decision Table",
  "status" : "active",
