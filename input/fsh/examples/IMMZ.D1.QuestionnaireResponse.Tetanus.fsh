Instance: Example.IMMZ.D1.QuestionnaireResponse.Tetanus
InstanceOf: QuestionnaireResponse
Title: "Example QuestionnaireReponse for Capture Client History for Tetanus"
Description: """
...
* insert QRItem( Coding, vaccineType, IMMZ.Z#DE19 "Tetanus-containing vaccines" )
