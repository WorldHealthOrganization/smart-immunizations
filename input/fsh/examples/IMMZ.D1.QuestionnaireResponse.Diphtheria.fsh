Instance: Example.IMMZ.D1.QuestionnaireResponse.Diphtheria
InstanceOf: QuestionnaireResponse
Title: "Example QuestionnaireReponse for Capture Client History for Diphtheria"
Description: """
...
* insert QRItem( Coding, vaccineType, IMMZ.Z#DE3 "Diphtheria-containing vaccines" )
