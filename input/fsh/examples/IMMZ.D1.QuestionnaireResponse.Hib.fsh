Instance: Example.IMMZ.D1.QuestionnaireResponse.Hib
InstanceOf: QuestionnaireResponse
Title: "Example QuestionnaireReponse for Capture Client History for Haemophilus influenzae type b"
Description: """
...
* insert QRItem( Coding, vaccineType, IMMZ.Z#DE4 "Hib-containing vaccines" )
