Instance: Example.IMMZ.D1.QuestionnaireResponse.Cholera
InstanceOf: QuestionnaireResponse
Title: "Example QuestionnaireReponse for Capture Client History for Cholera"
Description: """
...
* insert QRItem( Coding, typeOfCholeraDose, IMMZ.D#DE231 "WC-rBS vaccine" ) //
* insert QRItem( Coding, vaccineType, IMMZ.Z#DE2 "Cholera vaccines" )
