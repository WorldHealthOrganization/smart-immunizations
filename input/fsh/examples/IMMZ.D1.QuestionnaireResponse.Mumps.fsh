Instance: Example.IMMZ.D1.QuestionnaireResponse.Mumps
InstanceOf: QuestionnaireResponse
Title: "Example QuestionnaireReponse for Capture Client History for Mumps"
Description: """
...
* insert QRItem( Coding, vaccineType, IMMZ.Z#DE11 "Mumps-containing vaccines" )
