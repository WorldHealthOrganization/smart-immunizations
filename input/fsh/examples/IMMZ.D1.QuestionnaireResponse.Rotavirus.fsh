Instance: Example.IMMZ.D1.QuestionnaireResponse.Rotavirus
InstanceOf: QuestionnaireResponse
Title: "Example QuestionnaireReponse for Capture Client History for Rotavirus"
Description: """
...
* insert QRItem( Coding, vaccineType, IMMZ.Z#DE16 "Rotavirus vaccines" )
