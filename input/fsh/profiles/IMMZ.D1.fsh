...
* name = "Questionnaire profile: Capture or update client history"
* extension[actor].valueReference = Reference(DD.VaccinationlocationHealthworker)




Instance: DD.VaccinationlocationHealthworker2
InstanceOf: ActorDefinition
Title: "Vaccination location Health worker"
Description: """# TaskRef=StartEvent1# TaskRef=IMMZ.D12# TaskRef=End1# TaskRef=IMMZ.D4# TaskRef=IMMZ.D2# TaskRef=IMMZ.D5# TaskRef=IMMZ.D13# TaskRef=IMMZ.D1# Task=# Task=# Task=# Task=This is the definition of the actor Vaccination location Health worker as extracted from the Digital Adaptation Kit (DAK).
...
* [Determine required JE vaccination(s) if any](Requirement-DD.IMMZ.D2.DT.JE.html)
