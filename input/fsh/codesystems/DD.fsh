 ...
 * Decision Tables: DT.IMMZ.D2.DT.BCG
 * Tabs: DTs.BCG
...
"""
  ...
  * ^property[+].code = #"table"
  * ^property[=].valueString = "DT.IMMZ.D2.DT.BCG"
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "DTs.BCG"
...
Referenced in the following locations:
 * Decision Tables: DT.IMMZ.D5.DT.BCGcontraindications
 * Tabs: DTs.BCG
...
"""
  * ^designation[=].language = #CQL
  * ^property[+].code = #"table"
  * ^property[=].valueString = "DT.IMMZ.D5.DT.BCGcontraindications"
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "DTs.BCG"
...
Referenced in the following locations:
 * Decision Tables: DT.IMMZ.D2.DT.HepatitisB.Birthdose
 * Tabs: DTs.HepatitisB

"""
  * ^property[+].code = #"table"
  * ^property[=].valueString = "DT.IMMZ.D2.DT.HepatitisB.Birthdose"
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "DTs.HepatitisB"
...
Referenced in the following locations:
 * Decision Tables: DT.IMMZ.D2.DT.HepatitisB.3doses
 * Tabs: DTs.HepatitisB
...
"""
  * ^designation[=].language = #CQL
  * ^property[+].code = #"table"
  * ^property[=].valueString = "DT.IMMZ.D2.DT.HepatitisB.3doses"
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "DTs.HepatitisB"
...
* #"One hepatitis B primary series doses were administered" "Count of vaccines administered (where \"Vaccine type\" = \"Hepatitis B-containing vaccines\" and \"Type of dose\" = \"Primary series\") = 1"
  * ^definition = """Count of vaccines administered (where "Vaccine type" = "Hepatitis B-containing vaccines" and "Type of dose" = "Primary series") = 1
Referenced in the following locations:
 * Decision Tables: DT.IMMZ.D2.DT.HepatitisB.4doses
 * Tabs: DTs.HepatitisB
...
"""
  * ^designation[=].language = #CQL
  * ^property[+].code = #"table"
  * ^property[=].valueString = "DT.IMMZ.D2.DT.HepatitisB.4doses"
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "DTs.HepatitisB"
...
Referenced in the following locations:
 * Decision Tables: DT.IMMZ.D2.DT.HepatitisB.Delayedstart
 * Tabs: DTs.HepatitisB
...
"""
  * ^designation[=].language = #CQL
  * ^property[+].code = #"table"
  * ^property[=].valueString = "DT.IMMZ.D2.DT.HepatitisB.Delayedstart"
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "DTs.HepatitisB"
...
Referenced in the following locations:
 * Decision Tables: DT.IMMZ.D2.DT.Polio.Birthdose
 * Tabs: DTs.Polio

"""
  * ^property[+].code = #"table"
  * ^property[=].valueString = "DT.IMMZ.D2.DT.Polio.Birthdose"
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "DTs.Polio"
...
Referenced in the following locations:
 * Decision Tables: DT.IMMZ.D2.DT.Polio.bOPVplusIPV
 * Tabs: DTs.Polio

"""
  * ^property[+].code = #"table"
  * ^property[=].valueString = "DT.IMMZ.D2.DT.Polio.bOPVplusIPV"
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "DTs.Polio"
...
Referenced in the following locations:
 * Decision Tables: DT.IMMZ.D2.DT.Polio.SequentialIPVbOPV
 * Tabs: DTs.Polio

"""
  * ^property[+].code = #"table"
  * ^property[=].valueString = "DT.IMMZ.D2.DT.Polio.SequentialIPVbOPV"
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "DTs.Polio"
...
Referenced in the following locations:
 * Decision Tables: DT.IMMZ.D2.DT.Polio.IPV-only
 * Tabs: DTs.Polio

"""
  * ^property[+].code = #"table"
  * ^property[=].valueString = "DT.IMMZ.D2.DT.Polio.IPV-only"
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "DTs.Polio"
...
Referenced in the following locations:
 * Decision Tables: DT.IMMZ.D5.DT.Poliocontraindications
 * Tabs: DTs.Polio
...
"""
  * ^designation[=].language = #CQL
  * ^property[+].code = #"table"
  * ^property[=].valueString = "DT.IMMZ.D5.DT.Poliocontraindications"
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "DTs.Polio"
...
Referenced in the following locations:
 * Decision Tables: DT.IMMZ.D2.DT.DTP.On-timestart
 * Tabs: DTs.DTP
...
"""
  * ^designation[=].language = #CQL
  * ^property[+].code = #"table"
  * ^property[=].valueString = "DT.IMMZ.D2.DT.DTP.On-timestart"
  * ^property[+].code = #"tab"
...
Referenced in the following locations:
 * Decision Tables: DT.IMMZ.D2.DT.DTP.Delayedorinterruptedseries
 * Tabs: DTs.DTP

"""
  * ^property[+].code = #"table"
  * ^property[=].valueString = "DT.IMMZ.D2.DT.DTP.Delayedorinterruptedseries"
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "DTs.DTP"
...
Referenced in the following locations:
 * Decision Tables: DT.IMMZ.D2.DT.DTP.Pregnancy
 * Tabs: DTs.DTP

"""
  * ^property[+].code = #"table"
  * ^property[=].valueString = "DT.IMMZ.D2.DT.DTP.Pregnancy"
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "DTs.DTP"
...
* #"Should vaccinate client with second tetanus and diphtheria booster dose as three DTP primary series doses and one tetanus and diphtheria booster dose were administered and client is currently pregnant." "Check for contraindications."
  * ^definition = """Check for contraindications.
Referenced in the following locations:
 * Decision Tables: DT.IMMZ.D2.DT.DTP.Pregnancystartingwith4doses
 * Tabs: DTs.DTP

"""
  * ^property[+].code = #"table"
  * ^property[=].valueString = "DT.IMMZ.D2.DT.DTP.Pregnancystartingwith4doses"
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "DTs.DTP"
...
Referenced in the following locations:
 * Decision Tables: DT.IMMZ.D5.DT.DTPcontraindications
 * Tabs: DTs.DTP
...
"""
  * ^designation[=].language = #CQL
  * ^property[+].code = #"table"
  * ^property[=].valueString = "DT.IMMZ.D5.DT.DTPcontraindications"
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "DTs.DTP"
...
Referenced in the following locations:
 * Decision Tables: DT.IMMZ.D2.DT.Hib.3doses
 * Tabs: DTs.Hib
...
"""
  * ^designation[=].language = #CQL
  * ^property[+].code = #"table"
  * ^property[=].valueString = "DT.IMMZ.D2.DT.Hib.3doses"
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "DTs.Hib"
...
Referenced in the following locations:
 * Decision Tables: DT.IMMZ.D2.DT.Hib.3doseswithboosterdose
 * Tabs: DTs.Hib

"""
  * ^property[+].code = #"table"
  * ^property[=].valueString = "DT.IMMZ.D2.DT.Hib.3doseswithboosterdose"
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "DTs.Hib"
...
* #"Time passed since an Hib dose was administered" "Today's date − latest \"Date and time of vaccination\" (where \"Vaccine type\" = \"Hib-containing vaccines\")"
  * ^definition = """Today's date − latest "Date and time of vaccination" (where "Vaccine type" = "Hib-containing vaccines")
Referenced in the following locations:
 * Decision Tables: DT.IMMZ.D2.DT.Hib.2doseswithboosterdose
 * Tabs: DTs.Hib

"""
  * ^property[+].code = #"table"
  * ^property[=].valueString = "DT.IMMZ.D2.DT.Hib.2doseswithboosterdose"
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "DTs.Hib"
...
Referenced in the following locations:
 * Decision Tables: DT.IMMZ.D2.DT.Pneumococcal.2doseswithboosterdose
 * Tabs: DTs.Pneumococcal
...
"""
  * ^designation[=].language = #CQL
  * ^property[+].code = #"table"
  * ^property[=].valueString = "DT.IMMZ.D2.DT.Pneumococcal.2doseswithboosterdose"
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "DTs.Pneumococcal"
...
Referenced in the following locations:
 * Decision Tables: DT.IMMZ.D2.DT.Pneumococcal.3doses
 * Tabs: DTs.Pneumococcal

"""
  * ^property[+].code = #"table"
  * ^property[=].valueString = "DT.IMMZ.D2.DT.Pneumococcal.3doses"
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "DTs.Pneumococcal"
...
* #"The client has severe immunodeficiency" "'\"Potential contraindications\" = \"Immunodeficiency syndromes\""
  * ^definition = """'"Potential contraindications" = "Immunodeficiency syndromes"
Referenced in the following locations:
 * Decision Tables: DT.IMMZ.D5.DT.Rotaviruscontraindications
 * Tabs: DTs.Rotavirus
...
"""
  * ^designation[=].language = #CQL
  * ^property[+].code = #"table"
  * ^property[=].valueString = "DT.IMMZ.D5.DT.Rotaviruscontraindications"
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "DTs.Rotavirus"
...
Referenced in the following locations:
 * Decision Tables: DT.IMMZ.D2.DT.Measles.Ongoingtransmission
 * Tabs: DTs.Measles
...
"""
  * ^designation[=].language = #CQL
  * ^property[+].code = #"table"
  * ^property[=].valueString = "DT.IMMZ.D2.DT.Measles.Ongoingtransmission"
  * ^property[+].code = #"tab"
...
* #"Number of measles primary series doses administered" "Count of vaccines administered (where \"Vaccine type\" = \"Measles-containing vaccines\" and \"Type of dose\" = \"Primary series\")"
  * ^definition = """Count of vaccines administered (where "Vaccine type" = "Measles-containing vaccines" and "Type of dose" = "Primary series")
Referenced in the following locations:
 * Decision Tables: DT.IMMZ.D2.DT.Measles.Lowtransmission
 * Tabs: DTs.Measles

"""
  * ^property[+].code = #"table"
  * ^property[=].valueString = "DT.IMMZ.D2.DT.Measles.Lowtransmission"
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "DTs.Measles"
...
Referenced in the following locations:
 * Decision Tables: DT.IMMZ.D2.DT.Measles.MCVdose0
 * Tabs: DTs.Measles

"""
  * ^property[+].code = #"table"
  * ^property[=].valueString = "DT.IMMZ.D2.DT.Measles.MCVdose0"
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "DTs.Measles"
...
Referenced in the following locations:
 * Decision Tables: DT.IMMZ.D2.DT.Rubella.Highincidence
 * Tabs: DTs.Rubella
...
"""
  * ^designation[=].language = #CQL
  * ^property[+].code = #"table"
  * ^property[=].valueString = "DT.IMMZ.D2.DT.Rubella.Highincidence"
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "DTs.Rubella"
...
* #"Should not vaccinate client with rubella dose." "Check for any vaccines due and inform the caregiver of when to come back for the first dose."
  * ^definition = """Check for any vaccines due and inform the caregiver of when to come back for the first dose.
Referenced in the following locations:
 * Decision Tables: DT.IMMZ.D2.DT.Rubella.Lowincidence
 * Tabs: DTs.Rubella

"""
  * ^property[+].code = #"table"
  * ^property[=].valueString = "DT.IMMZ.D2.DT.Rubella.Lowincidence"
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "DTs.Rubella"
...
Referenced in the following locations:
 * Decision Tables: DT.IMMZ.D5.DT.Rubellacontraindications
 * Tabs: DTs.Rubella
...
"""
  * ^designation[=].language = #CQL
  * ^property[+].code = #"table"
  * ^property[=].valueString = "DT.IMMZ.D5.DT.Rubellacontraindications"
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "DTs.Rubella"
...
Referenced in the following locations:
 * Decision Tables: DT.IMMZ.D2.DT.HPV.2doses
 * Tabs: DTs.HPV
...
"""
  * ^designation[=].language = #CQL
  * ^property[+].code = #"table"
  * ^property[=].valueString = "DT.IMMZ.D2.DT.HPV.2doses"
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "DTs.HPV"
* #"Clients sex" "\"Sex\""
  * ^definition = """"Sex"
Referenced in the following locations:
 * Decision Tables: DT.IMMZ.D2.DT.HPV.2doses
...
* #"Number of HPV primary seres doses administered" "Count of vaccines administered (where \"Vaccine type\" = \"HPV vaccines\" and \"Type of dose\" = \"Primary series\")"
  * ^definition = """Count of vaccines administered (where "Vaccine type" = "HPV vaccines" and "Type of dose" = "Primary series")
Referenced in the following locations:
 * Decision Tables: DT.IMMZ.D2.DT.HPV.Singledose
 * Tabs: DTs.HPV

"""
  * ^property[+].code = #"table"
  * ^property[=].valueString = "DT.IMMZ.D2.DT.HPV.Singledose"
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "DTs.HPV"
...
* #"HPV vaccination could be contraindicated. Clinical judgement is required. Create a clinical note" "\"Immunization recommendation status\" = \"Further evaluation needed\""
  * ^definition = """"Immunization recommendation status" = "Further evaluation needed"
Referenced in the following locations:
 * Decision Tables: DT.IMMZ.D5.DT.HPVcontraindications
 * Tabs: DTs.HPV
...
"""
  * ^designation[=].language = #CQL
  * ^property[+].code = #"table"
  * ^property[=].valueString = "DT.IMMZ.D5.DT.HPVcontraindications"
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "DTs.HPV"
...
Referenced in the following locations:
 * Decision Tables: DT.IMMZ.D2.DT.JE.InactivatedVerocell-derivedvaccine
 * Tabs: DTs.JE
...
"""
  * ^designation[=].language = #CQL
  * ^property[+].code = #"table"
  * ^property[=].valueString = "DT.IMMZ.D2.DT.JE.InactivatedVerocell-derivedvaccine"
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "DTs.JE"
...
Referenced in the following locations:
 * Decision Tables: DT.IMMZ.D2.DT.JE.Liveattenuatedvaccine
 * Tabs: DTs.JE

"""
  * ^property[+].code = #"table"
  * ^property[=].valueString = "DT.IMMZ.D2.DT.JE.Liveattenuatedvaccine"
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "DTs.JE"
...
* #"Should not vaccinate client with JE dose as clients age is less than 9 months." "Check for any vaccines due and inform the caregiver of when to come back for the first JE dose."
  * ^definition = """Check for any vaccines due and inform the caregiver of when to come back for the first JE dose.
Referenced in the following locations:
 * Decision Tables: DT.IMMZ.D2.DT.JE.Liverecombinantvaccine
 * Tabs: DTs.JE

"""
  * ^property[+].code = #"table"
  * ^property[=].valueString = "DT.IMMZ.D2.DT.JE.Liverecombinantvaccine"
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "DTs.JE"
...
Referenced in the following locations:
 * Decision Tables: DT.IMMZ.D5.DT.JEcontraindications
 * Tabs: DTs.JE
...
"""
  * ^designation[=].language = #CQL
  * ^property[+].code = #"table"
  * ^property[=].valueString = "DT.IMMZ.D5.DT.JEcontraindications"
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "DTs.JE"
...
Referenced in the following locations:
 * Decision Tables: DT.IMMZ.D2.DT.Yellowfever
 * Tabs: DTs.Yellowfever
...
"""
  * ^designation[=].language = #CQL
  * ^property[+].code = #"table"
  * ^property[=].valueString = "DT.IMMZ.D2.DT.Yellowfever"
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "DTs.Yellowfever"
...
Referenced in the following locations:
 * Decision Tables: DT.IMMZ.D2.DT.TBE.FSME-Immun
 * Tabs: DTs.TBE
...
"""
  * ^designation[=].language = #CQL
  * ^property[+].code = #"table"
  * ^property[=].valueString = "DT.IMMZ.D2.DT.TBE.FSME-Immun"
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "DTs.TBE"
...
* #"Should not vaccinate client with second TBE dose as the latest dose was administered less than 1 month ago." "Check for any vaccines due and inform the caregiver of when to come back for the next dose."
  * ^definition = """Check for any vaccines due and inform the caregiver of when to come back for the next dose.
Referenced in the following locations:
 * Decision Tables: DT.IMMZ.D2.DT.TBE.Encepur
 * Tabs: DTs.TBE

"""
  * ^property[+].code = #"table"
  * ^property[=].valueString = "DT.IMMZ.D2.DT.TBE.Encepur"
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "DTs.TBE"
...
Referenced in the following locations:
 * Decision Tables: DT.IMMZ.D2.DT.TBE.TBE-Moscow
 * Tabs: DTs.TBE

"""
  * ^property[+].code = #"table"
  * ^property[=].valueString = "DT.IMMZ.D2.DT.TBE.TBE-Moscow"
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "DTs.TBE"
...
* #"Should not vaccinate client with first TBE dose as clients age is less than 3 years." "Check for any vaccines due and inform the caregiver of when to come back for the first dose."
  * ^definition = """Check for any vaccines due and inform the caregiver of when to come back for the first dose.
Referenced in the following locations:
 * Decision Tables: DT.IMMZ.D2.DT.TBE.EnceVir
 * Tabs: DTs.TBE

"""
  * ^property[+].code = #"table"
  * ^property[=].valueString = "DT.IMMZ.D2.DT.TBE.EnceVir"
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "DTs.TBE"
...
Referenced in the following locations:
 * Decision Tables: DT.IMMZ.D5.DT.TBEcontraindications
 * Tabs: DTs.TBE

"""
  * ^property[+].code = #"table"
  * ^property[=].valueString = "DT.IMMZ.D5.DT.TBEcontraindications"
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "DTs.TBE"
...
Referenced in the following locations:
 * Decision Tables: DT.IMMZ.D2.DT.Typhoid.TCV
 * Tabs: DTs.Typhoid
...
"""
  * ^designation[=].language = #CQL
  * ^property[+].code = #"table"
  * ^property[=].valueString = "DT.IMMZ.D2.DT.Typhoid.TCV"
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "DTs.Typhoid"
...
Referenced in the following locations:
 * Decision Tables: DT.IMMZ.D2.DT.Typhoid.ViPS
 * Tabs: DTs.Typhoid

"""
  * ^property[+].code = #"table"
  * ^property[=].valueString = "DT.IMMZ.D2.DT.Typhoid.ViPS"
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "DTs.Typhoid"
...
Referenced in the following locations:
 * Decision Tables: DT.IMMZ.D2.DT.Typhoid.Ty21a
 * Tabs: DTs.Typhoid

"""
  * ^property[+].code = #"table"
  * ^property[=].valueString = "DT.IMMZ.D2.DT.Typhoid.Ty21a"
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "DTs.Typhoid"
...
Referenced in the following locations:
 * Decision Tables: DT.IMMZ.D2.DT.Cholera.WCvaccines
 * Tabs: DTs.Cholera
...
"""
  * ^designation[=].language = #CQL
  * ^property[+].code = #"table"
  * ^property[=].valueString = "DT.IMMZ.D2.DT.Cholera.WCvaccines"
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "DTs.Cholera"
...
* #"Should not vaccinate client with cholera dose as clients age is less than 2 years." "Check for any vaccines due and inform the caregiver of when to come back for the first cholera dose."
  * ^definition = """Check for any vaccines due and inform the caregiver of when to come back for the first cholera dose.
Referenced in the following locations:
 * Decision Tables: DT.IMMZ.D2.DT.Cholera.WC-rBSvaccine3doses
 * Tabs: DTs.Cholera

"""
  * ^property[+].code = #"table"
  * ^property[=].valueString = "DT.IMMZ.D2.DT.Cholera.WC-rBSvaccine3doses"
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "DTs.Cholera"
...
* #"Dose number of the latest primary series dose is more than or equal to two" "Latest \"Dose number\" (where \"Vaccine type\" = \"Cholera vaccines\" and \"Type of dose\" = \"Primary series\") >= 2"
  * ^definition = """Latest "Dose number" (where "Vaccine type" = "Cholera vaccines" and "Type of dose" = "Primary series") >= 2
Referenced in the following locations:
 * Decision Tables: DT.IMMZ.D2.DT.Cholera.WC-rBSvaccine2doses
 * Tabs: DTs.Cholera
...
"""
  * ^designation[=].language = #CQL
  * ^property[+].code = #"table"
  * ^property[=].valueString = "DT.IMMZ.D2.DT.Cholera.WC-rBSvaccine2doses"
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "DTs.Cholera"
...
Referenced in the following locations:
 * Decision Tables: DT.IMMZ.D2.DT.Meningococcal.MenAconjugatevaccine1dose
...
"""
  * ^designation[=].language = #CQL
  * ^property[+].code = #"table"
  * ^property[=].valueString = "DT.IMMZ.D2.DT.Meningococcal.MenAconjugatevaccine1dose"
  * ^property[+].code = #"tab"
...
Referenced in the following locations:
 * Decision Tables: DT.IMMZ.D2.DT.Meningococcal.MenAconjugatevaccine2doses
 * Tabs: DTs.Meningococcal

"""
  * ^property[+].code = #"table"
  * ^property[=].valueString = "DT.IMMZ.D2.DT.Meningococcal.MenAconjugatevaccine2doses"
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "DTs.Meningococcal"
...
Referenced in the following locations:
 * Decision Tables: DT.IMMZ.D2.DT.Meningococcal.Polysaccharidevaccines
 * Tabs: DTs.Meningococcal

"""
  * ^property[+].code = #"table"
  * ^property[=].valueString = "DT.IMMZ.D2.DT.Meningococcal.Polysaccharidevaccines"
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "DTs.Meningococcal"
...
Referenced in the following locations:
 * Decision Tables: DT.IMMZ.D2.DT.HepatitisA.InactivatedHAV2doses
 * Tabs: DTs.HepatitisA
...
"""
  * ^designation[=].language = #CQL
  * ^property[+].code = #"table"
  * ^property[=].valueString = "DT.IMMZ.D2.DT.HepatitisA.InactivatedHAV2doses"
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "DTs.HepatitisA"
...
* #"Should not vaccinate client with Hepatitis A dose as clients age is less than 12 months." "Check for any other vaccines due and inform the caregiver of when to come back for the first dose."
  * ^definition = """Check for any other vaccines due and inform the caregiver of when to come back for the first dose.
Referenced in the following locations:
 * Decision Tables: DT.IMMZ.D2.DT.HepatitisA.InactivatedHAV1dose
 * Tabs: DTs.HepatitisA

"""
  * ^property[+].code = #"table"
  * ^property[=].valueString = "DT.IMMZ.D2.DT.HepatitisA.InactivatedHAV1dose"
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "DTs.HepatitisA"
...
Referenced in the following locations:
 * Decision Tables: DT.IMMZ.D2.DT.HepatitisA.LiveattenuatedHAV1dose
 * Tabs: DTs.HepatitisA

"""
  * ^property[+].code = #"table"
  * ^property[=].valueString = "DT.IMMZ.D2.DT.HepatitisA.LiveattenuatedHAV1dose"
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "DTs.HepatitisA"
...
Referenced in the following locations:
 * Decision Tables: DT.IMMZ.D5.DT.HepatitisAcontraindications
 * Tabs: DTs.HepatitisA
...
"""
  * ^designation[=].language = #CQL
  * ^property[+].code = #"table"
  * ^property[=].valueString = "DT.IMMZ.D5.DT.HepatitisAcontraindications"
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "DTs.HepatitisA"
...
Referenced in the following locations:
 * Decision Tables: DT.IMMZ.D2.DT.Rabies
 * Tabs: DTs.Rabies
...
"""
  * ^designation[=].language = #CQL
  * ^property[+].code = #"table"
  * ^property[=].valueString = "DT.IMMZ.D2.DT.Rabies"
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "DTs.Rabies"
...
Referenced in the following locations:
 * Decision Tables: DT.IMMZ.D2.DT.Dengue.3doseswithpre-vaccinationscreening
 * Tabs: DTs.Dengue
...
"""
  * ^designation[=].language = #CQL
  * ^property[+].code = #"table"
  * ^property[=].valueString = "DT.IMMZ.D2.DT.Dengue.3doseswithpre-vaccinationscreening"
  * ^property[+].code = #"tab"
...
* #"Dengue vaccination is contraindicated" "\"Immunization recommendation status\" = \"Contraindicated\""
  * ^definition = """"Immunization recommendation status" = "Contraindicated"
Referenced in the following locations:
 * Decision Tables: DT.IMMZ.D5.DT.Denguecontraindications
 * Tabs: DTs.Dengue
...
"""
  * ^designation[=].language = #CQL
  * ^property[+].code = #"table"
  * ^property[=].valueString = "DT.IMMZ.D5.DT.Denguecontraindications"
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "DTs.Dengue"
...
Referenced in the following locations:
 * Decision Tables: DT.IMMZ.D2.DT.Malaria
 * Tabs: DTs.Malaria
...
"""
  * ^designation[=].language = #CQL
  * ^property[+].code = #"table"
  * ^property[=].valueString = "DT.IMMZ.D2.DT.Malaria"
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "DTs.Malaria"
...
Referenced in the following locations:
 * Decision Tables: DT.IMMZ.D2.DT.Mumps
 * Tabs: DTs.Mumps
...
"""
  * ^designation[=].language = #CQL
  * ^property[+].code = #"table"
  * ^property[=].valueString = "DT.IMMZ.D2.DT.Mumps"
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "DTs.Mumps"
...
* #"The client has allergy to vaccine components" "'\"Potential contraindications\" = \"Severe allergic reactions\""
  * ^definition = """'"Potential contraindications" = "Severe allergic reactions"
Referenced in the following locations:
 * Decision Tables: DT.IMMZ.D5.DT.Mumpscontraindications
 * Tabs: DTs.Mumps
...
"""
  * ^designation[=].language = #CQL
  * ^property[+].code = #"table"
  * ^property[=].valueString = "DT.IMMZ.D5.DT.Mumpscontraindications"
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "DTs.Mumps"
...
Referenced in the following locations:
 * Decision Tables: DT.IMMZ.D2.DT.Seasonalinfluenza
 * Tabs: DTs.Seasonalinfluenza
...
"""
  * ^designation[=].language = #CQL
  * ^property[+].code = #"table"
  * ^property[=].valueString = "DT.IMMZ.D2.DT.Seasonalinfluenza"
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "DTs.Seasonalinfluenza"
...
* #"The client has a history of severe allergic reactions after a previous dose or to a vaccine component" "\"Potential contraindications\" = \"Severe allergic reactions\""
  * ^definition = """"Potential contraindications" = "Severe allergic reactions"
Referenced in the following locations:
 * Decision Tables: DT.IMMZ.D5.DT.Seasonalinfluenzacontraindications
 * Tabs: DTs.Seasonalinfluenza
...
"""
  * ^designation[=].language = #CQL
  * ^property[+].code = #"table"
  * ^property[=].valueString = "DT.IMMZ.D5.DT.Seasonalinfluenzacontraindications"
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "DTs.Seasonalinfluenza"
...
Referenced in the following locations:
 * Decision Tables: DT.IMMZ.D2.DT.Varicella.1dose
 * Tabs: DTs.Varicella
...
"""
  * ^designation[=].language = #CQL
  * ^property[+].code = #"table"
  * ^property[=].valueString = "DT.IMMZ.D2.DT.Varicella.1dose"
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "DTs.Varicella"
...
Referenced in the following locations:
 * Decision Tables: DT.IMMZ.D2.DT.Varicella.2doses
 * Tabs: DTs.Varicella

"""
  * ^property[+].code = #"table"
  * ^property[=].valueString = "DT.IMMZ.D2.DT.Varicella.2doses"
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "DTs.Varicella"
...
* #"The client is planning to get pregnant in the next month" "\"Potential contraindications\" = \"Planning to get pregnant in the next month\""
  * ^definition = """"Potential contraindications" = "Planning to get pregnant in the next month"
Referenced in the following locations:
 * Decision Tables: DT.IMMZ.D5.DT.Varicellacontraindications
 * Tabs: DTs.Varicella
...
"""
  * ^designation[=].language = #CQL
  * ^property[+].code = #"table"
  * ^property[=].valueString = "DT.IMMZ.D5.DT.Varicellacontraindications"
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "DTs.Varicella"
* #"Clinical judgement is required. Create clinical note" "\"Immunization recommendation status\" = \"Further evaluation needed\""
  * ^definition = """"Immunization recommendation status" = "Further evaluation needed"
