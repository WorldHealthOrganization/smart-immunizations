...
* #DE46 "Physical count adjustment" "An adjustment made to the stock level to correct discrepancies between the recorded inventory and the actual physical count, which may be necessary owing to errors, theft or other discrepancies"
* #DE47 "Closed stock discarded" "The quantity of vials that were not opened and have been wasted or discarded, owing to expiration or other reasons, during a specific period"
...
* #DE53 "Frozen" "The vaccine has been exposed to freezing temperatures, making it unsuitable for use as freezing can affect the integrity and efficacy of certain immunization products"
* #DE18 "Report subject area" "Location (vaccination location or place) for which the data in the report are being represented"
* #DE20 "Reporting period start date" "The start date of the reporting period for which data in the report have been included"
* #DE21 "Reporting period end date" "The end date of the reporting period for which data in the report have been included"
* #DE30 "Disaggregation group" "Indicates the overall strata or disaggregation represented in the report (e.g. by gender, by region, by age group, etc.)"
...
* #DE54 "By-Risk and occupational group" "A disaggregation grouped by the indicator population's risk and occupational group"
