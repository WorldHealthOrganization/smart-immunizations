...
"""
  ...
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "HepatitisB"
* #"Do not vaccinate client with hepatitis B if the client had a history of serious allergic reactions to any of the vaccine components. Allergy to yeast is considered a contraindication to immunization with yeast-produced hepatitis B-con.db391f6061" "Do not vaccinate client with hepatitis B if the client had a history of serious allergic reactions to any of the vaccine components. Allergy to yeast is considered a contraindication to immunization with yeast-produced hepatitis B-containing vaccine."
...
* #"Should not vaccinate client with first meningococcal dose as clients age is less than 2 years." "Check for any vaccines due and inform the caregiver of when to come back for the first dose."
  * ^definition = """Check for any vaccines due and inform the caregiver of when to come back for the first dose.
Referenced in the following locations:
 * Decision Tables: IMMZ.D2.DT.Meningococcal.Quadrivalentconjuga.b67e5e7efb
 * Tabs: Meningococcal

"""
  * ^property[+].code = #"table"
  * ^property[=].valueString = "IMMZ.D2.DT.Meningococcal.Quadrivalentconjuga.b67e5e7efb"
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "Meningococcal"
...
* #"Should not vaccinate client with first meningococcal dose as clients age is less than 9 months." "Check for any vaccines due and inform the caregiver of when to come back for the first dose."
  * ^definition = """Check for any vaccines due and inform the caregiver of when to come back for the first dose.
Referenced in the following locations:
 * Decision Tables: IMMZ.D2.DT.Meningococcal.Quadrivalentconjuga.88e1c8c0bb
 * Tabs: Meningococcal

"""
  * ^property[+].code = #"table"
  * ^property[=].valueString = "IMMZ.D2.DT.Meningococcal.Quadrivalentconjuga.88e1c8c0bb"
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "Meningococcal"
...
"""
  * ^designation[+].value = """//Found in input/cql/IMMZD5DTMeningococcalCILogic.cql
...
"""
  * ^designation[+].value = """//Found in input/cql/IMMZD5DTMalariaEncounterElements.cql
