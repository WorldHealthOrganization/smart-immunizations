...
"""
  ...
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "BCG"
* #"Clients antiretroviral therapy (ART) status" "Client's antiretroviral therapy (ART) status"
  * ^definition = """Client's antiretroviral therapy (ART) status
Referenced in the following locations:
 * Decision Tables: IMMZ.D2.DT.BCG
 * Tabs: BCG
...
"""
  ...
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "BCG"
* #"Is client immunologically stable" "Is client immunologically stable"
  * ^definition = """Is client immunologically stable
Referenced in the following locations:
 * Decision Tables: IMMZ.D2.DT.BCG
 * Tabs: BCG

"""
  * ^designation[+].value = """//Found in input/cql/BCGElements.cql
...
"""
  ...
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "BCG"
* #"Clients tuberculosos (TB) infection test result" "Client's tuberculosos (TB) infection test result"
  * ^definition = """Client's tuberculosos (TB) infection test result
Referenced in the following locations:
 * Decision Tables: IMMZ.D2.DT.BCG
 * Tabs: BCG
...
"""
  * ^designation[+].value = """//Found in input/cql/YellowfeverElements.cql
...
"""
  ...
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "BCG"
* #"Is client clinically well" "Is client clinically well"
  * ^definition = """Is client clinically well
Referenced in the following locations:
 * Decision Tables: IMMZ.D2.DT.BCG
 * Tabs: BCG
...
Referenced in the following locations:
 * Decision Tables: IMMZ.D5.DT.BCGcontraindications
 * Tabs: BCG
...
"""
  ...
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "BCG"
* #"Bacille Calmette–Guérin (BCG) vaccination is contraindicated" "'\"Immunization recommendation status\" = \"Contraindicated\""
...
"""
  ...
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "BCG"
* #"Do not vaccinate client with BCG as BCG vaccination is not recommended during pregnancy" "Do not vaccinate client with BCG as BCG vaccination is not recommended during pregnancy"
  * ^definition = """Do not vaccinate client with BCG as BCG vaccination is not recommended during pregnancy
Referenced in the following locations:
 * Decision Tables: IMMZ.D5.DT.BCGcontraindications
 * Tabs: BCG
...
"""
  ...
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "BCG"
* #"Birth dose administration" "Birth dose administration"
  * ^definition = """Birth dose administration
Referenced in the following locations:
...
//Found in input/cql/IMMZD2DTHepatitisBBirthLogic.cql
...
"""
  ...
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "HepatitisB"
* #"3-dose schedule (birth dose + 2 primary series doses), on-time start" "3-dose schedule (birth dose + 2 primary series doses), on-time start"
  * ^definition = """3-dose schedule (birth dose + 2 primary series doses), on-time start
Referenced in the following locations:
 * Decision Tables: IMMZ.D2.DT.HepatitisB.3doses
 * Tabs: HepatitisB
...
"""
  ...
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "HepatitisB"
* #"4-dose schedule (birth dose + 3 primary series doses), on-time start" "4-dose schedule (birth dose + 3 primary series doses), on-time start"
  * ^definition = """4-dose schedule (birth dose + 3 primary series doses), on-time start
Referenced in the following locations:
 * Decision Tables: IMMZ.D2.DT.HepatitisB.4doses
 * Tabs: HepatitisB
...
"""
  ...
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "HepatitisB"
* #"3-dose schedule (no birth dose + 3 doses), delayed start" "3-dose schedule (no birth dose + 3 doses), delayed start"
  * ^definition = """3-dose schedule (no birth dose + 3 doses), delayed start
Referenced in the following locations:
 * Decision Tables: IMMZ.D2.DT.HepatitisB.Delayedstart
 * Tabs: HepatitisB
...
"""
  ...
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "HepatitisB"
* #"Hepatitis B vaccination could be contraindicated. Clinical judgement is required. Create a clinical note." "'\"Immunization recommendation status\" = \"Further evaluation needed\""
  * ^definition = """'"Immunization recommendation status" = "Further evaluation needed"
Referenced in the following locations:
 * Decision Tables: IMMZ.D5.DT.HepatitisBcontraindications
 * Tabs: HepatitisB
...
"""
  ...
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "HepatitisB"
* #"Do not vaccinate client with hepatitis B if the client had a history of serious allergic reactions to any of the vaccine components. Allergy to yeast is considered a contraindication to immunization with yeast-produced hepatitis B-containing vaccine." "Do not vaccinate client with hepatitis B if the client had a history of serious allergic reactions to any of the vaccine components. Allergy to yeast is considered a contraindication to immunization with yeast-produced hepatitis B-containing vaccine."
  * ^definition = """Do not vaccinate client with hepatitis B if the client had a history of serious allergic reactions to any of the vaccine components. Allergy to yeast is considered a contraindication to immunization with yeast-produced hepatitis B-containing vaccine.
Referenced in the following locations:
 * Decision Tables: IMMZ.D5.DT.HepatitisBcontraindications
 * Tabs: HepatitisB
...
"""
  ...
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "HepatitisB"
* #"Birth dose administration as part of bivalent oral polio vaccine (bOPV) plus inactivated polio vaccine (IPV) schedule (in countries that are poliomyelitis (polio)-endemic countries or at high risk of importation and subsequent spread of polio that follow the combined bOPV–IPV schedule)" "Birth dose administration as part of \"bivalent oral polio vaccine (bOPV) plus inactivated polio vaccine (IPV)\" schedule (in countries that are poliomyelitis (polio)-endemic countries or at high risk of importation and subsequent spread of polio that follow the combined bOPV–IPV schedule)"
  * ^definition = """Birth dose administration as part of "bivalent oral polio vaccine (bOPV) plus inactivated polio vaccine (IPV)" schedule (in countries that are poliomyelitis (polio)-endemic countries or at high risk of importation and subsequent spread of polio that follow the combined bOPV–IPV schedule)
Referenced in the following locations:
 * Decision Tables: IMMZ.D2.DT.Polio.Birthdose
 * Tabs: Polio
...
"""
  * ^designation[+].value = """//Found in input/cql/PolioElements.cql
...
"""
  ...
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "Polio"
* #"Bivalent oral polio vaccine (bOPV) plus inactivated polio vaccine (IPV) schedule (applicable for all countries)" "\"Bivalent oral polio vaccine (bOPV) plus inactivated polio vaccine (IPV)\" schedule (applicable for all countries)"
  * ^definition = """"Bivalent oral polio vaccine (bOPV) plus inactivated polio vaccine (IPV)" schedule (applicable for all countries)
Referenced in the following locations:
 * Decision Tables: IMMZ.D2.DT.Polio.bOPVplusIPV
 * Tabs: Polio
...
"""
  ...
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "Polio"
* #"Sequential Bivalent oral polio vaccine (bOPV)–inactivated polio vaccine (IPV) schedule (in countries with high vaccination coverage [e.g. 90–95%] and low importation risk [where neighbouring countries and/or countries that share substantial population movement have a similarly high coverage])" "Sequential  \"Bivalent oral polio vaccine (bOPV)–inactivated polio vaccine (IPV)\" schedule (in countries with high vaccination coverage [e.g. 90–95%] and low importation risk [where neighbouring countries and/or countries that share substantial population movement have a similarly high coverage])"
  * ^definition = """Sequential  "Bivalent oral polio vaccine (bOPV)–inactivated polio vaccine (IPV)" schedule (in countries with high vaccination coverage [e.g. 90–95%] and low importation risk [where neighbouring countries and/or countries that share substantial population movement have a similarly high coverage])
Referenced in the following locations:
 * Decision Tables: IMMZ.D2.DT.Polio.SequentialIPVbOPV
 * Tabs: Polio
...
"""
  ...
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "Polio"
* #"Inactivated polio vaccine (IPV)-only (in countries, in polio-free regions, with a very low risk of importation and sustained high routine immunization coverage (third dose of the diphtheria–tetanus–pertussis vaccine [DTP3] > 90%)" "Inactivated polio vaccine (IPV)-only (in countries, in polio-free regions, with a very low risk of importation and sustained high routine immunization coverage (third dose of the diphtheria–tetanus–pertussis vaccine [DTP3] > 90%)"
  * ^definition = """Inactivated polio vaccine (IPV)-only (in countries, in polio-free regions, with a very low risk of importation and sustained high routine immunization coverage (third dose of the diphtheria–tetanus–pertussis vaccine [DTP3] > 90%)
Referenced in the following locations:
 * Decision Tables: IMMZ.D2.DT.Polio.IPV-only
 * Tabs: Polio
...
"""
  ...
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "Polio"
* #"Poliovirus vaccination could be contraindicated. Clinical judgement required" "\"Immunization recommendation status\" = \"Further evaluation needed\""
  * ^definition = """"Immunization recommendation status" = "Further evaluation needed"
Referenced in the following locations:
 * Decision Tables: IMMZ.D5.DT.Poliocontraindications
 * Tabs: Polio
...
"""
  ...
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "Polio"
* #"Do not vaccinate client with inactivated polio vaccine (IPV) if client has had a previous severe reaction or known allergy to streptomycin, neomycin or polymyxin B." "Do not vaccinate client with oral polio vaccine (OPV) if client has had a allergic reaction to OPV or to the trace antibiotics contained."
  * ^definition = """Do not vaccinate client with oral polio vaccine (OPV) if client has had a allergic reaction to OPV or to the trace antibiotics contained.
Referenced in the following locations:
 * Decision Tables: IMMZ.D5.DT.Poliocontraindications
 * Tabs: Polio
...
"""
  ...
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "Polio"
* #"DTP vaccination schedule, on-time start (at ≤ 12 months of age)" "DTP vaccination schedule, on-time start (at ≤ 12 months of age)"
  * ^definition = """DTP vaccination schedule, on-time start (at ≤ 12 months of age)
Referenced in the following locations:
 * Decision Tables: IMMZ.D2.DT.DTP.On-timestart
 * Tabs: DTP
...
"""
  ...
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "DTP"
* #"DTP vaccination schedule for the following groups: children ≥ 1 year of age with no previous immunization, adolescents and adults with no previous immunization (including pregnant women) and supplementary immunization activities in high-risk areas, for women of reproductive age" "DTP vaccination schedule for the following groups: children ≥ 1 year of age with no previous immunization, adolescents and adults with no previous immunization (including pregnant women) and supplementary immunization activities in high-risk areas, for women of reproductive age"
  * ^definition = """DTP vaccination schedule for the following groups: children ≥ 1 year of age with no previous immunization, adolescents and adults with no previous immunization (including pregnant women) and supplementary immunization activities in high-risk areas, for women of reproductive age
Referenced in the following locations:
 * Decision Tables: IMMZ.D2.DT.DTP.Delayedorinterruptedseries
 * Tabs: DTP
...
"""
  ...
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "DTP"
* #"Determine whether DTP-containing vaccines are needed for pregnant women" "Determine whether DTP-containing vaccines are needed for pregnant women"
  * ^definition = """Determine whether DTP-containing vaccines are needed for pregnant women
Referenced in the following locations:
 * Decision Tables: IMMZ.D2.DT.DTP.Pregnancy
 * Tabs: DTP
...
"""
  ...
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "DTP"
* #"Diphtheria and tetanus vaccination schedule in pregnant women who received 3 childhood DTP doses" "Diphtheria and tetanus vaccination schedule in pregnant women who received 3 childhood DTP doses"
  * ^definition = """Diphtheria and tetanus vaccination schedule in pregnant women who received 3 childhood DTP doses
Referenced in the following locations:
 * Decision Tables: IMMZ.D2.DT.DTP.Pregnancystartingwith3doses
 * Tabs: DTP
...
"""
  ...
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "DTP"
* #"Should vaccinate client with third tetanus and diphtheria booster dose as the latest tetanus and diphtheria dose was administered more than 1 year ago. This dose should be administered at least 1 year after second booster dose or during next pregnancy." "Check for contraindications."
  * ^definition = """Check for contraindications.
Referenced in the following locations:
 * Decision Tables: IMMZ.D2.DT.DTP.Pregnancystartingwith3doses
 * Tabs: DTP
...
"""
  ...
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "DTP"
* #"Diphtheria and tetanus vaccination schedule in pregnant women who received 4 childhood DTP doses" "Diphtheria and tetanus vaccination schedule in pregnant women who received 4 childhood DTP doses"
  * ^definition = """Diphtheria and tetanus vaccination schedule in pregnant women who received 4 childhood DTP doses
Referenced in the following locations:
 * Decision Tables: IMMZ.D2.DT.DTP.Pregnancystartingwith4doses
 * Tabs: DTP
...
"""
  ...
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "DTP"
* #"The client has a history of anaphylactic reactions" "\"Potential contraindications\" = \"History of anaphylactic reactions\""
  * ^definition = """"Potential contraindications" = "History of anaphylactic reactions"
Referenced in the following locations:
 * Decision Tables: IMMZ.D5.DT.DTPcontraindications
 * Tabs: DTP
...
"""
  ...
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "DTP"
* #"Tetanus and pertussis vaccination could be contraindicated. Clinical judgement is required. Create a clinical note" "\"Immunization recommendation status\" = \"Further evaluation needed\" (where \"Vaccine type\" = \"Pertussis-containing vaccines\")
AND 
...
define "Tetanus and pertussis vaccination could be contraindicated. Clinical judgement is required. Create a clinical note":
  //CQL AUTHORS: you need to insert stuff here
  // "Immunization recommendation status" = "Further evaluation needed" (where "Vaccine type" = "Pertussis-containing vaccines")
...
"""
  ...
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "DTP"
* #"Do not vaccinate client with pertussis and/or tetanus if the client has had a severe anaphylactic reaction to a vaccine component or reaction following a prior dose." "Do not vaccinate client with pertussis and/or tetanus if the client has had a severe anaphylactic reaction to a vaccine component or reaction following a prior dose."
  * ^definition = """Do not vaccinate client with pertussis and/or tetanus if the client has had a severe anaphylactic reaction to a vaccine component or reaction following a prior dose.
Referenced in the following locations:
 * Decision Tables: IMMZ.D5.DT.DTPcontraindications
 * Tabs: DTP
...
"""
  ...
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "DTP"
* #"3 primary doses without a booster dose (3p)" "3 primary doses without a booster dose (3p)"
  * ^definition = """3 primary doses without a booster dose (3p)
Referenced in the following locations:
 * Decision Tables: IMMZ.D2.DT.Hib.3doses
 * Tabs: Hib
...
"""
  ...
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "Hib"
* #"3 primary doses with a booster dose (3p+1)" "3 primary doses with a booster dose (3p+1)"
  * ^definition = """3 primary doses with a booster dose (3p+1)
Referenced in the following locations:
 * Decision Tables: IMMZ.D2.DT.Hib.3doseswithboosterdose
 * Tabs: Hib
...
"""
  ...
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "Hib"
* #"2 primary doses with a booster dose (2p+1)" "2 primary doses with a booster dose (2p+1)"
  * ^definition = """2 primary doses with a booster dose (2p+1)
Referenced in the following locations:
 * Decision Tables: IMMZ.D2.DT.Hib.2doseswithboosterdose
 * Tabs: Hib
...
* #"The client has a history of severe allergic reactions" "\"Potential contraindications\" = \"Severe allergic reactions\""
  * ^definition = """"Potential contraindications" = "Severe allergic reactions"
Referenced in the following locations:
 * Decision Tables: IMMZ.D5.DT.Hibcontraindications
 * Tabs: Hib
...
"""
  ...
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "Hib"
* #"Hib vaccination could be contraindicated. Clinical judgement is required. Create a clinical note." "\"Immunization recommendation status\" = \"Further evaluation needed\""
  * ^definition = """"Immunization recommendation status" = "Further evaluation needed"
Referenced in the following locations:
 * Decision Tables: IMMZ.D5.DT.Hibcontraindications
 * Tabs: Hib
...
"""
  ...
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "Hib"
* #"Do not vaccinate client with Hib conjugate vaccine if client has had allergic reaction or known allergies to any component of the vaccine." "Do not vaccinate client with Hib conjugate vaccine if client has had allergic reaction or known allergies to any component of the vaccine."
  * ^definition = """Do not vaccinate client with Hib conjugate vaccine if client has had allergic reaction or known allergies to any component of the vaccine.
Referenced in the following locations:
 * Decision Tables: IMMZ.D5.DT.Hibcontraindications
 * Tabs: Hib
...
Referenced in the following locations:
 * Decision Tables: IMMZ.D2.DT.Pneumococcal.2doseswithboosterdose
 * Tabs: Pneumococcal
...
"""
  ...
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "Pneumococcal"
...
"""
  ...
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "Pneumococcal"
* #"3 primary doses (3p+0)" "3 primary doses (3p+0)"
  * ^definition = """3 primary doses (3p+0)
Referenced in the following locations:
 * Decision Tables: IMMZ.D2.DT.Pneumococcal.3doses
 * Tabs: Pneumococcal
...
"""
  * ^designation[+].value = """//Found in input/cql/RotavirusElements.cql
...
"""
  ...
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "Rotavirus"
* #"The client has prior history of intussusception" "\"Potential contraindications\" = \"Prior history of intussusception\""
  * ^definition = """"Potential contraindications" = "Prior history of intussusception"
Referenced in the following locations:
 * Decision Tables: IMMZ.D5.DT.Rotaviruscontraindications
 * Tabs: Rotavirus
...
"""
  ...
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "Rotavirus"
* #"Do not vaccinate client with rotavirus as rotavirus vaccination is contraindicated for clients with prior history of intussusception." "Do not vaccinate client with rotavirus as rotavirus vaccination is contraindicated for clients with prior history of intussusception."
  * ^definition = """Do not vaccinate client with rotavirus as rotavirus vaccination is contraindicated for clients with prior history of intussusception.
Referenced in the following locations:
 * Decision Tables: IMMZ.D5.DT.Rotaviruscontraindications
 * Tabs: Rotavirus
...
"""
  ...
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "Rotavirus"
* #"Countries with ongoing transmission in which the risk of measles mortality remains high (countries that provide first dose of measles-containing vaccine (MCV) at 9 months and second dose of MCV at 15 months)" "Countries with ongoing transmission in which the risk of measles mortality remains high (countries that provide first dose of measles-containing vaccine (MCV) at 9 months and second dose of MCV at 15 months)"
  * ^definition = """Countries with ongoing transmission in which the risk of measles mortality remains high (countries that provide first dose of measles-containing vaccine (MCV) at 9 months and second dose of MCV at 15 months)
Referenced in the following locations:
 * Decision Tables: IMMZ.D2.DT.Measles.Ongoingtransmission
 * Tabs: Measles
...
"""
  ...
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "Measles"
* #"Countries with low levels of measles transmission (countries that provide first dose of measles-containing vaccine (MCV) at 12 months and second dose of MCV at 15 months)" "Countries with low levels of measles transmission (countries that provide first dose of measles-containing vaccine (MCV) at 12 months and second dose of MCV at 15 months)"
  * ^definition = """Countries with low levels of measles transmission (countries that provide first dose of measles-containing vaccine (MCV) at 12 months and second dose of MCV at 15 months)
Referenced in the following locations:
 * Decision Tables: IMMZ.D2.DT.Measles.Lowtransmission
 * Tabs: Measles
...
"""
  ...
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "Measles"
* #"Measles-containing vaccine dose 0 (MCV0) administration" "Measles-containing vaccine dose 0 (MCV0) administration"
  * ^definition = """Measles-containing vaccine dose 0 (MCV0) administration
Referenced in the following locations:
 * Decision Tables: IMMZ.D2.DT.Measles.MCVdose0
 * Tabs: Measles
...
//Found in input/cql/IMMZD2DTMeaslesDose0Logic.cql
...
"""
  ...
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "Measles"
* #"Measles-containing vaccine (MCV) supplementary dose administration" "Measles-containing vaccine (MCV) supplementary dose administration"
  * ^definition = """Measles-containing vaccine (MCV) supplementary dose administration
Referenced in the following locations:
 * Decision Tables: IMMZ.D2.DT.Measles.Supplementarydose
 * Tabs: Measles
...
//Found in input/cql/IMMZD2DTMeaslesSupplementaryLogic.cql
...
//Found in input/cql/IMMZD5DTMeaslesCILogic.cql
...
"""
  ...
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "Measles"
* #"Note: While vaccines are universally recommended, some clients may have contraindications to particular vaccines. Additional contraindications may be included in WHO position paper for the vaccine – Measles vaccines: WHO position paper (April 2017) (13)." "Note: While vaccines are universally recommended, some clients may have contraindications to particular vaccines. Additional contraindications may be included in WHO position paper for the vaccine – Measles vaccines: WHO position paper (April 2017) (13)."
  * ^definition = """Note: While vaccines are universally recommended, some clients may have contraindications to particular vaccines. Additional contraindications may be included in WHO position paper for the vaccine – Measles vaccines: WHO position paper (April 2017) (13).
Referenced in the following locations:
 * Decision Tables: IMMZ.D2.DT.Measles.Supplementarydose
 * Tabs: Measles
...
"""
  ...
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "Measles"
* #"Countries with high incidence and mortality from rubella" "Countries with high incidence and mortality from rubella"
  * ^definition = """Countries with high incidence and mortality from rubella
Referenced in the following locations:
 * Decision Tables: IMMZ.D2.DT.Rubella.Highincidence
 * Tabs: Rubella
...
//Found in input/cql/IMMZD2DTRubellaLowLogic.cql
...
"""
  ...
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "Rubella"
* #"Countries with low incidence of rubella" "Countries with low incidence of rubella"
  * ^definition = """Countries with low incidence of rubella
Referenced in the following locations:
 * Decision Tables: IMMZ.D2.DT.Rubella.Lowincidence
 * Tabs: Rubella
...
* #"The client is currently pregnant" "\"Potential contraindications\" = \"Currently pregnant\""
  * ^definition = """"Potential contraindications" = "Currently pregnant"
Referenced in the following locations:
 * Decision Tables: IMMZ.D5.DT.Rubellacontraindications
 * Tabs: Rubella
...
"""
  ...
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "Rubella"
* #"Do not vaccinate client with rubella as rubella vaccination is contraindicated for pregnant client." "Do not vaccinate client with rubella as rubella vaccination is contraindicated for pregnant client."
  * ^definition = """Do not vaccinate client with rubella as rubella vaccination is contraindicated for pregnant client.
Referenced in the following locations:
 * Decision Tables: IMMZ.D5.DT.Rubellacontraindications
 * Tabs: Rubella
...
"""
  ...
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "Rubella"
* #"2-dose schedule" "2-dose schedule"
  * ^definition = """2-dose schedule
Referenced in the following locations:
 * Decision Tables: IMMZ.D2.DT.HPV.2doses
 * Tabs: HPV
...
"""
  ...
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "HPV"
* #"Alternative single-dose schedule" "Alternative single-dose schedule"
  * ^definition = """Alternative single-dose schedule
Referenced in the following locations:
 * Decision Tables: IMMZ.D2.DT.HPV.Singledose
 * Tabs: HPV
...
"""
  ...
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "HPV"
* #"Human papillomavirus (HPV) vaccination is contraindicated" "\"Immunization recommendation status\" = \"Contraindicated\""
  * ^definition = """"Immunization recommendation status" = "Contraindicated"
Referenced in the following locations:
 * Decision Tables: IMMZ.D5.DT.HPVcontraindications
 * Tabs: HPV
...
"""
  ...
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "HPV"
* #"Do not vaccinate client with HPV as HPV vaccination is contraindicated for pregnant client." "Do not vaccinate client with HPV as HPV vaccination is contraindicated for pregnant client."
  * ^definition = """Do not vaccinate client with HPV as HPV vaccination is contraindicated for pregnant client.
Referenced in the following locations:
 * Decision Tables: IMMZ.D5.DT.HPVcontraindications
 * Tabs: HPV
...
"""
  ...
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "HPV"
* #"Inactivated Vero cell-derived vaccination schedule (2-dose scheme)" "JE vaccination should be integrated into national immunization schedules in all areas where JE is recognized as a public health priority"
  * ^definition = """JE vaccination should be integrated into national immunization schedules in all areas where JE is recognized as a public health priority
Referenced in the following locations:
 * Decision Tables: IMMZ.D2.DT.JE.InactivatedVerocell-derivedvaccine
 * Tabs: JE
...
"""
  ...
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "JE"
* #"Live attenuated vaccination schedule (1-dose scheme)" "JE vaccination should be integrated into national immunization schedules in all areas where JE is recognized as a public health priority"
  * ^definition = """JE vaccination should be integrated into national immunization schedules in all areas where JE is recognized as a public health priority
Referenced in the following locations:
 * Decision Tables: IMMZ.D2.DT.JE.Liveattenuatedvaccine
 * Tabs: JE
...
"""
  ...
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "JE"
* #"Live recombinant vaccination schedule (1-dose scheme)" "JE vaccination should be integrated into national immunization schedules in all areas where JE is recognized as a public health priority"
  * ^definition = """JE vaccination should be integrated into national immunization schedules in all areas where JE is recognized as a public health priority
Referenced in the following locations:
 * Decision Tables: IMMZ.D2.DT.JE.Liverecombinantvaccine
 * Tabs: JE
...
"""
  ...
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "JE"
* #"The client is immunocomprised" "\"Potential contraindications\" = \"Immunocompromised\""
  * ^definition = """"Potential contraindications" = "Immunocompromised"
Referenced in the following locations:
 * Decision Tables: IMMZ.D5.DT.JEcontraindications
 * Tabs: JE
...
"""
  ...
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "JE"
* #"The client is immunocompromised, consider risks of vaccination and make a judgement. Inactivated Vero cell-derived vaccines are preferred in immunocompromised clients." "The client is immunocompromised, consider risks of vaccination and make a judgement. Inactivated Vero cell-derived vaccines are preferred in immunocompromised clients."
  * ^definition = """The client is immunocompromised, consider risks of vaccination and make a judgement. Inactivated Vero cell-derived vaccines are preferred in immunocompromised clients.
Referenced in the following locations:
 * Decision Tables: IMMZ.D5.DT.JEcontraindications
 * Tabs: JE
...
Referenced in the following locations:
 * Decision Tables: IMMZ.D2.DT.Yellowfever
 * Tabs: Yellowfever
...
"""
  ...
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "Yellowfever"
...
"""
  ...
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "Yellowfever"
* #"FSME-Immun schedule" "(In areas where the disease is highly endemic, implying that there is a high individual risk of infection, WHO recommends that vaccination be offered to all age groups, including children)"
  * ^definition = """(In areas where the disease is highly endemic, implying that there is a high individual risk of infection, WHO recommends that vaccination be offered to all age groups, including children)
Referenced in the following locations:
 * Decision Tables: IMMZ.D2.DT.TBE.FSME-Immun
 * Tabs: TBE
...
"""
  ...
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "TBE"
* #"Encepur schedule" "(In areas where the disease is highly endemic, implying that there is a high individual risk of infection, WHO recommends that vaccination be offered to all age groups, including children		)"
  * ^definition = """(In areas where the disease is highly endemic, implying that there is a high individual risk of infection, WHO recommends that vaccination be offered to all age groups, including children		)
Referenced in the following locations:
 * Decision Tables: IMMZ.D2.DT.TBE.Encepur
 * Tabs: TBE
...
"""
  ...
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "TBE"
* #"TBE-Moscow schedule" "(In areas where the disease is highly endemic, implying that there is a high individual risk of infection, WHO recommends that vaccination be offered to all age groups, including children	)"
  * ^definition = """(In areas where the disease is highly endemic, implying that there is a high individual risk of infection, WHO recommends that vaccination be offered to all age groups, including children	)
Referenced in the following locations:
 * Decision Tables: IMMZ.D2.DT.TBE.TBE-Moscow
 * Tabs: TBE
...
"""
  ...
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "TBE"
* #"EnceVir schedule" "(In areas where the disease is highly endemic, implying that there is a high individual risk of infection, WHO recommends that vaccination be offered to all age groups, including children					)"
  * ^definition = """(In areas where the disease is highly endemic, implying that there is a high individual risk of infection, WHO recommends that vaccination be offered to all age groups, including children					)
Referenced in the following locations:
 * Decision Tables: IMMZ.D2.DT.TBE.EnceVir
 * Tabs: TBE
...
"""
  ...
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "TBE"
* #"Conduct a risk–benefit assessment considering the incidence of the disease, consider risks of vaccination and make a clinical judgement." "Conduct a risk–benefit assessment considering the incidence of the disease,  consider risks of vaccination and make a clinical judgement."
  * ^definition = """Conduct a risk–benefit assessment considering the incidence of the disease,  consider risks of vaccination and make a clinical judgement.
Referenced in the following locations:
 * Decision Tables: IMMZ.D5.DT.TBEcontraindications
 * Tabs: TBE
...
"""
  ...
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "TBE"
* #"Typhoid conjugate vaccine (TCV) schedule" "Typhoid conjugate vaccine (TCV) schedule"
  * ^definition = """Typhoid conjugate vaccine (TCV) schedule
Referenced in the following locations:
 * Decision Tables: IMMZ.D2.DT.Typhoid.TCV
 * Tabs: Typhoid
...
"""
  ...
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "Typhoid"
* #"Unconjugated Vi polysaccharide (ViPS) schedule" "Unconjugated Vi polysaccharide (ViPS) schedule"
  * ^definition = """Unconjugated Vi polysaccharide (ViPS) schedule
Referenced in the following locations:
 * Decision Tables: IMMZ.D2.DT.Typhoid.ViPS
 * Tabs: Typhoid
...
"""
  ...
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "Typhoid"
* #"Live attenuated Ty21a vaccine schedule" "Live attenuated Ty21a vaccine schedule"
  * ^definition = """Live attenuated Ty21a vaccine schedule
Referenced in the following locations:
 * Decision Tables: IMMZ.D2.DT.Typhoid.Ty21a
 * Tabs: Typhoid
...
"""
  ...
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "Typhoid"
* #"Whole-cell (WC) vaccines schedule" "Whole-cell (WC) vaccines schedule"
  * ^definition = """Whole-cell (WC) vaccines schedule
Referenced in the following locations:
 * Decision Tables: IMMZ.D2.DT.Cholera.WCvaccines
 * Tabs: Cholera
...
"""
  ...
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "Cholera"
* #"Whole cell-recombinant B subunit (WC-rBS) vaccine, 3-dose schedule for clients aged 2–5 years" "Whole cell-recombinant B subunit (WC-rBS) vaccine, 3-dose schedule for clients aged 2–5 years"
  * ^definition = """Whole cell-recombinant B subunit (WC-rBS) vaccine, 3-dose schedule for clients aged 2–5 years
Referenced in the following locations:
 * Decision Tables: IMMZ.D2.DT.Cholera.WC-rBSvaccine3doses
 * Tabs: Cholera
...
"""
  ...
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "Cholera"
* #"Whole cell-recombinant B subunit (WC-rBS) vaccine, 2-dose schedule for clients aged over 5 years" "Whole cell-recombinant B subunit (WC-rBS) vaccine, 2-dose schedule for clients aged over 5 years"
  * ^definition = """Whole cell-recombinant B subunit (WC-rBS) vaccine, 2-dose schedule for clients aged over 5 years
Referenced in the following locations:
 * Decision Tables: IMMZ.D2.DT.Cholera.WC-rBSvaccine2doses
 * Tabs: Cholera
...
"""
  ...
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "Cholera"
* #"MenA conjugate vaccine, 1-dose schedule" "MenA conjugate vaccine, 1-dose schedule"
  * ^definition = """MenA conjugate vaccine, 1-dose schedule
Referenced in the following locations:
 * Decision Tables: IMMZ.D2.DT.Meningococcal.MenAconjugatevaccine1dose
 * Tabs: Meningococcal

"""
  * ^designation[+].value = """//Found in input/cql/MeningococcalElements.cql
...
"""
  ...
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "Meningococcal"
...
"""
  ...
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "Meningococcal"
* #"MenA conjugate vaccine, 2-dose schedule (specific context where there is a compelling reason to vaccinate infants aged under 9 months)" "MenA conjugate vaccine, 2-dose schedule (specific context where there is a compelling reason to vaccinate infants aged under 9 months)"
  * ^definition = """MenA conjugate vaccine, 2-dose schedule (specific context where there is a compelling reason to vaccinate infants aged under 9 months)
Referenced in the following locations:
 * Decision Tables: IMMZ.D2.DT.Meningococcal.MenAconjugatevaccine2doses
 * Tabs: Meningococcal
...
"""
  ...
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "Meningococcal"
* #"Monovalent MenC conjugate vaccine schedule" "Monovalent MenC conjugate vaccine schedule"
  * ^definition = """Monovalent MenC conjugate vaccine schedule
Referenced in the following locations:
 * Decision Tables: IMMZ.D2.DT.Meningococcal.MonovalentMenCconjugatevaccine
 * Tabs: Meningococcal
...
"""
  ...
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "Meningococcal"
* #"Quadrivalent conjugate vaccines (A,C,W135,Y-CRM), 1-dose schedule" "Quadrivalent conjugate vaccines (A,C,W135,Y-CRM), 1-dose schedule"
  * ^definition = """Quadrivalent conjugate vaccines (A,C,W135,Y-CRM), 1-dose schedule
Referenced in the following locations:
 * Decision Tables: IMMZ.D2.DT.Meningococcal.Quadrivalentconjugatevaccines1dose
 * Tabs: Meningococcal
...
"""
  ...
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "Meningococcal"
* #"Quadrivalent conjugate vaccines (A,C,W135,Y-D), 2-dose schedule" "Quadrivalent conjugate vaccines (A,C,W135,Y-D), 2-dose schedule"
  * ^definition = """Quadrivalent conjugate vaccines (A,C,W135,Y-D), 2-dose schedule
Referenced in the following locations:
 * Decision Tables: IMMZ.D2.DT.Meningococcal.Quadrivalentconjugatevaccines2doses
 * Tabs: Meningococcal
...
"""
  ...
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "Meningococcal"
* #"Polysaccharide vaccines schedule" "(Polysaccharide vaccines can be used to control outbreaks in countries where limited economic resources or insufficient supply restrict the use of meningococcal conjugate vaccines)"
  * ^definition = """(Polysaccharide vaccines can be used to control outbreaks in countries where limited economic resources or insufficient supply restrict the use of meningococcal conjugate vaccines)
Referenced in the following locations:
 * Decision Tables: IMMZ.D2.DT.Meningococcal.Polysaccharidevaccines
 * Tabs: Meningococcal
...
"""
  ...
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "Meningococcal"
* #"Meningococcal vaccination could be contraindicated. Clinical judgement is required. Create a clinical note" "\"Immunization recommendation status\" (where \"Type of meningococcal dose\" = \"Polysaccharide vaccine\") = \"Further evaluation needed\""
...
Referenced in the following locations:
 * Decision Tables: IMMZ.D5.DT.Meningococcalcontraindications
 * Tabs: Meningococcal
...
//Found in input/cql/IMMZD5DTMeningococcalCILogic.cql
...
"""
  ...
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "Meningococcal"
* #"Do not vaccinate client with meningococcal if client has history of severe allergic reaction to any component of the meningococcal vaccine." "Do not vaccinate client with meningococcal if client has history of severe allergic reaction to any component of the meningococcal vaccine."
  * ^definition = """Do not vaccinate client with meningococcal if client has history of severe allergic reaction to any component of the meningococcal vaccine.
Referenced in the following locations:
 * Decision Tables: IMMZ.D5.DT.Meningococcalcontraindications
 * Tabs: Meningococcal
...
"""
  ...
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "Meningococcal"
* #"Inactivated hepatitis A virus (HAV), 2-dose schedule" "Inactivated hepatitis A virus (HAV), 2-dose schedule"
  * ^definition = """Inactivated hepatitis A virus (HAV), 2-dose schedule
Referenced in the following locations:
 * Decision Tables: IMMZ.D2.DT.HepatitisA.InactivatedHAV2doses
 * Tabs: HepatitisA
...
"""
  ...
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "HepatitisA"
...
"""
  ...
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "HepatitisA"
* #"Inactivated hepatitis A virus (HAV), 1-dose schedule" "Inactivated hepatitis A virus (HAV), 1-dose schedule"
  * ^definition = """Inactivated hepatitis A virus (HAV), 1-dose schedule
Referenced in the following locations:
 * Decision Tables: IMMZ.D2.DT.HepatitisA.InactivatedHAV1dose
 * Tabs: HepatitisA
...
"""
  ...
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "HepatitisA"
* #"Live attenuated hepatitis A virus (HAV), 1 dose schedule" "Live attenuated hepatitis A virus (HAV), 1 dose schedule"
  * ^definition = """Live attenuated hepatitis A virus (HAV), 1 dose schedule
Referenced in the following locations:
 * Decision Tables: IMMZ.D2.DT.HepatitisA.LiveattenuatedHAV1dose
 * Tabs: HepatitisA
...
Referenced in the following locations:
 * Decision Tables: IMMZ.D5.DT.HepatitisAcontraindications
 * Tabs: HepatitisA
...
"""
  ...
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "HepatitisA"
* #"Do not vaccinate client with hepatitis A as hepatitis A vaccination is contraindicated for pregnant client and may pose a theoretical risk to the developing fetus." "Do not vaccinate client with hepatitis A as hepatitis A  vaccination is contraindicated for pregnant client and may pose a theoretical risk to the developing fetus."
  * ^definition = """Do not vaccinate client with hepatitis A as hepatitis A  vaccination is contraindicated for pregnant client and may pose a theoretical risk to the developing fetus.
Referenced in the following locations:
 * Decision Tables: IMMZ.D5.DT.HepatitisAcontraindications
 * Tabs: HepatitisA
...
"""
  ...
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "HepatitisA"
* #"Pre-exposure prophylaxis (PrEP), 2-dose scheme; high risk of rabies virus exposure" "Pre-exposure prophylaxis (PrEP), 2-dose scheme; high risk of rabies virus exposure"
  * ^definition = """Pre-exposure prophylaxis (PrEP), 2-dose scheme; high risk of rabies virus exposure
Referenced in the following locations:
 * Decision Tables: IMMZ.D2.DT.Rabies
 * Tabs: Rabies

"""
  * ^designation[+].value = """//Found in input/cql/RabiesElements.cql
...
"""
  ...
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "Rabies"
* #"Check if the client has a history of severe hypersensitivity to any of the components or to excipients listed by the vaccine manufacturer. If so, provide an alternative rabies vaccine product for PreP." "Check if the client has a history of severe hypersensitivity to any of the components or to excipients listed by the vaccine manufacturer. If so, provide an alternative rabies vaccine product for PreP."
  * ^definition = """Check if the client has a history of severe hypersensitivity to any of the components or to excipients listed by the vaccine manufacturer. If so, provide an alternative rabies vaccine product for PreP.
Referenced in the following locations:
 * Decision Tables: IMMZ.D5.DT.Rabiescontraindications
 * Tabs: Rabies
...
"""
  ...
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "Rabies"
* #"CYD-TDV (Dengvaxia), 3-dose schedule with pre-vaccination screening, the recommended strategy where feasible (pre-vaccination screening whereby only those tested seropositive would be vaccinated)" "CYD-TDV (Dengvaxia), 3-dose schedule with pre-vaccination screening, the recommended strategy where feasible (pre-vaccination screening whereby only those tested seropositive would be vaccinated)"
  * ^definition = """CYD-TDV (Dengvaxia), 3-dose schedule with pre-vaccination screening, the recommended strategy where feasible (pre-vaccination screening whereby only those tested seropositive would be vaccinated)
Referenced in the following locations:
 * Decision Tables: IMMZ.D2.DT.Dengue.3doseswithpre-vaccinationscreening
 * Tabs: Dengue
...
"""
  ...
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "Dengue"
* #"CYD-TDV (Dengvaxia), 3-dose schedule without pre-vaccination screening [when pre-vaccination screening is not feasible and in areas with recent documentation of seroprevalence rates of at least 80% by age 9 years]" "CYD-TDV (Dengvaxia), 3-dose schedule without pre-vaccination screening [when pre-vaccination screening is not feasible and in areas with recent documentation of seroprevalence rates of at least 80% by age 9 years]"
  * ^definition = """CYD-TDV (Dengvaxia), 3-dose schedule without pre-vaccination screening [when pre-vaccination screening is not feasible and in areas with recent documentation of seroprevalence rates of at least 80% by age 9 years]
Referenced in the following locations:
 * Decision Tables: IMMZ.D2.DT.Dengue.3doseswithoutpre-vaccinationscreening
 * Tabs: Dengue
...
* #"The client is immunocompromised" "\"Potential contraindications\" = \"Immunocompromised\""
  * ^definition = """"Potential contraindications" = "Immunocompromised"
Referenced in the following locations:
 * Decision Tables: IMMZ.D5.DT.Denguecontraindications
 * Tabs: Dengue
...
//Found in input/cql/IMMZD5DTDengueCILogic.cql
...
"""
  ...
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "Dengue"
* #"4-dose schedule (The RTS,S/AS01 malaria vaccine should be used for the prevention of Plasmodium falciparum malaria in children living in regions with moderate to high malaria transmission, as defined by WHO)" "4-dose schedule (The RTS,S/AS01 malaria vaccine should be used for the prevention of Plasmodium falciparum malaria in children living in regions with moderate to high malaria transmission, as defined by WHO)"
  * ^definition = """4-dose schedule (The RTS,S/AS01 malaria vaccine should be used for the prevention of Plasmodium falciparum malaria in children living in regions with moderate to high malaria transmission, as defined by WHO)
Referenced in the following locations:
 * Decision Tables: IMMZ.D2.DT.Malaria
 * Tabs: Malaria
...
//Found in input/cql/IMMZD2DTMalaria4DoseLogic.cql
...
"""
  ...
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "Malaria"
* #"The client has hypersensitivity to any of the vaccine components" "\"Potential contraindications\" = \"Hypersensitivity to vaccine components\""
  * ^definition = """"Potential contraindications" = "Hypersensitivity to vaccine components"
Referenced in the following locations:
 * Decision Tables: IMMZ.D5.DT.Malariacontraindications
 * Tabs: Malaria
...
//Found in input/cql/IMMZD5DTMalariaEncounterElements.cql
...
//Found in input/cql/IMMZD5DTMalariaElements.cql
...
"""
  ...
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "Malaria"
* #"Malaria vaccination could be contraindicated. Clinical judgement is required. Create a clinical note" "\"Immunization recommendation status\" =  \"Further evaluation needed\""
  * ^definition = """"Immunization recommendation status" =  "Further evaluation needed"
Referenced in the following locations:
 * Decision Tables: IMMZ.D5.DT.Malariacontraindications
 * Tabs: Malaria
...
"""
  ...
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "Malaria"
* #"Do not vaccinate client with RTS,S/AS01 vaccine if client has severe hypersensitivity to any of the vaccine components." "Do not vaccinate client with RTS,S/AS01 vaccine if client has severe hypersensitivity to any of the vaccine components."
  * ^definition = """Do not vaccinate client with RTS,S/AS01 vaccine if client has severe hypersensitivity to any of the vaccine components.
Referenced in the following locations:
 * Decision Tables: IMMZ.D5.DT.Malariacontraindications
 * Tabs: Malaria
...
"""
  ...
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "Malaria"
* #"2-dose schedule (countries with mumps in schedule and low transmission of measles)" "2-dose schedule (countries with mumps in schedule and low transmission of measles)"
  * ^definition = """2-dose schedule (countries with mumps in schedule and low transmission of measles)
Referenced in the following locations:
 * Decision Tables: IMMZ.D2.DT.Mumps
 * Tabs: Mumps

"""
  * ^designation[+].value = """//Found in input/cql/MumpsElements.cql
...
* #"Mumps vaccination is contraindicated" "\"Immunization recommendation status\" = \"Contraindicated\""
  * ^definition = """"Immunization recommendation status" = "Contraindicated"
Referenced in the following locations:
 * Decision Tables: IMMZ.D5.DT.Mumpscontraindications
 * Tabs: Mumps
...
"""
  ...
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "Mumps"
* #"Do not vaccinate client with mumps as mumps vaccination is contraindicated for pregnant individuals." "Do not vaccinate client with mumps as mumps vaccination is contraindicated for pregnant individuals."
  * ^definition = """Do not vaccinate client with mumps as mumps vaccination is contraindicated for pregnant individuals.
Referenced in the following locations:
 * Decision Tables: IMMZ.D5.DT.Mumpscontraindications
 * Tabs: Mumps
...
"""
  ...
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "Mumps"
* #"Inactivated trivalent and quadrivalent vaccines, 2-dose schedule" "Inactivated trivalent and quadrivalent vaccines, 2-dose schedule"
  * ^definition = """Inactivated trivalent and quadrivalent vaccines, 2-dose schedule
Referenced in the following locations:
 * Decision Tables: IMMZ.D2.DT.Seasonalinfluenza
...
"""
  ...
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "Seasonalinfluenza"
...
* #"Seasonal influenza vaccination could be contraindicated. Clinical judgement is required. Create a clinical note" "'\"Immunization recommendation status\" = \"Further evaluation needed\""
  * ^definition = """'"Immunization recommendation status" = "Further evaluation needed"
Referenced in the following locations:
 * Decision Tables: IMMZ.D5.DT.Seasonalinfluenzacontraindications
 * Tabs: Seasonalinfluenza
...
* #"Countries where varicella is an important public health burden could consider introducing varicella vaccination in the routine childhood immunization programme. However, resources should be sufficient to ensure reaching and sustaining vaccine coverage ≥ 80%. Decision-making on childhood varicella vaccination should also include consideration of the possible impact on herpes zoster." "The number of doses recommended is dependent on the goal of the vaccination programme. One dose is sufficient to reduce mortality and severe morbidity from varicella but not to prevent limited virus circulation and outbreaks. Two doses have higher effectiveness and should therefore be recommended in countries where the programmatic goal is, in addition to decreasing mortality and severe morbidity, to further reduce the number of cases and outbreaks."
  * ^definition = """The number of doses recommended is dependent on the goal of the vaccination programme. One dose is sufficient to reduce mortality and severe morbidity from varicella but not to prevent limited virus circulation and outbreaks. Two doses have higher effectiveness and should therefore be recommended in countries where the programmatic goal is, in addition to decreasing mortality and severe morbidity, to further reduce the number of cases and outbreaks.
Referenced in the following locations:
 * Decision Tables: IMMZ.D2.DT.Varicella.1dose
 * Tabs: Varicella
...
"""
  ...
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "Varicella"
* #"1-dose schedule" "1-dose schedule"
  * ^definition = """1-dose schedule
Referenced in the following locations:
 * Decision Tables: IMMZ.D2.DT.Varicella.1dose
 * Tabs: Varicella
...
//Found in input/cql/IMMZD2DTVaricella1DoseLogic.cql
...
Referenced in the following locations:
 * Decision Tables: IMMZ.D2.DT.Varicella.2doses
 * Tabs: Varicella
...
"""
  ...
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "Varicella"
* #"Varicella vaccination is contraindicated" "\"Immunization recommendation status\" = \"Contraindicated\""
  * ^definition = """"Immunization recommendation status" = "Contraindicated"
Referenced in the following locations:
 * Decision Tables: IMMZ.D5.DT.Varicellacontraindications
 * Tabs: Varicella
...
//Found in input/cql/IMMZD5DTVaricellaCILogic.cql
...
"""
  ...
  * ^property[+].code = #"tab"
  * ^property[=].valueString = "Varicella"
* #"Do not vaccinate client with varicella as varicella vaccination is contraindicated for pregnant client." "Do not vaccinate client with varicella as varicella vaccination is contraindicated for pregnant client."
  * ^definition = """Do not vaccinate client with varicella as varicella vaccination is contraindicated for pregnant client.
Referenced in the following locations:
 * Decision Tables: IMMZ.D5.DT.Varicellacontraindications
 * Tabs: Varicella
