...
* #DE105 "Dose 0" "Indicates that the client received a dose of a product/ antigen that is not a part of the primary vaccination series and is administered before the primary vaccination series is provided"
...
* #DE10 "HIV status" "The current HIV status of the client"
...
* #DE84 "Type of TB infection test performed" "The type of tuberculosis (TB) infection test performed"
...
* #DE35 "Type of poliovirus dose" "The type of the poliovirus vaccine dose administered to the client"
* #DE36 "IPV" "Inactivated polio vaccine (IPV)"
* #DE37 "bOPV" "Bivalent oral polio vaccine (bOPV)"
* #DE49 "ART start date" "The date on which the client started or restarted ART"
...
* #DE53 "Inactivated Vero cell-derived vaccine" "Inactivated Vero cell-derived JE vaccine type"
* #DE54 "Live attenuated vaccine" "Live attenuated JE vaccine type"
* #DE55 "Live recombinant vaccine" "Live recombinant JE vaccine type"
* #DE56 "Type of TBE dose" "The type of tick-borne encephalitis (TBE) vaccine dose administered"
* #DE57 "FSME-Immun" "FSME-Immun vaccine product, which is an inactivated whole-virus vaccine for TBE"
* #DE58 "Encepur" "Encepur vaccine product, which is an inactivated viral vaccine for TBE"
* #DE59 "TBE-Moscow" "TBE-Moscow vaccine product, which is a vaccine for TBE"
* #DE60 "EnceVir" "EnceVir vaccine product, which is a vaccine for TBE"
* #DE61 "Type of typhoid dose" "The type of typhoid vaccine dose administered to the client"
* #DE62 "Typbar-TCV" "Typbar typhoid conjugate vaccine (Typbar-TCV)"
...
* #DE67 "WC-rBS vaccine" "Vaccine contains a mixture of the recombinant B subunit (rBS) of cholera toxin plus killed WC"
* #DE68 "Type of meningococcal dose" "The type of meningococcal vaccine dose administered to the client"
* #DE69 "MenA conjugate vaccine (5µg)" "Monovalent serogroup A (MenA) conjugate vaccine (5µg) "
...
* #DE73 "Type of hepatitis A dose" "The type of hepatitis A-containing vaccine dose administered to the client"
...
* #DE99 "Type of hepatitis B dose" "The type of hepatitis B-containing vaccine dose administered to the client"
...
* #DE76 "VNA level" "Vaccine-induced neutralizing antibody (VNA) level, measured as a serum antibody concentration from the result of the concentrated, purified cell culture-derived and embryonated egg-based rabies vaccines (CCEEV)"
* #DE98 "Risk of occupational exposure to rabies virus" "Professional at risk of occupational exposure to rabies virus, particularly animal health workers. Also considered for medical professionals who regularly provide care to persons with rabies"
