...
* insert AddWithExpandCanonical( IMMZ.Z, #DE17, [[Rubella-containing vaccines]] )
* insert AddWithExpand( $ICD11, #XM7PP1, [[Rubella vaccine]] )
* insert AddWithExpand( $SCT, #836388000, [[Rubella virus antigen-containing vaccine product]] )
* insert AddWithExpand( $ATC, #J07BJ, [[Rubella vaccines]] )
