...
* insert AddWithExpandCanonical( IMMZ.D2.DT.Inputs, #csailt12m, [[Client's age is less than 12 months]] )
* insert AddWithExpandCanonical( IMMZ.D2.DT.Inputs, #nhapsdwa, [[No hepatitis A primary series doses were administered]] )
* insert AddWithExpandCanonical( IMMZ.D2.DT.Inputs, #csaimtoet12m, [[Client's age is more than or equal to 12 months]] )
* insert AddWithExpandCanonical( IMMZ.D2.DT.Inputs, #ohapsdwa, [[One hepatitis A primary series dose was administered]] )
* insert AddWithExpandCanonical( IMMZ.D2.DT.Inputs, #tlhadwalt6ma, [[The latest Hepatitis A dose was administered less than 6 months ago]] )
* insert AddWithExpandCanonical( IMMZ.D2.DT.Inputs, #tlhadwamt6ma, [[The latest Hepatitis A dose was administered more than 6 months ago]] )
* insert AddWithExpandCanonical( IMMZ.D2.DT.Inputs, #thapsdwa, [[Two hepatitis A primary series doses were administered]] )
