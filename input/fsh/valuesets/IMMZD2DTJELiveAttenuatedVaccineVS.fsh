...
Description: """
ValueSet IMMZD2DTJELiveAttenuatedVaccine for IMMZ.D2.DT.JE.Live attenuated vaccine.
...
* insert AddWithExpandCanonical( IMMZDAK, [[#"Client's age is less than 8 months-41"]], [[Client's age is less than 8 months]] )
...
* insert AddWithExpandCanonical( IMMZDAK, [[#"Client's age is more than or equal to 8 months-41"]], [[Client's age is more than or equal to 8 months]] )
* insert AddWithExpandCanonical( IMMZDAK, [[#"No live vaccine was administered in the last 4 weeks-101"]], [[No live vaccine was administered in the last 4 weeks]] )
