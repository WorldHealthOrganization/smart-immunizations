...
Description: """
ValueSet IMMZD2DTHPVSingleDose for IMMZ.D2.DT.HPV.Single dose.
...
* insert AddWithExpandCanonical( IMMZDAK, [[#"Client's age is between 9 and 20 years-51"]], [[Client's age is between 9 and 20 years]] )
* insert AddWithExpandCanonical( IMMZDAK, [[#"Client is due for HPV vaccination-44"]], [[Client is due for HPV vaccination]] )
* insert AddWithExpandCanonical( IMMZDAK, [[#"Client's age is more than 20 years-41"]], [[Client's age is more than 20 years]] )
