...
* insert AddWithExpandCanonical( IMMZ.Z, #DE11, [[Mumps-containing vaccines]] )
* insert AddWithExpand( $ICD11, #XM1131, [[Mumps vaccine]] )
* insert AddWithExpand( $SCT, #836498007, [[Mumps orthorubulavirus antigen-containing vaccine product]] )
* insert AddWithExpand( $ATC, #J07BE, [[Mumps vaccines]] )
