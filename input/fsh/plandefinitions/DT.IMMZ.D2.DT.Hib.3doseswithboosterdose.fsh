...
* library = Canonical(DT.IMMZ.D2.DT.Hib.3doseswithboosterdose)
* extension[+]
  * url = "http://hl7.org/fhir/uv/cpg/StructureDefinition/cpg-knowledgeCapability"
  * valueCode = #computable
* version = "{version}"
* name = "DT.IMMZ.D2.DT.Hib.3doseswithboosterdose"
* status = #draft
* experimental = false
* publisher = "WHO"
 ...
 * dynamicValue[+]
   ...
   * expression
     ...
     * expression = "Code { system: 'http://hl7.org/fhir/request-priority', code: 'routine' }"
  * action[output]
  * title = When a first dose is given to a child older than 12 months of age, only one dose is recommended. 
   * description = {description}
 ...
 * dynamicValue[+]
   ...
   * expression
     ...
     * expression = "Code { system: 'http://hl7.org/fhir/request-priority', code: 'routine' }"
  * action[output]
  * title = The interval between doses should be at least 4 weeks if 3 primary doses are given. Hib-containing vaccine is not required for healthy children aged over 5 years. 
   * description = {description}
   * definitionCanonical = Canonical(DTO.ClientisnotdueforHibvaccination)
  * dynamicValue[+]
    * path = "status"
