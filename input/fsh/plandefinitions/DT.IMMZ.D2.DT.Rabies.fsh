...
* library = Canonical(DT.IMMZ.D2.DT.Rabies)
* extension[+]
...
* relatedArtifact[+]
  ...
  * action[output]
  * title = The schedule is for a 2-site intradermal vaccine administered on days 0 and 7. If intramuscular administration is used, WHO recommends a 1-site intramuscular vaccine administration on days 0 and 7.
 ...
 * dynamicValue[+]
  ...
  * action[output]
  * title = PrEP schedule: 2-site intradermal vaccine administered on days 0 and 7. If intramuscular administration is used, WHO recommends a 1-site intramuscular vaccine administration on days 0 and 7. 
   * description = {description}
 ...
 * dynamicValue[+]
   ...
   * expression
     ...
     * expression = "Code { system: 'http://hl7.org/fhir/request-priority', code: 'routine' }"
  * action[output]
  * title = If any doses are delayed, vaccination should be resumed, not restarted. A change in the route of administration or in vaccine product during a course is acceptable if such a change is unavoidable.
 ...
 * dynamicValue[+]
   ...
   * expression
     ...
     * expression = "Code { system: 'http://hl7.org/fhir/request-priority', code: 'routine' }"
  * action[output]
  * title = No further PrEP booster doses following a primary series of PrEP or PEP are required for individuals living in, or travelling to, high-risk areas.
