...
* insert SGDecisionTable( IMMZ.D2.DT.DTP.Delayedorinterruptedseries,"0.2.0)
...
* insert SGDecisionTableCondition("TwoDTPprimaryseriesdoseswereadministered")
* insert SGDecisionTableCondition("ThelatestDTPdosewasadministeredmorethan6monthsago")
* insert SGDecisionTableOutput(DTO.PrimaryDTPseriesiscomplete.Clientisnotdu.96abddfbd3,"Primary DTP series is complete. Client is not due for tetanus and diphtheria booster dose","""  """)
...
* insert SGDecisionTableCondition("ThelatestDTPdosewasadministeredlessthan1yearago")
...
* insert SGDecisionTableCondition("ThreeDTPprimaryseriesdoseswereadministered")
* insert SGDecisionTableCondition("Notetanusanddiphtheriaboosterdoseswereadministered")
* insert SGDecisionTableCondition("ThelatestDTPdosewasadministeredmorethan1yearago")
