...
* insert SGDecisionTable( IMMZ.D2.DT.HepatitisB.Delayedstart,"0.2.0)
...
* insert SGDecisionTableCondition("NohepatitisBdoseswereadministered")
* insert SGDecisionTableCondition("ClientsageismorethanMemberStatesdefinedlowerlimit")
...
* insert SGDecisionTableCondition("OnehepatitisBdosewasadministered")
...
* insert SGDecisionTableCondition("ThelatesthepatitisBdosewasadministeredmorethan4weeksago")
* insert SGDecisionTableOutput(DTO.ClientisnotdueforahepatitisBvaccination,"Client is not due for a hepatitis B vaccination","""  """)
* insert SGDecisionTableCondition("TwohepatitisBdoseswereadministered")
* insert SGDecisionTableCondition("ThelatesthepatitisBdosewasadministeredlessthan4weeksago")
...
* insert SGDecisionTableCondition("TwohepatitisBdoseswereadministered")
* insert SGDecisionTableCondition("ThelatesthepatitisBdosewasadministeredmorethan4weeksago")
* insert SGDecisionTableCondition("ThefirsthepatitisBdosewasadministeredlessthan6monthsago")
...
* insert SGDecisionTableCondition("TwohepatitisBdoseswereadministered")
* insert SGDecisionTableCondition("ThelatesthepatitisBdosewasadministeredmorethan4weeksago")
* insert SGDecisionTableCondition("ThefirsthepatitisBdosewasadministeredmorethan6monthsago")
...
* insert SGDecisionTableCondition("ThreehepatitisBdoseswereadministered")
