...
* library = Canonical(DT.IMMZ.D2.DT.Measles.MCVdose0)
* extension[+]
...
* relatedArtifact[+]
  ...
  * action[output]
  * title = Note: The countries should apply the national immunization policy for MCV0 dose and adjust this logic accordingly.
