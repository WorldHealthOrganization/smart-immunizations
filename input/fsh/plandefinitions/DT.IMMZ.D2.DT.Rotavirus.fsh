Instance: DT.IMMZ.D2.DT.Rotavirus
InstanceOf: DD.IMMZ.D2.DT.Rotavirus
Title: "Decision Table Determine required vaccinations"
Description: """Determine required vaccinations """
Usage: #definition
* meta.profile[+] = "http://hl7.org/fhir/uv/crmi/StructureDefinition/crmi-shareableplandefinition"
* meta.profile[+] = "http://hl7.org/fhir/uv/crmi/StructureDefinition/crmi-publishableplandefinition"
* library = Canonical(DTs.Rotavirus)
* extension[+]
...
WHO recommends that the first dose of rotavirus vaccine be administered as soon as possible after 6 weeks of age. """
  * definitionCanonical = Canonical(DTO.Clientisnotdueforrotavirusvaccination)
  * dynamicValue[+]
    * path = "status"
    * expression
...
"""
  * definitionCanonical = Canonical(DTO.Clientisdueforrotavirusvaccination)
  * dynamicValue[+]
    * path = "status"
    * expression
      * language = #text/cql-expression
...
"""
  * definitionCanonical = Canonical(DTO.Rotavirusimmunizationscheduleiscomplete)
  * dynamicValue[+]
    * path = "status"
    * expression
      * language = #text/cql-expression
