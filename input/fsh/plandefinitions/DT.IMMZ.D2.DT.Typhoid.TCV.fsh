...
* insert SGDecisionTable( IMMZ.D2.DT.Typhoid.TCV,"0.2.0)
...
* insert SGDecisionTableCondition("Clientsageisbetween6monthsand45years")
...
* insert SGDecisionTableCondition("Notyphoidprimaryseriesdoseswereadministered")
* insert SGDecisionTableCondition("Clientsageismorethanorequalto45years")
