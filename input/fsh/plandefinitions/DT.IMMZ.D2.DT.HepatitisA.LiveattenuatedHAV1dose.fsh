...
* insert SGDecisionTable( IMMZ.D2.DT.HepatitisA.LiveattenuatedHAV1dose,"0.2.0)
...
* insert SGDecisionTableCondition("Clientsageislessthan18months")
...
* insert SGDecisionTableCondition("Clientsageismorethanorequalto18months")
