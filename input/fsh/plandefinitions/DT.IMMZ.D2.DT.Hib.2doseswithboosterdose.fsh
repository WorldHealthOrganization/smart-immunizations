...
* insert SGDecisionTable( IMMZ.D2.DT.Hib.2doseswithboosterdose,"Determine required vaccinations",0.2.0)
...
* insert SGDecisionTableCondition("One Hib primary series doses was administered")
...
* insert SGDecisionTableCondition("The latest Hib dose was administered less than 8 weeks ago")
...
* insert SGDecisionTableCondition("Client's age is at least 6 weeks and not more than 5 years")
* insert SGDecisionTableCondition("Client's age was less than 1 year when first Hib dose was administered")
* insert SGDecisionTableCondition("The latest Hib dose was administered more than 8 weeks ago")
* insert SGDecisionTableGuidance("""Should vaccinate client with second Hib dose as client's age was less than 1 year when first Hib dose was adminsitered and latest Hib dose was administered more than 8 weeks ago. 
Check for contraindications.""")
* insert SGDecisionTableCondition("One Hib primary series doses was administered")
* insert SGDecisionTableCondition("Client's age is at least 6 weeks and not more than 5 years")
* insert SGDecisionTableCondition("Client's age was less than 1 year when first Hib dose was administered")
