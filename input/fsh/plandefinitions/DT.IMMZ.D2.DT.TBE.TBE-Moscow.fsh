...
* insert SGDecisionTable( IMMZ.D2.DT.TBE.TBE-Moscow,"Determine required vaccinations",0.2.0)
...
* insert SGDecisionTableOutput("Client is due for TBE vaccination","Client is due for TBE vaccination","""The TBE-Moscow vaccine is licensed for use in people aged 3 years or older.""")
...
* insert SGDecisionTableCondition("No TBE primary series doses were administered")
* insert SGDecisionTableCondition("Client's age is more than or equal to 3 years")
* insert SGDecisionTableOutput("Client is not due for TBE vaccination","Client is not due for TBE vaccination","""The manufacturer of TBE-Moscow recommends a standard primary immunization schedule of 2 doses given at an interval of 1–7 months.""")
