...
* library = Canonical(DT.IMMZ.D2.DT.Polio.Birthdose)
* extension[+]
...
Additionally, a birth dose of bOPV administered while infants are still protected by maternally_x0002_derived antibodies (up to 6 months) may prevent vaccine-associated paralytic polio (VAPP). 
   ...
   * definitionCanonical = Canonical(DTO.ClientisdueforthebOPVbirthdose)
  * dynamicValue[+]
    * path = "status"
    * expression
 ...
 * dynamicValue[+]
  ...
  * title = 
   * description = {description}
   * definitionCanonical = Canonical(DTO.ClientisnotdueforthebOPVbirthdose)
  * dynamicValue[+]
    * path = "status"
    * expression
    * language = #text/cql-expression
