...
* insert SGDecisionTableOutput(DTO.None,"None","""3-dose schedule birth dose + 2 primary series doses\, on-time start  """)
...
* insert SGDecisionTableOutput(DTO.Output,"Output","""Annotations  """)
* insert SGDecisionTableGuidance("""Guidance displayed to health worker """)
* insert SGDecisionTableOutput(DTO.None,"None","""4-dose schedule birth dose + 3 primary series doses\, on-time start  """)
