...
* insert SGDecisionTable( IMMZ.D2.DT.HepatitisB.Birthdose,"0.2.0)
...
* insert SGDecisionTableCondition("HepatitisBbirthdosewasnotadministered")
* insert SGDecisionTableCondition("ClientsageislessthanMemberStatesdefinedupperlimit")
...
* insert SGDecisionTableCondition("HepatitisBbirthdosewasnotadministered")
* insert SGDecisionTableCondition("ClientsageismorethanMemberStatesdefinedupperlimit")
...
* insert SGDecisionTableCondition("HepatitisBbirthdosewasadministered")
