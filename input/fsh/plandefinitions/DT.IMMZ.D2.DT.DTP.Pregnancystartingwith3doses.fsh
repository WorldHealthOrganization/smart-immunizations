...
* insert SGDecisionTable( IMMZ.D2.DT.DTP.Pregnancystartingwith3doses,"Determine required vaccinations",0.2.0)
...
* insert SGDecisionTableCondition("One tetanus and diphtheria booster doses were administered")
* insert SGDecisionTableCondition("Client is currently pregnant")
* insert SGDecisionTableCondition("The latest tetanus and diphtheria dose was administered less than 4 weeks ago")
...
* insert SGDecisionTableCondition("One tetanus and diphtheria booster doses were administered")
* insert SGDecisionTableCondition("Client is currently pregnant")
* insert SGDecisionTableCondition("The latest tetanus and diphtheria dose was administered more than 4 weeks ago")
