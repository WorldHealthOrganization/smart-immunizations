...
* insert SGDecisionTable( IMMZ.D2.DT.DTP.Pregnancystartingwith3doses,"0.2.0)
...
* insert SGDecisionTableCondition("ThreeDTPprimaryseriesdoseswereadministered")
* insert SGDecisionTableCondition("Onetetanusanddiphtheriaboosterdoseswereadministered")
* insert SGDecisionTableCondition("Clientiscurrentlypregnant")
* insert SGDecisionTableCondition("Thelatesttetanusanddiphtheriadosewasadminist.dd83e830fd")
...
* insert SGDecisionTableCondition("Onetetanusanddiphtheriaboosterdoseswereadministered")
* insert SGDecisionTableCondition("Clientiscurrentlypregnant")
* insert SGDecisionTableCondition("Thelatesttetanusanddiphtheriadosewasadminist.050a9aecce")
