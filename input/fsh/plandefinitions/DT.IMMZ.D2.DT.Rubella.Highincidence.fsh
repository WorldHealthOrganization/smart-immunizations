...
* library = Canonical(DT.IMMZ.D2.DT.Rubella.Highincidence)
* extension[+]
...
* relatedArtifact[+]
  ...
  * action[output]
  * title = The first dose of rubella-containing vaccine can be delivered at 9 months of age, due to a high level of measles virus transmission. 
   * description = {description}
   * definitionCanonical = Canonical(DTO.Clientisnotdueforrubellavaccination)
  * dynamicValue[+]
    * path = "status"
    * expression
 ...
 * dynamicValue[+]
  ...
  * title = The first dose of rubella-containing vaccine can be delivered at 9 months of age, due to a high level of measles virus transmission. 
   * description = {description}
   * definitionCanonical = Canonical(DTO.Clientisdueforrubellavaccination)
  * dynamicValue[+]
    * path = "status"
    * expression
    * language = #text/cql-expression
 ...
 * dynamicValue[+]
  ...
  * title = – 
   * description = {description}
   * definitionCanonical = Canonical(DTO.Rubellaimmunizationscheduleiscomplete)
  * dynamicValue[+]
    * path = "status"
    * expression
    * language = #text/cql-expression
