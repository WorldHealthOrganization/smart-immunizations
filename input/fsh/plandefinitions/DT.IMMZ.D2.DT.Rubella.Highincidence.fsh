...
* insert SGDecisionTable( IMMZ.D2.DT.Rubella.Highincidence,"Determine required vaccinations",0.2.0)


* insert SGDecisionTableOutput("Client is due for rubella vaccination","Client is due for rubella vaccination","""The first dose of rubella-containing vaccine can be delivered at 9 months of age, due to a high level of measles virus transmission.""")
