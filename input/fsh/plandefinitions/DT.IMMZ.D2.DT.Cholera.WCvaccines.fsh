...
* insert SGDecisionTableOutput(DTO.None,"None","""Whole cell-recombinant B subunit WC-rBS vaccine\, 3-dose schedule for clients aged 2–5 years  """)
...
* insert SGDecisionTableOutput(DTO.Output,"Output","""Annotations  """)
* insert SGDecisionTableGuidance("""Guidance displayed to health worker """)
* insert SGDecisionTableOutput(DTO.None,"None","""Whole cell-recombinant B subunit WC-rBS vaccine\, 2-dose schedule for clients aged over 5 years  """)
