...
* insert SGDecisionTableOutput(DTO.None,"None","""MenA conjugate vaccine\, 2-dose schedule specific context where there is a compelling reason to vaccinate infants aged under 9 months  """)
...
* insert SGDecisionTableOutput(DTO.Output,"Output","""Annotations  """)
* insert SGDecisionTableGuidance("""Guidance displayed to health worker """)
* insert SGDecisionTableOutput(DTO.None,"None","""Monovalent MenC conjugate vaccine schedule  """)
