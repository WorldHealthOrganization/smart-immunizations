...
* library = Canonical(DT.IMMZ.D2.DT.Meningococcal.MenAconjugatevaccine1dose)
* extension[+]
...
Meningococcal A conjugate vaccine: updated guidance (Feburary 2015) (21)"""
  ...
  * action[output]
  * title = For MenA conjugate vaccine (5µg), a 1-dose schedule is recommended at 9–18 months of age based on local programmatic and epidemiologic considerations. 
