...
* insert SGDecisionTable( DT.IMMZ.D2.DT.HepatitisA.InactivatedHAV2doses,0.2.0)
...
* insert SGDecisionTableGuidance("""Should not vaccinate client with first hepatitis A dose as clients age is less than 12 months. \nCheck for any other vaccines due and inform the caregiver of when to come back for the first dose. """)
...
* insert SGDecisionTableOutput(DTO.ClientisnotdueforHepatitisAvaccination,"Client is not due for Hepatitis A vaccination","""The interval between doses is flexible\, from 6 months to 4–5 years or more\, but is usually 6–18 months.  """)
