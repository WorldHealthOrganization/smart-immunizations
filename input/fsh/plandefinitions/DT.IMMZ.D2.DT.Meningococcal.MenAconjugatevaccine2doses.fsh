...
* library = Canonical(DT.IMMZ.D2.DT.Meningococcal.MenAconjugatevaccine2doses)
* extension[+]
...
* relatedArtifact[+]
  ...
  * action[output]
  * title = If, in a specific context, there is a compelling reason to vaccinate infants aged under 9 months, a 2-dose schedule should be used starting at 3 months of age, with an interval of at least 8 weeks between doses. 
