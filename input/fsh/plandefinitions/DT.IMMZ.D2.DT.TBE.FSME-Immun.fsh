...
* insert SGDecisionTable( IMMZ.D2.DT.TBE.FSME-Immun,"0.2.0)
...
* insert SGDecisionTableCondition("ThelatestTBEdosewasadministeredlessthan5monthsago")
...
* insert SGDecisionTableOutput(DTO.ClientisdueforTBEvaccination,"Client is due for TBE vaccination","""  """)
* insert SGDecisionTableCondition("TwoTBEprimaryseriesdoseswereadministered")
* insert SGDecisionTableCondition("ThelatestTBEdosewasadministeredmorethan5monthsago")
