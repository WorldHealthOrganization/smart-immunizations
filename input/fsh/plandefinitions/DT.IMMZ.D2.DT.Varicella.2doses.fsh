...
* library = Canonical(DT.IMMZ.D2.DT.Varicella.2doses)
* extension[+]
...
* relatedArtifact[+]
  ...
  * action[output]
  * title = Depending on the goal of the vaccination programme, 1–2 doses should be given with the first dose administered at 12–18 months of age. 
   * description = {description}
   * definitionCanonical = Canonical(DTO.Clientisnotdueforvaricellavaccination)
  * dynamicValue[+]
    * path = "status"
    * expression
 ...
 * dynamicValue[+]
  ...
  * title = 
   * description = {description}
   * definitionCanonical = Canonical(DTO.Clientisdueforvaricellavaccination)
  * dynamicValue[+]
    * path = "status"
    * expression
    * language = #text/cql-expression
 ...
 * dynamicValue[+]
   ...
   * expression
     ...
     * expression = "Code { system: 'http://hl7.org/fhir/request-priority', code: 'routine' }"
  * action[output]
  * title = The minimum interval between doses should be as recommended by the manufacturer, ranging from 4 weeks to 3 months. 
   * description = {description}
   * definitionCanonical = Canonical(DTO.Clientisnotdueforvaricellavaccination)
  * dynamicValue[+]
    * path = "status"
 ...
 * dynamicValue[+]
   ...
   * expression
     ...
     * expression = "Code { system: 'http://hl7.org/fhir/request-priority', code: 'routine' }"
  * action[output]
  * title = Varicella-containing vaccine can be administered concomitantly with other vaccines included in the routine childhood immunization programme. Unless given together with other live viral vaccines (measles, MR, MMR), it should be administered at a minimum interval of 28 days. 
   * description = {description}
   * definitionCanonical = Canonical(DTO.Clientisnotdueforvaricellavaccination)
  * dynamicValue[+]
    * path = "status"
 ...
 * dynamicValue[+]
  ...
  * title = – 
   * description = {description}
   * definitionCanonical = Canonical(DTO.Varicellaimmunizationscheduleiscomplete)
  * dynamicValue[+]
    * path = "status"
    * expression
    * language = #text/cql-expression
