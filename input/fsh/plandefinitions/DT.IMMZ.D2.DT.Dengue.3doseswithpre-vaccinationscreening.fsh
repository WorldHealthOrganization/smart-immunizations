...
* insert SGDecisionTable( IMMZ.D2.DT.Dengue.3doseswithpre-vaccinationscreening,"Determine required vaccinations",0.2.0)
...
* insert SGDecisionTableCondition("Client's age is more than 45 years")
* insert SGDecisionTableOutput("Client is not due for dengue vaccination","Client is not due for dengue vaccination","""Because of the excess risk of hospitalized dengue identified among seronegative trial participants who became infected after vaccination, the WHO Global Advisory Committee on Vaccine Safety \(GACVS\) concluded that individuals who have not been infected with the wild dengue virus \(i.e. who are seronegative\) should not be vaccinated with CYD-TDV \(Dengvaxia\).
...
* insert SGDecisionTableCondition("Client's dengue serostatus is negative")
...
* insert SGDecisionTableCondition("Client's dengue serostatus is negative")
* insert SGDecisionTableOutput("Client is due for dengue vaccination","Client is due for dengue vaccination","""Pre-vaccination screening is necessary to avoid vaccinating truly seronegative persons.""")
...
* insert SGDecisionTableCondition("Client's dengue serostatus is positive")
