...
* library = Canonical(DT.IMMZ.D2.DT.Typhoid.Ty21a)
* extension[+]
...
Typhoid vaccines: WHO position paper (March 2018) (16)"""
  ...
  * action[output]
  * title = Countries may consider the routine use of Ty21a vaccine for individuals aged over 6 years. 
 ...
 * dynamicValue[+]
  ...
  * action[output]
  * title = For Ty21a, a 3-dose oral immunization schedule, administering the vaccine every second (alternate) day, is recommended above 6 years of age. If interruption between doses is > 21 days, restart primary series. 
   * description = {description}
 ...
 * dynamicValue[+]
   ...
   * expression
     ...
     * expression = "Code { system: 'http://hl7.org/fhir/request-priority', code: 'routine' }"
  * action[output]
  * title = As a general rule, any live vaccine may be given either simultaneously or at an interval of 4 weeks. 
   * description = {description}
   * definitionCanonical = Canonical(DTO.ClientisnotdueforTyphoidvaccination)
  * dynamicValue[+]
    * path = "status"
 ...
 * dynamicValue[+]
   ...
   * expression
     ...
     * expression = "Code { system: 'http://hl7.org/fhir/request-priority', code: 'routine' }"
  * action[output]
  * title = Revaccination is recommended every 3–7 years for Ty21a (every 1 to 7 years for travellers from non-endemic to endemic areas, depending on national policies). As a general rule, any live vaccine may be given either simultaneously or at an interval of 4 weeks. 
   * description = {description}
