Instance: DT.IMMZ.D2.DT.Meningococcal.MonovalentMenCcon8355565df4
InstanceOf: DD.IMMZ.D2.DT.Meningococcal.MonovalentMenCcon5b92ae9190
...
* version = "{version}"
* name = "DT.IMMZ.D2.DT.Meningococcal.MonovalentMenCcon8355565df4"
* status = #draft
* experimental = false
* publisher = "WHO"
...
"Completed the primary vaccination series" (where "Vaccine type" = "Meningococcal vaccines") = TRUE
"""
  * definitionCanonical = Canonical(DTO.Theprimaryseriesiscomplete.Clientisduefor735fd5cd82)
  * dynamicValue[+]
    * path = "status"
    * expression
      * language = #text/cql-expression
