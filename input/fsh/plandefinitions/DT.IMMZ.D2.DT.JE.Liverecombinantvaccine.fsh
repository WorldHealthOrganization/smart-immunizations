...
* insert SGDecisionTable( IMMZ.D2.DT.JE.Liverecombinantvaccine,"Determine required vaccinations",0.2.0)
...
* insert SGDecisionTableCondition("Client's age is more than or equal to 9 months")
* insert SGDecisionTableCondition("No live vaccine was administered in the last 4 weeks")
* insert SGDecisionTableOutput("Client is not due for JE vaccination","Client is not due for JE vaccination","""Live recombinant vaccine: Single dose administered at ≥ 9 months of age. As a general rule, any live vaccine may be given either simultaneously or at an interval of 4 weeks.""")
* insert SGDecisionTableCondition("No JE primary series doses were administered")
* insert SGDecisionTableCondition("Client's age is more than or equal to 9 months")
...
* insert SGDecisionTableCondition("One JE primary series doses were administered")
