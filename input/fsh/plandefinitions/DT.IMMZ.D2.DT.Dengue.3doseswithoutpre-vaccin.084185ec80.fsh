...
* library = Canonical(DT.IMMZ.D2.DT.Dengue.3doseswithoutpre-vaccin.084185ec80)
* extension[+]
  * url = "http://hl7.org/fhir/uv/cpg/StructureDefinition/cpg-knowledgeCapability"
  * valueCode = #computable
* version = "{version}"
* name = "DT.IMMZ.D2.DT.Dengue.3doseswithoutpre-vaccin.084185ec80"
* status = #draft
* experimental = false
* publisher = "WHO"
