Instance: QIMMZD1ClientHistoryMumps
InstanceOf: sdc-questionnaire-extr-smap
Title: "Capture Client History Questionnaire - Mumps"
Description: "Immunization - Capture Client History Questionnaire for Mumps Immunization"
Usage: #definition
* id = "IMMZD1ClientHistoryMumps"
* version = "2023"
* status = #draft
* subjectType = #Patient
* language = #en
...
* contained[+] = IMMZ.Z.DE11

* extension[+].url = "http://hl7.org/fhir/uv/sdc/StructureDefinition/sdc-questionnaire-targetStructureMap"
* extension[=].valueCanonical = "http://smart.who.int/ig/smart-immunizations/StructureMap/IMMZD1MumpsQRToResources"
