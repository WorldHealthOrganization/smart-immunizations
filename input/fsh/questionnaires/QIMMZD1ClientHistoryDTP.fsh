Instance: QIMMZD1ClientHistoryDTP
InstanceOf: sdc-questionnaire-extr-smap
Title: "Capture Client History Questionnaire - DTP"
Description: "Immunization - Capture Client History Questionnaire for DTP Immunization"
Usage: #definition
* id = "IMMZD1ClientHistoryDTP"
* version = "2024"
* status = #draft
* subjectType = #Patient
* language = #en
...
* item[=]
  ...
  * item[=]
    * answerValueSet = Canonical(IMMZ.Z.DE24)
    * code[+] = IMMZ.D#DE19
    * code[+] = $LNC#39236-5
    * code[+] = $SCT#787859002
