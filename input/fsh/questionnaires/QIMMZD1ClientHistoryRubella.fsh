Instance: QIMMZD1ClientHistoryRubella
InstanceOf: sdc-questionnaire-extr-smap
Title: "Capture Client History Questionnaire - Rubella"
Description: "Immunization - Capture Client History Questionnaire for Rubella Immunization"
Usage: #definition
* id = "IMMZD1ClientHistoryRubella"
* version = "2023"
* status = #draft
* subjectType = #Patient
* language = #en
...
* contained[+] = IMMZ.Z.DE17

* extension[+].url = "http://hl7.org/fhir/uv/sdc/StructureDefinition/sdc-questionnaire-targetStructureMap"
* extension[=].valueCanonical = "http://smart.who.int/ig/smart-immunizations/StructureMap/IMMZD1RubellaQRToResources"
