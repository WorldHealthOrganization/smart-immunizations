...
| Draft as of 2025-11-25 | *Computable Name*:IMMZD5DTTBEEncounterElements |

 
This library defines encounter-based elements for TBE used throughout the Immunization CPG 

* * **Content:**application/elm+xml: ````Encoded data (16720 characters)````: **Id:**
  * ?: IMMZD5DTTBEEncounterElements
* * **Content:**application/elm+xml: ````Encoded data (16720 characters)````: **Version:**
  * ?: 0.2.0
* * **Content:**application/elm+xml: ````Encoded data (16720 characters)````: **Url:**
  * ?: [IMMZD5DTTBEEncounterElements](Library-IMMZD5DTTBEEncounterElements.md)
* * **Content:**application/elm+xml: ````Encoded data (16720 characters)````: **Status:**
  * ?: draft
* * **Content:**application/elm+xml: ````Encoded data (16720 characters)````: **Date:**
  * ?: 2025-11-25 19:41:02+0000
* * **Content:**application/elm+xml: ````Encoded data (16720 characters)````: **Publisher:**
  * ?: WHO
* * **Content:**application/elm+xml: ````Encoded data (16720 characters)````: **Description:**
  * ?: This library defines encounter-based elements for TBE used throughout the Immunization CPG
