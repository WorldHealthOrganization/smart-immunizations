...
| Draft as of 2025-11-25 | *Computable Name*:IMMZIND01Logic |

 
This library defines population criteria logic for the IMMZ.IND.01 indicator in the Immunization CPG 

* * **Content:**application/elm+xml: ````Encoded data (23220 characters)````: **Id:**
  * ?: IMMZIND01Logic
* * **Content:**application/elm+xml: ````Encoded data (23220 characters)````: **Version:**
  * ?: 0.2.0
* * **Content:**application/elm+xml: ````Encoded data (23220 characters)````: **Url:**
  * ?: [IMMZIND01Logic](Library-IMMZIND01Logic.md)
* * **Content:**application/elm+xml: ````Encoded data (23220 characters)````: **Status:**
  * ?: draft
* * **Content:**application/elm+xml: ````Encoded data (23220 characters)````: **Date:**
  * ?: 2025-11-25 19:41:02+0000
* * **Content:**application/elm+xml: ````Encoded data (23220 characters)````: **Publisher:**
  * ?: WHO
* * **Content:**application/elm+xml: ````Encoded data (23220 characters)````: **Description:**
  * ?: This library defines population criteria logic for the IMMZ.IND.01 indicator in the Immunization CPG
