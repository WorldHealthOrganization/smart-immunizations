...
| Draft as of 2026-07-07 | *Computable Name*:IMMZD5DTTyphoidEncounterElements |

 
This library defines encounter-based elements for Typhoid used throughout the Immunization CPG 

* * **Content: **application/elm+xml: ````Encoded data (22660 characters)````: **Id: **
  * ?: IMMZD5DTTyphoidEncounterElements
* * **Content: **application/elm+xml: ````Encoded data (22660 characters)````: **Version: **
  * ?: 0.2.0
* * **Content: **application/elm+xml: ````Encoded data (22660 characters)````: **Url: **
  * ?: [IMMZD5DTTyphoidEncounterElements](Library-IMMZD5DTTyphoidEncounterElements.md)
* * **Content: **application/elm+xml: ````Encoded data (22660 characters)````: **Status: **
  * ?: draft
* * **Content: **application/elm+xml: ````Encoded data (22660 characters)````: **Date: **
  * ?: 2026-07-07 22:08:04+0000
* * **Content: **application/elm+xml: ````Encoded data (22660 characters)````: **Publisher: **
  * ?: WHO
* * **Content: **application/elm+xml: ````Encoded data (22660 characters)````: **Description: **
  * ?: This library defines encounter-based elements for Typhoid used throughout the Immunization CPG
