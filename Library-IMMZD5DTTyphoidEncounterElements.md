...
| Draft as of 2025-11-25 | *Computable Name*:IMMZD5DTTyphoidEncounterElements |

 
This library defines encounter-based elements for Typhoid used throughout the Immunization CPG 

* * **Content:**application/elm+xml: ````Encoded data (22636 characters)````: **Id:**
  * ?: IMMZD5DTTyphoidEncounterElements
* * **Content:**application/elm+xml: ````Encoded data (22636 characters)````: **Version:**
  * ?: 0.2.0
* * **Content:**application/elm+xml: ````Encoded data (22636 characters)````: **Url:**
  * ?: [IMMZD5DTTyphoidEncounterElements](Library-IMMZD5DTTyphoidEncounterElements.md)
* * **Content:**application/elm+xml: ````Encoded data (22636 characters)````: **Status:**
  * ?: draft
* * **Content:**application/elm+xml: ````Encoded data (22636 characters)````: **Date:**
  * ?: 2025-11-25 19:41:02+0000
* * **Content:**application/elm+xml: ````Encoded data (22636 characters)````: **Publisher:**
  * ?: WHO
* * **Content:**application/elm+xml: ````Encoded data (22636 characters)````: **Description:**
  * ?: This library defines encounter-based elements for Typhoid used throughout the Immunization CPG
