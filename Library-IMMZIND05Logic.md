...
| Draft as of 2025-11-25 | *Computable Name*:IMMZIND05Logic |

 
This library defines population criteria logic for the IMMZ.IND.05 indicator in the Immunization CPG 

* * **Content:**application/elm+xml: ````Encoded data (23776 characters)````: **Id:**
  * ?: IMMZIND05Logic
* * **Content:**application/elm+xml: ````Encoded data (23776 characters)````: **Version:**
  * ?: 0.2.0
* * **Content:**application/elm+xml: ````Encoded data (23776 characters)````: **Url:**
  * ?: [IMMZIND05Logic](Library-IMMZIND05Logic.md)
* * **Content:**application/elm+xml: ````Encoded data (23776 characters)````: **Status:**
  * ?: draft
* * **Content:**application/elm+xml: ````Encoded data (23776 characters)````: **Date:**
  * ?: 2025-11-25 19:41:02+0000
* * **Content:**application/elm+xml: ````Encoded data (23776 characters)````: **Publisher:**
  * ?: WHO
* * **Content:**application/elm+xml: ````Encoded data (23776 characters)````: **Description:**
  * ?: This library defines population criteria logic for the IMMZ.IND.05 indicator in the Immunization CPG
