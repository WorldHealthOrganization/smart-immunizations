...
| Draft as of 2025-11-25 | *Computable Name*:IMMZD5DTRabiesElements |

 
This library defines context-independent elements for Rabies used throughout the Immunization CPG 

* * **Content:**application/elm+xml: ````Encoded data (12928 characters)````: **Id:**
  * ?: IMMZD5DTRabiesElements
* * **Content:**application/elm+xml: ````Encoded data (12928 characters)````: **Version:**
  * ?: 0.2.0
* * **Content:**application/elm+xml: ````Encoded data (12928 characters)````: **Url:**
  * ?: [IMMZD5DTRabiesElements](Library-IMMZD5DTRabiesElements.md)
* * **Content:**application/elm+xml: ````Encoded data (12928 characters)````: **Status:**
  * ?: draft
* * **Content:**application/elm+xml: ````Encoded data (12928 characters)````: **Date:**
  * ?: 2025-11-25 19:41:02+0000
* * **Content:**application/elm+xml: ````Encoded data (12928 characters)````: **Publisher:**
  * ?: WHO
* * **Content:**application/elm+xml: ````Encoded data (12928 characters)````: **Description:**
  * ?: This library defines context-independent elements for Rabies used throughout the Immunization CPG
