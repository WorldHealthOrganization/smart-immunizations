...
| Draft as of 2025-11-25 | *Computable Name*:IMMZD18SMeningococcalMenAConjugateVaccine1Dose |
...
```json
{
  ...
  "library" : [
    "http://smart.who.int/immunizations/Library/IMMZD18SMeningococcalMenAConjugateVaccine1DoseLogic"
  ],
  "action" : [
    {
