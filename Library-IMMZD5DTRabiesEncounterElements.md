...
| Draft as of 2025-11-25 | *Computable Name*:IMMZD5DTRabiesEncounterElements |

 
This library defines encounter-based elements for Rabies used throughout the Immunization CPG 

* * **Content:**application/elm+xml: ````Encoded data (15128 characters)````: **Id:**
  * ?: IMMZD5DTRabiesEncounterElements
* * **Content:**application/elm+xml: ````Encoded data (15128 characters)````: **Version:**
  * ?: 0.2.0
* * **Content:**application/elm+xml: ````Encoded data (15128 characters)````: **Url:**
  * ?: [IMMZD5DTRabiesEncounterElements](Library-IMMZD5DTRabiesEncounterElements.md)
* * **Content:**application/elm+xml: ````Encoded data (15128 characters)````: **Status:**
  * ?: draft
* * **Content:**application/elm+xml: ````Encoded data (15128 characters)````: **Date:**
  * ?: 2025-11-25 19:41:02+0000
* * **Content:**application/elm+xml: ````Encoded data (15128 characters)````: **Publisher:**
  * ?: WHO
* * **Content:**application/elm+xml: ````Encoded data (15128 characters)````: **Description:**
  * ?: This library defines encounter-based elements for Rabies used throughout the Immunization CPG
