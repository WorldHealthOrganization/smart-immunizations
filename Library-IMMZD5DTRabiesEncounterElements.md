# IMMZD5DTRabiesEncounterElements - WHO Immunization Implementation Guide v0.2.0
...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/Library/IMMZD5DTRabiesEncounterElements | *Version*:0.2.0 |
| Draft as of 2025-11-14 | *Computable Name*:IMMZD5DTRabiesEncounterElements |

 
This library defines encounter-based elements for Rabies used throughout the Immunization CPG 

* * **Content:**application/elm+xml: ````Encoded data (14900 characters)````: **Id:**
  * ?: IMMZD5DTRabiesEncounterElements
* * **Content:**application/elm+xml: ````Encoded data (14900 characters)````: **Version:**
  * ?: 0.2.0
* * **Content:**application/elm+xml: ````Encoded data (14900 characters)````: **Url:**
  * ?: [IMMZD5DTRabiesEncounterElements](Library-IMMZD5DTRabiesEncounterElements.md)
* * **Content:**application/elm+xml: ````Encoded data (14900 characters)````: **Status:**
  * ?: draft
* * **Content:**application/elm+xml: ````Encoded data (14900 characters)````: **Date:**
  * ?: 2025-11-14 22:57:55+0000
* * **Content:**application/elm+xml: ````Encoded data (14900 characters)````: **Publisher:**
  * ?: WHO
* * **Content:**application/elm+xml: ````Encoded data (14900 characters)````: **Description:**
  * ?: This library defines encounter-based elements for Rabies used throughout the Immunization CPG
