...
| Draft as of 2025-11-25 | *Computable Name*:IMMZD5DTBCGEncounterElements |

 
This library defines encounter-based elements for BCG used throughout the Immunization CPG 

* * **Content:**application/elm+xml: ````Encoded data (25568 characters)````: **Id:**
  * ?: IMMZD5DTBCGEncounterElements
* * **Content:**application/elm+xml: ````Encoded data (25568 characters)````: **Version:**
  * ?: 0.2.0
* * **Content:**application/elm+xml: ````Encoded data (25568 characters)````: **Url:**
  * ?: [IMMZD5DTBCGEncounterElements](Library-IMMZD5DTBCGEncounterElements.md)
* * **Content:**application/elm+xml: ````Encoded data (25568 characters)````: **Status:**
  * ?: draft
* * **Content:**application/elm+xml: ````Encoded data (25568 characters)````: **Date:**
  * ?: 2025-11-25 19:41:02+0000
* * **Content:**application/elm+xml: ````Encoded data (25568 characters)````: **Publisher:**
  * ?: WHO
* * **Content:**application/elm+xml: ````Encoded data (25568 characters)````: **Description:**
  * ?: This library defines encounter-based elements for BCG used throughout the Immunization CPG
