...
| Draft as of 2025-11-25 | *Computable Name*:IMMZD5DTHepatitisAElements |

 
This library defines context-independent elements for Hepatitis A used throughout the Immunization CPG 

* * **Content:**application/elm+xml: ````Encoded data (16784 characters)````: **Id:**
  * ?: IMMZD5DTHepatitisAElements
* * **Content:**application/elm+xml: ````Encoded data (16784 characters)````: **Version:**
  * ?: 0.2.0
* * **Content:**application/elm+xml: ````Encoded data (16784 characters)````: **Url:**
  * ?: [IMMZD5DTHepatitisAElements](Library-IMMZD5DTHepatitisAElements.md)
* * **Content:**application/elm+xml: ````Encoded data (16784 characters)````: **Status:**
  * ?: draft
* * **Content:**application/elm+xml: ````Encoded data (16784 characters)````: **Date:**
  * ?: 2025-11-25 19:41:02+0000
* * **Content:**application/elm+xml: ````Encoded data (16784 characters)````: **Publisher:**
  * ?: WHO
* * **Content:**application/elm+xml: ````Encoded data (16784 characters)````: **Description:**
  * ?: This library defines context-independent elements for Hepatitis A used throughout the Immunization CPG
