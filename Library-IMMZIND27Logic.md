...
| Draft as of 2025-11-25 | *Computable Name*:IMMZIND27Logic |

 
This library defines population criteria logic for the IMMZ.IND.27 indicator in the Immunization CPG 

* * **Content:**application/elm+xml: ````Encoded data (23216 characters)````: **Id:**
  * ?: IMMZIND27Logic
* * **Content:**application/elm+xml: ````Encoded data (23216 characters)````: **Version:**
  * ?: 0.2.0
* * **Content:**application/elm+xml: ````Encoded data (23216 characters)````: **Url:**
  * ?: [IMMZIND27Logic](Library-IMMZIND27Logic.md)
* * **Content:**application/elm+xml: ````Encoded data (23216 characters)````: **Status:**
  * ?: draft
* * **Content:**application/elm+xml: ````Encoded data (23216 characters)````: **Date:**
  * ?: 2025-11-25 19:41:02+0000
* * **Content:**application/elm+xml: ````Encoded data (23216 characters)````: **Publisher:**
  * ?: WHO
* * **Content:**application/elm+xml: ````Encoded data (23216 characters)````: **Description:**
  * ?: This library defines population criteria logic for the IMMZ.IND.27 indicator in the Immunization CPG
