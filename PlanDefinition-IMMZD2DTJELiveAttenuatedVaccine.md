...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/PlanDefinition/IMMZD2DTJELiveAttenuatedVaccine | *Version*:0.2.0 |
| Draft as of 2025-11-25 | *Computable Name*:IMMZD2DTJELiveAttenuatedVaccine |
...
```json
{
  ...
  "library" : [
    "http://smart.who.int/immunizations/Library/IMMZD2DTJELiveAttenuatedVaccineLogic"
  ],
  "action" : [
    {
      "extension" : [
