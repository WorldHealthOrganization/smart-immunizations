...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:AdverseEvent">
      <sch:assert test="count(f:extension[@url = 'http://smart.who.int/immunizations/StructureDefinition/IMMZOtherMedicalEvent']) &lt;= 1">extension with URL = 'http://smart.who.int/immunizations/StructureDefinition/IMMZOtherMedicalEvent': maximum cardinality of 'extension' is 1</sch:assert>
