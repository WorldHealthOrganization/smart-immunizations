# IMMZD2DTRabies ValueSet for Decision Table - WHO Immunization Implementation Guide v0.2.0

* [**Table of Contents**](toc.md)
* [**Indices**](indices.md)
* [**Artifact Index**](artifacts.md)
* **IMMZD2DTRabies ValueSet for Decision Table**

## ValueSet: IMMZD2DTRabies ValueSet for Decision Table 

| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/ValueSet/IMMZD2DTRabiesVS | *Version*:0.2.0 |
| Active as of 2026-07-07 | *Computable Name*:IMMZD2DTRabiesVS |

 
ValueSet IMMZD2DTRabies for IMMZ.D2.DT.Rabies. Business rule: Determine if the client is due for a rabies vaccination according to the national immunization schedule Trigger: IMMZ.D2 Determine required vaccination(s) if any Table: Pre-exposure prophylaxis (PrEP), 2-dose scheme; high risk of rabies virus exposure 
...
##### IMMZD2DTRabies ValueSet for Decision Table Schema API
...
### GET /ValueSet-IMMZD2DTRabiesVS.schema.json

#### JSON Schema definition for the enumeration ValueSet-IMMZD2DTRabiesVS

This endpoint serves the JSON Schema definition for the enumeration ValueSet-IMMZD2DTRabiesVS.

## Schema Definition

### ValueSet-IMMZD2DTRabiesVS

**Description:** JSON Schema for IMMZD2DTRabies ValueSet for Decision Table ValueSet codes. Generated from FHIR expansions using IRI format.
...
```json
{
  ...
  "id" : "IMMZD2DTRabiesVS",
  "url" : "http://smart.who.int/immunizations/ValueSet/IMMZD2DTRabiesVS",
  "version" : "0.2.0",
  "name" : "IMMZD2DTRabiesVS",
