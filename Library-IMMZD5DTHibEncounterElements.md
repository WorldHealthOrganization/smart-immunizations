...
| Draft as of 2025-11-25 | *Computable Name*:IMMZD5DTHibEncounterElements |

 
This library defines encounter-based elements for Hib used throughout the Immunization CPG 

* * **Content:**application/elm+xml: ````Encoded data (15116 characters)````: **Id:**
  * ?: IMMZD5DTHibEncounterElements
* * **Content:**application/elm+xml: ````Encoded data (15116 characters)````: **Version:**
  * ?: 0.2.0
* * **Content:**application/elm+xml: ````Encoded data (15116 characters)````: **Url:**
  * ?: [IMMZD5DTHibEncounterElements](Library-IMMZD5DTHibEncounterElements.md)
* * **Content:**application/elm+xml: ````Encoded data (15116 characters)````: **Status:**
  * ?: draft
* * **Content:**application/elm+xml: ````Encoded data (15116 characters)````: **Date:**
  * ?: 2025-11-25 19:41:02+0000
* * **Content:**application/elm+xml: ````Encoded data (15116 characters)````: **Publisher:**
  * ?: WHO
* * **Content:**application/elm+xml: ````Encoded data (15116 characters)````: **Description:**
  * ?: This library defines encounter-based elements for Hib used throughout the Immunization CPG
