...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/PlanDefinition/IMMZD2DTPneumococcal3Doses | *Version*:0.2.0 |
| Draft as of 2025-11-25 | *Computable Name*:IMMZD2DTPneumococcal3Doses |
...
```json
{
  ...
  "library" : [
    "http://smart.who.int/immunizations/Library/IMMZD2DTPneumococcal3DosesLogic"
  ],
  "action" : [
    {
      "extension" : [
