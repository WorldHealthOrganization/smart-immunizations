...
| Draft as of 2025-11-25 | *Computable Name*:IMMZD5DTJEElements |

 
This library defines context-independent elements for JE used throughout the Immunization CPG 

* * **Content:**application/elm+xml: ````Encoded data (14396 characters)````: **Id:**
  * ?: IMMZD5DTJEElements
* * **Content:**application/elm+xml: ````Encoded data (14396 characters)````: **Version:**
  * ?: 0.2.0
* * **Content:**application/elm+xml: ````Encoded data (14396 characters)````: **Url:**
  * ?: [IMMZD5DTJEElements](Library-IMMZD5DTJEElements.md)
* * **Content:**application/elm+xml: ````Encoded data (14396 characters)````: **Status:**
  * ?: draft
* * **Content:**application/elm+xml: ````Encoded data (14396 characters)````: **Date:**
  * ?: 2025-11-25 19:41:02+0000
* * **Content:**application/elm+xml: ````Encoded data (14396 characters)````: **Publisher:**
  * ?: WHO
* * **Content:**application/elm+xml: ````Encoded data (14396 characters)````: **Description:**
  * ?: This library defines context-independent elements for JE used throughout the Immunization CPG
