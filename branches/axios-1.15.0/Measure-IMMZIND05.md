# IMMZIND05 - WHO Immunization Implementation Guide v0.2.0
...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/Measure/IMMZIND05 | *Version*:0.2.0 |
| Draft as of 2025-06-11 | *Computable Name*:IMMZIND05 |

 
IMMZ.IND.05 Immunization coverage for hepatitis B-containing vaccines (birth dose) 
...
* Knowledge Artifact Metadata: Initial Population
  * ?: **ID**: IMMZ.IND.05.IP**Description**:Initial Population**Logic Definition**:[Initial Population](#immzind05logic-initial-population)
* Knowledge Artifact Metadata: Denominator
  * ?: **ID**: IMMZ.IND.05.D**Description**:Denominator**Logic Definition**:[Denominator](#immzind05logic-denominator)
* Knowledge Artifact Metadata: Numerator
  * ?: **ID**: IMMZ.IND.05.N**Description**:Numerator**Logic Definition**:[Numerator](#immzind05logic-numerator)
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.05.S1**Code**: By-Administrative Area
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.05.S2**Code**: By-Sex
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.05.S3**Code**: By-Age group
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.05.S4**Code**: By-Age group
...
* Knowledge Artifact Metadata: Dependency
  * ?: **Description**: Library HepB**Resource**:[IMMZD2DTHepatitisBElements](Library-IMMZD2DTHepatitisBElements.md)**Canonical URL**:http://smart.who.int/immunizations/Library/IMMZD2DTHepatitisBElements
* Knowledge Artifact Metadata: Dependency
...
* Knowledge Artifact Metadata: Dependency
  * ?: **Description**: Value set Hepatitis B-containing vaccines**Resource**:[IMMZ.Z.DE6 ValueSet for Hepatitis B-containing vaccines](ValueSet-IMMZ.Z.DE6.md)**Canonical URL**:http://smart.who.int/immunizations/ValueSet/IMMZ.Z.DE6
...
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**IMMZD2DTHepatitisBElements
* Knowledge Artifact Metadata: ````/* @internal: Hepatitis B containing Doses Administered to Patient */ define "Hepatitis B Doses Administered to Patient": Elements."Doses Administered to Patient" I where I.vaccineCode in Concepts."Hepatitis B-containing vaccines"````
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**IMMZD2DTHepatitisBElements
* Knowledge Artifact Metadata: ````/* @internal: Hepatitis B Dose 0 Doses Administered to Patient */ define "Hepatitis B Dose 0 Doses Administered to Patient": "Hepatitis B Doses Administered to Patient".seriesDose0()````
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**IMMZIND05Logic
* Knowledge Artifact Metadata: ````/* @numerator: Number of hepatitis B-containing vaccine birth doses administered through routine services during the reporting period @pseudocode: COUNT of immunization events WHERE "Vaccine type" = "Hepatitis B-containing vaccines" AND "Dose 0 administered" = "Yes" AND "Date and time of vaccination" is during the reporting period */ define "Numerator": exists( HepB."Hepatitis B Dose 0 Doses Administered to Patient" I where I.occurrence.toInterval() starts during "Measurement Period" )````
* Knowledge Artifact Metadata:  Logic Definition
...
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**IMMZIND05Logic
* Knowledge Artifact Metadata: ````/* @disaggregation: Administrative area Sex Age in years Age group: < 24 hours of birth */ define "Stratification 1": Elements."By Geographic Region Stratifier"````
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**IMMZIND05Logic
...
* Knowledge Artifact Metadata: ````/** * @description: Gets the doses from the dose 0 series */ define fluent function seriesDose0(immunizations List<Immunization>): immunizations I where exists( I.protocolApplied pa where pa.series = 'Dose 0' )````
* Knowledge Artifact Metadata:  Logic Definition
...
```json
{
  ...
  "url" : "http://smart.who.int/immunizations/Measure/IMMZIND05",
  "version" : "0.2.0",
  "name" : "IMMZIND05",
  "title" : "IMMZIND05",
  "status" : "draft",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZIND05Logic"],
  "scoring" : {
    "coding" : [{
