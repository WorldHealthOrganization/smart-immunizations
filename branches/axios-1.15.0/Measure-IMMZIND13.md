# IMMZIND13 - WHO Immunization Implementation Guide v0.2.0
...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/Measure/IMMZIND13 | *Version*:0.2.0 |
| Draft as of 2025-06-11 | *Computable Name*:IMMZIND13 |

 
IMMZ.IND.13 Immunization coverage for measles and rubella-containing vaccine, 2nd dose 
...
* Knowledge Artifact Metadata: Initial Population
  * ?: **ID**: IMMZ.IND.13.IP**Description**:Initial Population**Logic Definition**:[Initial Population](#immzind13logic-initial-population)
* Knowledge Artifact Metadata: Denominator
  * ?: **ID**: IMMZ.IND.13.D**Description**:Denominator**Logic Definition**:[Denominator](#immzind13logic-denominator)
* Knowledge Artifact Metadata: Numerator
  * ?: **ID**: IMMZ.IND.13.N**Description**:Numerator**Logic Definition**:[Numerator](#immzind13logic-numerator)
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.13.S1**Code**: By-Administrative Area
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.13.S2**Code**: By-Sex
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.13.S3**Code**: By-Age group
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.13.S4**Code**: By-Age group
...
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**IMMZIND13Logic
* Knowledge Artifact Metadata: ````/* @numerator: Number of measles and rubella-containing vaccine doses (2nd dose) administered through routine services during the reporting period @pseudocode: COUNT of immunization events WHERE "Vaccine type" = "Measles and rubella-containing vaccines" for the 2nd dose in the primary series AND "Date and time of vaccination" is during the reporting period */ define "Numerator": exists( Elements."Measles and Rubella Doses Administered to Patient During Measurement Period".getDose('2') )````
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**IMMZIndicatorElements
...
```json
{
  ...
  "url" : "http://smart.who.int/immunizations/Measure/IMMZIND13",
  "version" : "0.2.0",
  "name" : "IMMZIND13",
  "title" : "IMMZIND13",
  "status" : "draft",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZIND13Logic"],
  "scoring" : {
    "coding" : [{
