# IMMZIND03 - WHO Immunization Implementation Guide v0.2.0
...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/Measure/IMMZIND03 | *Version*:0.2.0 |
| Draft as of 2025-06-11 | *Computable Name*:IMMZIND03 |

 
IMMZ.IND.03 Immunization coverage for pentavalent vaccine, 2nd dose 
...
* Knowledge Artifact Metadata: Initial Population
  * ?: **ID**: IMMZ.IND.03.IP**Description**:Initial Population**Logic Definition**:[Initial Population](#immzind03logic-initial-population)
* Knowledge Artifact Metadata: Denominator
  * ?: **ID**: IMMZ.IND.03.D**Description**:Denominator**Logic Definition**:[Denominator](#immzind03logic-denominator)
* Knowledge Artifact Metadata: Numerator
  * ?: **ID**: IMMZ.IND.03.N**Description**:Numerator**Logic Definition**:[Numerator](#immzind03logic-numerator)
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.03.S1**Code**: By-Administrative Area
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.03.S2**Code**: By-Sex
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.03.S3**Code**: By-Age group
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.03.S4**Code**: By-Age group
...
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**IMMZIND03Logic
* Knowledge Artifact Metadata: ````/* @numerator: Number of pentavalent doses (2nd dose) administered through routine services during the reporting period @pseudocode: COUNT of immunization events WHERE "Vaccine type" = "Pentavalent vaccines" for the 2nd dose in the primary series AND "Date and time of vaccination" is during the reporting period */ define "Numerator": exists( Elements."Pentavalent Doses Administered to Patient During Measurement Period".getDose('2') )````
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**IMMZIndicatorElements
...
```json
{
  ...
  "url" : "http://smart.who.int/immunizations/Measure/IMMZIND03",
  "version" : "0.2.0",
  "name" : "IMMZIND03",
  "title" : "IMMZIND03",
  "status" : "draft",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZIND03Logic"],
  "scoring" : {
    "coding" : [{
