# IMMZD2DTDTPPregnancy ValueSet for Decision Table - WHO Immunization Implementation Guide v1.0.0
...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/ValueSet/IMMZD2DTDTPPregnancyVS | *Version*:1.0.0 |
| Active as of 2026-04-09 | *Computable Name*:IMMZD2DTDTPPregnancyVS |
...
##### IMMZD2DTDTPPregnancy ValueSet for Decision Table Schema API
...
### GET /ValueSet-IMMZD2DTDTPPregnancyVS.schema.json

#### JSON Schema definition for the enumeration ValueSet-IMMZD2DTDTPPregnancyVS

This endpoint serves the JSON Schema definition for the enumeration ValueSet-IMMZD2DTDTPPregnancyVS.

## Schema Definition

### ValueSet-IMMZD2DTDTPPregnancyVS

**Description:** JSON Schema for IMMZD2DTDTPPregnancy ValueSet for Decision Table ValueSet codes. Generated from FHIR expansions using IRI format.
