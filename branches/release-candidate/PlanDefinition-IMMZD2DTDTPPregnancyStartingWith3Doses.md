# IMMZ.D2.DT.DTP.Pregnancy starting with 3 doses - WHO Immunization Implementation Guide v1.0.0
...
| Draft as of 2026-04-09 | *Computable Name*:IMMZD2DTDTPPregnancyStartingWith3Doses |
...
```json
{
  ...
  "contained" : [{
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD2DTDTPPregnancyStartingWith3DosesLogic"
      },
      {
        "url" : "name",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZD2DTDTPPregnancyStartingWith3DosesLogic"],
  "action" : [{
    "extension" : [{
