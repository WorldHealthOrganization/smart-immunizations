# IMMZD5DTBCGContraindications ValueSet for Decision Table - WHO Immunization Implementation Guide v1.0.0
...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/ValueSet/IMMZD5DTBCGContraindicationsVS | *Version*:1.0.0 |
| Active as of 2026-04-09 | *Computable Name*:IMMZD5DTBCGContraindicationsVS |
...
##### IMMZD5DTBCGContraindications ValueSet for Decision Table Schema API
...
### GET /ValueSet-IMMZD5DTBCGContraindicationsVS.schema.json

#### JSON Schema definition for the enumeration ValueSet-IMMZD5DTBCGContraindicationsVS

This endpoint serves the JSON Schema definition for the enumeration ValueSet-IMMZD5DTBCGContraindicationsVS.

## Schema Definition

### ValueSet-IMMZD5DTBCGContraindicationsVS

**Description:** JSON Schema for IMMZD5DTBCGContraindications ValueSet for Decision Table ValueSet codes. Generated from FHIR expansions using IRI format.
