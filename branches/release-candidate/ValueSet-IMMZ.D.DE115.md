# IMMZ.D.DE115 ValueSet for Reaction outcome - WHO Immunization Implementation Guide v1.0.0
...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/ValueSet/IMMZ.D.DE115 | *Version*:1.0.0 |
| Active as of 2026-04-09 | *Computable Name*:IMMZ_D_DE115 |
...
##### IMMZ.D.DE115 ValueSet for Reaction outcome Schema API
...
### GET /ValueSet-IMMZ.D.DE115.schema.json

#### JSON Schema definition for the enumeration ValueSet-IMMZ.D.DE115

This endpoint serves the JSON Schema definition for the enumeration ValueSet-IMMZ.D.DE115.

## Schema Definition

### ValueSet-IMMZ.D.DE115
