# IMMZD5DTYellowFeverContraindications ValueSet for Decision Table - WHO Immunization Implementation Guide v1.0.0
...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/ValueSet/IMMZD5DTYellowFeverContraindicationsVS | *Version*:1.0.0 |
| Active as of 2026-04-09 | *Computable Name*:IMMZD5DTYellowFeverContraindicationsVS |
...
##### IMMZD5DTYellowFeverContraindications ValueSet for Decision Table Schema API
...
### GET /ValueSet-IMMZD5DTYellowFeverContraindicationsVS.schema.json

#### JSON Schema definition for the enumeration ValueSet-IMMZD5DTYellowFeverContraindicationsVS

This endpoint serves the JSON Schema definition for the enumeration ValueSet-IMMZD5DTYellowFeverContraindicationsVS.

## Schema Definition

### ValueSet-IMMZD5DTYellowFeverContraindicationsVS

**Description:** JSON Schema for IMMZD5DTYellowFeverContraindications ValueSet for Decision Table ValueSet codes. Generated from FHIR expansions using IRI format.
