# IMMZD5DTMalariaContraindications ValueSet for Decision Table - WHO Immunization Implementation Guide v1.0.0
...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/ValueSet/IMMZD5DTMalariaContraindicationsVS | *Version*:1.0.0 |
| Active as of 2026-04-09 | *Computable Name*:IMMZD5DTMalariaContraindicationsVS |
...
##### IMMZD5DTMalariaContraindications ValueSet for Decision Table Schema API
...
### GET /ValueSet-IMMZD5DTMalariaContraindicationsVS.schema.json

#### JSON Schema definition for the enumeration ValueSet-IMMZD5DTMalariaContraindicationsVS

This endpoint serves the JSON Schema definition for the enumeration ValueSet-IMMZD5DTMalariaContraindicationsVS.

## Schema Definition

### ValueSet-IMMZD5DTMalariaContraindicationsVS

**Description:** JSON Schema for IMMZD5DTMalariaContraindications ValueSet for Decision Table ValueSet codes. Generated from FHIR expansions using IRI format.
