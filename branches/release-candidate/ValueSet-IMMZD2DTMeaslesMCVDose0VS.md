# IMMZD2DTMeaslesMCVDose0 ValueSet for Decision Table - WHO Immunization Implementation Guide v1.0.0
...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/ValueSet/IMMZD2DTMeaslesMCVDose0VS | *Version*:1.0.0 |
| Active as of 2026-04-09 | *Computable Name*:IMMZD2DTMeaslesMCVDose0VS |
...
##### IMMZD2DTMeaslesMCVDose0 ValueSet for Decision Table Schema API
...
### GET /ValueSet-IMMZD2DTMeaslesMCVDose0VS.schema.json

#### JSON Schema definition for the enumeration ValueSet-IMMZD2DTMeaslesMCVDose0VS

This endpoint serves the JSON Schema definition for the enumeration ValueSet-IMMZD2DTMeaslesMCVDose0VS.

## Schema Definition

### ValueSet-IMMZD2DTMeaslesMCVDose0VS

**Description:** JSON Schema for IMMZD2DTMeaslesMCVDose0 ValueSet for Decision Table ValueSet codes. Generated from FHIR expansions using IRI format.
