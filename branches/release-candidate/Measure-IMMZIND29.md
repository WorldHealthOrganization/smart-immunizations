# IMMZIND29 - WHO Immunization Implementation Guide v1.0.0
...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/Measure/IMMZIND29 | *Version*:1.0.0 |
| Draft as of 2025-06-11 | *Computable Name*:IMMZIND29 |

 
IMMZ.IND.29 Immunization coverage for seasonal influenza vaccines 
...
* Knowledge Artifact Metadata: Initial Population
  * ?: **ID**: IMMZ.IND.29.IP**Description**:Initial Population**Logic Definition**:[Initial Population](#immzind29logic-initial-population)
* Knowledge Artifact Metadata: Denominator
  * ?: **ID**: IMMZ.IND.29.D**Description**:Denominator**Logic Definition**:[Denominator](#immzind29logic-denominator)
* Knowledge Artifact Metadata: Numerator
  * ?: **ID**: IMMZ.IND.29.N**Description**:Numerator**Logic Definition**:[Numerator](#immzind29logic-numerator)
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.29.S1**Code**: By-Administrative Area
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.29.S2**Code**: By-Sex
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.29.S3**Code**: By-Age group
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.29.S4**Code**: By-Age group
...
* Knowledge Artifact Metadata: Dependency
  * ?: **Description**: Library Seasonalinfluenza**Resource**:[IMMZD2DTSeasonalinfluenzaElements](Library-IMMZD2DTSeasonalinfluenzaElements.md)**Canonical URL**:http://smart.who.int/immunizations/Library/IMMZD2DTSeasonalinfluenzaElements
* Knowledge Artifact Metadata: Dependency
...
* Knowledge Artifact Metadata: Dependency
  * ?: **Description**: Value set Seasonal influenza vaccines**Resource**:[IMMZ.Z.DE18 ValueSet for Seasonal influenza vaccines](ValueSet-IMMZ.Z.DE18.md)**Canonical URL**:http://smart.who.int/immunizations/ValueSet/IMMZ.Z.DE18
...
* Knowledge Artifact Metadata: Data Requirement
  * ?: **Type**: Immunization**Profile(s)**:[Immunization](http://hl7.org/fhir/R4/immunization.html)**Must Support Elements**: status, isSubpotent, vaccineCode, occurrence**Code Filter(s)**:**Path**: status**Code**: **Path**: vaccineCode**ValueSet**:[IMMZ.Z.DE18 ValueSet for Seasonal influenza vaccines](ValueSet-IMMZ.Z.DE18.md)
* Knowledge Artifact Metadata: Data Requirement
...
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**IMMZD2DTSeasonalinfluenzaElements
* Knowledge Artifact Metadata: ````/* @internal: Seasonal influenza containing Doses Administered to Patient */ define "Seasonal influenza Doses Administered to Patient": Elements."Doses Administered to Patient" I where I.vaccineCode in Concepts."Seasonal influenza vaccines"````
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**IMMZIND29Logic
* Knowledge Artifact Metadata: ````/* @numerator: Number of seasonal influenza vaccine doses administered through routine services during the reporting period @pseudocode: COUNT of immunization events WHERE "Vaccine type" = "Seasonal influenza vaccines" AND "Date and time of vaccination" is during the reporting period */ define "Numerator": exists( Seasonalinfluenza."Seasonal influenza Doses Administered to Patient" I where I.occurrence.toInterval() starts during "Measurement Period" )````
* Knowledge Artifact Metadata:  Logic Definition
...
```json
{
  ...
  "contained" : [{
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD2DTSeasonalinfluenzaElements"
      },
      {
        "url" : "name",
  ...
  "url" : "http://smart.who.int/immunizations/Measure/IMMZIND29",
  "version" : "1.0.0",
  "name" : "IMMZIND29",
  "title" : "IMMZIND29",
  "status" : "draft",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZIND29Logic"],
  "scoring" : {
    "coding" : [{
