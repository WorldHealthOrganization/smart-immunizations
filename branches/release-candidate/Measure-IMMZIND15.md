# IMMZIND15 - WHO Immunization Implementation Guide v1.0.0
...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/Measure/IMMZIND15 | *Version*:1.0.0 |
| Draft as of 2025-06-11 | *Computable Name*:IMMZIND15 |

 
IMMZ.IND.15 Immunization coverage for HPV vaccine, 2nd dose 
...
* Knowledge Artifact Metadata: Initial Population
  * ?: **ID**: IMMZ.IND.15.IP**Description**:Initial Population**Logic Definition**:[Initial Population](#immzind15logic-initial-population)
* Knowledge Artifact Metadata: Denominator
  * ?: **ID**: IMMZ.IND.15.D**Description**:Denominator**Logic Definition**:[Denominator](#immzind15logic-denominator)
* Knowledge Artifact Metadata: Numerator
  * ?: **ID**: IMMZ.IND.15.N**Description**:Numerator**Logic Definition**:[Numerator](#immzind15logic-numerator)
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.15.S1**Code**: By-Administrative Area
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.15.S2**Code**: By-Sex
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.15.S3**Code**: By-Age group
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.15.S4**Code**: By-Age group
...
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**IMMZIND15Logic
* Knowledge Artifact Metadata: ````/* @numerator: Number of HPV vaccine doses (2nd dose) administered through routine services during the reporting period @pseudocode: COUNT of immunization events WHERE "Vaccine type" = "HPV vaccines" for the 2nd dose in the primary series AND "Date and time of vaccination" is during the reporting period */ define "Numerator": exists ( (HPV."HPV Primary Series Doses Administered to Patient".getDose('2')) I where I.occurrence.toInterval() starts during "Measurement Period" )````
* Knowledge Artifact Metadata:  Logic Definition
...
```json
{
  ...
  "contained" : [{
    ...
    },
    {
      ...
      {
        "url" : "statement",
        "valueString" : "/*\n@numerator: Number of HPV vaccine doses (2nd dose) administered through routine services during the reporting period\n@pseudocode: COUNT of immunization events WHERE \"Vaccine type\" = \"HPV vaccines\" for the 2nd dose in the primary series AND \"Date and time of vaccination\" is during the reporting period\n*/\ndefine \"Numerator\":\n  exists (\n    (HPV.\"HPV Primary Series Doses Administered to Patient\".getDose('2')) I\n      where I.occurrence.toInterval() starts during \"Measurement Period\"\n  )"
      },
      {
        "url" : "displaySequence",
        "valueInteger" : 3
  ...
  "url" : "http://smart.who.int/immunizations/Measure/IMMZIND15",
  "version" : "1.0.0",
  "name" : "IMMZIND15",
  "title" : "IMMZIND15",
  "status" : "draft",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZIND15Logic"],
  "scoring" : {
    "coding" : [{
