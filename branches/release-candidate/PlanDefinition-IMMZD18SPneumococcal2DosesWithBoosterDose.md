# IMMZ.D18.S.Pneumococcal.2 doses with booster dose schedule - WHO Immunization Implementation Guide v1.0.0
...
| Draft as of 2026-04-09 | *Computable Name*:IMMZD18SPneumococcal2DosesWithBoosterDose |
...
```json
{
  ...
  "contained" : [{
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD18SPneumococcal2DosesWithBoosterDoseLogic"
      },
      {
        "url" : "name",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZD18SPneumococcal2DosesWithBoosterDoseLogic"],
  "action" : [{
