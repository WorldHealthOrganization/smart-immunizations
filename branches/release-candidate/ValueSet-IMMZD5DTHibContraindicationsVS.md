# IMMZD5DTHibContraindications ValueSet for Decision Table - WHO Immunization Implementation Guide v1.0.0
...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/ValueSet/IMMZD5DTHibContraindicationsVS | *Version*:1.0.0 |
| Active as of 2026-04-09 | *Computable Name*:IMMZD5DTHibContraindicationsVS |
...
##### IMMZD5DTHibContraindications ValueSet for Decision Table Schema API
...
### GET /ValueSet-IMMZD5DTHibContraindicationsVS.schema.json

#### JSON Schema definition for the enumeration ValueSet-IMMZD5DTHibContraindicationsVS

This endpoint serves the JSON Schema definition for the enumeration ValueSet-IMMZD5DTHibContraindicationsVS.

## Schema Definition

### ValueSet-IMMZD5DTHibContraindicationsVS

**Description:** JSON Schema for IMMZD5DTHibContraindications ValueSet for Decision Table ValueSet codes. Generated from FHIR expansions using IRI format.
