# IMMZ.D5.DT.Yellow fever contraindications - WHO Immunization Implementation Guide v1.0.0
...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/PlanDefinition/IMMZD5DTYellowFeverContraindications | *Version*:1.0.0 |
| Draft as of 2026-04-09 | *Computable Name*:IMMZD5DTYellowFeverContraindications |

 
IMMZ.D5.DT.Yellow fever contraindications IMMZ.D5.DT.Yellow fever contraindications 

* **Actions: **: **Url: **
  * : [IMMZ.D5.DT.Yellow fever contraindications](PlanDefinition-IMMZD5DTYellowFeverContraindications.md)
* **Actions: **: **Version: **
  * : 1.0.0
* **Actions: **: **Title: **
  * : IMMZ.D5.DT.Yellow fever contraindications
...
```json
{
  ...
  "id" : "IMMZD5DTYellowFeverContraindications",
  "meta" : {
  ...
  "contained" : [{
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD5DTYellowfeverEncounterElements"
      },
      {
        "url" : "name",
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD5DTYellowFeverContraindicationsLogic"
      },
      {
        "url" : "name",
        "valueString" : "Yellow fever vaccination is contraindicated Case 1"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Yellow fever vaccination is contraindicated Case 2"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Yellow fever vaccination is contraindicated"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Yellow fever vaccination is contraindicated Guidance"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Client's age is 6–9 months"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Client's age is more than or equal to 60 years"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Yellow fever vaccination could be contraindicated. Clinical judgement is required. Create a clinical note"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Yellow fever vaccination could be contraindicated. Clinical judgement is required. Create a clinical note Guidance"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Draft Medication Request for Yellow fever dose"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Draft Medication Request ID for Yellow fever dose"
      },
      {
        "url" : "statement",
  ...
  "url" : "http://smart.who.int/immunizations/PlanDefinition/IMMZD5DTYellowFeverContraindications",
  "version" : "1.0.0",
  "name" : "IMMZD5DTYellowFeverContraindications",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZD5DTYellowFeverContraindicationsLogic"],
  "action" : [{
