# IMMZ.D2.DT.Meningococcal.MenA conjugate vaccine 1 dose - WHO Immunization Implementation Guide v1.0.0
...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/PlanDefinition/IMMZD2DTMeningococcalMenAConjugateVaccine1Dose | *Version*:1.0.0 |
| Draft as of 2026-04-09 | *Computable Name*:IMMZD2DTMeningococcalMenAConjugateVaccine1Dose |
...
```json
{
  ...
  "contained" : [{
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD2DTMeningococcalMenAConjugateVaccine1DoseLogic"
      },
      {
        "url" : "name",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZD2DTMeningococcalMenAConjugateVaccine1DoseLogic"],
  "action" : [{
    "extension" : [{
