# IMMZD2DTHib2DosesWithBoosterDose ValueSet for Decision Table - WHO Immunization Implementation Guide v1.0.0
...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/ValueSet/IMMZD2DTHib2DosesWithBoosterDoseVS | *Version*:1.0.0 |
| Active as of 2026-04-09 | *Computable Name*:IMMZD2DTHib2DosesWithBoosterDoseVS |
...
##### IMMZD2DTHib2DosesWithBoosterDose ValueSet for Decision Table Schema API
...
### GET /ValueSet-IMMZD2DTHib2DosesWithBoosterDoseVS.schema.json

#### JSON Schema definition for the enumeration ValueSet-IMMZD2DTHib2DosesWithBoosterDoseVS

This endpoint serves the JSON Schema definition for the enumeration ValueSet-IMMZD2DTHib2DosesWithBoosterDoseVS.

## Schema Definition

### ValueSet-IMMZD2DTHib2DosesWithBoosterDoseVS

**Description:** JSON Schema for IMMZD2DTHib2DosesWithBoosterDose ValueSet for Decision Table ValueSet codes. Generated from FHIR expansions using IRI format.
