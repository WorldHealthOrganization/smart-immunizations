# IMMZD2DTDTPPregnancyStartingWith3Doses ValueSet for Decision Table - WHO Immunization Implementation Guide v1.0.0
...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/ValueSet/IMMZD2DTDTPPregnancyStartingWith3DosesVS | *Version*:1.0.0 |
| Active as of 2026-04-09 | *Computable Name*:IMMZD2DTDTPPregnancyStartingWith3DosesVS |
...
##### IMMZD2DTDTPPregnancyStartingWith3Doses ValueSet for Decision Table Schema API
...
### GET /ValueSet-IMMZD2DTDTPPregnancyStartingWith3DosesVS.schema.json

#### JSON Schema definition for the enumeration ValueSet-IMMZD2DTDTPPregnancyStartingWith3DosesVS

This endpoint serves the JSON Schema definition for the enumeration ValueSet-IMMZD2DTDTPPregnancyStartingWith3DosesVS.

## Schema Definition

### ValueSet-IMMZD2DTDTPPregnancyStartingWith3DosesVS

**Description:** JSON Schema for IMMZD2DTDTPPregnancyStartingWith3Doses ValueSet for Decision Table ValueSet codes. Generated from FHIR expansions using IRI format.
