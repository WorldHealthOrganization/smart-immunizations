# IMMZIND30 - WHO Immunization Implementation Guide v1.0.0
...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/Measure/IMMZIND30 | *Version*:1.0.0 |
| Draft as of 2025-06-11 | *Computable Name*:IMMZIND30 |

 
IMMZ.IND.30 Immunization coverage for COVID-19 vaccines 
...
* Knowledge Artifact Metadata: Initial Population
  * ?: **ID**: IMMZ.IND.30.IP**Description**:Initial Population**Logic Definition**:[Initial Population](#immzind30logic-initial-population)
* Knowledge Artifact Metadata: Denominator
  * ?: **ID**: IMMZ.IND.30.D**Description**:Denominator**Logic Definition**:[Denominator](#immzind30logic-denominator)
* Knowledge Artifact Metadata: Numerator
  * ?: **ID**: IMMZ.IND.30.N**Description**:Numerator**Logic Definition**:[Numerator](#immzind30logic-numerator)
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.30.S1**Code**: By-Administrative Area
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.30.S2**Code**: By-Sex
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.30.S3**Code**: By-Age group
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.30.S4**Code**: By-Age group
...
* Knowledge Artifact Metadata: Dependency
  * ?: **Description**: Value set COVID-19 vaccines**Resource**:[IMMZ.Z.DE26 ValueSet for COVID-19 vaccines](ValueSet-IMMZ.Z.DE26.md)**Canonical URL**:http://smart.who.int/immunizations/ValueSet/IMMZ.Z.DE26
* Knowledge Artifact Metadata: Direct Reference Code
  * ?: **Display**: < 18 years**Code**: P0Y--P18Y**System**:http://ohie.org/CodeSystem/iso-8601-derived-periods
* Knowledge Artifact Metadata: Direct Reference Code
  * ?: **Display**: 18 - 29 years**Code**: P18Y--P30Y**System**:http://ohie.org/CodeSystem/iso-8601-derived-periods
* Knowledge Artifact Metadata: Direct Reference Code
  * ?: **Display**: 30 - 49 years**Code**: P30Y--P50Y**System**:http://ohie.org/CodeSystem/iso-8601-derived-periods
* Knowledge Artifact Metadata: Direct Reference Code
  * ?: **Display**: 50 - 69 years**Code**: P50Y--P70Y**System**:http://ohie.org/CodeSystem/iso-8601-derived-periods
* Knowledge Artifact Metadata: Direct Reference Code
  * ?: **Display**: >= 70 years**Code**: P70Y--P9999Y**System**:http://ohie.org/CodeSystem/iso-8601-derived-periods
* Knowledge Artifact Metadata: Direct Reference Code
...
* Knowledge Artifact Metadata: Data Requirement
  * ?: **Type**: Immunization**Profile(s)**:[Immunization](http://hl7.org/fhir/R4/immunization.html)**Must Support Elements**: status, isSubpotent, occurrence**Code Filter(s)**:**Path**: status**Code**: 
* Knowledge Artifact Metadata: Data Requirement
  * ?: **Type**: Immunization**Profile(s)**:[Immunization](http://hl7.org/fhir/R4/immunization.html)**Must Support Elements**: status, isSubpotent, occurrence, vaccineCode**Code Filter(s)**:**Path**: status**Code**: **Path**: vaccineCode**ValueSet**:[IMMZ.Z.DE26 ValueSet for COVID-19 vaccines](ValueSet-IMMZ.Z.DE26.md)
* Knowledge Artifact Metadata: Data Requirement
...
* Knowledge Artifact Metadata: ````/** * @define Doses which were administered during the measurement period */ define "Doses Administered to Patient During Measurement Period": Elements."Doses Administered to Patient" I where I.occurrence.toInterval() starts during "Measurement Period"````
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**IMMZIndicatorElements
* Knowledge Artifact Metadata: ````define "COVID-19 Doses Administered to Patient During Measurement Period": "Doses Administered to Patient During Measurement Period" I where I.vaccineCode in Concepts."COVID-19 vaccines"````
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**IMMZIND30Logic
* Knowledge Artifact Metadata: ````/* @numerator: Number of COVID-19 vaccine doses administered through routine services during the reporting period @pseudocode: COUNT of immunization events WHERE "Vaccine type" = "COVID-19 vaccines" AND "Date and time of vaccination" is during the reporting period */ define "Numerator": exists( Elements."COVID-19 Doses Administered to Patient During Measurement Period" )````
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**IMMZIndicatorElements
* Knowledge Artifact Metadata: ````/* @stratifier: Age Group Stratifier */ define "By Age Group Stratifier": case when AgeInYearsAt(end of "Measurement Period") < 18 then Age."P0Y--P18Y" when AgeInYearsAt(end of "Measurement Period") < 30 then Age."P18Y--P30Y" when AgeInYearsAt(end of "Measurement Period") < 50 then Age."P30Y--P50Y" when AgeInYearsAt(end of "Measurement Period") < 70 then Age."P50Y--P70Y" when AgeInYearsAt(end of "Measurement Period") >= 70 then Age."P70Y--P9999Y" else null end````
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**IMMZIND30Logic
* Knowledge Artifact Metadata: ````define "Stratification 4": Elements."By Age Group Stratifier"````
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**IMMZIndicatorElements
...
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**IMMZIND30Logic
* Knowledge Artifact Metadata: ````/* @disaggregation: Administrative area Sex Age in years Age group (depending on schedule) Risk & occupational group */ define "Stratification 1": Elements."By Geographic Region Stratifier"````
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**IMMZIND30Logic
...
```json
{
  ...
  "contained" : [{
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "COVID-19 Doses Administered to Patient During Measurement Period"
      },
      {
        "url" : "statement",
        "valueString" : "define \"COVID-19 Doses Administered to Patient During Measurement Period\":\n  \"Doses Administered to Patient During Measurement Period\" I \n    where I.vaccineCode in Concepts.\"COVID-19 vaccines\""
      },
      {
        "url" : "displaySequence",
        "valueInteger" : 2
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "By Age Group Stratifier"
      },
      {
        "url" : "statement",
  ...
  "url" : "http://smart.who.int/immunizations/Measure/IMMZIND30",
  "version" : "1.0.0",
  "name" : "IMMZIND30",
  "title" : "IMMZIND30",
  "status" : "draft",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZIND30Logic"],
  "scoring" : {
    "coding" : [{
