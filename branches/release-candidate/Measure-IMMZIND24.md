# IMMZIND24 - WHO Immunization Implementation Guide v1.0.0
...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/Measure/IMMZIND24 | *Version*:1.0.0 |
| Draft as of 2025-06-11 | *Computable Name*:IMMZIND24 |

 
IMMZ.IND.24 Immunization coverage for tetanus and diphtheria-containing vaccines (Td), 5th dose 
...
* Knowledge Artifact Metadata: Initial Population
  * ?: **ID**: IMMZ.IND.24.IP**Description**:Initial Population**Logic Definition**:[Initial Population](#immzind24logic-initial-population)
* Knowledge Artifact Metadata: Denominator
  * ?: **ID**: IMMZ.IND.24.D**Description**:Denominator**Logic Definition**:[Denominator](#immzind24logic-denominator)
* Knowledge Artifact Metadata: Numerator
  * ?: **ID**: IMMZ.IND.24.N**Description**:Numerator**Logic Definition**:[Numerator](#immzind24logic-numerator)
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.24.S1**Code**: By-Administrative Area
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.24.S2**Code**: By-Sex
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.24.S3**Code**: By-Age group
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.24.S4**Code**: By-Age group
...
* Knowledge Artifact Metadata: Dependency
  * ?: **Description**: Library DTP**Resource**:[IMMZD2DTDTPElements](Library-IMMZD2DTDTPElements.md)**Canonical URL**:http://smart.who.int/immunizations/Library/IMMZD2DTDTPElements
* Knowledge Artifact Metadata: Dependency
...
* Knowledge Artifact Metadata: Dependency
  * ?: **Description**: Value set Tetanus and diphtheria-containing vaccines**Resource**:[IMMZ.Z.DE28 ValueSet for Tetanus and diphtheria-containing vaccines](ValueSet-IMMZ.Z.DE28.md)**Canonical URL**:http://smart.who.int/immunizations/ValueSet/IMMZ.Z.DE28
...
* Knowledge Artifact Metadata: Direct Reference Code
  * ?: **Display**: 1 - 2 years**Code**: P1Y--P3Y**System**:http://ohie.org/CodeSystem/iso-8601-derived-periods
* Knowledge Artifact Metadata: Direct Reference Code
  * ?: **Display**: 3 - 5 years**Code**: P3Y--P6Y**System**:http://ohie.org/CodeSystem/iso-8601-derived-periods
* Knowledge Artifact Metadata: Direct Reference Code
  * ?: **Display**: 6 - 12 years**Code**: P6Y--P13Y**System**:http://ohie.org/CodeSystem/iso-8601-derived-periods
* Knowledge Artifact Metadata: Direct Reference Code
  * ?: **Display**: >= 13 years**Code**: P13Y--P9999Y**System**:http://ohie.org/CodeSystem/iso-8601-derived-periods
* Knowledge Artifact Metadata: Direct Reference Code
...
* Knowledge Artifact Metadata: Data Requirement
  * ?: **Type**: Immunization**Profile(s)**:[Immunization](http://hl7.org/fhir/R4/immunization.html)**Must Support Elements**: status, isSubpotent**Code Filter(s)**:**Path**: status**Code**: 
* Knowledge Artifact Metadata: Data Requirement
  * ?: **Type**: Immunization**Profile(s)**:[Immunization](http://hl7.org/fhir/R4/immunization.html)**Must Support Elements**: status, isSubpotent, vaccineCode**Code Filter(s)**:**Path**: status**Code**: **Path**: vaccineCode**ValueSet**:[IMMZ.Z.DE28 ValueSet for Tetanus and diphtheria-containing vaccines](ValueSet-IMMZ.Z.DE28.md)
* Knowledge Artifact Metadata: Data Requirement
  * ?: **Type**: Immunization**Profile(s)**:[Immunization](http://hl7.org/fhir/R4/immunization.html)**Must Support Elements**: occurrence
...
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**IMMZD2DTDTPElements
* Knowledge Artifact Metadata: ````/* @internal: Td Doses Administered to Patient */ define "Td Doses Administered to Patient": Elements."Doses Administered to Patient" I where I.vaccineCode in Concepts."Tetanus and diphtheria-containing vaccines"````
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**IMMZIND24Logic
* Knowledge Artifact Metadata: ````/* @numerator: Number of tetanus and diphtheria-containing vaccine doses (5th dose) administered through routine services during the reporting period @pseudocode: COUNT of immunization events WHERE "Vaccine type" = "Tetanus and diphtheria-containing vaccines (Td)" for the fifth dose in the primary series AND "Date and time of vaccination" is during the reporting period */ define "Numerator": Coalesce( DTP."Td Doses Administered to Patient".sortedIndex(4).occurrence.toInterval() starts during "Measurement Period", false )````
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**IMMZIndicatorElements
* Knowledge Artifact Metadata: ````/* @stratifier: Child By Age Stratifiers */ define "Child By Age Stratifier": case when AgeInYearsAt(end of "Measurement Period") < 1 then Age."P0Y--P1Y" when AgeInYearsAt(end of "Measurement Period") < 3 then Age."P1Y--P3Y" when AgeInYearsAt(end of "Measurement Period") < 6 then Age."P3Y--P6Y" when AgeInYearsAt(end of "Measurement Period") < 13 then Age."P6Y--P13Y" when AgeInYearsAt(end of "Measurement Period") >= 13 then Age."P13Y--P9999Y" else null end````
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**IMMZIND24Logic
* Knowledge Artifact Metadata: ````define "Stratification 4": Elements."Child By Age Stratifier"````
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**IMMZIndicatorElements
...
```json
{
  ...
  "contained" : [{
    ...
    },
    {
      ...
      {
        "url" : "statement",
        "valueString" : "/*\n@numerator: Number of tetanus and diphtheria-containing vaccine doses (5th dose) administered through routine services during the reporting period\n@pseudocode: COUNT of immunization events WHERE \"Vaccine type\" = \"Tetanus and diphtheria-containing vaccines (Td)\" for the fifth dose in the primary series AND \"Date and time of vaccination\" is during the reporting period\n*/\ndefine \"Numerator\":\n  Coalesce( DTP.\"Td Doses Administered to Patient\".sortedIndex(4).occurrence.toInterval() starts during \"Measurement Period\",\n    false )"
      },
      {
        "url" : "displaySequence",
        "valueInteger" : 2
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Child By Age Stratifier"
      },
      {
        "url" : "statement",
  ...
  "url" : "http://smart.who.int/immunizations/Measure/IMMZIND24",
  "version" : "1.0.0",
  "name" : "IMMZIND24",
  "title" : "IMMZIND24",
  "status" : "draft",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZIND24Logic"],
  "scoring" : {
    "coding" : [{
