# IMMZD2DTTyphoidViPS ValueSet for Decision Table - WHO Immunization Implementation Guide v1.0.0
...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/ValueSet/IMMZD2DTTyphoidViPSVS | *Version*:1.0.0 |
| Active as of 2026-04-09 | *Computable Name*:IMMZD2DTTyphoidViPSVS |
...
##### IMMZD2DTTyphoidViPS ValueSet for Decision Table Schema API
...
### GET /ValueSet-IMMZD2DTTyphoidViPSVS.schema.json

#### JSON Schema definition for the enumeration ValueSet-IMMZD2DTTyphoidViPSVS

This endpoint serves the JSON Schema definition for the enumeration ValueSet-IMMZD2DTTyphoidViPSVS.

## Schema Definition

### ValueSet-IMMZD2DTTyphoidViPSVS

**Description:** JSON Schema for IMMZD2DTTyphoidViPS ValueSet for Decision Table ValueSet codes. Generated from FHIR expansions using IRI format.
