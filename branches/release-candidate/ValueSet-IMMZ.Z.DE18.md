# IMMZ.Z.DE18 ValueSet for Seasonal influenza vaccines - WHO Immunization Implementation Guide v1.0.0
...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/ValueSet/IMMZ.Z.DE18 | *Version*:1.0.0 |
| Active as of 2026-04-09 | *Computable Name*:IMMZ_Z_DE18 |
...
##### IMMZ.Z.DE18 ValueSet for Seasonal influenza vaccines Schema API
...
### GET /ValueSet-IMMZ.Z.DE18.schema.json

#### JSON Schema definition for the enumeration ValueSet-IMMZ.Z.DE18

This endpoint serves the JSON Schema definition for the enumeration ValueSet-IMMZ.Z.DE18.

## Schema Definition

### ValueSet-IMMZ.Z.DE18

**Description:** JSON Schema for IMMZ.Z.DE18 ValueSet for Seasonal influenza vaccines ValueSet codes. Generated from FHIR expansions using IRI format.
