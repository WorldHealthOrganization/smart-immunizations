# IMMZ.D18.S.TBE.EnceVir schedule - WHO Immunization Implementation Guide v1.0.0
...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/PlanDefinition/IMMZD18STBEEnceVir | *Version*:1.0.0 |
| Draft as of 2026-04-09 | *Computable Name*:IMMZD18STBEEnceVir |
...
```json
{
  ...
  "contained" : [{
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD18STBEEnceVirLogic"
      },
      {
        "url" : "name",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Tick-borne encephalitis (TBE) EnceVir dose 1"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "TBE EnceVir dose 3"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "TBE EnceVir dose 3 Due Date"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "TBE EnceVir dose 3 Create"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "TBE EnceVir booster dose"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "TBE EnceVir booster dose Due Date"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "TBE EnceVir booster dose Create"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "TBE EnceVir Dose 2"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "TBE EnceVir Dose 2 Due Date"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "TBE EnceVir Dose 2 Overdue"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "TBE EnceVir Dose 2 Create"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Tick-borne encephalitis (TBE) EnceVir dose 1 Due Date"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Tick-borne encephalitis (TBE) EnceVir dose 1 Create"
      },
      {
        "url" : "statement",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZD18STBEEnceVirLogic"],
  "action" : [{
