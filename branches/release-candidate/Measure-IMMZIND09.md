# IMMZIND09 - WHO Immunization Implementation Guide v1.0.0
...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/Measure/IMMZIND09 | *Version*:1.0.0 |
| Draft as of 2025-06-11 | *Computable Name*:IMMZIND09 |

 
IMMZ.IND.09 Immunization coverage for inactivated polio vaccine (IPV), 1st dose 
...
* Knowledge Artifact Metadata: Initial Population
  * ?: **ID**: IMMZ.IND.09.IP**Description**:Initial Population**Logic Definition**:[Initial Population](#immzind09logic-initial-population)
* Knowledge Artifact Metadata: Denominator
  * ?: **ID**: IMMZ.IND.09.D**Description**:Denominator**Logic Definition**:[Denominator](#immzind09logic-denominator)
* Knowledge Artifact Metadata: Numerator
  * ?: **ID**: IMMZ.IND.09.N**Description**:Numerator**Logic Definition**:[Numerator](#immzind09logic-numerator)
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.09.S1**Code**: By-Administrative Area
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.09.S2**Code**: By-Sex
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.09.S3**Code**: By-Age group
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.09.S4**Code**: By-Age group
...
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**IMMZIND09Logic
* Knowledge Artifact Metadata: ````/* @numerator: Number of IPV doses (1st dose) administered through routine services during the reporting period @pseudocode: COUNT of immunization events WHERE "Vaccine type" = "Inactivated polio vaccines" for the 1st dose in the primary series AND "Date and time of vaccination" is during the reporting period */ define "Numerator": Coalesce( Polio."Polio IPV Primary Series Doses Administered to Patient".sortedIndex(0).occurrence.toInterval() starts during "Measurement Period", false )````
* Knowledge Artifact Metadata:  Logic Definition
...
```json
{
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZIND09Logic"],
  "scoring" : {
    "coding" : [{
