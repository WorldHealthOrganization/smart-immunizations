# IMMZD5DTDTPContraindications ValueSet for Decision Table - WHO Immunization Implementation Guide v1.0.0

* [**Table of Contents**](toc.md)
* [**Indices**](indices.md)
* [**Artifact Index**](artifacts.md)
* **IMMZD5DTDTPContraindications ValueSet for Decision Table**

## ValueSet: IMMZD5DTDTPContraindications ValueSet for Decision Table 

| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/ValueSet/IMMZD5DTDTPContraindicationsVS | *Version*:1.0.0 |
| Active as of 2026-04-09 | *Computable Name*:IMMZD5DTDTPContraindicationsVS |
...
##### IMMZD5DTDTPContraindications ValueSet for Decision Table Schema API
...
### GET /ValueSet-IMMZD5DTDTPContraindicationsVS.schema.json

#### JSON Schema definition for the enumeration ValueSet-IMMZD5DTDTPContraindicationsVS
...
```json
{
  ...
  "id" : "IMMZD5DTDTPContraindicationsVS",
  "url" : "http://smart.who.int/immunizations/ValueSet/IMMZD5DTDTPContraindicationsVS",
  "version" : "1.0.0",
  "name" : "IMMZD5DTDTPContraindicationsVS",
