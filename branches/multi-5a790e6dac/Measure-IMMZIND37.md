# IMMZIND37 - WHO Immunization Implementation Guide v0.2.0
...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/Measure/IMMZIND37 | *Version*:0.2.0 |
| Draft as of 2025-06-11 | *Computable Name*:IMMZIND37 |

 
IMMZ.IND.37 Drop-out rate from the 1st dose of measles and rubella-containing vaccine to the 2nd dose 
...
* Knowledge Artifact Metadata: Initial Population
  * ?: **ID**: IMMZ.IND.37.IP**Description**:Initial Population**Logic Definition**:[Initial Population](#immzind37logic-initial-population)
* Knowledge Artifact Metadata: Denominator
  * ?: **ID**: IMMZ.IND.37.D**Description**:Denominator**Logic Definition**:[Denominator](#immzind37logic-denominator)
* Knowledge Artifact Metadata: Numerator
  * ?: **ID**: IMMZ.IND.37.N**Description**:Numerator**Logic Definition**:[Numerator](#immzind37logic-numerator)
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.37.S1**Code**: By-Administrative Area
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.37.S2**Code**: By-Sex
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.37.S3**Code**: By-Age group
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.37.S4**Code**: By-Age group
...
* Knowledge Artifact Metadata: Direct Reference Code
  * ?: **Display**: >= 2 years**Code**: P2Y--P9999Y**System**:http://ohie.org/CodeSystem/iso-8601-derived-periods
* Knowledge Artifact Metadata: Direct Reference Code
...
* Knowledge Artifact Metadata: Data Requirement
  * ?: **Type**: Immunization**Profile(s)**:[Immunization](http://hl7.org/fhir/R4/immunization.html)**Must Support Elements**: status, isSubpotent, vaccineCode, occurrence
* Knowledge Artifact Metadata: Data Requirement
...
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**IMMZIND37Logic
* Knowledge Artifact Metadata: ````/* @denominator: Number of clients in the target population who received dose 1 of measles and rubella-containing vaccine during the reporting period @pseudocode: COUNT clients with an immunization event WHERE "Vaccine type" = "Measles and rubella-containing vaccines" for a 1st dose in the primary series AND "Date and time of vaccination" is during the reporting period @note: Updated to include those who have received the first dose and are due for the second during the measurement period */ define "Denominator": exists( Elements."Measles and Rubella Doses Administered to Patient".getDose('1') ) and Patient.birthDate + 15 months during "Measurement Period"````
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**IMMZIndicatorElements
...
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**IMMZIND37Logic
* Knowledge Artifact Metadata: ````/* @numerator: Number of clients who received a 1st dose of measles and rubella-containing vaccine during the reporting period who should have received the 2nd dose of measles and rubella-containing vaccine during the reporting period but did not receive it @pseudocode: (COUNT of clients with an immunization event WHERE "Vaccine type"" = "Measles and rubella-containing vaccines" for the 1st dose in the primary series AND "Date and time of vaccination" is during the reporting period) - (COUNT of clients with an immunization event WHERE "Vaccine type"" = "Measles and rubella-containing vaccines" for the 2nd dose in the primary series AND "Date and time of vaccination" is during the reporting period) @note: Only include those from the denominator that did not receive a measles/rubella 2nd dose during the measurement period. Those where the 2nd dose due date is during the period but have not received the 2nd dose. */ define "Numerator": "Denominator" and not exists( Elements."Measles and Rubella Doses Administered to Patient During Measurement Period".getDose('2') )````
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**IMMZIndicatorElements
* Knowledge Artifact Metadata: ````/* @stratifier: Toddler By Age Stratifiers */ define "Toddler By Age Stratifier": case when AgeInYearsAt(end of "Measurement Period") < 1 then Age."P0Y--P1Y" when AgeInYearsAt(end of "Measurement Period") < 2 then Age."P1Y--P2Y" when AgeInYearsAt(end of "Measurement Period") >= 2 then Age."P2Y--P9999Y" else null end````
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**IMMZIND37Logic
* Knowledge Artifact Metadata: ````define "Stratification 4": Elements."Toddler By Age Stratifier"````
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**IMMZIndicatorElements
...
```json
{
  ...
  "url" : "http://smart.who.int/immunizations/Measure/IMMZIND37",
  "version" : "0.2.0",
  "name" : "IMMZIND37",
  "title" : "IMMZIND37",
  "status" : "draft",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZIND37Logic"],
  "scoring" : {
    "coding" : [{
