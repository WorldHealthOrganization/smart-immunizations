# IMMZIND12 - WHO Immunization Implementation Guide v0.2.0
...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/Measure/IMMZIND12 | *Version*:0.2.0 |
| Draft as of 2025-06-11 | *Computable Name*:IMMZIND12 |

 
IMMZ.IND.12 Immunization coverage for measles and rubella-containing vaccine, 1st dose 
...
* Knowledge Artifact Metadata: Initial Population
  * ?: **ID**: IMMZ.IND.12.IP**Description**:Initial Population**Logic Definition**:[Initial Population](#immzind12logic-initial-population)
* Knowledge Artifact Metadata: Denominator
  * ?: **ID**: IMMZ.IND.12.D**Description**:Denominator**Logic Definition**:[Denominator](#immzind12logic-denominator)
* Knowledge Artifact Metadata: Numerator
  * ?: **ID**: IMMZ.IND.12.N**Description**:Numerator**Logic Definition**:[Numerator](#immzind12logic-numerator)
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.12.S1**Code**: By-Administrative Area
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.12.S2**Code**: By-Sex
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.12.S3**Code**: By-Age group
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.12.S4**Code**: By-Age group
...
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**IMMZIND12Logic
* Knowledge Artifact Metadata: ````/* @numerator: Number of measles and rubella-containing vaccine doses (1st dose) administered through routine services during the reporting period @pseudocode: COUNT of immunization events WHERE "Vaccine type" = "Measles and rubella-containing vaccines" for the 1st dose in the primary series AND "Date and time of vaccination" is during the reporting period */ define "Numerator": exists( Elements."Measles and Rubella Doses Administered to Patient During Measurement Period".getDose('1') )````
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**IMMZIndicatorElements
...
```json
{
  ...
  "url" : "http://smart.who.int/immunizations/Measure/IMMZIND12",
  "version" : "0.2.0",
  "name" : "IMMZIND12",
  "title" : "IMMZIND12",
  "status" : "draft",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZIND12Logic"],
  "scoring" : {
    "coding" : [{
