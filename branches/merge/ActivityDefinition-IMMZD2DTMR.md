# IMMZD2DTMR - WHO Immunization Implementation Guide v1.0.0
...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/ActivityDefinition/IMMZD2DTMR | *Version*:1.0.0 |
...
* **Product: **: **Version: **
  * **system: **[http://smart.who.int/immunizations/CodeSystem/IMMZ.Z](CodeSystem-IMMZ.Z.md)**code: **DE0: 1.0.0
* **Product: **: **Status: **
...
```json
{
  ...
  "id" : "IMMZD2DTMR",
  "meta" : {
    "profile" : ["http://hl7.org/fhir/uv/cpg/StructureDefinition/cpg-immunizationactivity|2.0.0"]
  },
  "extension" : [{
