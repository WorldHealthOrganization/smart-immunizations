# IMMZD2DTMeningococcalMonovalentMenCConjugateVaccine ValueSet for Decision Table - WHO Immunization Implementation Guide v1.0.0
...
| Active as of 2026-03-31 | *Computable Name*:IMMZD2DTMeningococcalMonovalentMenCConjugateVaccineVS |
...
##### IMMZD2DTMeningococcalMonovalentMenCConjugateVaccine ValueSet for Decision Table Schema API
...
### GET /ValueSet-IMMZD2DTMeningococcalMonovalentMenCConjugateVaccineVS.schema.json

#### JSON Schema definition for the enumeration ValueSet-IMMZD2DTMeningococcalMonovalentMenCConjugateVaccineVS

This endpoint serves the JSON Schema definition for the enumeration ValueSet-IMMZD2DTMeningococcalMonovalentMenCConjugateVaccineVS.

## Schema Definition

### ValueSet-IMMZD2DTMeningococcalMonovalentMenCConjugateVaccineVS

**Description:** JSON Schema for IMMZD2DTMeningococcalMonovalentMenCConjugateVaccine ValueSet for Decision Table ValueSet codes. Generated from FHIR expansions using IRI format.
