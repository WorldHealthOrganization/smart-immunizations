# IMMZD18STBEEnceVir ValueSet for Decision Table - WHO Immunization Implementation Guide v1.0.0
...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/ValueSet/IMMZD18STBEEnceVirVS | *Version*:1.0.0 |
| Active as of 2026-03-31 | *Computable Name*:IMMZD18STBEEnceVirVS |
...
##### IMMZD18STBEEnceVir ValueSet for Decision Table Schema API
...
### GET /ValueSet-IMMZD18STBEEnceVirVS.schema.json

#### JSON Schema definition for the enumeration ValueSet-IMMZD18STBEEnceVirVS

This endpoint serves the JSON Schema definition for the enumeration ValueSet-IMMZD18STBEEnceVirVS.

## Schema Definition

### ValueSet-IMMZD18STBEEnceVirVS

**Description:** JSON Schema for IMMZD18STBEEnceVir ValueSet for Decision Table ValueSet codes. Generated from FHIR expansions using IRI format.
