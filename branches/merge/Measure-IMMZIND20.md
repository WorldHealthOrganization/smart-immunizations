# IMMZIND20 - WHO Immunization Implementation Guide v1.0.0
...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/Measure/IMMZIND20 | *Version*:1.0.0 |
| Draft as of 2025-06-11 | *Computable Name*:IMMZIND20 |

 
IMMZ.IND.20 Immunization coverage for rotavirus vaccines, 1st dose 
...
* Knowledge Artifact Metadata: Initial Population
  * ?: **ID**: IMMZ.IND.20.IP**Description**:Initial Population**Logic Definition**:[Initial Population](#immzind20logic-initial-population)
* Knowledge Artifact Metadata: Denominator
  * ?: **ID**: IMMZ.IND.20.D**Description**:Denominator**Logic Definition**:[Denominator](#immzind20logic-denominator)
* Knowledge Artifact Metadata: Numerator
  * ?: **ID**: IMMZ.IND.20.N**Description**:Numerator**Logic Definition**:[Numerator](#immzind20logic-numerator)
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.20.S1**Code**: By-Administrative Area
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.20.S2**Code**: By-Sex
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.20.S3**Code**: By-Age group
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.20.S4**Code**: By-Age group
...
* Knowledge Artifact Metadata: Dependency
  * ?: **Description**: Library Rotavirus**Resource**:[IMMZD2DTRotavirusElements](Library-IMMZD2DTRotavirusElements.md)**Canonical URL**:http://smart.who.int/immunizations/Library/IMMZD2DTRotavirusElements
* Knowledge Artifact Metadata: Dependency
...
* Knowledge Artifact Metadata: Dependency
  * ?: **Description**: Value set Rotavirus vaccines**Resource**:[IMMZ.Z.DE16 ValueSet for Rotavirus vaccines](ValueSet-IMMZ.Z.DE16.md)**Canonical URL**:http://smart.who.int/immunizations/ValueSet/IMMZ.Z.DE16
...
* Knowledge Artifact Metadata: Data Requirement
  * ?: **Type**: Immunization**Profile(s)**:[Immunization](http://hl7.org/fhir/R4/immunization.html)**Must Support Elements**: status, isSubpotent, vaccineCode, protocolApplied**Code Filter(s)**:**Path**: status**Code**: **Path**: vaccineCode**ValueSet**:[IMMZ.Z.DE16 ValueSet for Rotavirus vaccines](ValueSet-IMMZ.Z.DE16.md)
* Knowledge Artifact Metadata: Data Requirement
...
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**IMMZD2DTRotavirusElements
* Knowledge Artifact Metadata: ````/* @internal: Rotavirus containing Doses Administered to Patient */ define "Rotavirus Doses Administered to Patient": Elements."Doses Administered to Patient" I where I.vaccineCode in Concepts."Rotavirus vaccines"````
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**IMMZD2DTRotavirusElements
* Knowledge Artifact Metadata: ````/* @internal: Rotavirus containing Doses Administered to Patient that are in the Primary series */ define "Rotavirus Primary Series Doses Administered to Patient": "Rotavirus Doses Administered to Patient".seriesPrimary()````
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**IMMZIND20Logic
* Knowledge Artifact Metadata: ````/* @numerator: Number of rotavirus vaccine doses (1st dose) administered through routine services during the reporting period @pseudocode: COUNT of immunization events WHERE "Vaccine type" = "Rotavirus vaccines" for the 1st dose in the primary series AND "Date and time of vaccination" is during the reporting period */ define "Numerator": exists( (Rotavirus."Rotavirus Primary Series Doses Administered to Patient".getDose('1')) I where I.occurrence.toInterval() starts during "Measurement Period" )````
* Knowledge Artifact Metadata:  Logic Definition
...
```json
{
  ...
  "contained" : [{
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD2DTRotavirusElements"
      },
      {
        "url" : "name",
        "valueString" : "Rotavirus Doses Administered to Patient"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Rotavirus Primary Series Doses Administered to Patient"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "statement",
        "valueString" : "/*\n@numerator: Number of rotavirus vaccine doses (1st dose) administered through routine services during the reporting period\n@pseudocode: COUNT of immunization events WHERE \"Vaccine type\" = \"Rotavirus vaccines\" for the 1st dose in the primary series AND \"Date and time of vaccination\" is during the reporting period\n*/\ndefine \"Numerator\":\n  exists( (Rotavirus.\"Rotavirus Primary Series Doses Administered to Patient\".getDose('1')) I\n    where I.occurrence.toInterval() starts during \"Measurement Period\" )"
      },
      {
        "url" : "displaySequence",
        "valueInteger" : 3
  ...
  "url" : "http://smart.who.int/immunizations/Measure/IMMZIND20",
  "version" : "1.0.0",
  "name" : "IMMZIND20",
  "title" : "IMMZIND20",
  "status" : "draft",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZIND20Logic"],
  "scoring" : {
    "coding" : [{
