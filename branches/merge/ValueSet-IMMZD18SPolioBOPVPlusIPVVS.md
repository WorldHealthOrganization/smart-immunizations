# IMMZD18SPolioBOPVPlusIPV ValueSet for Decision Table - WHO Immunization Implementation Guide v1.0.0
...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/ValueSet/IMMZD18SPolioBOPVPlusIPVVS | *Version*:1.0.0 |
| Active as of 2026-03-31 | *Computable Name*:IMMZD18SPolioBOPVPlusIPVVS |
...
##### IMMZD18SPolioBOPVPlusIPV ValueSet for Decision Table Schema API
...
### GET /ValueSet-IMMZD18SPolioBOPVPlusIPVVS.schema.json

#### JSON Schema definition for the enumeration ValueSet-IMMZD18SPolioBOPVPlusIPVVS

This endpoint serves the JSON Schema definition for the enumeration ValueSet-IMMZD18SPolioBOPVPlusIPVVS.

## Schema Definition

### ValueSet-IMMZD18SPolioBOPVPlusIPVVS

**Description:** JSON Schema for IMMZD18SPolioBOPVPlusIPV ValueSet for Decision Table ValueSet codes. Generated from FHIR expansions using IRI format.
