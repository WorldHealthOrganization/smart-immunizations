# IMMZD5DTHepatitisAContraindications ValueSet for Decision Table - WHO Immunization Implementation Guide v1.0.0
...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/ValueSet/IMMZD5DTHepatitisAContraindicationsVS | *Version*:1.0.0 |
| Active as of 2026-03-31 | *Computable Name*:IMMZD5DTHepatitisAContraindicationsVS |
...
##### IMMZD5DTHepatitisAContraindications ValueSet for Decision Table Schema API
...
### GET /ValueSet-IMMZD5DTHepatitisAContraindicationsVS.schema.json

#### JSON Schema definition for the enumeration ValueSet-IMMZD5DTHepatitisAContraindicationsVS

This endpoint serves the JSON Schema definition for the enumeration ValueSet-IMMZD5DTHepatitisAContraindicationsVS.

## Schema Definition

### ValueSet-IMMZD5DTHepatitisAContraindicationsVS

**Description:** JSON Schema for IMMZD5DTHepatitisAContraindications ValueSet for Decision Table ValueSet codes. Generated from FHIR expansions using IRI format.
