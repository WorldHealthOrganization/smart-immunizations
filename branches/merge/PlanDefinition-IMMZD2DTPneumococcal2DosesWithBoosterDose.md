# IMMZ.D2.DT.Pneumococcal.2 doses with booster dose - WHO Immunization Implementation Guide v1.0.0
...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/PlanDefinition/IMMZD2DTPneumococcal2DosesWithBoosterDose | *Version*:1.0.0 |
| Draft as of 2026-03-31 | *Computable Name*:IMMZD2DTPneumococcal2DosesWithBoosterDose |
...
```json
{
  ...
  "contained" : [{
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD2DTPneumococcal2DosesWithBoosterDoseLogic"
      },
      {
        "url" : "name",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZD2DTPneumococcal2DosesWithBoosterDoseLogic"],
  "action" : [{
    "extension" : [{
