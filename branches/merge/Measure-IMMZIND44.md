# IMMZIND44 - WHO Immunization Implementation Guide v1.0.0
...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/Measure/IMMZIND44 | *Version*:1.0.0 |
...
* Knowledge Artifact Metadata: Data Requirement
  * ?: **Type**: AdverseEvent**Profile(s)**:[AdverseEvent](http://hl7.org/fhir/R4/adverseevent.html)**Must Support Elements**: seriousness, seriousness.coding
* Knowledge Artifact Metadata: Data Requirement
  * ?: **Type**: AdverseEvent**Profile(s)**:[AdverseEvent](http://hl7.org/fhir/R4/adverseevent.html)**Must Support Elements**: actuality**Code Filter(s)**:**Path**: actuality**Code**: 
* Knowledge Artifact Metadata: Data Requirement
  * ?: **Type**: Resource**Profile(s)**:[Resource](http://hl7.org/fhir/R4/resource.html)**Must Support Elements**: id
* Knowledge Artifact Metadata: Data Requirement
  * ?: **Type**: Immunization**Profile(s)**:[Immunization](http://hl7.org/fhir/R4/immunization.html)**Must Support Elements**: location, manufacturer, vaccineCode, vaccineCode.coding
* Knowledge Artifact Metadata: Data Requirement
  * ?: **Type**: Location**Profile(s)**:[Location](http://hl7.org/fhir/R4/location.html)**Must Support Elements**: address, address.state
...
```json
{
  ...
  "contained" : [{
    ...
    "dataRequirement" : [{
      ...
      "mustSupport" : ["seriousness", "seriousness.coding"]
    },
    {
      "type" : "AdverseEvent",
      "profile" : ["http://hl7.org/fhir/StructureDefinition/AdverseEvent"],
    ...
    },
    {
      ...
      "mustSupport" : ["location", "manufacturer", "vaccineCode", "vaccineCode.coding"]
    },
    {
      "type" : "Location",
      "profile" : ["http://hl7.org/fhir/StructureDefinition/Location"],
      "mustSupport" : ["address", "address.state"]
    }]
  }],
  "extension" : [{
