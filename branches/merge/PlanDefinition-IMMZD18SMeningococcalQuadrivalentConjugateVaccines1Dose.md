# IMMZ.D18.S.Meningococcal.Quadrivalent conjugate vaccines 1-dose schedule - WHO Immunization Implementation Guide v1.0.0
...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/PlanDefinition/IMMZD18SMeningococcalQuadrivalentConjugateVaccines1Dose | *Version*:1.0.0 |
| Draft as of 2026-03-31 | *Computable Name*:IMMZD18SMeningococcalQuadrivalentConjugateVaccines1Dose |
...
```json
{
  ...
  "contained" : [{
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD18SMeningococcalQuadrivalentConjugateVaccines1DoseLogic"
      },
      {
        "url" : "name",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZD18SMeningococcalQuadrivalentConjugateVaccines1DoseLogic"],
  "action" : [{
