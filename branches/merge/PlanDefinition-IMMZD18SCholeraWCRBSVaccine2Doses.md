# IMMZ.D18.S.Cholera.WC-rBS vaccine 2-dose schedule - WHO Immunization Implementation Guide v1.0.0
...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/PlanDefinition/IMMZD18SCholeraWCRBSVaccine2Doses | *Version*:1.0.0 |
| Draft as of 2026-03-31 | *Computable Name*:IMMZD18SCholeraWCRBSVaccine2Doses |
...
```json
{
  ...
  "contained" : [{
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD18SCholeraWCRBSVaccine2DosesLogic"
      },
      {
        "url" : "name",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZD18SCholeraWCRBSVaccine2DosesLogic"],
  "action" : [{
