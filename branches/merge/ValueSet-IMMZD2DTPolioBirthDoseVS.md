# IMMZD2DTPolioBirthDose ValueSet for Decision Table - WHO Immunization Implementation Guide v1.0.0
...
| Active as of 2026-03-31 | *Computable Name*:IMMZD2DTPolioBirthDoseVS |
...
##### IMMZD2DTPolioBirthDose ValueSet for Decision Table Schema API
...
### GET /ValueSet-IMMZD2DTPolioBirthDoseVS.schema.json

#### JSON Schema definition for the enumeration ValueSet-IMMZD2DTPolioBirthDoseVS

This endpoint serves the JSON Schema definition for the enumeration ValueSet-IMMZD2DTPolioBirthDoseVS.

## Schema Definition

### ValueSet-IMMZD2DTPolioBirthDoseVS

**Description:** JSON Schema for IMMZD2DTPolioBirthDose ValueSet for Decision Table ValueSet codes. Generated from FHIR expansions using IRI format.
