# IMMZ.D18.S.Polio.Sequential IPV–bOPV schedule - WHO Immunization Implementation Guide v1.0.0
...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/PlanDefinition/IMMZD18SPolioSequentialIPVbOPV | *Version*:1.0.0 |
| Draft as of 2026-03-31 | *Computable Name*:IMMZD18SPolioSequentialIPVbOPV |
...
```json
{
  ...
  "contained" : [{
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD18SPolioSequentialIPVbOPVLogic"
      },
      {
        "url" : "name",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZD18SPolioSequentialIPVbOPVLogic"],
  "action" : [{
    "title" : "IPV dose 1",
