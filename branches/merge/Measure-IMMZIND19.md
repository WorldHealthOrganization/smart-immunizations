# IMMZIND19 - WHO Immunization Implementation Guide v1.0.0
...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/Measure/IMMZIND19 | *Version*:1.0.0 |
...
* Knowledge Artifact Metadata: Initial Population
  * ?: **ID**: IMMZ.IND.19.IP**Description**:Initial Population**Logic Definition**:[Initial Population](#immzind19logic-initial-population)
* Knowledge Artifact Metadata: Denominator
  * ?: **ID**: IMMZ.IND.19.D**Description**:Denominator**Logic Definition**:[Denominator](#immzind19logic-denominator)
* Knowledge Artifact Metadata: Numerator
  * ?: **ID**: IMMZ.IND.19.N**Description**:Numerator**Logic Definition**:[Numerator](#immzind19logic-numerator)
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.19.S1**Code**: By-Administrative Area
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.19.S2**Code**: By-Sex
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.19.S3**Code**: By-Age group
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.19.S4**Code**: By-Age group
...
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**IMMZIND19Logic
* Knowledge Artifact Metadata: ````/* @numerator: Number of pneumococcal vaccine doses (3rd dose) administered through routine services during the reporting period @pseudocode: COUNT of immunization events WHERE "Vaccine type" = "Pneumococcal vaccines" for the 3rd dose in the primary series AND "Date and time of vaccination" is during the reporting period */ define "Numerator": exists( (Pneumococcal."Pneumococcal Primary Series Doses Administered to Patient".getDose('3')) I where I.occurrence.toInterval() starts during "Measurement Period" )````
* Knowledge Artifact Metadata:  Logic Definition
...
```json
{
  ...
  "url" : "http://smart.who.int/immunizations/Measure/IMMZIND19",
  "version" : "1.0.0",
  "name" : "IMMZIND19",
  "title" : "IMMZIND19",
  "status" : "draft",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZIND19Logic"],
  "scoring" : {
    "coding" : [{
