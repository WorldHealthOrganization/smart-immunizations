# IMMZD2DTDengue3DosesWithPreVaccinationScreening ValueSet for Decision Table - WHO Immunization Implementation Guide v1.0.0
...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/ValueSet/IMMZD2DTDengue3DosesWithPreVaccinationScreeningVS | *Version*:1.0.0 |
| Active as of 2026-03-31 | *Computable Name*:IMMZD2DTDengue3DosesWithPreVaccinationScreeningVS |
...
##### IMMZD2DTDengue3DosesWithPreVaccinationScreening ValueSet for Decision Table Schema API
...
### GET /ValueSet-IMMZD2DTDengue3DosesWithPreVaccinationScreeningVS.schema.json

#### JSON Schema definition for the enumeration ValueSet-IMMZD2DTDengue3DosesWithPreVaccinationScreeningVS

This endpoint serves the JSON Schema definition for the enumeration ValueSet-IMMZD2DTDengue3DosesWithPreVaccinationScreeningVS.

## Schema Definition

### ValueSet-IMMZD2DTDengue3DosesWithPreVaccinationScreeningVS

**Description:** JSON Schema for IMMZD2DTDengue3DosesWithPreVaccinationScreening ValueSet for Decision Table ValueSet codes. Generated from FHIR expansions using IRI format.
