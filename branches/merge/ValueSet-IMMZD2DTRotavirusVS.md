# IMMZD2DTRotavirus ValueSet for Decision Table - WHO Immunization Implementation Guide v1.0.0
...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/ValueSet/IMMZD2DTRotavirusVS | *Version*:1.0.0 |
| Active as of 2026-03-31 | *Computable Name*:IMMZD2DTRotavirusVS |
...
##### IMMZD2DTRotavirus ValueSet for Decision Table Schema API
...
### GET /ValueSet-IMMZD2DTRotavirusVS.schema.json

#### JSON Schema definition for the enumeration ValueSet-IMMZD2DTRotavirusVS

This endpoint serves the JSON Schema definition for the enumeration ValueSet-IMMZD2DTRotavirusVS.

## Schema Definition

### ValueSet-IMMZD2DTRotavirusVS

**Description:** JSON Schema for IMMZD2DTRotavirus ValueSet for Decision Table ValueSet codes. Generated from FHIR expansions using IRI format.
