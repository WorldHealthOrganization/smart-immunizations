# SMART Guidelines Immunizations Immunization - WHO Immunization Implementation Guide v1.0.0
...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/StructureDefinition/IMMZ.Immunization | *Version*:1.0.0 |
| Active as of 2025-01-16 | *Computable Name*:IMMZImmunization |
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["http://smart.who.int/immunizations/StructureDefinition/IMMZTypeOfDose"]
      }]
    },
    {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["http://smart.who.int/immunizations/StructureDefinition/IMMZVaccineBrand"]
      }]
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["http://smart.who.int/immunizations/StructureDefinition/IMMZLiveVaccine"]
      }]
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["http://smart.who.int/immunizations/StructureDefinition/IMMZMarketAuthorization"]
      }]
    },
    {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["http://smart.who.int/immunizations/StructureDefinition/IMMZCountryOfVaccination"]
      }]
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["http://smart.who.int/immunizations/StructureDefinition/IMMZAdministrativeArea"]
      }]
    },
    {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["http://smart.who.int/immunizations/StructureDefinition/IMMZDueDateOfNextDose"]
      }]
    },
    {
