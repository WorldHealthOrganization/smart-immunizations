# IMMZ.D.DE5 ValueSet for Reason vaccine was not administered - WHO Immunization Implementation Guide v1.0.0
...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/ValueSet/IMMZ.D.DE5 | *Version*:1.0.0 |
| Active as of 2026-03-31 | *Computable Name*:IMMZ_D_DE5 |
...
##### IMMZ.D.DE5 ValueSet for Reason vaccine was not administered Schema API
...
### GET /ValueSet-IMMZ.D.DE5.schema.json

#### JSON Schema definition for the enumeration ValueSet-IMMZ.D.DE5

This endpoint serves the JSON Schema definition for the enumeration ValueSet-IMMZ.D.DE5.

## Schema Definition

### ValueSet-IMMZ.D.DE5

**Description:** JSON Schema for IMMZ.D.DE5 ValueSet for Reason vaccine was not administered ValueSet codes. Generated from FHIR expansions using IRI format.
