# IMMZD18SPneumococcal3Doses ValueSet for Decision Table - WHO Immunization Implementation Guide v1.0.0
...
| Active as of 2026-03-31 | *Computable Name*:IMMZD18SPneumococcal3DosesVS |
...
##### IMMZD18SPneumococcal3Doses ValueSet for Decision Table Schema API
...
### GET /ValueSet-IMMZD18SPneumococcal3DosesVS.schema.json

#### JSON Schema definition for the enumeration ValueSet-IMMZD18SPneumococcal3DosesVS

This endpoint serves the JSON Schema definition for the enumeration ValueSet-IMMZD18SPneumococcal3DosesVS.

## Schema Definition

### ValueSet-IMMZD18SPneumococcal3DosesVS

**Description:** JSON Schema for IMMZD18SPneumococcal3Doses ValueSet for Decision Table ValueSet codes. Generated from FHIR expansions using IRI format.
