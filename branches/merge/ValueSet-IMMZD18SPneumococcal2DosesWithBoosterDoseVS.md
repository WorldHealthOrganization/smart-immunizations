# IMMZD18SPneumococcal2DosesWithBoosterDose ValueSet for Decision Table - WHO Immunization Implementation Guide v1.0.0
...
| Active as of 2026-03-31 | *Computable Name*:IMMZD18SPneumococcal2DosesWithBoosterDoseVS |
...
##### IMMZD18SPneumococcal2DosesWithBoosterDose ValueSet for Decision Table Schema API
...
### GET /ValueSet-IMMZD18SPneumococcal2DosesWithBoosterDoseVS.schema.json

#### JSON Schema definition for the enumeration ValueSet-IMMZD18SPneumococcal2DosesWithBoosterDoseVS

This endpoint serves the JSON Schema definition for the enumeration ValueSet-IMMZD18SPneumococcal2DosesWithBoosterDoseVS.

## Schema Definition

### ValueSet-IMMZD18SPneumococcal2DosesWithBoosterDoseVS

**Description:** JSON Schema for IMMZD18SPneumococcal2DosesWithBoosterDose ValueSet for Decision Table ValueSet codes. Generated from FHIR expansions using IRI format.
