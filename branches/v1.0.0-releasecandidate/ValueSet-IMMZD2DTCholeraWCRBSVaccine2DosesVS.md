# IMMZD2DTCholeraWCRBSVaccine2Doses ValueSet for Decision Table - WHO Immunization Implementation Guide v0.2.0

* [**Table of Contents**](toc.md)
* [**Indices**](indices.md)
* [**Artifact Index**](artifacts.md)
* **IMMZD2DTCholeraWCRBSVaccine2Doses ValueSet for Decision Table**

## ValueSet: IMMZD2DTCholeraWCRBSVaccine2Doses ValueSet for Decision Table 

| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/ValueSet/IMMZD2DTCholeraWCRBSVaccine2DosesVS | *Version*:0.2.0 |
| Active as of 2026-07-20 | *Computable Name*:IMMZD2DTCholeraWCRBSVaccine2DosesVS |

 
ValueSet IMMZD2DTCholeraWCRBSVaccine2Doses for IMMZ.D2.DT.Cholera.WC-rBS vaccine 2 doses. Business rule: Determine if the client is due for a cholera vaccination according to the national immunization schedule Trigger: IMMZ.D2 Determine required vaccination(s) if any Table: Whole cell-recombinant B subunit (WC-rBS) vaccine, 2-dose schedule for clients aged over 5 years 
...
##### IMMZD2DTCholeraWCRBSVaccine2Doses ValueSet for Decision Table Schema API
...
### GET /ValueSet-IMMZD2DTCholeraWCRBSVaccine2DosesVS.schema.json

#### JSON Schema definition for the enumeration ValueSet-IMMZD2DTCholeraWCRBSVaccine2DosesVS

This endpoint serves the JSON Schema definition for the enumeration ValueSet-IMMZD2DTCholeraWCRBSVaccine2DosesVS.

## Schema Definition

### ValueSet-IMMZD2DTCholeraWCRBSVaccine2DosesVS

**Description:** JSON Schema for IMMZD2DTCholeraWCRBSVaccine2Doses ValueSet for Decision Table ValueSet codes. Generated from FHIR expansions using IRI format.
...
```json
{
  ...
  "id" : "IMMZD2DTCholeraWCRBSVaccine2DosesVS",
  "url" : "http://smart.who.int/immunizations/ValueSet/IMMZD2DTCholeraWCRBSVaccine2DosesVS",
  "version" : "0.2.0",
  "name" : "IMMZD2DTCholeraWCRBSVaccine2DosesVS",
