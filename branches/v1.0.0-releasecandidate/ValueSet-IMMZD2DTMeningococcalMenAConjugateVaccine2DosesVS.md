# IMMZD2DTMeningococcalMenAConjugateVaccine2Doses ValueSet for Decision Table - WHO Immunization Implementation Guide v0.2.0

* [**Table of Contents**](toc.md)
* [**Indices**](indices.md)
* [**Artifact Index**](artifacts.md)
* **IMMZD2DTMeningococcalMenAConjugateVaccine2Doses ValueSet for Decision Table**

## ValueSet: IMMZD2DTMeningococcalMenAConjugateVaccine2Doses ValueSet for Decision Table 

| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/ValueSet/IMMZD2DTMeningococcalMenAConjugateVaccine2DosesVS | *Version*:0.2.0 |
| Active as of 2026-07-20 | *Computable Name*:IMMZD2DTMeningococcalMenAConjugateVaccine2DosesVS |

 
ValueSet IMMZD2DTMeningococcalMenAConjugateVaccine2Doses for IMMZ.D2.DT.Meningococcal.MenA conjugate vaccine 2 doses. Business rule: Determine if the client is due for a meningococcal vaccination according to the national immunization schedule Trigger: IMMZ.D2 Determine required vaccination(s) if any Table: MenA conjugate vaccine, 2-dose schedule (specific context where there is a compelling reason to vaccinate infants aged under 9 months) 
...
##### IMMZD2DTMeningococcalMenAConjugateVaccine2Doses ValueSet for Decision Table Schema API
...
### GET /ValueSet-IMMZD2DTMeningococcalMenAConjugateVaccine2DosesVS.schema.json

#### JSON Schema definition for the enumeration ValueSet-IMMZD2DTMeningococcalMenAConjugateVaccine2DosesVS

This endpoint serves the JSON Schema definition for the enumeration ValueSet-IMMZD2DTMeningococcalMenAConjugateVaccine2DosesVS.

## Schema Definition

### ValueSet-IMMZD2DTMeningococcalMenAConjugateVaccine2DosesVS

**Description:** JSON Schema for IMMZD2DTMeningococcalMenAConjugateVaccine2Doses ValueSet for Decision Table ValueSet codes. Generated from FHIR expansions using IRI format.
...
```json
{
  ...
  "id" : "IMMZD2DTMeningococcalMenAConjugateVaccine2DosesVS",
  "url" : "http://smart.who.int/immunizations/ValueSet/IMMZD2DTMeningococcalMenAConjugateVaccine2DosesVS",
  "version" : "0.2.0",
  "name" : "IMMZD2DTMeningococcalMenAConjugateVaccine2DosesVS",
