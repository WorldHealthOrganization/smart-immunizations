# IMMZ.D2.DT.DTP.Delayed or interrupted series - WHO Immunization Implementation Guide v0.2.0
...
## PlanDefinition: IMMZ.D2.DT.DTP.Delayed or interrupted series 

| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/PlanDefinition/IMMZD2DTDTPDelayedOrInterruptedSeries | *Version*:0.2.0 |
| Draft as of 2026-07-20 | *Computable Name*:IMMZD2DTDTPDelayedOrInterruptedSeries |
...
* **Actions: **: **Url: **
  * : [IMMZ.D2.DT.DTP.Delayed or interrupted series](PlanDefinition-IMMZD2DTDTPDelayedOrInterruptedSeries.md)
* **Actions: **: **Version: **
  * : 0.2.0
* **Actions: **: **Title: **
  * : IMMZ.D2.DT.DTP.Delayed or interrupted series
...
```json
{
  ...
  "id" : "IMMZD2DTDTPDelayedOrInterruptedSeries",
  "meta" : {
  ...
  "contained" : [{
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "The latest DTP dose was administered less than 1 year ago"
      },
      {
        "url" : "statement",
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD2DTDTPDelayedOrInterruptedSeriesLogic"
      },
      {
        "url" : "name",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "The latest DTP dose was administered more than 1 year ago"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "The latest tetanus and diphtheria dose was administered less than 1 year ago"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "The latest tetanus and diphtheria dose was administered more than 1 year ago"
      },
      {
        "url" : "statement",
  ...
  "url" : "http://smart.who.int/immunizations/PlanDefinition/IMMZD2DTDTPDelayedOrInterruptedSeries",
  "version" : "0.2.0",
  "name" : "IMMZD2DTDTPDelayedOrInterruptedSeries",
  ...
  {
    "title" : "Check for Guidance for the patient regarding IMMZ.D2.DT.DTP.Delayed or interrupted series.",
    "description" : "Show Guidance for the patient regarding IMMZ.D2.DT.DTP.Delayed or interrupted series.",
    "condition" : [{
      "kind" : "applicability",
      "expression" : {
