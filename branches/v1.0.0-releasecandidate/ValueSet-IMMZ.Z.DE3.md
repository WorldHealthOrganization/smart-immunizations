# IMMZ.Z.DE3 ValueSet for Diphtheria-containing vaccines - WHO Immunization Implementation Guide v0.2.0
...
## ValueSet: IMMZ.Z.DE3 ValueSet for Diphtheria-containing vaccines 

| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/ValueSet/IMMZ.Z.DE3 | *Version*:0.2.0 |
| Active as of 2026-07-20 | *Computable Name*:IMMZ_Z_DE3 |

 
ValueSet for Diphtheria-containing vaccines for IMMZ.Z.DE3 
...
##### IMMZ.Z.DE3 ValueSet for Diphtheria-containing vaccines Schema API
...
### GET /ValueSet-IMMZ.Z.DE3.schema.json

#### JSON Schema definition for the enumeration ValueSet-IMMZ.Z.DE3

This endpoint serves the JSON Schema definition for the enumeration ValueSet-IMMZ.Z.DE3.

## Schema Definition

### ValueSet-IMMZ.Z.DE3

**Description:** JSON Schema for IMMZ.Z.DE3 ValueSet for Diphtheria-containing vaccines ValueSet codes. Generated from FHIR expansions using IRI format.
...
```json
{
  ...
  "id" : "IMMZ.Z.DE3",
  "url" : "http://smart.who.int/immunizations/ValueSet/IMMZ.Z.DE3",
  "version" : "0.2.0",
  "name" : "IMMZ_Z_DE3",
  ...
  "compose" : {
    ...
    },
    {
      ...
      "concept" : [{
        "code" : "30936-9",
        "display" : "Long common name: Corynebacterium diphtheriae + Clostridium tetani + Bordetella pertussis dose count in combination vaccine"
      }]
    }]
  }
}
