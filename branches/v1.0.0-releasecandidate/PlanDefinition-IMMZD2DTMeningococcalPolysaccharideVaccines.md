# IMMZ.D2.DT.Meningococcal.Polysaccharide vaccines - WHO Immunization Implementation Guide v0.2.0
...
## PlanDefinition: IMMZ.D2.DT.Meningococcal.Polysaccharide vaccines 

| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/PlanDefinition/IMMZD2DTMeningococcalPolysaccharideVaccines | *Version*:0.2.0 |
| Draft as of 2026-07-20 | *Computable Name*:IMMZD2DTMeningococcalPolysaccharideVaccines |

 
IMMZ.D2.DT.Meningococcal.Polysaccharide vaccines Polysaccharide vaccines schedule (Polysaccharide vaccines can be used to control outbreaks in countries where limited economic resources or insufficient supply restrict the use of meningococcal conjugate vaccines) 

* **Actions: **: **Url: **
  * : [IMMZ.D2.DT.Meningococcal.Polysaccharide vaccines](PlanDefinition-IMMZD2DTMeningococcalPolysaccharideVaccines.md)
* **Actions: **: **Version: **
  * : 0.2.0
* **Actions: **: **Title: **
  * : IMMZ.D2.DT.Meningococcal.Polysaccharide vaccines
...
```json
{
  ...
  "id" : "IMMZD2DTMeningococcalPolysaccharideVaccines",
  "meta" : {
  ...
  "contained" : [{
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD2DTMeningococcalPolysaccharideVaccinesLogic"
      },
      {
        "url" : "name",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Client's age is more than 2 years"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "The latest meningococcal dose was administered less than 3 years ago"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "The primary series is complete. Client is not due for meningococcal booster dose."
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "The primary series is complete. Client is not due for meningococcal booster dose. Guidance"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "The latest meningococcal dose was administered more than 3 years ago"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "The primary series is complete. Clinical judgement is required for meningococcal booster dose. Create a clinical note"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "The primary series is complete. Clinical judgement is required for meningococcal booster dose. Create a clinical note Guidance"
      },
      {
        "url" : "statement",
  ...
  "url" : "http://smart.who.int/immunizations/PlanDefinition/IMMZD2DTMeningococcalPolysaccharideVaccines",
  "version" : "0.2.0",
  "name" : "IMMZD2DTMeningococcalPolysaccharideVaccines",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZD2DTMeningococcalPolysaccharideVaccinesLogic"],
  "action" : [{
    "extension" : [{
      "url" : "http://hl7.org/fhir/uv/cpg/StructureDefinition/cpg-rationale",
      "valueMarkdown" : "Polysaccharide vaccines should be administered to individuals aged ≥ 2 years as one single dose.\nOne booster 3–5 years after the primary dose may be given to persons considered to be a continued high risk of exposure, including some health workers."
    }],
  ...
  {
    "title" : "Check for Guidance for the patient regarding IMMZ.D2.DT.Meningococcal.Polysaccharide vaccines.",
    "description" : "Show Guidance for the patient regarding IMMZ.D2.DT.Meningococcal.Polysaccharide vaccines.",
    "condition" : [{
      "kind" : "applicability",
      "expression" : {
