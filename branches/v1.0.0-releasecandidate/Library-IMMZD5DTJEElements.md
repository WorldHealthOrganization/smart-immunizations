...
| Draft as of 2026-07-20 | *Computable Name*:IMMZD5DTJEElements |

 
This library defines context-independent elements for JE used throughout the Immunization CPG 

* * **Content: **application/elm+xml: ````Encoded data (14420 characters)````: **Id: **
  * ?: IMMZD5DTJEElements
* * **Content: **application/elm+xml: ````Encoded data (14420 characters)````: **Version: **
  * ?: 0.2.0
* * **Content: **application/elm+xml: ````Encoded data (14420 characters)````: **Url: **
  * ?: [IMMZD5DTJEElements](Library-IMMZD5DTJEElements.md)
* * **Content: **application/elm+xml: ````Encoded data (14420 characters)````: **Status: **
  * ?: draft
* * **Content: **application/elm+xml: ````Encoded data (14420 characters)````: **Date: **
  * ?: 2026-07-20 11:34:37+0000
* * **Content: **application/elm+xml: ````Encoded data (14420 characters)````: **Publisher: **
  * ?: WHO
* * **Content: **application/elm+xml: ````Encoded data (14420 characters)````: **Description: **
  * ?: This library defines context-independent elements for JE used throughout the Immunization CPG
