# IMMZD2DTHib3DosesWithBoosterDose ValueSet for Decision Table - WHO Immunization Implementation Guide v0.2.0

* [**Table of Contents**](toc.md)
* [**Indices**](indices.md)
* [**Artifact Index**](artifacts.md)
* **IMMZD2DTHib3DosesWithBoosterDose ValueSet for Decision Table**

## ValueSet: IMMZD2DTHib3DosesWithBoosterDose ValueSet for Decision Table 

| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/ValueSet/IMMZD2DTHib3DosesWithBoosterDoseVS | *Version*:0.2.0 |
| Active as of 2026-07-20 | *Computable Name*:IMMZD2DTHib3DosesWithBoosterDoseVS |

 
ValueSet IMMZD2DTHib3DosesWithBoosterDose for IMMZ.D2.DT.Hib.3 doses with booster dose. Business rule: Determine if the client is due for a Haemophilus influenzae type b (Hib) vaccination according to the national immunization schedule Trigger: IMMZ.D2 Determine required vaccination(s) if any Table: 3 primary doses with a booster dose (3p+1) 
...
##### IMMZD2DTHib3DosesWithBoosterDose ValueSet for Decision Table Schema API
...
### GET /ValueSet-IMMZD2DTHib3DosesWithBoosterDoseVS.schema.json

#### JSON Schema definition for the enumeration ValueSet-IMMZD2DTHib3DosesWithBoosterDoseVS

This endpoint serves the JSON Schema definition for the enumeration ValueSet-IMMZD2DTHib3DosesWithBoosterDoseVS.

## Schema Definition

### ValueSet-IMMZD2DTHib3DosesWithBoosterDoseVS

**Description:** JSON Schema for IMMZD2DTHib3DosesWithBoosterDose ValueSet for Decision Table ValueSet codes. Generated from FHIR expansions using IRI format.
...
```json
{
  ...
  "id" : "IMMZD2DTHib3DosesWithBoosterDoseVS",
  "url" : "http://smart.who.int/immunizations/ValueSet/IMMZD2DTHib3DosesWithBoosterDoseVS",
  "version" : "0.2.0",
  "name" : "IMMZD2DTHib3DosesWithBoosterDoseVS",
