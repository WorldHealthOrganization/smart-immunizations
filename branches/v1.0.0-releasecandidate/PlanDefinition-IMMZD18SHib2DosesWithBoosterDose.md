# IMMZ.D18.S.Hib.2 doses with booster dose schedule - WHO Immunization Implementation Guide v0.2.0
...
## PlanDefinition: IMMZ.D18.S.Hib.2 doses with booster dose schedule 

| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/PlanDefinition/IMMZD18SHib2DosesWithBoosterDose | *Version*:0.2.0 |
| Draft as of 2026-07-20 | *Computable Name*:IMMZD18SHib2DosesWithBoosterDose |

 
IMMZ.D18.S.Hib.2 doses with booster dose schedule 2 primary doses with a booster dose (2p+1) schedule 

* **Actions: **: **Url: **
  * : [IMMZ.D18.S.Hib.2 doses with booster dose schedule](PlanDefinition-IMMZD18SHib2DosesWithBoosterDose.md)
* **Actions: **: **Version: **
  * : 0.2.0
* **Actions: **: **Title: **
  * : IMMZ.D18.S.Hib.2 doses with booster dose schedule
...
```json
{
  ...
  "id" : "IMMZD18SHib2DosesWithBoosterDose",
  "meta" : {
  ...
  "contained" : [{
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD18SHib2DosesWithBoosterDoseLogic"
      },
      {
        "url" : "name",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Second Hib dose from the primary series was administered. The primary series has been completed"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "One Hib booster dose was administered. Hib immunization schedule has been completed"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Hib booster dose Expiration"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Hib booster dose Due Date"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Hib booster dose Create"
      },
      {
        "url" : "statement",
  ...
  "url" : "http://smart.who.int/immunizations/PlanDefinition/IMMZD18SHib2DosesWithBoosterDose",
  "version" : "0.2.0",
  "name" : "IMMZD18SHib2DosesWithBoosterDose",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZD18SHib2DosesWithBoosterDoseLogic"],
  "action" : [{
  ...
  },
  {
    ...
    },
    {
      ...
      "expression" : {
        "language" : "text/cql-identifier",
        "expression" : "Hib booster dose Create"
      }
    },
    {
      "path" : "category.coding",
