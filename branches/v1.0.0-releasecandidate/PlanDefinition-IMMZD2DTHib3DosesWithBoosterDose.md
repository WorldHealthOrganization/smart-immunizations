# IMMZ.D2.DT.Hib.3 doses with booster dose - WHO Immunization Implementation Guide v0.2.0
...
## PlanDefinition: IMMZ.D2.DT.Hib.3 doses with booster dose 

| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/PlanDefinition/IMMZD2DTHib3DosesWithBoosterDose | *Version*:0.2.0 |
| Draft as of 2026-07-20 | *Computable Name*:IMMZD2DTHib3DosesWithBoosterDose |

 
IMMZ.D2.DT.Hib.3 doses with booster dose 3 primary doses with a booster dose (3p+1) 

* **Actions: **: **Url: **
  * : [IMMZ.D2.DT.Hib.3 doses with booster dose](PlanDefinition-IMMZD2DTHib3DosesWithBoosterDose.md)
* **Actions: **: **Version: **
  * : 0.2.0
* **Actions: **: **Title: **
  * : IMMZ.D2.DT.Hib.3 doses with booster dose
...
```json
{
  ...
  "id" : "IMMZD2DTHib3DosesWithBoosterDose",
  "meta" : {
  ...
  "contained" : [{
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD2DTHib3DosesWithBoosterDoseLogic"
      },
      {
        "url" : "name",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "The latest Hib dose was administered less than 4 weeks ago"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Client's age is between 6 weeks and not more than 5 years"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Client is not due for Hib vaccination Case 4"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "The latest Hib dose was administered more than 4 weeks ago"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Client is due for Hib vaccination Case 3"
      },
      {
        "url" : "statement",
  ...
  "url" : "http://smart.who.int/immunizations/PlanDefinition/IMMZD2DTHib3DosesWithBoosterDose",
  "version" : "0.2.0",
  "name" : "IMMZD2DTHib3DosesWithBoosterDose",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZD2DTHib3DosesWithBoosterDoseLogic"],
  "action" : [{
    "extension" : [{
  ...
  {
    "title" : "Check for Guidance for the patient regarding IMMZ.D2.DT.Hib.3 doses with booster dose.",
    "description" : "Show Guidance for the patient regarding IMMZ.D2.DT.Hib.3 doses with booster dose.",
    "condition" : [{
      "kind" : "applicability",
      "expression" : {
