# IMMZ.D2.DT.HPV.Single dose - WHO Immunization Implementation Guide v0.2.0
...
## PlanDefinition: IMMZ.D2.DT.HPV.Single dose 

| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/PlanDefinition/IMMZD2DTHPVSingleDose | *Version*:0.2.0 |
| Draft as of 2026-07-20 | *Computable Name*:IMMZD2DTHPVSingleDose |

 
IMMZ.D2.DT.HPV.Single dose Alternative single-dose schedule 

* **Actions: **: **Url: **
  * : [IMMZ.D2.DT.HPV.Single dose](PlanDefinition-IMMZD2DTHPVSingleDose.md)
* **Actions: **: **Version: **
  * : 0.2.0
* **Actions: **: **Title: **
  * : IMMZ.D2.DT.HPV.Single dose
...
```json
{
  ...
  "contained" : [{
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD2DTHPVSingleDoseLogic"
      },
      {
        "url" : "name",
        "valueString" : "Client is not due for HPV vaccination Case 1"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "The latest HPV dose was administered less than 6 months ago"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Client is not due for HPV vaccination Case 2"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Client is not due for HPV vaccination Case 3"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Client is not due for HPV vaccination Case 4"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Client is not due for HPV vaccination Case 5"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Client is not due for HPV vaccination"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Client is not due for HPV vaccination Guidance"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Client's age is between 9 and 20 years"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Client is due for HPV vaccination Case 1"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "The latest HPV dose was administered more than 6 months ago"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Client is due for HPV vaccination Case 2"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Client is due for HPV vaccination Case 3"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Client is due for HPV vaccination Case 4"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Client is due for HPV vaccination Case 5"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Client is due for HPV vaccination"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Client is due for HPV vaccination Guidance"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Client's age is more than 20 years"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Client is not immunocompromised"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "HPV immunization schedule is complete Case 1"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "HPV immunization schedule is complete Case 2"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "HPV immunization schedule is complete"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "HPV immunization schedule is complete Guidance"
      },
      {
        "url" : "statement",
  ...
  "url" : "http://smart.who.int/immunizations/PlanDefinition/IMMZD2DTHPVSingleDose",
  "version" : "0.2.0",
  "name" : "IMMZD2DTHPVSingleDose",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZD2DTHPVSingleDoseLogic"],
  "action" : [{
    "extension" : [{
      "url" : "http://hl7.org/fhir/uv/cpg/StructureDefinition/cpg-rationale",
      "valueMarkdown" : "As an off-label option, a single-dose schedule can be used in girls and boys aged 9–20 years."
    }],
  ...
  {
    "title" : "Check for Guidance for the patient regarding IMMZ.D2.DT.HPV.Single dose.",
    "description" : "Show Guidance for the patient regarding IMMZ.D2.DT.HPV.Single dose.",
    "condition" : [{
      "kind" : "applicability",
      "expression" : {
