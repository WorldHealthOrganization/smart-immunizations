# IMMZ.D5.DT.Malaria contraindications - WHO Immunization Implementation Guide v0.2.0
...
## PlanDefinition: IMMZ.D5.DT.Malaria contraindications 

| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/PlanDefinition/IMMZD5DTMalariaContraindications | *Version*:0.2.0 |
| Draft as of 2026-07-20 | *Computable Name*:IMMZD5DTMalariaContraindications |

 
IMMZ.D5.DT.Malaria contraindications IMMZ.D5.DT.Malaria contraindications 

* **Actions: **: **Url: **
  * : [IMMZ.D5.DT.Malaria contraindications](PlanDefinition-IMMZD5DTMalariaContraindications.md)
* **Actions: **: **Version: **
  * : 0.2.0
* **Actions: **: **Title: **
  * : IMMZ.D5.DT.Malaria contraindications
...
```json
{
  ...
  "id" : "IMMZD5DTMalariaContraindications",
  "meta" : {
  ...
  "contained" : [{
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD5DTMalariaContraindicationsLogic"
      },
      {
        "url" : "name",
        "valueString" : "Malaria vaccination could be contraindicated. Clinical judgement is required. Create a clinical note"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Malaria vaccination could be contraindicated. Clinical judgement is required. Create a clinical note Guidance"
      },
      {
        "url" : "statement",
  ...
  "url" : "http://smart.who.int/immunizations/PlanDefinition/IMMZD5DTMalariaContraindications",
  "version" : "0.2.0",
  "name" : "IMMZD5DTMalariaContraindications",
  "title" : "IMMZ.D5.DT.Malaria contraindications",
  "type" : {
    "coding" : [{
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZD5DTMalariaContraindicationsLogic"],
  "action" : [{
    "title" : "Check for Guidance for the patient regarding IMMZ.D5.DT.Malaria contraindications.",
    "description" : "Show Guidance for the patient regarding IMMZ.D5.DT.Malaria contraindications.",
    "condition" : [{
      "kind" : "applicability",
      "expression" : {
