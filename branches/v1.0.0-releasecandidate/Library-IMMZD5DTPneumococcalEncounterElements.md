...
| Draft as of 2026-07-20 | *Computable Name*:IMMZD5DTPneumococcalEncounterElements |

 
This library defines encounter-based elements for Pneumococcal used throughout the Immunization CPG 

* * **Content: **application/elm+xml: ````Encoded data (17348 characters)````: **Id: **
  * ?: IMMZD5DTPneumococcalEncounterElements
* * **Content: **application/elm+xml: ````Encoded data (17348 characters)````: **Version: **
  * ?: 0.2.0
* * **Content: **application/elm+xml: ````Encoded data (17348 characters)````: **Url: **
  * ?: [IMMZD5DTPneumococcalEncounterElements](Library-IMMZD5DTPneumococcalEncounterElements.md)
* * **Content: **application/elm+xml: ````Encoded data (17348 characters)````: **Status: **
  * ?: draft
* * **Content: **application/elm+xml: ````Encoded data (17348 characters)````: **Date: **
  * ?: 2026-07-20 11:34:37+0000
* * **Content: **application/elm+xml: ````Encoded data (17348 characters)````: **Publisher: **
  * ?: WHO
* * **Content: **application/elm+xml: ````Encoded data (17348 characters)````: **Description: **
  * ?: This library defines encounter-based elements for Pneumococcal used throughout the Immunization CPG
