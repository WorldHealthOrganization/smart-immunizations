...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/smart.who.int.immunizations|current/StructureDefinition/StructureDefinition-IMMZD2.json)
