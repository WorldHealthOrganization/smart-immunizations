...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/PlanDefinition/IMMZD2DTDTPOnTime | *Version*:0.2.0 |
| Draft as of 2026-03-31 | *Computable Name*:IMMZD2DTDTPOnTime |

 
IMMZ.D2.DT.DTP.On-time start DTP vaccination schedule, on-time start (at ≤ 12 months of age) 

* **Actions: **: **Url: **
  * : [IMMZ.D2.DT.DTP.On-time start](PlanDefinition-IMMZD2DTDTPOnTime.md)
* **Actions: **: **Version: **
  * : 0.2.0
* **Actions: **: **Title: **
  * : IMMZ.D2.DT.DTP.On-time start
...
```json
{
  ...
  "contained" : [{
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD2DTDTPOnTimeLogic"
      },
      {
        "url" : "name",
  ...
  "url" : "http://smart.who.int/immunizations/PlanDefinition/IMMZD2DTDTPOnTime",
  "version" : "0.2.0",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZD2DTDTPOnTimeLogic"],
  "action" : [{
    "extension" : [{
