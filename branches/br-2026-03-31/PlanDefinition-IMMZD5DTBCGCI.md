...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/PlanDefinition/IMMZD5DTBCGCI | *Version*:0.2.0 |
| Draft as of 2026-03-31 | *Computable Name*:IMMZD5DTBCGCI |

 
IMMZ.D5.DT.BCG contraindications Potential contraindications 

* **Actions: **: **Url: **
  * : [IMMZ.D5.DT.BCG contraindications](PlanDefinition-IMMZD5DTBCGCI.md)
* **Actions: **: **Version: **
  * : 0.2.0
* **Actions: **: **Title: **
  * : IMMZ.D5.DT.BCG contraindications
...
```json
{
  ...
  "contained" : [{
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD5DTBCGEncounterElements"
      },
      {
        "url" : "name",
        "valueString" : "The client is pregnant"
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD5DTBCGCILogic"
      },
      {
        "url" : "name",
        "valueString" : "Bacille Calmette–Guérin (BCG) vaccination is contraindicated"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Bacille Calmette–Guérin (BCG) vaccination is contraindicated Guidance"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "BCG vaccination could be contraindicated. Clinical judgement is required. Create a clinical note. Case 1"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "BCG vaccination could be contraindicated. Clinical judgement is required. Create a clinical note. Case 2"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "BCG vaccination could be contraindicated. Clinical judgement is required. Create a clinical note."
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "BCG vaccination could be contraindicated. Clinical judgement is required. Create a clinical note. Guidance"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "BCG vaccination is contraindicated Case 1"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "BCG vaccination is contraindicated Case 2"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "BCG vaccination is contraindicated"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "BCG vaccination is contraindicated Guidance"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Draft Medication Request for BCG dose"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Draft Medication Request ID for BCG dose"
      },
      {
        "url" : "statement",
  ...
  "url" : "http://smart.who.int/immunizations/PlanDefinition/IMMZD5DTBCGCI",
  "version" : "0.2.0",
  "name" : "IMMZD5DTBCGCI",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZD5DTBCGCILogic"],
  "action" : [{
  ...
  },
  {
    ...
    "definitionCanonical" : "http://smart.who.int/immunizations/ActivityDefinition/IMMZD5DTMeaslesMR",
    "dynamicValue" : [{
      "path" : "id",
      "expression" : {
