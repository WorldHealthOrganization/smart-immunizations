...
| Draft as of 2026-03-31 | *Computable Name*:IMMZD18STBEMoscow |
...
```json
{
  ...
  "contained" : [{
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD18STBEMoscowLogic"
      },
      {
        "url" : "name",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZD18STBEMoscowLogic"],
  "action" : [{
