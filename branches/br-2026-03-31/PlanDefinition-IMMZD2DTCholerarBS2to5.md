...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/PlanDefinition/IMMZD2DTCholerarBS2to5 | *Version*:0.2.0 |
| Draft as of 2026-03-31 | *Computable Name*:IMMZD2DTCholerarBS2to5 |
...
* **Actions: **: **Url: **
  * : [IMMZ.D2.DT.Cholera.WC-rBS vaccine 3 doses](PlanDefinition-IMMZD2DTCholerarBS2to5.md)
* **Actions: **: **Version: **
  * : 0.2.0
* **Actions: **: **Title: **
  * : IMMZ.D2.DT.Cholera.WC-rBS vaccine 3 doses
...
```json
{
  ...
  "contained" : [{
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD2DTCholerarBS2to5Logic"
      },
      {
        "url" : "name",
        "valueString" : "Client is not due for cholera vaccination Case 1"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Client's age is 2–5 years"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Client is not due for cholera vaccination Case 2"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Dose number of the latest primary series dose is two"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Client is not due for cholera vaccination Case 3"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Dose number of the latest primary series dose is less than three"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Dose number of the latest primary series dose is three"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "The latest cholera dose was administered approximately more than 6 months ago {Member States defined exact interval}"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Client is due for cholera vaccination Case 5"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "The latest cholera dose was administered less than {Member States defined lower limit} days ago"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Primary series is complete. Client is not due for cholera booster dose"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Primary series is complete. Client is not due for cholera booster dose Guidance"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "The latest cholera dose was administered approximately less than 6 months ago {Member States defined exact interval}"
      },
      {
        "url" : "statement",
  ...
  "url" : "http://smart.who.int/immunizations/PlanDefinition/IMMZD2DTCholerarBS2to5",
  "version" : "0.2.0",
  "name" : "IMMZD2DTCholerarBS2to5",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZD2DTCholerarBS2to5Logic"],
  "action" : [{
    "extension" : [{
    ...
    "definitionCanonical" : "http://smart.who.int/immunizations/ActivityDefinition/IMMZD2DTCholeraMR",
    "dynamicValue" : [{
      "path" : "status",
      "expression" : {
