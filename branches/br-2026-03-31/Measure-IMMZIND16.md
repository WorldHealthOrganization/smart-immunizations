# IMMZIND16 - WHO Immunization Implementation Guide v0.2.0
...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/Measure/IMMZIND16 | *Version*:0.2.0 |
| Draft as of 2025-06-11 | *Computable Name*:IMMZIND16 |

 
IMMZ.IND.16 Immunization coverage for meningococcal vaccine 
...
* Knowledge Artifact Metadata: Initial Population
  * ?: **ID**: IMMZ.IND.16.IP**Description**:Initial Population**Logic Definition**:[Initial Population](#immzind16logic-initial-population)
* Knowledge Artifact Metadata: Denominator
  * ?: **ID**: IMMZ.IND.16.D**Description**:Denominator**Logic Definition**:[Denominator](#immzind16logic-denominator)
* Knowledge Artifact Metadata: Numerator
  * ?: **ID**: IMMZ.IND.16.N**Description**:Numerator**Logic Definition**:[Numerator](#immzind16logic-numerator)
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.16.S1**Code**: By-Administrative Area
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.16.S2**Code**: By-Sex
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.16.S3**Code**: By-Age group
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.16.S4**Code**: By-Age group
...
* Knowledge Artifact Metadata: Dependency
  * ?: **Description**: Library Meningococcal**Resource**:[IMMZD2DTMeningococcalElements](Library-IMMZD2DTMeningococcalElements.md)**Canonical URL**:http://smart.who.int/immunizations/Library/IMMZD2DTMeningococcalElements
* Knowledge Artifact Metadata: Dependency
...
* Knowledge Artifact Metadata: Dependency
  * ?: **Description**: Value set Meningococcal vaccines**Resource**:[IMMZ.Z.DE10 ValueSet for Meningococcal vaccines](ValueSet-IMMZ.Z.DE10.md)**Canonical URL**:http://smart.who.int/immunizations/ValueSet/IMMZ.Z.DE10
...
* Knowledge Artifact Metadata: Data Requirement
  * ?: **Type**: Immunization**Profile(s)**:[Immunization](http://hl7.org/fhir/R4/immunization.html)**Must Support Elements**: status, isSubpotent, vaccineCode, occurrence**Code Filter(s)**:**Path**: status**Code**: **Path**: vaccineCode**ValueSet**:[IMMZ.Z.DE10 ValueSet for Meningococcal vaccines](ValueSet-IMMZ.Z.DE10.md)
* Knowledge Artifact Metadata: Data Requirement
...
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**IMMZD2DTMeningococcalElements
* Knowledge Artifact Metadata: ````/* @internal: Meningococcal containing Doses Administered to Patient */ define "Meningococcal Doses Administered to Patient": Elements."Doses Administered to Patient" I where I.vaccineCode in Concepts."Meningococcal vaccines"````
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**IMMZIND16Logic
* Knowledge Artifact Metadata: ````/* @numerator: Number of meningococcal vaccine doses administered through routine services during the reporting period @pseudocode: COUNT of immunization events WHERE "Vaccine type" = "Meningococcal vaccines" AND "Date and time of vaccination" is during the reporting period */ define "Numerator": exists( Meningococcal."Meningococcal Doses Administered to Patient" I where I.occurrence.toInterval() starts during "Measurement Period" )````
* Knowledge Artifact Metadata:  Logic Definition
...
```json
{
  ...
  "contained" : [{
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD2DTMeningococcalElements"
      },
      {
        "url" : "name",
  ...
  "url" : "http://smart.who.int/immunizations/Measure/IMMZIND16",
  "version" : "0.2.0",
  "name" : "IMMZIND16",
  "title" : "IMMZIND16",
  "status" : "draft",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZIND16Logic"],
  "scoring" : {
    "coding" : [{
