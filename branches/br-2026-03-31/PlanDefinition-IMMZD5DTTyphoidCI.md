...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/PlanDefinition/IMMZD5DTTyphoidCI | *Version*:0.2.0 |
| Draft as of 2026-03-31 | *Computable Name*:IMMZD5DTTyphoidCI |

 
IMMZ.D5.DT.Typhoid contraindications Potential contraindications 

* **Actions: **: **Url: **
  * : [IMMZ.D5.DT.Typhoid contraindications](PlanDefinition-IMMZD5DTTyphoidCI.md)
* **Actions: **: **Version: **
  * : 0.2.0
* **Actions: **: **Title: **
  * : IMMZ.D5.DT.Typhoid contraindications
...
```json
{
  ...
  "contained" : [{
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD5DTTyphoidCILogic"
      },
      {
        "url" : "name",
  ...
  "url" : "http://smart.who.int/immunizations/PlanDefinition/IMMZD5DTTyphoidCI",
  "version" : "0.2.0",
  "name" : "IMMZD5DTTyphoidCI",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZD5DTTyphoidCILogic"],
  "action" : [{
    ...
    "definitionCanonical" : "http://smart.who.int/immunizations/ActivityDefinition/IMMZD5DTTyphoidMR",
    "dynamicValue" : [{
      "path" : "id",
      "expression" : {
