...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/PlanDefinition/IMMZD2DTHib2p1b | *Version*:0.2.0 |
| Draft as of 2026-03-31 | *Computable Name*:IMMZD2DTHib2p1b |

 
IMMZ.D2.DT.Hib.2 doses with booster dose 2 primary doses with a booster dose (2p+1) 

* **Actions: **: **Url: **
  * : [IMMZ.D2.DT.Hib.2 doses with booster dose](PlanDefinition-IMMZD2DTHib2p1b.md)
* **Actions: **: **Version: **
  * : 0.2.0
* **Actions: **: **Title: **
  * : IMMZ.D2.DT.Hib.2 doses with booster dose
...
| |
| :--- |
| [IMMZD2DTHib2p1bLogic](Library-IMMZD2DTHib2p1bLogic.md) |
...
```json
{
  ...
  "contained" : [{
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD2DTHib2p1bLogic"
      },
      {
        "url" : "name",
  ...
  "url" : "http://smart.who.int/immunizations/PlanDefinition/IMMZD2DTHib2p1b",
  "version" : "0.2.0",
  "name" : "IMMZD2DTHib2p1b",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZD2DTHib2p1bLogic"],
  "action" : [{
    "extension" : [{
