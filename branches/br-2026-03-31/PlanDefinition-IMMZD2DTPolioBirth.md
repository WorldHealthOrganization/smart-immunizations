...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/PlanDefinition/IMMZD2DTPolioBirth | *Version*:0.2.0 |
| Draft as of 2026-03-31 | *Computable Name*:IMMZD2DTPolioBirth |
...
* **Actions: **: **Url: **
  * : [IMMZ.D2.DT.Polio.Birth dose](PlanDefinition-IMMZD2DTPolioBirth.md)
* **Actions: **: **Version: **
  * : 0.2.0
* **Actions: **: **Title: **
  * : IMMZ.D2.DT.Polio.Birth dose
...
```json
{
  ...
  "contained" : [{
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "bOPV birth dose (a zero dose) was not administered"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Client's age is less than 1 week"
      },
      {
        "url" : "statement",
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD2DTPolioBirthLogic"
      },
      {
        "url" : "name",
        "valueString" : "Client is due for the bOPV birth dose"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Client is due for the bOPV birth dose Guidance"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Client's age is more than or equal to 1 week"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Client is not due for the bOPV birth dose Case 1"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Client is not due for the bOPV birth dose Case 2"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Client is not due for the bOPV birth dose"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Client is not due for the bOPV birth dose Guidance"
      },
      {
        "url" : "statement",
  ...
  "url" : "http://smart.who.int/immunizations/PlanDefinition/IMMZD2DTPolioBirth",
  "version" : "0.2.0",
  "name" : "IMMZD2DTPolioBirth",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZD2DTPolioBirthLogic"],
  "action" : [{
    "extension" : [{
