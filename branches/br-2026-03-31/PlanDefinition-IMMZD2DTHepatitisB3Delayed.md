...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/PlanDefinition/IMMZD2DTHepatitisB3Delayed | *Version*:0.2.0 |
| Draft as of 2026-03-31 | *Computable Name*:IMMZD2DTHepatitisB3Delayed |

 
IMMZ.D2.DT.Hepatitis B.Delayed start 3-dose schedule (no birth dose + 3 doses), delayed start 

* **Actions: **: **Url: **
  * : [IMMZ.D2.DT.Hepatitis B.Delayed start](PlanDefinition-IMMZD2DTHepatitisB3Delayed.md)
* **Actions: **: **Version: **
  * : 0.2.0
* **Actions: **: **Title: **
  * : IMMZ.D2.DT.Hepatitis B.Delayed start
...
| |
| :--- |
| [IMMZD2DTHepatitisB3DelayedLogic](Library-IMMZD2DTHepatitisB3DelayedLogic.md) |
...
```json
{
  ...
  "contained" : [{
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Number of Hepatitis B Doses Administered"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "No hepatitis B doses were administered"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Client's age is more than {Member States defined lower limit}"
      },
      {
        "url" : "statement",
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD2DTHepatitisB3DelayedLogic"
      },
      {
        "url" : "name",
        "valueString" : "Client is due for hepatitis B vaccination"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Client is due for hepatitis B vaccination Guidance"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "One hepatitis B dose was administered"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Two hepatitis B doses were administered"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Date of First Hepatitis B Dose"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "The first hepatitis B dose was administered less than 6 months ago"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "The first hepatitis B dose was administered more than 6 months ago"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Three hepatitis B doses were administered"
      },
      {
        "url" : "statement",
  ...
  "url" : "http://smart.who.int/immunizations/PlanDefinition/IMMZD2DTHepatitisB3Delayed",
  "version" : "0.2.0",
  "name" : "IMMZD2DTHepatitisB3Delayed",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZD2DTHepatitisB3DelayedLogic"],
  "action" : [{
    "extension" : [{
    ...
    "definitionCanonical" : "http://smart.who.int/immunizations/ActivityDefinition/IMMZD2DTHepatitisBMR",
    "dynamicValue" : [{
      "path" : "status",
      "expression" : {
