...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/PlanDefinition/IMMZD2DTPolioIPV | *Version*:0.2.0 |
| Draft as of 2026-03-31 | *Computable Name*:IMMZD2DTPolioIPV |
...
* **Actions: **: **Url: **
  * : [IMMZ.D2.DT.Polio.IPV-only](PlanDefinition-IMMZD2DTPolioIPV.md)
* **Actions: **: **Version: **
  * : 0.2.0
* **Actions: **: **Title: **
  * : IMMZ.D2.DT.Polio.IPV-only
...
```json
{
  ...
  "contained" : [{
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD2DTPolioIPVLogic"
      },
      {
        "url" : "name",
  ...
  "url" : "http://smart.who.int/immunizations/PlanDefinition/IMMZD2DTPolioIPV",
  "version" : "0.2.0",
  "name" : "IMMZD2DTPolioIPV",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZD2DTPolioIPVLogic"],
  "action" : [{
    "extension" : [{
