...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/PlanDefinition/IMMZD2DTYellowfever | *Version*:0.2.0 |
| Draft as of 2026-03-31 | *Computable Name*:IMMZD2DTYellowfever |

 
IMMZ.D2.DT.Yellow fever IMMZ.D2.DT.Yellow fever 

* **Actions: **: **Url: **
  * : [IMMZ.D2.DT.Yellow fever](PlanDefinition-IMMZD2DTYellowfever.md)
* **Actions: **: **Version: **
  * : 0.2.0
* **Actions: **: **Title: **
  * : IMMZ.D2.DT.Yellow fever
...
```json
{
  ...
  "contained" : [{
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD2DTYellowfeverLogic"
      },
      {
        "url" : "name",
        "valueString" : "Client is not due for yellow fever vaccination Case 1"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Client is not due for yellow fever vaccination Case 2"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Client is not due for yellow fever vaccination"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Client is not due for yellow fever vaccination Guidance"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Client is due for yellow fever vaccination"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Client is due for yellow fever vaccination Guidance"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Yellow fever immunization schedule is complete"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Yellow fever immunization schedule is complete Guidance"
      },
      {
        "url" : "statement",
  ...
  "url" : "http://smart.who.int/immunizations/PlanDefinition/IMMZD2DTYellowfever",
  "version" : "0.2.0",
  "name" : "IMMZD2DTYellowfever",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZD2DTYellowfeverLogic"],
  "action" : [{
    "extension" : [{
    ...
    "definitionCanonical" : "http://smart.who.int/immunizations/ActivityDefinition/IMMZD2DTYellowfeverMR",
    "dynamicValue" : [{
      "path" : "status",
      "expression" : {
