...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/PlanDefinition/IMMZD2DTRubellaLow | *Version*:0.2.0 |
| Draft as of 2026-03-31 | *Computable Name*:IMMZD2DTRubellaLow |

 
IMMZ.D2.DT.Rubella.Low incidence Countries with low incidence of rubella 

* **Actions: **: **Url: **
  * : [IMMZ.D2.DT.Rubella.Low incidence](PlanDefinition-IMMZD2DTRubellaLow.md)
* **Actions: **: **Version: **
  * : 0.2.0
* **Actions: **: **Title: **
  * : IMMZ.D2.DT.Rubella.Low incidence
...
```json
{
  ...
  "contained" : [{
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD2DTRubellaLowLogic"
      },
      {
        "url" : "name",
  ...
  "url" : "http://smart.who.int/immunizations/PlanDefinition/IMMZD2DTRubellaLow",
  "version" : "0.2.0",
  "name" : "IMMZD2DTRubellaLow",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZD2DTRubellaLowLogic"],
  "action" : [{
    "extension" : [{
    ...
    "definitionCanonical" : "http://smart.who.int/immunizations/ActivityDefinition/IMMZD2DTRubellaMR",
    "dynamicValue" : [{
      "path" : "status",
      "expression" : {
