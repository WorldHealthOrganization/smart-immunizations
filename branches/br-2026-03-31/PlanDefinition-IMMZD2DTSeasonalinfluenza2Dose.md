...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/PlanDefinition/IMMZD2DTSeasonalinfluenza2Dose | *Version*:0.2.0 |
| Draft as of 2026-03-31 | *Computable Name*:IMMZD2DTSeasonalinfluenza2Dose |

 
IMMZ.D2.DT.Seasonal influenza Inactivated trivalent and quadrivalent vaccines, 2-dose schedule 

* **Actions: **: **Url: **
  * : [IMMZ.D2.DT.Seasonal influenza](PlanDefinition-IMMZD2DTSeasonalinfluenza2Dose.md)
* **Actions: **: **Version: **
  * : 0.2.0
* **Actions: **: **Title: **
  * : IMMZ.D2.DT.Seasonal influenza
...
```json
{
  ...
  "id" : "IMMZD2DTSeasonalinfluenza2Dose",
  "meta" : {
  ...
  "contained" : [{
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD2DTSeasonalinfluenza2DoseLogic"
      },
      {
        "url" : "name",
        "valueString" : "Client is not due for seasonal influenza vaccination Case 1"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "The latest seasonal influenza dose was administered less than 4 weeks ago"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Client is not due for seasonal influenza vaccination Case 2"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Client is not due for seasonal influenza vaccination"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Client is not due for seasonal influenza vaccination Guidance"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Client is due for seasonal influenza vaccination Case 1"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "The latest seasonal influenza dose was administered more than 4 weeks ago"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Client is due for seasonal influenza vaccination Case 2"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Client is due for seasonal influenza vaccination"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Client is due for seasonal influenza vaccination Guidance"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "The latest seasonal influenza dose was  administered less than 1 year ago"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "The primary series is complete. Client is not due for seasonal influenza annual dose Case 1"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "The primary series is complete. Client is not due for seasonal influenza annual dose Case 2"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "The primary series is complete. Client is not due for seasonal influenza annual dose"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "The primary series is complete. Client is not due for seasonal influenza annual dose Guidance"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "The latest seasonal influenza dose was administered more than 1 year ago"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "The primary series is complete. Client is due for seasonal influenza annual dose Case 1"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "The primary series is complete. Client is due for seasonal influenza annual dose Case 2"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "The primary series is complete. Client is due for seasonal influenza annual dose"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "The primary series is complete. Client is due for seasonal influenza annual dose Guidance"
      },
      {
        "url" : "statement",
  ...
  "url" : "http://smart.who.int/immunizations/PlanDefinition/IMMZD2DTSeasonalinfluenza2Dose",
  "version" : "0.2.0",
  "name" : "IMMZD2DTSeasonalinfluenza2Dose",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZD2DTSeasonalinfluenza2DoseLogic"],
  "action" : [{
    "extension" : [{
    ...
    "definitionCanonical" : "http://smart.who.int/immunizations/ActivityDefinition/IMMZD2DTSeasonalinfluenzaMR",
    "dynamicValue" : [{
      "path" : "status",
      "expression" : {
