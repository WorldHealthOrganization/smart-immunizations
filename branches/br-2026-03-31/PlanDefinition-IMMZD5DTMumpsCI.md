...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/PlanDefinition/IMMZD5DTMumpsCI | *Version*:0.2.0 |
| Draft as of 2026-03-31 | *Computable Name*:IMMZD5DTMumpsCI |

 
IMMZ.D5.DT.Mumps contraindications Potential contraindications 

* **Actions: **: **Url: **
  * : [IMMZ.D5.DT.Mumps contraindications](PlanDefinition-IMMZD5DTMumpsCI.md)
* **Actions: **: **Version: **
  * : 0.2.0
* **Actions: **: **Title: **
  * : IMMZ.D5.DT.Mumps contraindications
...
```json
{
  ...
  "contained" : [{
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD5DTMumpsCILogic"
      },
      {
        "url" : "name",
  ...
  "url" : "http://smart.who.int/immunizations/PlanDefinition/IMMZD5DTMumpsCI",
  "version" : "0.2.0",
  "name" : "IMMZD5DTMumpsCI",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZD5DTMumpsCILogic"],
  "action" : [{
    ...
    "definitionCanonical" : "http://smart.who.int/immunizations/ActivityDefinition/IMMZD5DTMumpsMR",
    "dynamicValue" : [{
      "path" : "id",
      "expression" : {
