...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/PlanDefinition/IMMZD5DTVaricellaCI | *Version*:0.2.0 |
| Draft as of 2026-03-31 | *Computable Name*:IMMZD5DTVaricellaCI |

 
IMMZ.D5.DT.Varicella contraindications Potential contraindications 

* **Actions: **: **Url: **
  * : [IMMZ.D5.DT.Varicella contraindications](PlanDefinition-IMMZD5DTVaricellaCI.md)
* **Actions: **: **Version: **
  * : 0.2.0
* **Actions: **: **Title: **
  * : IMMZ.D5.DT.Varicella contraindications
...
```json
{
  ...
  "contained" : [{
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD5DTVaricellaEncounterElements"
      },
      {
        "url" : "name",
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD5DTVaricellaCILogic"
      },
      {
        "url" : "name",
        "valueString" : "Varicella vaccination is contraindicated"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Varicella vaccination is contraindicated Guidance"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "The client is planning to get pregnant in the next month"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "The client is receiving or has received medications that may be immunosuppressive"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Clinical judgement is required. Create clinical note Case 3"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Varicella vaccination could be contraindicated. Clinical judgement is required. Create clinical note"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Varicella vaccination could be contraindicated. Clinical judgement is required. Create clinical note Guidance"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Draft Medication Request for Varicella dose"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Draft Medication Request ID for Varicella dose"
      },
      {
        "url" : "statement",
  ...
  "url" : "http://smart.who.int/immunizations/PlanDefinition/IMMZD5DTVaricellaCI",
  "version" : "0.2.0",
  "name" : "IMMZD5DTVaricellaCI",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZD5DTVaricellaCILogic"],
  "action" : [{
    ...
    "definitionCanonical" : "http://smart.who.int/immunizations/ActivityDefinition/IMMZD5DTVaricellaMR",
    "dynamicValue" : [{
      "path" : "id",
      "expression" : {
