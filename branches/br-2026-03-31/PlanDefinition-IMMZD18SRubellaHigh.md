...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/PlanDefinition/IMMZD18SRubellaHigh | *Version*:0.2.0 |
| Draft as of 2026-03-31 | *Computable Name*:IMMZD18SRubellaHigh |

 
IMMZ.D18.S.Rubella.High incidence schedule Schedule for countries with high incidence and mortality from rubella 

* **Actions: **: **Url: **
  * : [IMMZ.D18.S.Rubella.High incidence schedule](PlanDefinition-IMMZD18SRubellaHigh.md)
* **Actions: **: **Version: **
  * : 0.2.0
* **Actions: **: **Title: **
  * : IMMZ.D18.S.Rubella.High incidence schedule
...
```json
{
  ...
  "contained" : [{
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD18SRubellaHighLogic"
      },
      {
        "url" : "name",
  ...
  "url" : "http://smart.who.int/immunizations/PlanDefinition/IMMZD18SRubellaHigh",
  "version" : "0.2.0",
  "name" : "IMMZD18SRubellaHigh",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZD18SRubellaHighLogic"],
  "action" : [{
