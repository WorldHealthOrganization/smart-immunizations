...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/PlanDefinition/IMMZD18SPneumococcal3p0b | *Version*:0.2.0 |
| Draft as of 2026-03-31 | *Computable Name*:IMMZD18SPneumococcal3p0b |

 
IMMZ.D18.S.Pneumococcal.3 doses schedule 3 primary doses (3p+0) schedule 

* **Actions: **: **Url: **
  * : [IMMZ.D18.S.Pneumococcal.3 doses schedule](PlanDefinition-IMMZD18SPneumococcal3p0b.md)
* **Actions: **: **Version: **
  * : 0.2.0
* **Actions: **: **Title: **
  * : IMMZ.D18.S.Pneumococcal.3 doses schedule
...
```json
{
  ...
  "contained" : [{
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD18SPneumococcal3p0bLogic"
      },
      {
        "url" : "name",
  ...
  "url" : "http://smart.who.int/immunizations/PlanDefinition/IMMZD18SPneumococcal3p0b",
  "version" : "0.2.0",
  "name" : "IMMZD18SPneumococcal3p0b",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZD18SPneumococcal3p0bLogic"],
  "action" : [{
