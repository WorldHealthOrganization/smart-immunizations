...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/PlanDefinition/IMMZD18SCholerarBS2to5 | *Version*:0.2.0 |
| Draft as of 2026-03-31 | *Computable Name*:IMMZD18SCholerarBS2to5 |
...
* **Actions: **: **Url: **
  * : [IMMZ.D18.S.Cholera.WC-rBS vaccine 3-dose schedule](PlanDefinition-IMMZD18SCholerarBS2to5.md)
* **Actions: **: **Version: **
  * : 0.2.0
* **Actions: **: **Title: **
  * : IMMZ.D18.S.Cholera.WC-rBS vaccine 3-dose schedule
...
```json
{
  ...
  "contained" : [{
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD18SCholerarBS2to5Logic"
      },
      {
        "url" : "name",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Cholera dose 2 Expiration"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Second cholera dose was administered"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Cholera dose 3 Expiration"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Three doses from primary series were administered. The primary series has been completed"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Cholera dose 3 Due Date"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Cholera dose 3 Create"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Cholera booster dose Expiration"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Cholera booster dose"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Cholera booster dose Due Date"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Cholera booster dose Create"
      },
      {
        "url" : "statement",
  ...
  "url" : "http://smart.who.int/immunizations/PlanDefinition/IMMZD18SCholerarBS2to5",
  "version" : "0.2.0",
  "name" : "IMMZD18SCholerarBS2to5",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZD18SCholerarBS2to5Logic"],
  "action" : [{
