...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/PlanDefinition/IMMZD2DTMeaslesDose0 | *Version*:0.2.0 |
| Draft as of 2026-03-31 | *Computable Name*:IMMZD2DTMeaslesDose0 |

 
Measles-containing vaccine dose 0 (MCV0) administration 

* **Actions: **: **Url: **
  * : [IMMZ.D2.DT.Measles.MCV dose 0](PlanDefinition-IMMZD2DTMeaslesDose0.md)
* **Actions: **: **Version: **
  * : 0.2.0
* **Actions: **: **Title: **
  * : IMMZ.D2.DT.Measles.MCV dose 0
...
```json
{
  ...
  "contained" : [{
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD2DTMeaslesDose0Logic"
      },
      {
        "url" : "name",
        "valueString" : "Client is not due for MCV0 Case 1"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "MCV0 was not administered"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Client's age is between 6 months and 9 months"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Client is not due for MCV0 Case 2"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Client is not due for MCV0 Case 3"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Client is not due for MCV0 Case 4"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Client is not due for MCV0"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Client is not due for MCV0 Guidance"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Consider MCV0. Guidance"
      },
      {
        "url" : "statement",
  ...
  "url" : "http://smart.who.int/immunizations/PlanDefinition/IMMZD2DTMeaslesDose0",
  "version" : "0.2.0",
  ...
  "description" : "Measles-containing vaccine dose 0 (MCV0) administration",
  "relatedArtifact" : [{
    "type" : "citation",
    "citation" : "WHO recommendations for routine immunization - summary tables (January 2025)"
  }],
  "library" : ["http://smart.who.int/immunizations/Library/IMMZD2DTMeaslesDose0Logic"],
  "action" : [{
    "title" : "Send Guidance for the patient regarding MCV Dose 0 series.",
    "description" : "Send Guidance for the patient regarding MCV dose 0 series.",
    "condition" : [{
      "kind" : "applicability",
      "expression" : {
