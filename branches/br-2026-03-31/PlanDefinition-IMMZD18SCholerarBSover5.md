...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/PlanDefinition/IMMZD18SCholerarBSover5 | *Version*:0.2.0 |
| Draft as of 2026-03-31 | *Computable Name*:IMMZD18SCholerarBSover5 |
...
* **Actions: **: **Url: **
  * : [IMMZ.D18.S.Cholera.WC-rBS vaccine 2-dose schedule](PlanDefinition-IMMZD18SCholerarBSover5.md)
* **Actions: **: **Version: **
  * : 0.2.0
* **Actions: **: **Title: **
  * : IMMZ.D18.S.Cholera.WC-rBS vaccine 2-dose schedule
...
```json
{
  ...
  "contained" : [{
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD18SCholerarBSover5Logic"
      },
      {
        "url" : "name",
  ...
  "url" : "http://smart.who.int/immunizations/PlanDefinition/IMMZD18SCholerarBSover5",
  "version" : "0.2.0",
  "name" : "IMMZD18SCholerarBSover5",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZD18SCholerarBSover5Logic"],
  "action" : [{
