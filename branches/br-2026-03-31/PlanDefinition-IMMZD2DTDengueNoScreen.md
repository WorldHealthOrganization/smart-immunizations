...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/PlanDefinition/IMMZD2DTDengueNoScreen | *Version*:0.2.0 |
| Draft as of 2026-03-31 | *Computable Name*:IMMZD2DTDengueNoScreen |
...
* **Actions: **: **Url: **
  * : [IMMZ.D2.DT.Dengue.3 doses without pre-vaccination screening](PlanDefinition-IMMZD2DTDengueNoScreen.md)
* **Actions: **: **Version: **
  * : 0.2.0
* **Actions: **: **Title: **
  * : IMMZ.D2.DT.Dengue.3 doses without pre-vaccination screening
...
```json
{
  ...
  "contained" : [{
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD2DTDengueNoScreenLogic"
      },
      {
        "url" : "name",
  ...
  "url" : "http://smart.who.int/immunizations/PlanDefinition/IMMZD2DTDengueNoScreen",
  "version" : "0.2.0",
  "name" : "IMMZD2DTDengueNoScreen",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZD2DTDengueNoScreenLogic"],
  "action" : [{
    "extension" : [{
    ...
    "definitionCanonical" : "http://smart.who.int/immunizations/ActivityDefinition/IMMZD2DTDengueMR",
    "dynamicValue" : [{
      "path" : "status",
      "expression" : {
