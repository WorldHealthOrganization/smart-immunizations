...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/PlanDefinition/IMMZD18SMumps2Dose | *Version*:0.2.0 |
| Draft as of 2026-03-31 | *Computable Name*:IMMZD18SMumps2Dose |

 
IMMZ.D18.S.Mumps schedule 2-dose schedule 

* **Actions: **: **Url: **
  * : [IMMZ.D18.S.Mumps schedule](PlanDefinition-IMMZD18SMumps2Dose.md)
* **Actions: **: **Version: **
  * : 0.2.0
* **Actions: **: **Title: **
  * : IMMZ.D18.S.Mumps schedule
...
```json
{
  ...
  "contained" : [{
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD18SMumps2DoseLogic"
      },
      {
        "url" : "name",
        "valueString" : "First mumps dose from the primary series was administered"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Second mumps dose from the primary series was administered. The primary series has been completed"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Mumps dose 2 Due Date"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Mumps dose 2 Overdue"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Mumps dose 2 Create"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Mumps dose 1 Due Date"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Mumps dose 1 Overdue"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Mumps dose 1 Create"
      },
      {
        "url" : "statement",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZD18SMumps2DoseLogic"],
  "action" : [{
    "title" : "Mumps dose 1",
