# IMMZ.D2.DT.Dengue.Seropos ValueSet for Decision Table - WHO Immunization Implementation Guide v0.2.0

* [**Table of Contents**](toc.md)
* [**Indices**](indices.md)
* [**Artifact Index**](artifacts.md)
* **IMMZ.D2.DT.Dengue.Seropos ValueSet for Decision Table**

## ValueSet: IMMZ.D2.DT.Dengue.Seropos ValueSet for Decision Table 

| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/ValueSet/IMMZ.D2.DT.Dengue.Seropos | *Version*:0.2.0 |
| Active as of 2026-03-31 | *Computable Name*:IMMZ_D2_DT_Dengue_3_doses_with_pre_vaccination_screening |

 
ValueSet IMMZ.D2.DT.Dengue.Seropos for IMMZ.D2.DT.Dengue.3 doses with pre-vaccination screening. Business rule: Determine if the client is due for a dengue vaccination according to the national immunization schedule Trigger: IMMZ.D2 Determine required vaccination(s) if any
...
##### IMMZ.D2.DT.Dengue.Seropos ValueSet for Decision Table Schema API

JSON Schema for IMMZ.D2.DT.Dengue.Seropos ValueSet for Decision Table ValueSet codes. Generated from FHIR expansions using IRI format.

**Version:** 1.0.0

## Endpoints

### GET /ValueSet-IMMZ.D2.DT.Dengue.Seropos.schema.json

#### JSON Schema definition for the enumeration ValueSet-IMMZ.D2.DT.Dengue.Seropos

This endpoint serves the JSON Schema definition for the enumeration ValueSet-IMMZ.D2.DT.Dengue.Seropos.

## Schema Definition

### ValueSet-IMMZ.D2.DT.Dengue.Seropos

**Description:** JSON Schema for IMMZ.D2.DT.Dengue.Seropos ValueSet for Decision Table ValueSet codes. Generated from FHIR expansions using IRI format.
...
```json
{
  ...
  "id" : "IMMZ.D2.DT.Dengue.Seropos",
  "url" : "http://smart.who.int/immunizations/ValueSet/IMMZ.D2.DT.Dengue.Seropos",
  "version" : "0.2.0",
