...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/PlanDefinition/IMMZD2DTPneumococcal2p1b | *Version*:0.2.0 |
| Draft as of 2026-03-31 | *Computable Name*:IMMZD2DTPneumococcal2p1b |

 
IMMZ.D2.DT.Pneumococcal.2 doses with booster dose 2 primary doses with a booster dose (2p+1) 

* **Actions: **: **Url: **
  * : [IMMZ.D2.DT.Pneumococcal.2 doses with booster dose](PlanDefinition-IMMZD2DTPneumococcal2p1b.md)
* **Actions: **: **Version: **
  * : 0.2.0
* **Actions: **: **Title: **
  * : IMMZ.D2.DT.Pneumococcal.2 doses with booster dose
...
```json
{
  ...
  "contained" : [{
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD2DTPneumococcal2p1bLogic"
      },
      {
        "url" : "name",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "The client's age is more than or equal to 12 months and less than 24 months"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Client is due for pneumococcal booster dose Case 3"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "The client's age is less than 12 months"
      },
      {
        "url" : "statement",
  ...
  "url" : "http://smart.who.int/immunizations/PlanDefinition/IMMZD2DTPneumococcal2p1b",
  "version" : "0.2.0",
  "name" : "IMMZD2DTPneumococcal2p1b",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZD2DTPneumococcal2p1bLogic"],
  "action" : [{
    "extension" : [{
