...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/PlanDefinition/IMMZD2DTMeningococcalPoly | *Version*:0.2.0 |
| Draft as of 2026-03-31 | *Computable Name*:IMMZD2DTMeningococcalPoly |
...
* **Actions: **: **Url: **
  * : [IMMZ.D2.DT.Meningococcal.Polysaccharide vaccines](PlanDefinition-IMMZD2DTMeningococcalPoly.md)
* **Actions: **: **Version: **
  * : 0.2.0
* **Actions: **: **Title: **
  * : IMMZ.D2.DT.Meningococcal.Polysaccharide vaccines
...
```json
{
  ...
  "contained" : [{
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD2DTMeningococcalPolyLogic"
      },
      {
        "url" : "name",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Date of Latest Meningococcal Dose"
      },
      {
        "url" : "statement",
  ...
  "url" : "http://smart.who.int/immunizations/PlanDefinition/IMMZD2DTMeningococcalPoly",
  "version" : "0.2.0",
  "name" : "IMMZD2DTMeningococcalPoly",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZD2DTMeningococcalPolyLogic"],
  "action" : [{
    "extension" : [{
    ...
    "definitionCanonical" : "http://smart.who.int/immunizations/ActivityDefinition/IMMZD2DTMeningococcalMR",
    "dynamicValue" : [{
      "path" : "status",
      "expression" : {
