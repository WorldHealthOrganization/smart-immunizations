...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/PlanDefinition/IMMZD2DTHPV2Dose | *Version*:0.2.0 |
| Draft as of 2026-03-31 | *Computable Name*:IMMZD2DTHPV2Dose |

 
IMMZ.D2.DT.HPV.2 doses 2-dose schedule 

* **Actions: **: **Url: **
  * : [IMMZ.D2.DT.HPV.2 doses](PlanDefinition-IMMZD2DTHPV2Dose.md)
* **Actions: **: **Version: **
  * : 0.2.0
* **Actions: **: **Title: **
  * : IMMZ.D2.DT.HPV.2 doses
...
```json
{
  ...
  "contained" : [{
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD2DTHPV2DoseLogic"
      },
      {
        "url" : "name",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Client's age is between 9 and 14 years"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Client's biological sex is female"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Client's age more than or equal to 15 years"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Client's biological sex is not female"
      },
      {
        "url" : "statement",
  ...
  "url" : "http://smart.who.int/immunizations/PlanDefinition/IMMZD2DTHPV2Dose",
  "version" : "0.2.0",
  "name" : "IMMZD2DTHPV2Dose",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZD2DTHPV2DoseLogic"],
  "action" : [{
    "extension" : [{
