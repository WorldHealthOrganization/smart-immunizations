...
| Draft as of 2026-03-31 | *Computable Name*:IMMZD18SRabiesPrEP |
...
```json
{
  ...
  "contained" : [{
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD18SRabiesPrEPLogic"
      },
      {
        "url" : "name",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZD18SRabiesPrEPLogic"],
  "action" : [{
    "title" : "Rabies dose 1",
