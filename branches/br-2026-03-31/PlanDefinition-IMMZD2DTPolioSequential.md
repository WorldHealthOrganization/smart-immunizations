...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/PlanDefinition/IMMZD2DTPolioSequential | *Version*:0.2.0 |
| Draft as of 2026-03-31 | *Computable Name*:IMMZD2DTPolioSequential |
...
* **Actions: **: **Url: **
  * : [IMMZ.D2.DT.Polio.Sequential IPV–bOPV](PlanDefinition-IMMZD2DTPolioSequential.md)
* **Actions: **: **Version: **
  * : 0.2.0
* **Actions: **: **Title: **
  * : IMMZ.D2.DT.Polio.Sequential IPV–bOPV
...
```json
{
  ...
  "contained" : [{
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD2DTPolioSequentialLogic"
      },
      {
        "url" : "name",
  ...
  "url" : "http://smart.who.int/immunizations/PlanDefinition/IMMZD2DTPolioSequential",
  "version" : "0.2.0",
  "name" : "IMMZD2DTPolioSequential",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZD2DTPolioSequentialLogic"],
  "action" : [{
    "extension" : [{
