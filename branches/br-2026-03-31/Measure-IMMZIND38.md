# IMMZIND38 - WHO Immunization Implementation Guide v0.2.0
...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/Measure/IMMZIND38 | *Version*:0.2.0 |
| Draft as of 2025-06-11 | *Computable Name*:IMMZIND38 |

 
IMMZ.IND.38 Drop-out rate from the 1st dose of malaria vaccines to the 3rd dose 
...
* Knowledge Artifact Metadata: Initial Population
  * ?: **ID**: IMMZ.IND.38.IP**Description**:Initial Population**Logic Definition**:[Initial Population](#immzind38logic-initial-population)
* Knowledge Artifact Metadata: Denominator
  * ?: **ID**: IMMZ.IND.38.D**Description**:Denominator**Logic Definition**:[Denominator](#immzind38logic-denominator)
* Knowledge Artifact Metadata: Numerator
  * ?: **ID**: IMMZ.IND.38.N**Description**:Numerator**Logic Definition**:[Numerator](#immzind38logic-numerator)
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.38.S1**Code**: By-Administrative Area
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.38.S2**Code**: By-Sex
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.38.S3**Code**: By-Age group
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.38.S4**Code**: By-Age group
...
* Knowledge Artifact Metadata: Dependency
  * ?: **Description**: Library Malaria**Resource**:[IMMZD2DTMalariaElements](Library-IMMZD2DTMalariaElements.md)**Canonical URL**:http://smart.who.int/immunizations/Library/IMMZD2DTMalariaElements
* Knowledge Artifact Metadata: Dependency
...
* Knowledge Artifact Metadata: Dependency
  * ?: **Description**: Value set Malaria vaccines**Resource**:[IMMZ.Z.DE27 ValueSet for Malaria vaccines](ValueSet-IMMZ.Z.DE27.md)**Canonical URL**:http://smart.who.int/immunizations/ValueSet/IMMZ.Z.DE27
...
* Knowledge Artifact Metadata: Data Requirement
  * ?: **Type**: Immunization**Profile(s)**:[Immunization](http://hl7.org/fhir/R4/immunization.html)**Must Support Elements**: status, isSubpotent, vaccineCode, protocolApplied**Code Filter(s)**:**Path**: status**Code**: **Path**: vaccineCode**ValueSet**:[IMMZ.Z.DE27 ValueSet for Malaria vaccines](ValueSet-IMMZ.Z.DE27.md)
* Knowledge Artifact Metadata: Data Requirement
...
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**IMMZD2DTMalariaElements
* Knowledge Artifact Metadata: ````/* @internal: Malaria containing Doses Administered to Patient */ define "Malaria Doses Administered to Patient": Elements."Doses Administered to Patient" I where I.vaccineCode in Concepts."Malaria vaccines"````
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**IMMZD2DTMalariaElements
* Knowledge Artifact Metadata: ````/* @internal: Malaria containing Doses Administered to Patient that are in the Primary series */ define "Malaria Primary Series Doses Administered to Patient": "Malaria Doses Administered to Patient".seriesPrimary()````
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**IMMZIND38Logic
* Knowledge Artifact Metadata: ````/* @denominator: Number of clients in the target population who received dose 1 of malaria vaccine during the reporting period @pseudocode: COUNT clients with an immunization event WHERE "Vaccine type" = "Malaria vaccines" for the 1st dose in the primary series AND "Date and time of vaccination" is during the reporting period @note: Updated to match the definition to only include those who are due for the 3rd dose. If client ever received a 2nd dose the due date is 4 weeks after that. If client has only received the 1st dose, the due date is 8 weeks after that. Only include in the denominator those who are due during the measurement period.*/ define "Denominator": if exists (Malaria."Malaria Primary Series Doses Administered to Patient".getDose('2')) then exists( (Malaria."Malaria Primary Series Doses Administered to Patient".getDose('2')) I where (start of I.occurrence.toInterval() + 4 weeks) during "Measurement Period" ) else exists( (Malaria."Malaria Primary Series Doses Administered to Patient".getDose('1')) I where (start of I.occurrence.toInterval() + 8 weeks) during "Measurement Period" )````
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**IMMZIND38Logic
* Knowledge Artifact Metadata: ````/* @numerator: Number of clients who received a 1st dose of malaria vaccine during the reporting period who should have received (via scheduling logic) the 3rd dose of malaria vaccine during the reporting period but did not receive it @pseudocode: (COUNT of clients with an immunization event WHERE "Vaccine type" = "Malaria vaccines" for the 1st dose in the primary series AND "Date and time of vaccination" is during the reporting period) - (COUNT of clients with an immunization event WHERE "Vaccine type" = "Malaria vaccines" for the 3rd dose in the primary series AND "Date and time of vaccination" is during the reporting period) @note: Only include those from the denominator that did not receive a 3rd dose during the measurement period. Those where the 3rd dose due date is during the period but have not received the 3rd dose. */ define "Numerator": "Denominator" and not exists( (Malaria."Malaria Primary Series Doses Administered to Patient".getDose('3')) I where I.occurrence.toInterval() starts during "Measurement Period" )````
* Knowledge Artifact Metadata:  Logic Definition
...
```json
{
  ...
  "contained" : [{
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD2DTMalariaElements"
      },
      {
        "url" : "name",
  ...
  "url" : "http://smart.who.int/immunizations/Measure/IMMZIND38",
  "version" : "0.2.0",
  "name" : "IMMZIND38",
  "title" : "IMMZIND38",
  "status" : "draft",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZIND38Logic"],
  "scoring" : {
    "coding" : [{
