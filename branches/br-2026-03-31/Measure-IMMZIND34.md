# IMMZIND34 - WHO Immunization Implementation Guide v0.2.0
...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/Measure/IMMZIND34 | *Version*:0.2.0 |
| Draft as of 2025-06-11 | *Computable Name*:IMMZIND34 |

 
IMMZ.IND.34 Immunization coverage for malaria vaccines, 4th dose 
...
* Knowledge Artifact Metadata: Initial Population
  * ?: **ID**: IMMZ.IND.34.IP**Description**:Initial Population**Logic Definition**:[Initial Population](#immzind34logic-initial-population)
* Knowledge Artifact Metadata: Denominator
  * ?: **ID**: IMMZ.IND.34.D**Description**:Denominator**Logic Definition**:[Denominator](#immzind34logic-denominator)
* Knowledge Artifact Metadata: Numerator
  * ?: **ID**: IMMZ.IND.34.N**Description**:Numerator**Logic Definition**:[Numerator](#immzind34logic-numerator)
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.34.S1**Code**: By-Administrative Area
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.34.S2**Code**: By-Sex
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.34.S3**Code**: By-Age group
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.34.S4**Code**: By-Age group
...
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**IMMZIND34Logic
* Knowledge Artifact Metadata: ````/* @numerator: Number of malaria vaccine doses (4th dose) administered through routine services during the reporting period @pseudocode: COUNT of immunization events WHERE "Vaccine type" = "Malaria vaccines" for the 4th dose in the primary series AND "Date and time of vaccination" is during the reporting period */ define "Numerator": exists( (Malaria."Malaria Primary Series Doses Administered to Patient".getDose('4')) I where I.occurrence.toInterval() starts during "Measurement Period" )````
* Knowledge Artifact Metadata:  Logic Definition
...
```json
{
  ...
  "contained" : [{
    ...
    },
    {
      ...
      {
        "url" : "statement",
        "valueString" : "/*\n@numerator: Number of malaria vaccine doses (4th dose) administered through routine services during the reporting period\n@pseudocode: COUNT of immunization events WHERE \"Vaccine type\" = \"Malaria vaccines\" for the 4th dose in the primary series AND \"Date and time of vaccination\" is during the reporting period\n*/\ndefine \"Numerator\":\n  exists( (Malaria.\"Malaria Primary Series Doses Administered to Patient\".getDose('4')) I\n    where I.occurrence.toInterval() starts during \"Measurement Period\" )"
      },
      {
        "url" : "displaySequence",
        "valueInteger" : 3
  ...
  "url" : "http://smart.who.int/immunizations/Measure/IMMZIND34",
  "version" : "0.2.0",
  "name" : "IMMZIND34",
  "title" : "IMMZIND34",
  "status" : "draft",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZIND34Logic"],
  "scoring" : {
    "coding" : [{
