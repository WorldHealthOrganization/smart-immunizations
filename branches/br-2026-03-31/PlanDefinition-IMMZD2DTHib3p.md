...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/PlanDefinition/IMMZD2DTHib3p | *Version*:0.2.0 |
| Draft as of 2026-03-31 | *Computable Name*:IMMZD2DTHib3p |

 
IMMZ.D2.DT.Hib.3 doses 3 primary doses without a booster dose (3p) 

* **Actions: **: **Url: **
  * : [IMMZ.D2.DT.Hib.3 doses](PlanDefinition-IMMZD2DTHib3p.md)
* **Actions: **: **Version: **
  * : 0.2.0
* **Actions: **: **Title: **
  * : IMMZ.D2.DT.Hib.3 doses
...
```json
{
  ...
  "contained" : [{
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD2DTHib3pLogic"
      },
      {
        "url" : "name",
  ...
  "url" : "http://smart.who.int/immunizations/PlanDefinition/IMMZD2DTHib3p",
  "version" : "0.2.0",
  "name" : "IMMZD2DTHib3p",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZD2DTHib3pLogic"],
  "action" : [{
    "extension" : [{
