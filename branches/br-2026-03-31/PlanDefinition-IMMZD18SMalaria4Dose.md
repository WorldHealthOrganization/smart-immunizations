...
| Draft as of 2026-03-31 | *Computable Name*:IMMZD18SMalaria4Dose |
...
```json
{
  ...
  "contained" : [{
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD18SMalaria4DoseLogic"
      },
      {
        "url" : "name",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZD18SMalaria4DoseLogic"],
  "action" : [{
