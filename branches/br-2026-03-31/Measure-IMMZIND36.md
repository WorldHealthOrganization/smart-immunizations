# IMMZIND36 - WHO Immunization Implementation Guide v0.2.0
...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/Measure/IMMZIND36 | *Version*:0.2.0 |
| Draft as of 2025-06-11 | *Computable Name*:IMMZIND36 |

 
IMMZ.IND.36 Drop-out rate of BCG to measles and rubella-containing vaccine 1st dose 
...
* Knowledge Artifact Metadata: Initial Population
  * ?: **ID**: IMMZ.IND.36.IP**Description**:Initial Population**Logic Definition**:[Initial Population](#immzind36logic-initial-population)
* Knowledge Artifact Metadata: Denominator
  * ?: **ID**: IMMZ.IND.36.D**Description**:Denominator**Logic Definition**:[Denominator](#immzind36logic-denominator)
* Knowledge Artifact Metadata: Numerator
  * ?: **ID**: IMMZ.IND.36.N**Description**:Numerator**Logic Definition**:[Numerator](#immzind36logic-numerator)
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.36.S1**Code**: By-Administrative Area
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.36.S2**Code**: By-Sex
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.36.S3**Code**: By-Age group
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.36.S4**Code**: By-Age group
...
* Knowledge Artifact Metadata: Dependency
  * ?: **Description**: Library BCG**Resource**:[IMMZD2DTBCGElements](Library-IMMZD2DTBCGElements.md)**Canonical URL**:http://smart.who.int/immunizations/Library/IMMZD2DTBCGElements
* Knowledge Artifact Metadata: Dependency
...
* Knowledge Artifact Metadata: Dependency
  * ?: **Description**: Value set BCG vaccines**Resource**:[IMMZ.Z.DE1 ValueSet for BCG vaccines](ValueSet-IMMZ.Z.DE1.md)**Canonical URL**:http://smart.who.int/immunizations/ValueSet/IMMZ.Z.DE1
* Knowledge Artifact Metadata: Dependency
  * ?: **Description**: Value set Measles and rubella-containing vaccines**Resource**:[IMMZ.Z.DE32 ValueSet for Measles and rubella-containing vaccines](ValueSet-IMMZ.Z.DE32.md)**Canonical URL**:http://smart.who.int/immunizations/ValueSet/IMMZ.Z.DE32
...
* Knowledge Artifact Metadata: Data Requirement
  * ?: **Type**: Immunization**Profile(s)**:[Immunization](http://hl7.org/fhir/R4/immunization.html)**Must Support Elements**: status, isSubpotent, vaccineCode, protocolApplied**Code Filter(s)**:**Path**: status**Code**: **Path**: vaccineCode**ValueSet**:[IMMZ.Z.DE1 ValueSet for BCG vaccines](ValueSet-IMMZ.Z.DE1.md)
* Knowledge Artifact Metadata: Data Requirement
  * ?: **Type**: Immunization**Profile(s)**:[Immunization](http://hl7.org/fhir/R4/immunization.html)**Must Support Elements**: status, isSubpotent, vaccineCode, protocolApplied, occurrence**Code Filter(s)**:**Path**: status**Code**: **Path**: vaccineCode**ValueSet**:[IMMZ.Z.DE32 ValueSet for Measles and rubella-containing vaccines](ValueSet-IMMZ.Z.DE32.md)
* Knowledge Artifact Metadata: Data Requirement
...
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**IMMZD2DTBCGElements
* Knowledge Artifact Metadata: ````/* @internal: BCG containing Doses Administered to Patient */ define "BCG Doses Administered to Patient": Elements."Doses Administered to Patient" I where I.vaccineCode in Concepts."BCG vaccines"````
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**IMMZIND36Logic
* Knowledge Artifact Metadata: ````/* @denominator: Number of clients in the target population who received BCG vaccine during the reporting period @pseudocode: COUNT clients with an immunization event WHERE "Vaccine type" = "BCG vaccines" AND "Date and time of vaccination" is during the reporting period @note: Only including those who are eligible for first dose of Measles/rubella at 9 months and who have received the BCG dose. This is for high incidence of Measles/rubella. For low incidence this should be 12 months. */ define "Denominator": exists( BCG."BCG Doses Administered to Patient" I ) and Patient.birthDate + 9 months during "Measurement Period"````
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**IMMZIndicatorElements
* Knowledge Artifact Metadata: ````define "Measles and Rubella Doses Administered to Patient": Elements."Doses Administered to Patient" I where I.vaccineCode in Concepts."Measles and rubella-containing vaccines"````
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**IMMZIndicatorElements
* Knowledge Artifact Metadata: ````define "Measles and Rubella Doses Administered to Patient During Measurement Period": "Measles and Rubella Doses Administered to Patient" I where I.occurrence.toInterval() starts during "Measurement Period"````
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**IMMZIND36Logic
* Knowledge Artifact Metadata: ````/* @numerator: Number of clients who received BCG vaccine during the reporting period who should have received 1st dose of measles and rubella-containing vaccine during the reporting period but did not receive it @pseudocode: (COUNT of clients with an immunization event WHERE "Vaccine type"" = "BCG vaccines" AND "Date and time of vaccination" is during the reporting period) - (COUNT of clients with an immunization event WHERE "Vaccine type" = "Measles and rubella-containing vaccines" for the 1st dose in the primary series AND "Date and time of vaccination" is during the reporting period) @note: Only include those from the denominator that did not receive a measles/rubella 1st dose during the measurement period. Those where the 1st dose due date is during the period but have not received the 1st dose. */ define "Numerator": "Denominator" and not exists( Elements."Measles and Rubella Doses Administered to Patient During Measurement Period".getDose('1') )````
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**IMMZIndicatorElements
...
```json
{
  ...
  "contained" : [{
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Measles and Rubella Doses Administered to Patient"
      },
      {
        "url" : "statement",
        "valueString" : "define \"Measles and Rubella Doses Administered to Patient\":\n  Elements.\"Doses Administered to Patient\" I \n    where I.vaccineCode in Concepts.\"Measles and rubella-containing vaccines\""
      },
      {
        "url" : "displaySequence",
        "valueInteger" : 3
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Measles and Rubella Doses Administered to Patient During Measurement Period"
      },
      {
        "url" : "statement",
        "valueString" : "define \"Measles and Rubella Doses Administered to Patient During Measurement Period\":\n  \"Measles and Rubella Doses Administered to Patient\" I\n    where I.occurrence.toInterval() starts during \"Measurement Period\""
      },
      {
        "url" : "displaySequence",
        "valueInteger" : 4
    ...
    },
    {
      "type" : "Immunization",
      "profile" : ["http://hl7.org/fhir/StructureDefinition/Immunization"],
      "mustSupport" : ["status", "isSubpotent", "vaccineCode", "protocolApplied"],
      "codeFilter" : [{
        "path" : "status",
        "code" : [{
          "code" : "completed"
  ...
  "url" : "http://smart.who.int/immunizations/Measure/IMMZIND36",
  "version" : "0.2.0",
  "name" : "IMMZIND36",
  "title" : "IMMZIND36",
  "status" : "draft",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZIND36Logic"],
  "scoring" : {
    "coding" : [{
