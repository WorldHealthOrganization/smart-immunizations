...
| Draft as of 2026-03-31 | *Computable Name*:IMMZD5DTSeasonalinfluenzaCI |
...
```json
{
  ...
  "contained" : [{
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD5DTSeasonalinfluenzaCILogic"
      },
      {
        "url" : "name",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZD5DTSeasonalinfluenzaCILogic"],
  "action" : [{
