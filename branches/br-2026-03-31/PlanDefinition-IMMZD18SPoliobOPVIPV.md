...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/PlanDefinition/IMMZD18SPoliobOPVIPV | *Version*:0.2.0 |
| Draft as of 2026-03-31 | *Computable Name*:IMMZD18SPoliobOPVIPV |

 
IMMZ.D18.S.Polio.bOPV plus IPV schedule Bivalent oral polio vaccine (bOPV) plus inactivated polio vaccine (IPV) schedule 

* **Actions: **: **Url: **
  * : [IMMZ.D18.S.Polio.bOPV plus IPV schedule](PlanDefinition-IMMZD18SPoliobOPVIPV.md)
* **Actions: **: **Version: **
  * : 0.2.0
* **Actions: **: **Title: **
  * : IMMZ.D18.S.Polio.bOPV plus IPV schedule
...
```json
{
  ...
  "contained" : [{
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD18SPoliobOPVIPVLogic"
      },
      {
        "url" : "name",
        "valueString" : "First bOPV dose from the primary series was administered"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Second bOPV dose from the primary series was administered"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Third bOPV dose from the primary series was administered. The primary series has been completed"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "bOPV dose 3 Due Date"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "bOPV dose 3 Create"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "bOPV dose 1 Due Date"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "bOPV dose 1 Create"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "bOPV dose 2 Due Date"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "bOPV dose 2 Create"
      },
      {
        "url" : "statement",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZD18SPoliobOPVIPVLogic"],
  "action" : [{
    "title" : "bOPV dose 1",
