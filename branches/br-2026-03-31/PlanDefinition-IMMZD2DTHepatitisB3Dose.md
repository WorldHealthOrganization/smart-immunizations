...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/PlanDefinition/IMMZD2DTHepatitisB3Dose | *Version*:0.2.0 |
| Draft as of 2026-03-31 | *Computable Name*:IMMZD2DTHepatitisB3Dose |

 
IMMZ.D2.DT.Hepatitis B.3 doses 3-dose schedule (birth dose + 2 primary series doses), on-time start 

* **Actions: **: **Url: **
  * : [IMMZ.D2.DT.Hepatitis B.3 doses](PlanDefinition-IMMZD2DTHepatitisB3Dose.md)
* **Actions: **: **Version: **
  * : 0.2.0
* **Actions: **: **Title: **
  * : IMMZ.D2.DT.Hepatitis B.3 doses
...
```json
{
  ...
  "contained" : [{
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD2DTHepatitisB3DoseLogic"
      },
      {
        "url" : "name",
  ...
  "url" : "http://smart.who.int/immunizations/PlanDefinition/IMMZD2DTHepatitisB3Dose",
  "version" : "0.2.0",
  "name" : "IMMZD2DTHepatitisB3Dose",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZD2DTHepatitisB3DoseLogic"],
  "action" : [{
    "extension" : [{
