...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/PlanDefinition/IMMZD2DTHPVAlt | *Version*:0.2.0 |
| Draft as of 2026-03-31 | *Computable Name*:IMMZD2DTHPVAlt |

 
IMMZ.D2.DT.HPV.Single dose Alternative single-dose schedule 

* **Actions: **: **Url: **
  * : [IMMZ.D2.DT.HPV.Single dose](PlanDefinition-IMMZD2DTHPVAlt.md)
* **Actions: **: **Version: **
  * : 0.2.0
* **Actions: **: **Title: **
  * : IMMZ.D2.DT.HPV.Single dose
...
```json
{
  ...
  "contained" : [{
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD2DTHPVAltLogic"
      },
      {
        "url" : "name",
  ...
  "url" : "http://smart.who.int/immunizations/PlanDefinition/IMMZD2DTHPVAlt",
  "version" : "0.2.0",
  "name" : "IMMZD2DTHPVAlt",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZD2DTHPVAltLogic"],
  "action" : [{
    "extension" : [{
    ...
    "definitionCanonical" : "http://smart.who.int/immunizations/ActivityDefinition/IMMZD2DTHPVMR",
    "dynamicValue" : [{
      "path" : "status",
      "expression" : {
