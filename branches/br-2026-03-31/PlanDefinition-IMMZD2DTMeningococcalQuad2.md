...
| Draft as of 2026-03-31 | *Computable Name*:IMMZD2DTMeningococcalQuad2 |
...
```json
{
  ...
  "contained" : [{
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD2DTMeningococcalQuad2Logic"
      },
      {
        "url" : "name",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZD2DTMeningococcalQuad2Logic"],
  "action" : [{
    "extension" : [{
