...
| Draft as of 2026-03-31 | *Computable Name*:IMMZD5DTMeningococcalCI |
...
```json
{
  ...
  "contained" : [{
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD5DTMeningococcalCILogic"
      },
      {
        "url" : "name",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZD5DTMeningococcalCILogic"],
  "action" : [{
