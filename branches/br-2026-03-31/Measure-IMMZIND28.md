# IMMZIND28 - WHO Immunization Implementation Guide v0.2.0
...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/Measure/IMMZIND28 | *Version*:0.2.0 |
| Draft as of 2025-06-11 | *Computable Name*:IMMZIND28 |

 
IMMZ.IND.28 Immunization coverage for typhoid vaccines 
...
* Knowledge Artifact Metadata: Initial Population
  * ?: **ID**: IMMZ.IND.28.IP**Description**:Initial Population**Logic Definition**:[Initial Population](#immzind28logic-initial-population)
* Knowledge Artifact Metadata: Denominator
  * ?: **ID**: IMMZ.IND.28.D**Description**:Denominator**Logic Definition**:[Denominator](#immzind28logic-denominator)
* Knowledge Artifact Metadata: Numerator
  * ?: **ID**: IMMZ.IND.28.N**Description**:Numerator**Logic Definition**:[Numerator](#immzind28logic-numerator)
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.28.S1**Code**: By-Administrative Area
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.28.S2**Code**: By-Sex
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.28.S3**Code**: By-Age group
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.28.S4**Code**: By-Age group
...
* Knowledge Artifact Metadata: Dependency
  * ?: **Description**: Library Typhoid**Resource**:[IMMZD2DTTyphoidElements](Library-IMMZD2DTTyphoidElements.md)**Canonical URL**:http://smart.who.int/immunizations/Library/IMMZD2DTTyphoidElements
* Knowledge Artifact Metadata: Dependency
...
* Knowledge Artifact Metadata: Dependency
  * ?: **Description**: Value set Typhoid vaccines**Resource**:[IMMZ.Z.DE21 ValueSet for Typhoid vaccines](ValueSet-IMMZ.Z.DE21.md)**Canonical URL**:http://smart.who.int/immunizations/ValueSet/IMMZ.Z.DE21
...
* Knowledge Artifact Metadata: Data Requirement
  * ?: **Type**: Immunization**Profile(s)**:[Immunization](http://hl7.org/fhir/R4/immunization.html)**Must Support Elements**: status, isSubpotent, vaccineCode, occurrence**Code Filter(s)**:**Path**: status**Code**: **Path**: vaccineCode**ValueSet**:[IMMZ.Z.DE21 ValueSet for Typhoid vaccines](ValueSet-IMMZ.Z.DE21.md)
* Knowledge Artifact Metadata: Data Requirement
...
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**IMMZD2DTTyphoidElements
* Knowledge Artifact Metadata: ````/* @internal: Typhoid containing Doses Administered to Patient */ define "Typhoid Doses Administered to Patient": Elements."Doses Administered to Patient" I where I.vaccineCode in Concepts."Typhoid vaccines"````
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**IMMZIND28Logic
* Knowledge Artifact Metadata: ````/* @numerator: Number of typhoid vaccine doses administered through routine services during the reporting period @pseudocode: COUNT of immunization events WHERE "Vaccine type" = "Typhoid vaccines" AND "Date and time of vaccination" is during the reporting period */ define "Numerator": exists( Typhoid."Typhoid Doses Administered to Patient" I where I.occurrence.toInterval() starts during "Measurement Period" )````
* Knowledge Artifact Metadata:  Logic Definition
...
```json
{
  ...
  "contained" : [{
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD2DTTyphoidElements"
      },
      {
        "url" : "name",
  ...
  "url" : "http://smart.who.int/immunizations/Measure/IMMZIND28",
  "version" : "0.2.0",
  "name" : "IMMZIND28",
  "title" : "IMMZIND28",
  "status" : "draft",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZIND28Logic"],
  "scoring" : {
    "coding" : [{
