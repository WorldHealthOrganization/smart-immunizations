# IMMZIND06 - WHO Immunization Implementation Guide v0.2.0
...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/Measure/IMMZIND06 | *Version*:0.2.0 |
| Draft as of 2025-06-11 | *Computable Name*:IMMZIND06 |

 
IMMZ.IND.06 Immunization coverage for oral polio vaccine (OPV), 1st dose 
...
* Knowledge Artifact Metadata: Initial Population
  * ?: **ID**: IMMZ.IND.06.IP**Description**:Initial Population**Logic Definition**:[Initial Population](#immzind06logic-initial-population)
* Knowledge Artifact Metadata: Denominator
  * ?: **ID**: IMMZ.IND.06.D**Description**:Denominator**Logic Definition**:[Denominator](#immzind06logic-denominator)
* Knowledge Artifact Metadata: Numerator
  * ?: **ID**: IMMZ.IND.06.N**Description**:Numerator**Logic Definition**:[Numerator](#immzind06logic-numerator)
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.06.S1**Code**: By-Administrative Area
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.06.S2**Code**: By-Sex
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.06.S3**Code**: By-Age group
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.06.S4**Code**: By-Age group
...
* Knowledge Artifact Metadata: Direct Reference Code
  * ?: **Display**: bOPV**Code**: DE214**System**:http://smart.who.int/immunizations/CodeSystem/IMMZ.D
* Knowledge Artifact Metadata: Direct Reference Code
...
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**IMMZD2DTPolioElements
* Knowledge Artifact Metadata: ````/* @internal: Polio bOPV Primary Series Doses Administered to Patient */ define "Polio bOPV Primary Series Doses Administered to Patient": "Polio Primary Series Doses Administered to Patient" I where I.typeOfDose() ~ Concepts."bOPV"````
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**IMMZIND06Logic
* Knowledge Artifact Metadata: ````/* @numerator: Number of OPV doses (1st dose) administered through routine services during the reporting period @pseudocode: COUNT of immunization events WHERE "Vaccine type" = "Oral polio vaccines" for the 1st dose in the primary series AND "Date and time of vaccination" is during the reporting period */ define "Numerator": Coalesce( Polio."Polio bOPV Primary Series Doses Administered to Patient".sortedIndex(0).occurrence.toInterval() starts during "Measurement Period", false )````
* Knowledge Artifact Metadata:  Logic Definition
...
```json
{
  ...
  "contained" : [{
    ...
    },
    {
      ...
      {
        "url" : "statement",
        "valueString" : "/*\n@numerator: Number of OPV doses (1st dose) administered through routine services during the reporting period\n@pseudocode: COUNT of immunization events WHERE \"Vaccine type\" = \"Oral polio vaccines\" for the 1st dose in the primary series AND \"Date and time of vaccination\" is during the reporting period\n*/\ndefine \"Numerator\":\n  Coalesce( Polio.\"Polio bOPV Primary Series Doses Administered to Patient\".sortedIndex(0).occurrence.toInterval() starts during \"Measurement Period\",\n    false )"
      },
      {
        "url" : "displaySequence",
        "valueInteger" : 4
  ...
  "url" : "http://smart.who.int/immunizations/Measure/IMMZIND06",
  "version" : "0.2.0",
  "name" : "IMMZIND06",
  "title" : "IMMZIND06",
  "status" : "draft",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZIND06Logic"],
  "scoring" : {
    "coding" : [{
