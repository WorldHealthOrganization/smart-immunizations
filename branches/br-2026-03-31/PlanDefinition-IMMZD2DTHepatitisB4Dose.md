...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/PlanDefinition/IMMZD2DTHepatitisB4Dose | *Version*:0.2.0 |
| Draft as of 2026-03-31 | *Computable Name*:IMMZD2DTHepatitisB4Dose |

 
IMMZ.D2.DT.Hepatitis B.4 doses 4-dose schedule (birth dose + 3 primary series doses), on-time start 

* **Actions: **: **Url: **
  * : [IMMZ.D2.DT.Hepatitis B.4 doses](PlanDefinition-IMMZD2DTHepatitisB4Dose.md)
* **Actions: **: **Version: **
  * : 0.2.0
* **Actions: **: **Title: **
  * : IMMZ.D2.DT.Hepatitis B.4 doses
...
```json
{
  ...
  "contained" : [{
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD2DTHepatitisB4DoseLogic"
      },
      {
        "url" : "name",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "One hepatitis B primary series doses were administered"
      },
      {
        "url" : "statement",
  ...
  "url" : "http://smart.who.int/immunizations/PlanDefinition/IMMZD2DTHepatitisB4Dose",
  "version" : "0.2.0",
  "name" : "IMMZD2DTHepatitisB4Dose",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZD2DTHepatitisB4DoseLogic"],
  "action" : [{
    "extension" : [{
