# IMMZ.D2.DT.DTP.Pregnancy - WHO Immunization Implementation Guide v0.2.0
...
## PlanDefinition: IMMZ.D2.DT.DTP.Pregnancy 

| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/PlanDefinition/IMMZD2DTDTPPregnant | *Version*:0.2.0 |
| Draft as of 2026-03-31 | *Computable Name*:IMMZD2DTDTPPregnant |

 
IMMZ.D2.DT.DTP.Pregnancy Determine whether DTP-containing vaccines are needed for pregnant women 

* **Actions: **: **Url: **
  * : [IMMZ.D2.DT.DTP.Pregnancy](PlanDefinition-IMMZD2DTDTPPregnant.md)
* **Actions: **: **Version: **
  * : 0.2.0
* **Actions: **: **Title: **
  * : IMMZ.D2.DT.DTP.Pregnancy
...
```json
{
  ...
  "contained" : [{
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD2DTDTPPregnantLogic"
      },
      {
        "url" : "name",
        "valueString" : "Client should follow 'delayed or interrupted series' decision logic"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Client should follow 'delayed or interrupted series' decision logic Guidance"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "No tetanus and diphtheria booster dose was administered"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Client should follow 'pregnancy starting with 3 doses' decision logic"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Client should follow 'pregnancy starting with 3 doses' decision logic Guidance"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Client should follow 'pregnancy starting with 4 doses' decision logic"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Client should follow 'pregnancy starting with 4 doses' decision logic Guidance"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Tetanus and diphtheria immunization schedule is complete Case 1"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Tetanus and diphtheria immunization schedule is complete Case 2"
      },
      {
        "url" : "statement",
  ...
  "url" : "http://smart.who.int/immunizations/PlanDefinition/IMMZD2DTDTPPregnant",
  "version" : "0.2.0",
  "name" : "IMMZD2DTDTPPregnant",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZD2DTDTPPregnantLogic"],
  "action" : [{
    "title" : "Check for Guidance for the patient regarding IMMZ.D2.DT.DTP.Pregnancy.",
    "description" : "Show Guidance for the patient regarding IMMZ.D2.DT.DTP.Pregnancy.\nDetermine whether DTP-containing vaccines are needed for pregnant women",
    "condition" : [{
      "kind" : "applicability",
      "expression" : {
