...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/PlanDefinition/IMMZD18SHPVAlt | *Version*:0.2.0 |
| Draft as of 2026-03-31 | *Computable Name*:IMMZD18SHPVAlt |

 
IMMZ.D18.S.Single-dose schedule Alternative single-dose schedule 

* **Actions: **: **Url: **
  * : [IMMZ.D18.S.Single-dose schedule](PlanDefinition-IMMZD18SHPVAlt.md)
* **Actions: **: **Version: **
  * : 0.2.0
* **Actions: **: **Title: **
  * : IMMZ.D18.S.Single-dose schedule
...
```json
{
  ...
  "contained" : [{
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD18SHPVAltLogic"
      },
      {
        "url" : "name",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Human papillomavirus (HPV) dose 1"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Human papillomavirus (HPV) dose 1 Due Date"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Human papillomavirus (HPV) dose 1 Overdue"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Human papillomavirus (HPV) dose 1 Create"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "HPV dose 2 (Immunocompromised or HIV-positive)"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "HPV dose 2 (Immunocompromised or HIV-positive) Due Date"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "HPV dose 2 (Immunocompromised or HIV-positive) Create"
      },
      {
        "url" : "statement",
  ...
  "url" : "http://smart.who.int/immunizations/PlanDefinition/IMMZD18SHPVAlt",
  "version" : "0.2.0",
  "name" : "IMMZD18SHPVAlt",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZD18SHPVAltLogic"],
  "action" : [{
