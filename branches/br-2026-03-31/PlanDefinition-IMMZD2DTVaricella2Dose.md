...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/PlanDefinition/IMMZD2DTVaricella2Dose | *Version*:0.2.0 |
| Draft as of 2026-03-31 | *Computable Name*:IMMZD2DTVaricella2Dose |

 
IMMZ.D2.DT.Varicella.2 doses 2-dose schedule 

* **Actions: **: **Url: **
  * : [IMMZ.D2.DT.Varicella.2 doses](PlanDefinition-IMMZD2DTVaricella2Dose.md)
* **Actions: **: **Version: **
  * : 0.2.0
* **Actions: **: **Title: **
  * : IMMZ.D2.DT.Varicella.2 doses
...
```json
{
  ...
  "contained" : [{
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD2DTVaricella2DoseLogic"
      },
      {
        "url" : "name",
  ...
  "url" : "http://smart.who.int/immunizations/PlanDefinition/IMMZD2DTVaricella2Dose",
  "version" : "0.2.0",
  "name" : "IMMZD2DTVaricella2Dose",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZD2DTVaricella2DoseLogic"],
  "action" : [{
    "extension" : [{
    ...
    "definitionCanonical" : "http://smart.who.int/immunizations/ActivityDefinition/IMMZD2DTVaricellaMR",
    "dynamicValue" : [{
      "path" : "status",
      "expression" : {
