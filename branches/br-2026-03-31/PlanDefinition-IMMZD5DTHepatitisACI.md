...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/PlanDefinition/IMMZD5DTHepatitisACI | *Version*:0.2.0 |
| Draft as of 2026-03-31 | *Computable Name*:IMMZD5DTHepatitisACI |

 
IMMZ.D5.DT.Hepatitis A contraindications Potential contraindications 

* **Actions: **: **Url: **
  * : [IMMZ.D5.DT.Hepatitis A contraindications](PlanDefinition-IMMZD5DTHepatitisACI.md)
* **Actions: **: **Version: **
  * : 0.2.0
* **Actions: **: **Title: **
  * : IMMZ.D5.DT.Hepatitis A contraindications
...
| |
| :--- |
| [IMMZD5DTHepatitisACILogic](Library-IMMZD5DTHepatitisACILogic.md) |
...
```json
{
  ...
  "contained" : [{
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD5DTHepatitisACILogic"
      },
      {
        "url" : "name",
  ...
  "url" : "http://smart.who.int/immunizations/PlanDefinition/IMMZD5DTHepatitisACI",
  "version" : "0.2.0",
  "name" : "IMMZD5DTHepatitisACI",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZD5DTHepatitisACILogic"],
  "action" : [{
    ...
    "definitionCanonical" : "http://smart.who.int/immunizations/ActivityDefinition/IMMZD5DTHepatitisAMR",
    "dynamicValue" : [{
      "path" : "id",
      "expression" : {
        "description" : "Draft Medication Request ID for HepatitisA dose",
        "language" : "text/cql-identifier",
        "expression" : "Draft Medication Request ID for HepatitisA dose"
      }
    }]
  },
  {
