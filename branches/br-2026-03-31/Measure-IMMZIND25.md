# IMMZIND25 - WHO Immunization Implementation Guide v0.2.0
...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/Measure/IMMZIND25 | *Version*:0.2.0 |
| Draft as of 2025-06-11 | *Computable Name*:IMMZIND25 |

 
IMMZ.IND.25 Immunization coverage for tetanus and diphtheria-containing vaccines (Td), 6th dose 
...
* Knowledge Artifact Metadata: Initial Population
  * ?: **ID**: IMMZ.IND.25.IP**Description**:Initial Population**Logic Definition**:[Initial Population](#immzind25logic-initial-population)
* Knowledge Artifact Metadata: Denominator
  * ?: **ID**: IMMZ.IND.25.D**Description**:Denominator**Logic Definition**:[Denominator](#immzind25logic-denominator)
* Knowledge Artifact Metadata: Numerator
  * ?: **ID**: IMMZ.IND.25.N**Description**:Numerator**Logic Definition**:[Numerator](#immzind25logic-numerator)
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.25.S1**Code**: By-Administrative Area
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.25.S2**Code**: By-Sex
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.25.S3**Code**: By-Age group
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.25.S4**Code**: By-Age group
...
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**IMMZIND25Logic
* Knowledge Artifact Metadata: ````/* @numerator: Number of tetanus and diphtheria-containing vaccine doses (6th dose) administered through routine services during the reporting period @pseudocode: COUNT of immunization events WHERE "Vaccine type" = "Tetanus and diphtheria-containing vaccines (Td)" for the sixth dose in the primary series AND "Date and time of vaccination" is during the reporting period */ define "Numerator": Coalesce( DTP."Td Doses Administered to Patient".sortedIndex(5).occurrence.toInterval() starts during "Measurement Period", false )````
* Knowledge Artifact Metadata:  Logic Definition
...
```json
{
  ...
  "url" : "http://smart.who.int/immunizations/Measure/IMMZIND25",
  "version" : "0.2.0",
  "name" : "IMMZIND25",
  "title" : "IMMZIND25",
  "status" : "draft",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZIND25Logic"],
  "scoring" : {
    "coding" : [{
