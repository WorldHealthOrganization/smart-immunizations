...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/PlanDefinition/IMMZD2DTRabiesPrEP | *Version*:0.2.0 |
| Draft as of 2026-03-31 | *Computable Name*:IMMZD2DTRabiesPrEP |

 
IMMZ.D2.DT.Rabies Pre-exposure prophylaxis (PrEP), 2-dose scheme; high risk of rabies virus exposure 

* **Actions: **: **Url: **
  * : [IMMZ.D2.DT.Rabies](PlanDefinition-IMMZD2DTRabiesPrEP.md)
* **Actions: **: **Version: **
  * : 0.2.0
* **Actions: **: **Title: **
  * : IMMZ.D2.DT.Rabies
...
```json
{
  ...
  "contained" : [{
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD2DTRabiesPrEPLogic"
      },
      {
        "url" : "name",
  ...
  "url" : "http://smart.who.int/immunizations/PlanDefinition/IMMZD2DTRabiesPrEP",
  "version" : "0.2.0",
  "name" : "IMMZD2DTRabiesPrEP",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZD2DTRabiesPrEPLogic"],
  "action" : [{
    "extension" : [{
    ...
    "definitionCanonical" : "http://smart.who.int/immunizations/ActivityDefinition/IMMZD2DTRabiesMR",
    "dynamicValue" : [{
      "path" : "status",
      "expression" : {
