...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/PlanDefinition/IMMZD5DTDTPCI | *Version*:0.2.0 |
| Draft as of 2026-03-31 | *Computable Name*:IMMZD5DTDTPCI |

 
IMMZ.D5.DT.DTP contraindications Potential contraindications 

* **Actions: **: **Url: **
  * : [IMMZ.D5.DT.DTP contraindications](PlanDefinition-IMMZD5DTDTPCI.md)
* **Actions: **: **Version: **
  * : 0.2.0
* **Actions: **: **Title: **
  * : IMMZ.D5.DT.DTP contraindications
...
```json
{
  ...
  "contained" : [{
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD5DTDTPCILogic"
      },
      {
        "url" : "name",
  ...
  "url" : "http://smart.who.int/immunizations/PlanDefinition/IMMZD5DTDTPCI",
  "version" : "0.2.0",
  "name" : "IMMZD5DTDTPCI",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZD5DTDTPCILogic"],
  "action" : [{
    ...
    "definitionCanonical" : "http://smart.who.int/immunizations/ActivityDefinition/IMMZD5DTDTPTdMR",
    "dynamicValue" : [{
      "path" : "id",
      "expression" : {
