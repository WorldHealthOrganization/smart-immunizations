# IMMZ.D2.DT.Cholera.rBSover5 ValueSet for Decision Table - WHO Immunization Implementation Guide v0.2.0

* [**Table of Contents**](toc.md)
* [**Indices**](indices.md)
* [**Artifact Index**](artifacts.md)
* **IMMZ.D2.DT.Cholera.rBSover5 ValueSet for Decision Table**

## ValueSet: IMMZ.D2.DT.Cholera.rBSover5 ValueSet for Decision Table 

| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/ValueSet/IMMZ.D2.DT.Cholera.rBSover5 | *Version*:0.2.0 |
| Active as of 2026-03-31 | *Computable Name*:IMMZ_D2_DT_Cholera_WC_rBS_vaccine_2_doses |

 
ValueSet IMMZ.D2.DT.Cholera.rBSover5 for IMMZ.D2.DT.Cholera.WC-rBS vaccine 2 doses. Business rule: Determine if the client is due for a cholera vaccination according to the national immunization schedule Trigger: IMMZ.D2 Determine required vaccination(s) if any
...
##### IMMZ.D2.DT.Cholera.rBSover5 ValueSet for Decision Table Schema API

JSON Schema for IMMZ.D2.DT.Cholera.rBSover5 ValueSet for Decision Table ValueSet codes. Generated from FHIR expansions using IRI format.

**Version:** 1.0.0

## Endpoints

### GET /ValueSet-IMMZ.D2.DT.Cholera.rBSover5.schema.json

#### JSON Schema definition for the enumeration ValueSet-IMMZ.D2.DT.Cholera.rBSover5

This endpoint serves the JSON Schema definition for the enumeration ValueSet-IMMZ.D2.DT.Cholera.rBSover5.

## Schema Definition

### ValueSet-IMMZ.D2.DT.Cholera.rBSover5

**Description:** JSON Schema for IMMZ.D2.DT.Cholera.rBSover5 ValueSet for Decision Table ValueSet codes. Generated from FHIR expansions using IRI format.
...
```json
{
  ...
  "id" : "IMMZ.D2.DT.Cholera.rBSover5",
  "url" : "http://smart.who.int/immunizations/ValueSet/IMMZ.D2.DT.Cholera.rBSover5",
  "version" : "0.2.0",
