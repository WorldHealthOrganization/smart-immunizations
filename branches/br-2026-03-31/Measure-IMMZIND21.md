# IMMZIND21 - WHO Immunization Implementation Guide v0.2.0
...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/Measure/IMMZIND21 | *Version*:0.2.0 |
| Draft as of 2025-06-11 | *Computable Name*:IMMZIND21 |

 
IMMZ.IND.21 Immunization coverage for rotavirus vaccines, 2nd dose 
...
* Knowledge Artifact Metadata: Initial Population
  * ?: **ID**: IMMZ.IND.21.IP**Description**:Initial Population**Logic Definition**:[Initial Population](#immzind21logic-initial-population)
* Knowledge Artifact Metadata: Denominator
  * ?: **ID**: IMMZ.IND.21.D**Description**:Denominator**Logic Definition**:[Denominator](#immzind21logic-denominator)
* Knowledge Artifact Metadata: Numerator
  * ?: **ID**: IMMZ.IND.21.N**Description**:Numerator**Logic Definition**:[Numerator](#immzind21logic-numerator)
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.21.S1**Code**: By-Administrative Area
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.21.S2**Code**: By-Sex
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.21.S3**Code**: By-Age group
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.21.S4**Code**: By-Age group
...
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**IMMZIND21Logic
* Knowledge Artifact Metadata: ````/* @numerator: Number of rotavirus vaccine doses (2nd dose) administered through routine services during the reporting period @pseudocode: COUNT of immunization events WHERE "Vaccine type" = "Rotavirus vaccines" for the 2nd dose in the primary series AND "Date and time of vaccination" is during the reporting period */ define "Numerator": exists( (Rotavirus."Rotavirus Primary Series Doses Administered to Patient".getDose('2')) I where I.occurrence.toInterval() starts during "Measurement Period" )````
* Knowledge Artifact Metadata:  Logic Definition
...
```json
{
  ...
  "url" : "http://smart.who.int/immunizations/Measure/IMMZIND21",
  "version" : "0.2.0",
  "name" : "IMMZIND21",
  "title" : "IMMZIND21",
  "status" : "draft",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZIND21Logic"],
  "scoring" : {
    "coding" : [{
