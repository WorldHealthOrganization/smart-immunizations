...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/PlanDefinition/IMMZD18SHepatitisB3Delayed | *Version*:0.2.0 |
| Draft as of 2026-03-31 | *Computable Name*:IMMZD18SHepatitisB3Delayed |

 
IMMZ.D18.S.Hepatitis B.Delayed start schedule 3-dose schedule (no birth dose + 3 doses), delayed start 

* **Actions: **: **Url: **
  * : [IMMZ.D18.S.Hepatitis B.Delayed start schedule](PlanDefinition-IMMZD18SHepatitisB3Delayed.md)
* **Actions: **: **Version: **
  * : 0.2.0
* **Actions: **: **Title: **
  * : IMMZ.D18.S.Hepatitis B.Delayed start schedule
...
```json
{
  ...
  "contained" : [{
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD18SHepatitisB3DelayedLogic"
      },
      {
        "url" : "name",
        "valueString" : "First hepatitis B dose was administered"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Second hepatitis B dose was administered"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Hepatitis B dose 1 Overdue"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Third hepatitis B dose was administered. The primary series has been completed"
      },
      {
        "url" : "statement",
  ...
  "url" : "http://smart.who.int/immunizations/PlanDefinition/IMMZD18SHepatitisB3Delayed",
  "version" : "0.2.0",
  "name" : "IMMZD18SHepatitisB3Delayed",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZD18SHepatitisB3DelayedLogic"],
  "action" : [{
