...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/PlanDefinition/IMMZD5DTMeaslesCI | *Version*:0.2.0 |
| Draft as of 2026-03-31 | *Computable Name*:IMMZD5DTMeaslesCI |

 
Check contraindications for Measles vaccine 

* **Actions: **: **Url: **
  * : [IMMZ.D5.DT.Measles contraindications](PlanDefinition-IMMZD5DTMeaslesCI.md)
* **Actions: **: **Version: **
  * : 0.2.0
* **Actions: **: **Title: **
  * : IMMZ.D5.DT.Measles contraindications
...
```json
{
  ...
  "contained" : [{
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD5DTMeaslesCILogic"
      },
      {
        "url" : "name",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Draft Medication Request for MCV dose"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Draft Medication Request ID for MCV dose"
      },
      {
        "url" : "statement",
  ...
  "url" : "http://smart.who.int/immunizations/PlanDefinition/IMMZD5DTMeaslesCI",
  "version" : "0.2.0",
  "name" : "IMMZD5DTMeaslesCI",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZD5DTMeaslesCILogic"],
  "action" : [{
    "title" : "Check for contraindications before administering the vaccine(s) due",
    "description" : "Show Guidance for the patient regarding MCV contraindication.",
    "condition" : [{
      "kind" : "applicability",
      "expression" : {
