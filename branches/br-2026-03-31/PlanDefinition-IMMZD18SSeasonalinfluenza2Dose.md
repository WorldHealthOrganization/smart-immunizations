...
| Draft as of 2026-03-31 | *Computable Name*:IMMZD18SSeasonalinfluenza2Dose |
...
```json
{
  ...
  "contained" : [{
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD18SSeasonalinfluenza2DoseLogic"
      },
      {
        "url" : "name",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZD18SSeasonalinfluenza2DoseLogic"],
  "action" : [{
