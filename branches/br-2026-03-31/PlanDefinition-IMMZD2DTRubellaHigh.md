...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/PlanDefinition/IMMZD2DTRubellaHigh | *Version*:0.2.0 |
| Draft as of 2026-03-31 | *Computable Name*:IMMZD2DTRubellaHigh |

 
IMMZ.D2.DT.Rubella.High incidence Countries with high incidence and mortality from rubella 

* **Actions: **: **Url: **
  * : [IMMZ.D2.DT.Rubella.High incidence](PlanDefinition-IMMZD2DTRubellaHigh.md)
* **Actions: **: **Version: **
  * : 0.2.0
* **Actions: **: **Title: **
  * : IMMZ.D2.DT.Rubella.High incidence
...
| |
| :--- |
| [IMMZD2DTRubellaHighLogic](Library-IMMZD2DTRubellaHighLogic.md) |
...
```json
{
  ...
  "contained" : [{
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD2DTRubellaHighLogic"
      },
      {
        "url" : "name",
  ...
  "url" : "http://smart.who.int/immunizations/PlanDefinition/IMMZD2DTRubellaHigh",
  "version" : "0.2.0",
  "name" : "IMMZD2DTRubellaHigh",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZD2DTRubellaHighLogic"],
  "action" : [{
    "extension" : [{
