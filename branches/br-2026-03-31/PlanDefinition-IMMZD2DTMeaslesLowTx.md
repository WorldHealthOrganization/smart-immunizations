...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/PlanDefinition/IMMZD2DTMeaslesLowTx | *Version*:0.2.0 |
| Draft as of 2026-03-31 | *Computable Name*:IMMZD2DTMeaslesLowTx |
...
* **Actions: **: **Url: **
  * : [IMMZ.D2.DT.Measles.Low transmission](PlanDefinition-IMMZD2DTMeaslesLowTx.md)
* **Actions: **: **Version: **
  * : 0.2.0
* **Actions: **: **Title: **
  * : IMMZ.D2.DT.Measles.Low transmission
...
```json
{
  ...
  "contained" : [{
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD2DTMeaslesLowTxLogic"
      },
      {
        "url" : "name",
        "valueString" : "Client is not due for MCV1 Case 1"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Client is not due for MCV1 Case 2"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Client is not due for MCV2 Case 1"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Client is not due for MCV2 Case 2"
      },
      {
        "url" : "statement",
  ...
  "url" : "http://smart.who.int/immunizations/PlanDefinition/IMMZD2DTMeaslesLowTx",
  "version" : "0.2.0",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZD2DTMeaslesLowTxLogic"],
  "action" : [{
    "extension" : [{
    ...
    "definitionCanonical" : "http://smart.who.int/immunizations/ActivityDefinition/IMMZD2DTMeaslesMR",
    "dynamicValue" : [{
      "path" : "status",
      "expression" : {
  ...
  },
  {
    ...
    "description" : "Send Guidance for the patient regarding MCV primary series.",
    "condition" : [{
      "kind" : "applicability",
      "expression" : {
