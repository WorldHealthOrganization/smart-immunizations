# IMMZIND11 - WHO Immunization Implementation Guide v0.2.0
...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/Measure/IMMZIND11 | *Version*:0.2.0 |
| Draft as of 2025-06-11 | *Computable Name*:IMMZIND11 |

 
IMMZ.IND.11 Immunization coverage for inactivated polio vaccine (IPV), 3rd dose 
...
* Knowledge Artifact Metadata: Initial Population
  * ?: **ID**: IMMZ.IND.11.IP**Description**:Initial Population**Logic Definition**:[Initial Population](#immzind11logic-initial-population)
* Knowledge Artifact Metadata: Denominator
  * ?: **ID**: IMMZ.IND.11.D**Description**:Denominator**Logic Definition**:[Denominator](#immzind11logic-denominator)
* Knowledge Artifact Metadata: Numerator
  * ?: **ID**: IMMZ.IND.11.N**Description**:Numerator**Logic Definition**:[Numerator](#immzind11logic-numerator)
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.11.S1**Code**: By-Administrative Area
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.11.S2**Code**: By-Sex
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.11.S3**Code**: By-Age group
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.11.S4**Code**: By-Age group
...
* Knowledge Artifact Metadata: Dependency
  * ?: **Description**: Library Polio**Resource**:[IMMZD2DTPolioElements](Library-IMMZD2DTPolioElements.md)**Canonical URL**:http://smart.who.int/immunizations/Library/IMMZD2DTPolioElements
* Knowledge Artifact Metadata: Dependency
...
* Knowledge Artifact Metadata: Dependency
  * ?: **Description**: Code system IMMZD**Resource**:[IMMZ.D CodeSystem for Data Elements](CodeSystem-IMMZ.D.md)**Canonical URL**:http://smart.who.int/immunizations/CodeSystem/IMMZ.D
* Knowledge Artifact Metadata: Dependency
...
* Knowledge Artifact Metadata: Dependency
  * ?: **Description**: Value set Poliovirus-containing vaccines**Resource**:[IMMZ.Z.DE14 ValueSet for Poliovirus-containing vaccines](ValueSet-IMMZ.Z.DE14.md)**Canonical URL**:http://smart.who.int/immunizations/ValueSet/IMMZ.Z.DE14
* Knowledge Artifact Metadata: Direct Reference Code
  * ?: **Display**: IPV**Code**: DE213**System**:http://smart.who.int/immunizations/CodeSystem/IMMZ.D
* Knowledge Artifact Metadata: Direct Reference Code
...
* Knowledge Artifact Metadata: Data Requirement
  * ?: **Type**: Immunization**Profile(s)**:[Immunization](http://hl7.org/fhir/R4/immunization.html)**Must Support Elements**: status, isSubpotent, protocolApplied, url**Code Filter(s)**:**Path**: status**Code**: 
* Knowledge Artifact Metadata: Data Requirement
  * ?: **Type**: Immunization**Profile(s)**:[Immunization](http://hl7.org/fhir/R4/immunization.html)**Must Support Elements**: occurrence, protocolApplied, url
* Knowledge Artifact Metadata: Data Requirement
  * ?: **Type**: Immunization**Profile(s)**:[Immunization](http://hl7.org/fhir/R4/immunization.html)**Must Support Elements**: status, isSubpotent, vaccineCode, protocolApplied, url**Code Filter(s)**:**Path**: status**Code**: **Path**: vaccineCode**ValueSet**:[IMMZ.Z.DE14 ValueSet for Poliovirus-containing vaccines](ValueSet-IMMZ.Z.DE14.md)
...
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**IMMZD2DTPolioElements
* Knowledge Artifact Metadata: ````/* @internal: Polio containing Doses Administered to Patient */ define "Polio Doses Administered to Patient": Elements."Doses Administered to Patient" I where I.vaccineCode in Concepts."Poliovirus-containing vaccines"````
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**IMMZD2DTPolioElements
* Knowledge Artifact Metadata: ````/* @internal: Polio containing Doses Administered to Patient that are in the Primary series */ define "Polio Primary Series Doses Administered to Patient": "Polio Doses Administered to Patient".seriesPrimary()````
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**IMMZD2DTPolioElements
* Knowledge Artifact Metadata: ````/* @internal: Polio IPV Primary Series Doses Administered to Patient */ define "Polio IPV Primary Series Doses Administered to Patient": "Polio Primary Series Doses Administered to Patient" I where I.typeOfDose() ~ Concepts."IPV"````
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**IMMZIND11Logic
* Knowledge Artifact Metadata: ````/* @numerator: Number of IPV doses (3rd dose) administered through routine services during the reporting period @pseudocode: COUNT of immunization events WHERE "Vaccine type" = "Inactivated polio vaccines" for the 3rd dose in the primary series AND "Date and time of vaccination" is during the reporting period */ define "Numerator": Coalesce( Polio."Polio IPV Primary Series Doses Administered to Patient".sortedIndex(2).occurrence.toInterval() starts during "Measurement Period", false )````
* Knowledge Artifact Metadata:  Logic Definition
...
* Knowledge Artifact Metadata: ````/** * @description: Sorts a list and returns the requested index */ define fluent function sortedIndex(immunizations List<Immunization>, idx Integer): if exists( immunizations ) then (immunizations I sort by start of occurrence.toInterval())[idx] else null````
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**IMMZCommon
* Knowledge Artifact Metadata: ````/** * @description: Gets the doses from the primary series */ define fluent function seriesPrimary(immunizations List<Immunization>): immunizations I where exists( I.protocolApplied pa where pa.series = 'Primary series' )````
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**FHIRHelpers
...
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**IMMZCommon
* Knowledge Artifact Metadata: ````/** * @description: Gets the type of antigen dose extension value from an Immunization */ define fluent function typeOfDose(immz Immunization): (First( immz.extension E where E.url = 'http://smart.who.int/immunizations/StructureDefinition/IMMZTypeOfDose' )).value as FHIR.CodeableConcept````
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**FHIRHelpers
* Knowledge Artifact Metadata: ````define function ToString(value uri): value.value````
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**FHIRHelpers
...
```json
{
  ...
  "contained" : [{
    ...
    },
    {
      ...
      {
        "url" : "statement",
        "valueString" : "/*\n@numerator: Number of IPV doses (3rd dose) administered through routine services during the reporting period\n@pseudocode: COUNT of immunization events WHERE \"Vaccine type\" = \"Inactivated polio vaccines\" for the 3rd dose in the primary series AND \"Date and time of vaccination\" is during the reporting period\n*/\ndefine \"Numerator\":\n  Coalesce( Polio.\"Polio IPV Primary Series Doses Administered to Patient\".sortedIndex(2).occurrence.toInterval() starts during \"Measurement Period\",\n    false )"
      },
      {
        "url" : "displaySequence",
        "valueInteger" : 4
    ...
    },
    {
      ...
      "mustSupport" : ["status", "isSubpotent", "protocolApplied", "url"],
      "codeFilter" : [{
        "path" : "status",
        "code" : [{
          "code" : "completed"
    ...
    },
    {
      "type" : "Immunization",
      "profile" : ["http://hl7.org/fhir/StructureDefinition/Immunization"],
      "mustSupport" : ["status", "isSubpotent", "vaccineCode", "protocolApplied", "url"],
      "codeFilter" : [{
        "path" : "status",
        "code" : [{
          "code" : "completed"
  ...
  "url" : "http://smart.who.int/immunizations/Measure/IMMZIND11",
  "version" : "0.2.0",
  "name" : "IMMZIND11",
  "title" : "IMMZIND11",
  "status" : "draft",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZIND11Logic"],
  "scoring" : {
    "coding" : [{
