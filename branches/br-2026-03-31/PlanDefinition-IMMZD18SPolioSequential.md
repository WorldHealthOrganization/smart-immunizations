...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/PlanDefinition/IMMZD18SPolioSequential | *Version*:0.2.0 |
| Draft as of 2026-03-31 | *Computable Name*:IMMZD18SPolioSequential |
...
* **Actions: **: **Url: **
  * : [IMMZ.D18.S.Polio.Sequential IPV–bOPV schedule](PlanDefinition-IMMZD18SPolioSequential.md)
* **Actions: **: **Version: **
  * : 0.2.0
* **Actions: **: **Title: **
  * : IMMZ.D18.S.Polio.Sequential IPV–bOPV schedule
...
```json
{
  ...
  "contained" : [{
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD18SPolioSequentialLogic"
      },
      {
        "url" : "name",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Second bOPV dose from the primary series was administered. The primary series has been completed"
      },
      {
        "url" : "statement",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZD18SPolioSequentialLogic"],
  "action" : [{
    "title" : "IPV dose 1",
