# IMMZ.D5.DT.Hepatitis B contraindications - WHO Immunization Implementation Guide v0.2.0
...
## PlanDefinition: IMMZ.D5.DT.Hepatitis B contraindications 

| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/PlanDefinition/IMMZD5DTHepatitisBContraindications | *Version*:0.2.0 |
| Draft as of 2026-06-04 | *Computable Name*:IMMZD5DTHepatitisBContraindications |

 
IMMZ.D5.DT.Hepatitis B contraindications IMMZ.D5.DT.Hepatitis B contraindications 

* **Actions: **: **Url: **
  * : [IMMZ.D5.DT.Hepatitis B contraindications](PlanDefinition-IMMZD5DTHepatitisBContraindications.md)
* **Actions: **: **Version: **
  * : 0.2.0
* **Actions: **: **Title: **
  * : IMMZ.D5.DT.Hepatitis B contraindications
...
```json
{
  ...
  "id" : "IMMZD5DTHepatitisBContraindications",
  "meta" : {
  ...
  "contained" : [{
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD5DTHepatitisBEncounterElements"
      },
      {
        "url" : "name",
        "valueString" : "The client has history of severe allergic reactions"
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD5DTHepatitisBContraindicationsLogic"
      },
      {
        "url" : "name",
        "valueString" : "Hepatitis B vaccination could be contraindicated. Clinical judgement is required. Create a clinical note."
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Hepatitis B vaccination could be contraindicated. Clinical judgement is required. Create a clinical note. Guidance"
      },
      {
        "url" : "statement",
  ...
  "url" : "http://smart.who.int/immunizations/PlanDefinition/IMMZD5DTHepatitisBContraindications",
  "version" : "0.2.0",
  "name" : "IMMZD5DTHepatitisBContraindications",
  "title" : "IMMZ.D5.DT.Hepatitis B contraindications",
  "type" : {
    "coding" : [{
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZD5DTHepatitisBContraindicationsLogic"],
  "action" : [{
    "title" : "Check for Guidance for the patient regarding IMMZ.D5.DT.Hepatitis B contraindications.",
    "description" : "Show Guidance for the patient regarding IMMZ.D5.DT.Hepatitis B contraindications.",
    "condition" : [{
      "kind" : "applicability",
      "expression" : {
