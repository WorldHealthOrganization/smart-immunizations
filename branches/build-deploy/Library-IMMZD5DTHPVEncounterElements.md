...
| Draft as of 2026-06-04 | *Computable Name*:IMMZD5DTHPVEncounterElements |

 
This library defines encounter-based elements for HPV used throughout the Immunization CPG 

* * **Content: **application/elm+xml: ````Encoded data (16872 characters)````: **Id: **
  * ?: IMMZD5DTHPVEncounterElements
* * **Content: **application/elm+xml: ````Encoded data (16872 characters)````: **Version: **
  * ?: 0.2.0
* * **Content: **application/elm+xml: ````Encoded data (16872 characters)````: **Url: **
  * ?: [IMMZD5DTHPVEncounterElements](Library-IMMZD5DTHPVEncounterElements.md)
* * **Content: **application/elm+xml: ````Encoded data (16872 characters)````: **Status: **
  * ?: draft
* * **Content: **application/elm+xml: ````Encoded data (16872 characters)````: **Date: **
  * ?: 2026-06-04 07:50:28+0000
* * **Content: **application/elm+xml: ````Encoded data (16872 characters)````: **Publisher: **
  * ?: WHO
* * **Content: **application/elm+xml: ````Encoded data (16872 characters)````: **Description: **
  * ?: This library defines encounter-based elements for HPV used throughout the Immunization CPG
