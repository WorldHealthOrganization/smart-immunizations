...
| Draft as of 2026-06-04 | *Computable Name*:IMMZD5DTHibEncounterElements |

 
This library defines encounter-based elements for Hib used throughout the Immunization CPG 

* * **Content: **application/elm+xml: ````Encoded data (15136 characters)````: **Id: **
  * ?: IMMZD5DTHibEncounterElements
* * **Content: **application/elm+xml: ````Encoded data (15136 characters)````: **Version: **
  * ?: 0.2.0
* * **Content: **application/elm+xml: ````Encoded data (15136 characters)````: **Url: **
  * ?: [IMMZD5DTHibEncounterElements](Library-IMMZD5DTHibEncounterElements.md)
* * **Content: **application/elm+xml: ````Encoded data (15136 characters)````: **Status: **
  * ?: draft
* * **Content: **application/elm+xml: ````Encoded data (15136 characters)````: **Date: **
  * ?: 2026-06-04 07:50:28+0000
* * **Content: **application/elm+xml: ````Encoded data (15136 characters)````: **Publisher: **
  * ?: WHO
* * **Content: **application/elm+xml: ````Encoded data (15136 characters)````: **Description: **
  * ?: This library defines encounter-based elements for Hib used throughout the Immunization CPG
