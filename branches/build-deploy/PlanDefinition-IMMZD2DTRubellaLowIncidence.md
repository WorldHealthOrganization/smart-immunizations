# IMMZ.D2.DT.Rubella.Low incidence - WHO Immunization Implementation Guide v0.2.0
...
## PlanDefinition: IMMZ.D2.DT.Rubella.Low incidence 

| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/PlanDefinition/IMMZD2DTRubellaLowIncidence | *Version*:0.2.0 |
| Draft as of 2026-06-04 | *Computable Name*:IMMZD2DTRubellaLowIncidence |

 
IMMZ.D2.DT.Rubella.Low incidence Countries with low incidence of rubella 

* **Actions: **: **Url: **
  * : [IMMZ.D2.DT.Rubella.Low incidence](PlanDefinition-IMMZD2DTRubellaLowIncidence.md)
* **Actions: **: **Version: **
  * : 0.2.0
* **Actions: **: **Title: **
  * : IMMZ.D2.DT.Rubella.Low incidence
...
```json
{
  ...
  "id" : "IMMZD2DTRubellaLowIncidence",
  "meta" : {
  ...
  "contained" : [{
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD2DTRubellaLowIncidenceLogic"
      },
      {
        "url" : "name",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Live vaccine was administered in the last the 4 weeks"
      },
      {
        "url" : "statement",
  ...
  "url" : "http://smart.who.int/immunizations/PlanDefinition/IMMZD2DTRubellaLowIncidence",
  "version" : "0.2.0",
  "name" : "IMMZD2DTRubellaLowIncidence",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZD2DTRubellaLowIncidenceLogic"],
  "action" : [{
    "extension" : [{
      "url" : "http://hl7.org/fhir/uv/cpg/StructureDefinition/cpg-rationale",
      "valueMarkdown" : "The first dose of rubella-containing vaccine can be delivered at 12 months of age."
    }],
  ...
  {
    "title" : "Check for Guidance for the patient regarding IMMZ.D2.DT.Rubella.Low incidence.",
    "description" : "Show Guidance for the patient regarding IMMZ.D2.DT.Rubella.Low incidence.",
    "condition" : [{
      "kind" : "applicability",
      "expression" : {
