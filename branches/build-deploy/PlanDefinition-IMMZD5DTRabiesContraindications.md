# IMMZ.D5.DT.Rabies contraindications - WHO Immunization Implementation Guide v0.2.0
...
## PlanDefinition: IMMZ.D5.DT.Rabies contraindications 

| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/PlanDefinition/IMMZD5DTRabiesContraindications | *Version*:0.2.0 |
| Draft as of 2026-06-04 | *Computable Name*:IMMZD5DTRabiesContraindications |

 
IMMZ.D5.DT.Rabies contraindications IMMZ.D5.DT.Rabies contraindications 

* **Actions: **: **Url: **
  * : [IMMZ.D5.DT.Rabies contraindications](PlanDefinition-IMMZD5DTRabiesContraindications.md)
* **Actions: **: **Version: **
  * : 0.2.0
* **Actions: **: **Title: **
  * : IMMZ.D5.DT.Rabies contraindications
...
```json
{
  ...
  "id" : "IMMZD5DTRabiesContraindications",
  "meta" : {
  ...
  "contained" : [{
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD5DTRabiesEncounterElements"
      },
      {
        "url" : "name",
        "valueString" : "The client has history of severe allergic reactions"
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD5DTRabiesContraindicationsLogic"
      },
      {
        "url" : "name",
  ...
  "url" : "http://smart.who.int/immunizations/PlanDefinition/IMMZD5DTRabiesContraindications",
  "version" : "0.2.0",
  "name" : "IMMZD5DTRabiesContraindications",
  "title" : "IMMZ.D5.DT.Rabies contraindications",
  "type" : {
    "coding" : [{
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZD5DTRabiesContraindicationsLogic"],
  "action" : [{
    "title" : "Check for Guidance for the patient regarding IMMZ.D5.DT.Rabies contraindications.",
    "description" : "Show Guidance for the patient regarding IMMZ.D5.DT.Rabies contraindications.",
    "condition" : [{
      "kind" : "applicability",
      "expression" : {
