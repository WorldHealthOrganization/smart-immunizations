...
| Draft as of 2026-06-04 | *Computable Name*:IMMZD5DTRabiesEncounterElements |

 
This library defines encounter-based elements for Rabies used throughout the Immunization CPG 

* * **Content: **application/elm+xml: ````Encoded data (15148 characters)````: **Id: **
  * ?: IMMZD5DTRabiesEncounterElements
* * **Content: **application/elm+xml: ````Encoded data (15148 characters)````: **Version: **
  * ?: 0.2.0
* * **Content: **application/elm+xml: ````Encoded data (15148 characters)````: **Url: **
