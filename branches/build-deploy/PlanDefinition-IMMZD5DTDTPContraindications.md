# IMMZ.D5.DT.DTP contraindications - WHO Immunization Implementation Guide v0.2.0
...
## PlanDefinition: IMMZ.D5.DT.DTP contraindications 

| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/PlanDefinition/IMMZD5DTDTPContraindications | *Version*:0.2.0 |
| Draft as of 2026-06-04 | *Computable Name*:IMMZD5DTDTPContraindications |

 
IMMZ.D5.DT.DTP contraindications IMMZ.D5.DT.DTP contraindications 

* **Actions: **: **Url: **
  * : [IMMZ.D5.DT.DTP contraindications](PlanDefinition-IMMZD5DTDTPContraindications.md)
* **Actions: **: **Version: **
  * : 0.2.0
* **Actions: **: **Title: **
  * : IMMZ.D5.DT.DTP contraindications
...
```json
{
  ...
  "id" : "IMMZD5DTDTPContraindications",
  "meta" : {
  ...
  "contained" : [{
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD5DTDTPEncounterElements"
      },
      {
        "url" : "name",
        "valueString" : "The client has a history of anaphylactic reactions"
      },
      {
        "url" : "statement",
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD5DTDTPContraindicationsLogic"
      },
      {
        "url" : "name",
        "valueString" : "Tetanus and pertussis vaccination could be contraindicated. Clinical judgement is required. Create a clinical note"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Tetanus and pertussis vaccination could be contraindicated. Clinical judgement is required. Create a clinical note Guidance"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "CI Severe acute illness Observation"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "CI Severe acute illness Condition"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "The client currently has a severe acute illness"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Tetanus vaccination is contraindicated"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Tetanus vaccination is contraindicated Guidance"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Draft Medication Request for Tetanus dose"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Draft Medication Request ID for Tetanus dose"
      },
      {
        "url" : "statement",
  ...
  "url" : "http://smart.who.int/immunizations/PlanDefinition/IMMZD5DTDTPContraindications",
  "version" : "0.2.0",
  "name" : "IMMZD5DTDTPContraindications",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZD5DTDTPContraindicationsLogic"],
  "action" : [{
    "title" : "Check for contraindications before administering the vaccine(s) due",
    "description" : "Contraindication for Tetanus immunization",
    "condition" : [{
      "kind" : "applicability",
      "expression" : {
        "description" : "Tetanus vaccination is contraindicated",
        "language" : "text/cql-identifier",
        "expression" : "Tetanus vaccination is contraindicated"
      }
    }],
    "type" : {
      "coding" : [{
    ...
    "dynamicValue" : [{
      "path" : "id",
      "expression" : {
        "description" : "Draft Medication Request ID for Tetanus dose",
        "language" : "text/cql-identifier",
        "expression" : "Draft Medication Request ID for Tetanus dose"
      }
    },
    {
      "path" : "medication",
      "expression" : {
        ...
        "expression" : "Concept { codes: { Code { system: 'http://smart.who.int/immunizations/CodeSystem/IMMZ.Z', code: 'DE19', display: 'Tetanus-containing vaccines' } }, display: 'Tetanus-containing vaccines' }"
      }
    }]
  },
  {
    "title" : "Check for Guidance for the patient regarding IMMZ.D5.DT.DTP contraindications.",
    "description" : "Show Guidance for the patient regarding IMMZ.D5.DT.DTP contraindications.",
    "condition" : [{
      "kind" : "applicability",
      "expression" : {
