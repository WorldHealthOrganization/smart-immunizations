...
| Draft as of 2026-06-04 | *Computable Name*:IMMZIND16Logic |

 
This library defines population criteria logic for the IMMZ.IND.16 indicator in the Immunization CPG 

* * **Content: **application/elm+xml: ````Encoded data (23664 characters)````: **Id: **
  * ?: IMMZIND16Logic
* * **Content: **application/elm+xml: ````Encoded data (23664 characters)````: **Version: **
  * ?: 0.2.0
* * **Content: **application/elm+xml: ````Encoded data (23664 characters)````: **Url: **
  * ?: [IMMZIND16Logic](Library-IMMZIND16Logic.md)
* * **Content: **application/elm+xml: ````Encoded data (23664 characters)````: **Status: **
  * ?: draft
* * **Content: **application/elm+xml: ````Encoded data (23664 characters)````: **Date: **
  * ?: 2026-06-04 07:50:28+0000
* * **Content: **application/elm+xml: ````Encoded data (23664 characters)````: **Publisher: **
  * ?: WHO
* * **Content: **application/elm+xml: ````Encoded data (23664 characters)````: **Description: **
  * ?: This library defines population criteria logic for the IMMZ.IND.16 indicator in the Immunization CPG
