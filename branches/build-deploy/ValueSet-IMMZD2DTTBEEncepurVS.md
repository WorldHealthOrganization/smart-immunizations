# IMMZD2DTTBEEncepur ValueSet for Decision Table - WHO Immunization Implementation Guide v0.2.0

* [**Table of Contents**](toc.md)
* [**Indices**](indices.md)
* [**Artifact Index**](artifacts.md)
* **IMMZD2DTTBEEncepur ValueSet for Decision Table**

## ValueSet: IMMZD2DTTBEEncepur ValueSet for Decision Table 

| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/ValueSet/IMMZD2DTTBEEncepurVS | *Version*:0.2.0 |
| Active as of 2026-06-04 | *Computable Name*:IMMZD2DTTBEEncepurVS |

 
ValueSet IMMZD2DTTBEEncepur for IMMZ.D2.DT.TBE.Encepur. Business rule: Determine if the client is due for a tick-borne encephalitis (TBE) vaccination according to the national immunization schedule Trigger: IMMZ.D2 Determine required vaccination(s) if any Table: Encepur schedule (In areas where the disease is highly endemic, implying that there is a high individual risk of infection, WHO recommends that vaccination be offered to all age groups, including children ) 
...
##### IMMZD2DTTBEEncepur ValueSet for Decision Table Schema API
...
### GET /ValueSet-IMMZD2DTTBEEncepurVS.schema.json

#### JSON Schema definition for the enumeration ValueSet-IMMZD2DTTBEEncepurVS

This endpoint serves the JSON Schema definition for the enumeration ValueSet-IMMZD2DTTBEEncepurVS.

## Schema Definition

### ValueSet-IMMZD2DTTBEEncepurVS

**Description:** JSON Schema for IMMZD2DTTBEEncepur ValueSet for Decision Table ValueSet codes. Generated from FHIR expansions using IRI format.
...
```json
{
  ...
  "id" : "IMMZD2DTTBEEncepurVS",
  "url" : "http://smart.who.int/immunizations/ValueSet/IMMZD2DTTBEEncepurVS",
  "version" : "0.2.0",
  "name" : "IMMZD2DTTBEEncepurVS",
