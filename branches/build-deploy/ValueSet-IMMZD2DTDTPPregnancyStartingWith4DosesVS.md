# IMMZD2DTDTPPregnancyStartingWith4Doses ValueSet for Decision Table - WHO Immunization Implementation Guide v0.2.0

* [**Table of Contents**](toc.md)
* [**Indices**](indices.md)
* [**Artifact Index**](artifacts.md)
* **IMMZD2DTDTPPregnancyStartingWith4Doses ValueSet for Decision Table**

## ValueSet: IMMZD2DTDTPPregnancyStartingWith4Doses ValueSet for Decision Table 

| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/ValueSet/IMMZD2DTDTPPregnancyStartingWith4DosesVS | *Version*:0.2.0 |
| Active as of 2026-06-04 | *Computable Name*:IMMZD2DTDTPPregnancyStartingWith4DosesVS |
...
##### IMMZD2DTDTPPregnancyStartingWith4Doses ValueSet for Decision Table Schema API
...
### GET /ValueSet-IMMZD2DTDTPPregnancyStartingWith4DosesVS.schema.json

#### JSON Schema definition for the enumeration ValueSet-IMMZD2DTDTPPregnancyStartingWith4DosesVS

This endpoint serves the JSON Schema definition for the enumeration ValueSet-IMMZD2DTDTPPregnancyStartingWith4DosesVS.

## Schema Definition

### ValueSet-IMMZD2DTDTPPregnancyStartingWith4DosesVS

**Description:** JSON Schema for IMMZD2DTDTPPregnancyStartingWith4Doses ValueSet for Decision Table ValueSet codes. Generated from FHIR expansions using IRI format.
...
```json
{
  ...
  "id" : "IMMZD2DTDTPPregnancyStartingWith4DosesVS",
  "url" : "http://smart.who.int/immunizations/ValueSet/IMMZD2DTDTPPregnancyStartingWith4DosesVS",
  "version" : "0.2.0",
