# IMMZ.D2.DT.JE.Live recombinant vaccine - WHO Immunization Implementation Guide v0.2.0
...
## PlanDefinition: IMMZ.D2.DT.JE.Live recombinant vaccine 

| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/PlanDefinition/IMMZD2DTJELiveRecombinantVaccine | *Version*:0.2.0 |
| Draft as of 2026-06-04 | *Computable Name*:IMMZD2DTJELiveRecombinantVaccine |

 
IMMZ.D2.DT.JE.Live recombinant vaccine Live recombinant vaccination schedule (1-dose scheme) JE vaccination should be integrated into national immunization schedules in all areas where JE is recognized as a public health priority 

* **Actions: **: **Url: **
  * : [IMMZ.D2.DT.JE.Live recombinant vaccine](PlanDefinition-IMMZD2DTJELiveRecombinantVaccine.md)
* **Actions: **: **Version: **
  * : 0.2.0
* **Actions: **: **Title: **
  * : IMMZ.D2.DT.JE.Live recombinant vaccine
...
```json
{
  ...
  "id" : "IMMZD2DTJELiveRecombinantVaccine",
  "meta" : {
  ...
  "contained" : [{
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD2DTJELiveRecombinantVaccineLogic"
      },
      {
        "url" : "name",
    ...
    },
    {
      ...
      {
        "url" : "statement",
        "valueString" : "/*\n@output: Client is not due for JE vaccination Guidance\n@guidance = Should not vaccinate client with JE dose as client's age is less than 9 months. \nCheck for any vaccines due and inform the caregiver of when to come back for the first JE dose.\n@guidance = Should not vaccinate client with JE dose as live vaccine was administered in the last 4 weeks. \nCheck for any other vaccines due and inform the caregiver of when to come back for the first JE dose.\n*/\ndefine \"Client is not due for JE vaccination Guidance\":\n  case\n    when \"Client is not due for JE vaccination Case 1\" then 'Should not vaccinate client with JE dose as client\\'s age is less than 9 months. \nCheck for any vaccines due and inform the caregiver of when to come back for the first JE dose.'\n    when \"Client is not due for JE vaccination Case 2\" then 'Should not vaccinate client with JE dose as live vaccine was administered in the last 4 weeks. \nCheck for any other vaccines due and inform the caregiver of when to come back for the first JE dose.'\n    else ''\n  end"
      },
      {
        "url" : "displaySequence",
        "valueInteger" : 17
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "One JE primary series doses were administered"
      },
      {
        "url" : "statement",
  ...
  "url" : "http://smart.who.int/immunizations/PlanDefinition/IMMZD2DTJELiveRecombinantVaccine",
  "version" : "0.2.0",
  "name" : "IMMZD2DTJELiveRecombinantVaccine",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZD2DTJELiveRecombinantVaccineLogic"],
  "action" : [{
    "extension" : [{
      "url" : "http://hl7.org/fhir/uv/cpg/StructureDefinition/cpg-rationale",
      "valueMarkdown" : "Live recombinant vaccine: Single dose administered at ≥ 9 months of age. As a general rule, any live vaccine may be \ngiven either simultaneously or at an interval of 4 weeks."
    }],
  ...
  {
    "title" : "Check for Guidance for the patient regarding IMMZ.D2.DT.JE.Live recombinant vaccine.",
    "description" : "Show Guidance for the patient regarding IMMZ.D2.DT.JE.Live recombinant vaccine.",
    "condition" : [{
      "kind" : "applicability",
      "expression" : {
