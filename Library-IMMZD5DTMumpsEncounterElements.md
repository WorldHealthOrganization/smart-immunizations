...
| Draft as of 2026-07-07 | *Computable Name*:IMMZD5DTMumpsEncounterElements |

 
This library defines encounter-based elements for Mumps used throughout the Immunization CPG 

* * **Content: **application/elm+xml: ````Encoded data (20668 characters)````: **Id: **
  * ?: IMMZD5DTMumpsEncounterElements
* * **Content: **application/elm+xml: ````Encoded data (20668 characters)````: **Version: **
  * ?: 0.2.0
* * **Content: **application/elm+xml: ````Encoded data (20668 characters)````: **Url: **
  * ?: [IMMZD5DTMumpsEncounterElements](Library-IMMZD5DTMumpsEncounterElements.md)
* * **Content: **application/elm+xml: ````Encoded data (20668 characters)````: **Status: **
  * ?: draft
* * **Content: **application/elm+xml: ````Encoded data (20668 characters)````: **Date: **
  * ?: 2026-07-07 22:08:04+0000
* * **Content: **application/elm+xml: ````Encoded data (20668 characters)````: **Publisher: **
  * ?: WHO
* * **Content: **application/elm+xml: ````Encoded data (20668 characters)````: **Description: **
  * ?: This library defines encounter-based elements for Mumps used throughout the Immunization CPG
