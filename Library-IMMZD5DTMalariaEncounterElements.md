...
| Draft as of 2026-07-07 | *Computable Name*:IMMZD5DTMalariaEncounterElements |

 
This library defines encounter-based elements for Malaria used throughout the Immunization CPG 

* * **Content: **application/elm+xml: ````Encoded data (15340 characters)````: **Id: **
  * ?: IMMZD5DTMalariaEncounterElements
* * **Content: **application/elm+xml: ````Encoded data (15340 characters)````: **Version: **
  * ?: 0.2.0
* * **Content: **application/elm+xml: ````Encoded data (15340 characters)````: **Url: **
  * ?: [IMMZD5DTMalariaEncounterElements](Library-IMMZD5DTMalariaEncounterElements.md)
* * **Content: **application/elm+xml: ````Encoded data (15340 characters)````: **Status: **
  * ?: draft
* * **Content: **application/elm+xml: ````Encoded data (15340 characters)````: **Date: **
  * ?: 2026-07-07 22:08:04+0000
* * **Content: **application/elm+xml: ````Encoded data (15340 characters)````: **Publisher: **
  * ?: WHO
* * **Content: **application/elm+xml: ````Encoded data (15340 characters)````: **Description: **
  * ?: This library defines encounter-based elements for Malaria used throughout the Immunization CPG
