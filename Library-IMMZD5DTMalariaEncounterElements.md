...
| Draft as of 2025-11-25 | *Computable Name*:IMMZD5DTMalariaEncounterElements |

 
This library defines encounter-based elements for Malaria used throughout the Immunization CPG 

* * **Content:**application/elm+xml: ````Encoded data (15316 characters)````: **Id:**
  * ?: IMMZD5DTMalariaEncounterElements
* * **Content:**application/elm+xml: ````Encoded data (15316 characters)````: **Version:**
  * ?: 0.2.0
* * **Content:**application/elm+xml: ````Encoded data (15316 characters)````: **Url:**
  * ?: [IMMZD5DTMalariaEncounterElements](Library-IMMZD5DTMalariaEncounterElements.md)
* * **Content:**application/elm+xml: ````Encoded data (15316 characters)````: **Status:**
  * ?: draft
* * **Content:**application/elm+xml: ````Encoded data (15316 characters)````: **Date:**
  * ?: 2025-11-25 19:41:02+0000
* * **Content:**application/elm+xml: ````Encoded data (15316 characters)````: **Publisher:**
  * ?: WHO
* * **Content:**application/elm+xml: ````Encoded data (15316 characters)````: **Description:**
  * ?: This library defines encounter-based elements for Malaria used throughout the Immunization CPG
