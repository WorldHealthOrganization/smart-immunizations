...
| Draft as of 2025-11-25 | *Computable Name*:IMMZD5DTSeasonalinfluenzaEncounterElements |

 
This library defines encounter-based elements for Seasonal influenza used throughout the Immunization CPG 

* * **Content:**application/elm+xml: ````Encoded data (17836 characters)````: **Id:**
  * ?: IMMZD5DTSeasonalinfluenzaEncounterElements
* * **Content:**application/elm+xml: ````Encoded data (17836 characters)````: **Version:**
  * ?: 0.2.0
* * **Content:**application/elm+xml: ````Encoded data (17836 characters)````: **Url:**
  * ?: [IMMZD5DTSeasonalinfluenzaEncounterElements](Library-IMMZD5DTSeasonalinfluenzaEncounterElements.md)
* * **Content:**application/elm+xml: ````Encoded data (17836 characters)````: **Status:**
  * ?: draft
* * **Content:**application/elm+xml: ````Encoded data (17836 characters)````: **Date:**
  * ?: 2025-11-25 19:41:02+0000
* * **Content:**application/elm+xml: ````Encoded data (17836 characters)````: **Publisher:**
  * ?: WHO
* * **Content:**application/elm+xml: ````Encoded data (17836 characters)````: **Description:**
  * ?: This library defines encounter-based elements for Seasonal influenza used throughout the Immunization CPG
