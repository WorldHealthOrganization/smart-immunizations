...
| Draft as of 2026-07-07 | *Computable Name*:IMMZD5DTSeasonalinfluenzaEncounterElements |

 
This library defines encounter-based elements for Seasonal influenza used throughout the Immunization CPG 

* * **Content: **application/elm+xml: ````Encoded data (17856 characters)````: **Id: **
  * ?: IMMZD5DTSeasonalinfluenzaEncounterElements
* * **Content: **application/elm+xml: ````Encoded data (17856 characters)````: **Version: **
  * ?: 0.2.0
* * **Content: **application/elm+xml: ````Encoded data (17856 characters)````: **Url: **
  * ?: [IMMZD5DTSeasonalinfluenzaEncounterElements](Library-IMMZD5DTSeasonalinfluenzaEncounterElements.md)
* * **Content: **application/elm+xml: ````Encoded data (17856 characters)````: **Status: **
  * ?: draft
* * **Content: **application/elm+xml: ````Encoded data (17856 characters)````: **Date: **
  * ?: 2026-07-07 22:08:04+0000
* * **Content: **application/elm+xml: ````Encoded data (17856 characters)````: **Publisher: **
  * ?: WHO
* * **Content: **application/elm+xml: ````Encoded data (17856 characters)````: **Description: **
  * ?: This library defines encounter-based elements for Seasonal influenza used throughout the Immunization CPG
