# IMMZD2DTMeaslesLowTransmission ValueSet for Decision Table - WHO Immunization Implementation Guide v1.0.0
...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/ValueSet/IMMZD2DTMeaslesLowTransmissionVS | *Version*:1.0.0 |
| Active as of 2026-04-09 | *Computable Name*:IMMZD2DTMeaslesLowTransmissionVS |
...
##### IMMZD2DTMeaslesLowTransmission ValueSet for Decision Table Schema API
...
### GET /ValueSet-IMMZD2DTMeaslesLowTransmissionVS.schema.json

#### JSON Schema definition for the enumeration ValueSet-IMMZD2DTMeaslesLowTransmissionVS

This endpoint serves the JSON Schema definition for the enumeration ValueSet-IMMZD2DTMeaslesLowTransmissionVS.

## Schema Definition

### ValueSet-IMMZD2DTMeaslesLowTransmissionVS

**Description:** JSON Schema for IMMZD2DTMeaslesLowTransmission ValueSet for Decision Table ValueSet codes. Generated from FHIR expansions using IRI format.
