# IMMZD2DTPolioIPVOnly ValueSet for Decision Table - WHO Immunization Implementation Guide v1.0.0
...
| Active as of 2026-04-09 | *Computable Name*:IMMZD2DTPolioIPVOnlyVS |
...
##### IMMZD2DTPolioIPVOnly ValueSet for Decision Table Schema API
...
### GET /ValueSet-IMMZD2DTPolioIPVOnlyVS.schema.json

#### JSON Schema definition for the enumeration ValueSet-IMMZD2DTPolioIPVOnlyVS

This endpoint serves the JSON Schema definition for the enumeration ValueSet-IMMZD2DTPolioIPVOnlyVS.

## Schema Definition

### ValueSet-IMMZD2DTPolioIPVOnlyVS

**Description:** JSON Schema for IMMZD2DTPolioIPVOnly ValueSet for Decision Table ValueSet codes. Generated from FHIR expansions using IRI format.
