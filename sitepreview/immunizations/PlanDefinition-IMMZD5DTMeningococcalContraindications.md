# IMMZ.D5.DT.Meningococcal contraindications - WHO Immunization Implementation Guide v1.0.0
...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/PlanDefinition/IMMZD5DTMeningococcalContraindications | *Version*:1.0.0 |
| Draft as of 2026-04-09 | *Computable Name*:IMMZD5DTMeningococcalContraindications |

 
IMMZ.D5.DT.Meningococcal contraindications IMMZ.D5.DT.Meningococcal contraindications 

* **Actions: **: **Url: **
  * : [IMMZ.D5.DT.Meningococcal contraindications](PlanDefinition-IMMZD5DTMeningococcalContraindications.md)
* **Actions: **: **Version: **
  * : 1.0.0
* **Actions: **: **Title: **
  * : IMMZ.D5.DT.Meningococcal contraindications
...
```json
{
  ...
  "id" : "IMMZD5DTMeningococcalContraindications",
  "meta" : {
  ...
  "contained" : [{
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD5DTMeningococcalEncounterElements"
      },
      {
        "url" : "name",
        "valueString" : "The client has history of severe allergic reactions"
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD5DTMeningococcalContraindicationsLogic"
      },
      {
        "url" : "name",
        "valueString" : "Meningococcal vaccination could be contraindicated. Clinical judgement is required. Create a clinical note"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Meningococcal vaccination could be contraindicated. Clinical judgement is required. Create a clinical note Guidance"
      },
      {
        "url" : "statement",
  ...
  "url" : "http://smart.who.int/immunizations/PlanDefinition/IMMZD5DTMeningococcalContraindications",
  "version" : "1.0.0",
  "name" : "IMMZD5DTMeningococcalContraindications",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZD5DTMeningococcalContraindicationsLogic"],
  "action" : [{
