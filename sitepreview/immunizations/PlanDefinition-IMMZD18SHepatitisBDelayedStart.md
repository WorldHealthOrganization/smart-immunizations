# IMMZ.D18.S.Hepatitis B.Delayed start schedule - WHO Immunization Implementation Guide v1.0.0
...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/PlanDefinition/IMMZD18SHepatitisBDelayedStart | *Version*:1.0.0 |
| Draft as of 2026-04-09 | *Computable Name*:IMMZD18SHepatitisBDelayedStart |
...
```json
{
  ...
  "contained" : [{
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD18SHepatitisBDelayedStartLogic"
      },
      {
        "url" : "name",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZD18SHepatitisBDelayedStartLogic"],
  "action" : [{
