# IMMZD18SMalaria ValueSet for Decision Table - WHO Immunization Implementation Guide v1.0.0
...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/ValueSet/IMMZD18SMalariaVS | *Version*:1.0.0 |
| Active as of 2026-04-09 | *Computable Name*:IMMZD18SMalariaVS |
...
##### IMMZD18SMalaria ValueSet for Decision Table Schema API
...
### GET /ValueSet-IMMZD18SMalariaVS.schema.json

#### JSON Schema definition for the enumeration ValueSet-IMMZD18SMalariaVS

This endpoint serves the JSON Schema definition for the enumeration ValueSet-IMMZD18SMalariaVS.

## Schema Definition

### ValueSet-IMMZD18SMalariaVS

**Description:** JSON Schema for IMMZD18SMalaria ValueSet for Decision Table ValueSet codes. Generated from FHIR expansions using IRI format.
