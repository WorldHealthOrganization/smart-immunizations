# IMMZ.D2.DT.Hepatitis A.Inactivated HAV 1 dose - WHO Immunization Implementation Guide v1.0.0
...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/PlanDefinition/IMMZD2DTHepatitisAInactivatedHAV1Dose | *Version*:1.0.0 |
| Draft as of 2026-04-09 | *Computable Name*:IMMZD2DTHepatitisAInactivatedHAV1Dose |
...
```json
{
  ...
  "contained" : [{
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD2DTHepatitisAInactivatedHAV1DoseLogic"
      },
      {
        "url" : "name",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZD2DTHepatitisAInactivatedHAV1DoseLogic"],
  "action" : [{
    "extension" : [{
