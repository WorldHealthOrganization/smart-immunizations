# IMMZ.D2.DT.Meningococcal.Quadrivalent conjugate vaccines 2 doses - WHO Immunization Implementation Guide v1.0.0
...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/PlanDefinition/IMMZD2DTMeningococcalQuadrivalentConjugateVaccines2Doses | *Version*:1.0.0 |
| Draft as of 2026-04-09 | *Computable Name*:IMMZD2DTMeningococcalQuadrivalentConjugateVaccines2Doses |
...
* **Actions: **: **Url: **
  * : [IMMZ.D2.DT.Meningococcal.Quadrivalent conjugate vaccines 2 doses](PlanDefinition-IMMZD2DTMeningococcalQuadrivalentConjugateVaccines2Doses.md)
* **Actions: **: **Version: **
  * : 1.0.0
* **Actions: **: **Title: **
  * : IMMZ.D2.DT.Meningococcal.Quadrivalent conjugate vaccines 2 doses
...
```json
{
  ...
  "id" : "IMMZD2DTMeningococcalQuadrivalentConjugateVaccines2Doses",
  "meta" : {
  ...
  "contained" : [{
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD2DTMeningococcalQuadrivalentConjugateVaccines2DosesLogic"
      },
      {
        "url" : "name",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Client's age was less than or equal to 23 months when the primary series was started"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "The latest meningococcal dose was administered less than 3 months ago"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Client's age is more than 9 months"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "The latest meningococcal dose was administered more than 3 months ago"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Client's age was more than 23 months when the primary series was started"
      },
      {
        "url" : "statement",
  ...
  "url" : "http://smart.who.int/immunizations/PlanDefinition/IMMZD2DTMeningococcalQuadrivalentConjugateVaccines2Doses",
  "version" : "1.0.0",
  "name" : "IMMZD2DTMeningococcalQuadrivalentConjugateVaccines2Doses",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZD2DTMeningococcalQuadrivalentConjugateVaccines2DosesLogic"],
  "action" : [{
    "extension" : [{
