# IMMZ.D5.DT.Measles contraindications - WHO Immunization Implementation Guide v1.0.0
...
## PlanDefinition: IMMZ.D5.DT.Measles contraindications 

| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/PlanDefinition/IMMZD5DTMeaslesContraindications | *Version*:1.0.0 |
| Draft as of 2026-04-09 | *Computable Name*:IMMZD5DTMeaslesContraindications |

 
IMMZ.D5.DT.Measles contraindications IMMZ.D5.DT.Measles contraindications 

* **Actions: **: **Url: **
  * : [IMMZ.D5.DT.Measles contraindications](PlanDefinition-IMMZD5DTMeaslesContraindications.md)
* **Actions: **: **Version: **
  * : 1.0.0
* **Actions: **: **Title: **
  * : IMMZ.D5.DT.Measles contraindications
...
```json
{
  ...
  "id" : "IMMZD5DTMeaslesContraindications",
  "meta" : {
  ...
  "contained" : [{
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD5DTMeaslesEncounterElements"
      },
      {
        "url" : "name",
        "valueString" : "The client is pregnant"
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD5DTMeaslesContraindicationsLogic"
      },
      {
        "url" : "name",
        "valueString" : "Measles vaccination contraindicated Case 1"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Measles vaccination contraindicated Case 2"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Measles vaccination contraindicated"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Measles vaccination contraindicated Guidance"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Measles vaccination could be contraindicated. Clinical judgement required. Create a clinical note"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Measles vaccination could be contraindicated. Clinical judgement required. Create a clinical note Guidance"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Clinical judgement required. Create a clinical note Case 1"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Clinical judgement required. Create a clinical note Case 2"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Clinical judgement required. Create a clinical note"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Clinical judgement required. Create a clinical note Guidance"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Draft Medication Request for Measles dose"
      },
      {
        "url" : "statement",
        "valueString" : "/*\n@internal: Draft Medication Request for Measles dose\n*/\ndefine \"Draft Medication Request for Measles dose\":\n\n  Encounter.\"Draft Medication Request for Patient\" MR \n    where MR.medication in Concepts.\"Measles-containing vaccines\""
      },
      {
        "url" : "displaySequence",
        "valueInteger" : 47
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Draft Medication Request ID for Measles dose"
      },
      {
        "url" : "statement",
  ...
  "url" : "http://smart.who.int/immunizations/PlanDefinition/IMMZD5DTMeaslesContraindications",
  "version" : "1.0.0",
  "name" : "IMMZD5DTMeaslesContraindications",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZD5DTMeaslesContraindicationsLogic"],
  "action" : [{
    ...
    "dynamicValue" : [{
      "path" : "id",
      "expression" : {
        "description" : "Draft Medication Request ID for Measles dose",
        "language" : "text/cql-identifier",
        "expression" : "Draft Medication Request ID for Measles dose"
      }
    },
    {
      "path" : "medication",
  ...
  {
    "title" : "Check for Guidance for the patient regarding IMMZ.D5.DT.Measles contraindications.",
    "description" : "Show Guidance for the patient regarding IMMZ.D5.DT.Measles contraindications.",
    "condition" : [{
      "kind" : "applicability",
      "expression" : {
