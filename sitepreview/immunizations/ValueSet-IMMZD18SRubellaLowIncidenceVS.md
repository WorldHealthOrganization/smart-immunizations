# IMMZD18SRubellaLowIncidence ValueSet for Decision Table - WHO Immunization Implementation Guide v1.0.0
...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/ValueSet/IMMZD18SRubellaLowIncidenceVS | *Version*:1.0.0 |
| Active as of 2026-04-09 | *Computable Name*:IMMZD18SRubellaLowIncidenceVS |
...
##### IMMZD18SRubellaLowIncidence ValueSet for Decision Table Schema API
...
### GET /ValueSet-IMMZD18SRubellaLowIncidenceVS.schema.json

#### JSON Schema definition for the enumeration ValueSet-IMMZD18SRubellaLowIncidenceVS

This endpoint serves the JSON Schema definition for the enumeration ValueSet-IMMZD18SRubellaLowIncidenceVS.

## Schema Definition

### ValueSet-IMMZD18SRubellaLowIncidenceVS

**Description:** JSON Schema for IMMZD18SRubellaLowIncidence ValueSet for Decision Table ValueSet codes. Generated from FHIR expansions using IRI format.
