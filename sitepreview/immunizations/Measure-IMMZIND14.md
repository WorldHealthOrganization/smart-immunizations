# IMMZIND14 - WHO Immunization Implementation Guide v1.0.0
...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/Measure/IMMZIND14 | *Version*:1.0.0 |
| Draft as of 2025-06-11 | *Computable Name*:IMMZIND14 |

 
IMMZ.IND.14 Immunization coverage for HPV vaccine, 1st dose 
...
* Knowledge Artifact Metadata: Initial Population
  * ?: **ID**: IMMZ.IND.14.IP**Description**:Initial Population**Logic Definition**:[Initial Population](#immzind14logic-initial-population)
* Knowledge Artifact Metadata: Denominator
  * ?: **ID**: IMMZ.IND.14.D**Description**:Denominator**Logic Definition**:[Denominator](#immzind14logic-denominator)
* Knowledge Artifact Metadata: Numerator
  * ?: **ID**: IMMZ.IND.14.N**Description**:Numerator**Logic Definition**:[Numerator](#immzind14logic-numerator)
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.14.S1**Code**: By-Administrative Area
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.14.S2**Code**: By-Sex
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.14.S3**Code**: By-Age group
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.14.S4**Code**: By-Age group
...
* Knowledge Artifact Metadata: Dependency
  * ?: **Description**: Library HPV**Resource**:[IMMZD2DTHPVElements](Library-IMMZD2DTHPVElements.md)**Canonical URL**:http://smart.who.int/immunizations/Library/IMMZD2DTHPVElements
* Knowledge Artifact Metadata: Dependency
...
* Knowledge Artifact Metadata: Dependency
  * ?: **Description**: Value set HPV vaccines**Resource**:[IMMZ.Z.DE7 ValueSet for HPV vaccines](ValueSet-IMMZ.Z.DE7.md)**Canonical URL**:http://smart.who.int/immunizations/ValueSet/IMMZ.Z.DE7
* Knowledge Artifact Metadata: Direct Reference Code
  * ?: **Display**: < 9 years**Code**: P0Y--P9Y**System**:http://ohie.org/CodeSystem/iso-8601-derived-periods
* Knowledge Artifact Metadata: Direct Reference Code
  * ?: **Display**: 9 - 14 years**Code**: P9Y--P15Y**System**:http://ohie.org/CodeSystem/iso-8601-derived-periods
* Knowledge Artifact Metadata: Direct Reference Code
  * ?: **Display**: >= 15 years**Code**: P15Y--P9999Y**System**:http://ohie.org/CodeSystem/iso-8601-derived-periods
* Knowledge Artifact Metadata: Direct Reference Code
...
* Knowledge Artifact Metadata: Data Requirement
  * ?: **Type**: Immunization**Profile(s)**:[Immunization](http://hl7.org/fhir/R4/immunization.html)**Must Support Elements**: status, isSubpotent, vaccineCode, protocolApplied**Code Filter(s)**:**Path**: status**Code**: **Path**: vaccineCode**ValueSet**:[IMMZ.Z.DE7 ValueSet for HPV vaccines](ValueSet-IMMZ.Z.DE7.md)
* Knowledge Artifact Metadata: Data Requirement
...
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**IMMZD2DTHPVElements
* Knowledge Artifact Metadata: ````/* @internal: HPV containing Doses Administered to Patient */ define "HPV Doses Administered to Patient": Elements."Doses Administered to Patient" I where I.vaccineCode in Concepts."HPV vaccines"````
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**IMMZD2DTHPVElements
* Knowledge Artifact Metadata: ````/* @internal: HPV containing Doses Administered to Patient that are in the Primary series */ define "HPV Primary Series Doses Administered to Patient": "HPV Doses Administered to Patient".seriesPrimary()````
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**IMMZIND14Logic
* Knowledge Artifact Metadata: ````/* @numerator: Number of HPV vaccine doses (1st dose) administered through routine services during the reporting period @pseudocode: COUNT of immunization events WHERE "Vaccine type" = "HPV vaccines" for the 1st dose in the primary series AND "Date and time of vaccination" is during the reporting period */ define "Numerator": exists ( (HPV."HPV Primary Series Doses Administered to Patient".getDose('1')) I where I.occurrence.toInterval() starts during "Measurement Period" )````
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**IMMZIndicatorElements
* Knowledge Artifact Metadata: ````/* @stratifier: Adolescent By Age Stratifiers */ define "Adolescent By Age Stratifier": case when AgeInYearsAt(end of "Measurement Period") < 9 then Age."P0Y--P9Y" when AgeInYearsAt(end of "Measurement Period") <= 14 then Age."P9Y--P15Y" when AgeInYearsAt(end of "Measurement Period") > 14 then Age."P15Y--P9999Y" else null end````
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**IMMZIND14Logic
* Knowledge Artifact Metadata: ````define "Stratification 4": Elements."Adolescent By Age Stratifier"````
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**IMMZIndicatorElements
...
```json
{
  ...
  "contained" : [{
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD2DTHPVElements"
      },
      {
        "url" : "name",
    ...
    },
    {
      ...
      {
        "url" : "statement",
        "valueString" : "/*\n@numerator: Number of HPV vaccine doses (1st dose) administered through routine services during the reporting period\n@pseudocode: COUNT of immunization events WHERE \"Vaccine type\" = \"HPV vaccines\" for the 1st dose in the primary series AND \"Date and time of vaccination\" is during the reporting period\n*/\ndefine \"Numerator\":\n  exists (\n    (HPV.\"HPV Primary Series Doses Administered to Patient\".getDose('1')) I\n      where I.occurrence.toInterval() starts during \"Measurement Period\"\n  )"
      },
      {
        "url" : "displaySequence",
        "valueInteger" : 3
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Adolescent By Age Stratifier"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "statement",
        "valueString" : "define \"Stratification 4\":\n\tElements.\"Adolescent By Age Stratifier\""
      },
      {
        "url" : "displaySequence",
        "valueInteger" : 5
  ...
  "url" : "http://smart.who.int/immunizations/Measure/IMMZIND14",
  "version" : "1.0.0",
  "name" : "IMMZIND14",
  "title" : "IMMZIND14",
  "status" : "draft",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZIND14Logic"],
  "scoring" : {
    "coding" : [{
