# IMMZD2DTJEInactivatedVeroCellDerivedVaccine ValueSet for Decision Table - WHO Immunization Implementation Guide v1.0.0
...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/ValueSet/IMMZD2DTJEInactivatedVeroCellDerivedVaccineVS | *Version*:1.0.0 |
| Active as of 2026-04-09 | *Computable Name*:IMMZD2DTJEInactivatedVeroCellDerivedVaccineVS |
...
##### IMMZD2DTJEInactivatedVeroCellDerivedVaccine ValueSet for Decision Table Schema API
...
### GET /ValueSet-IMMZD2DTJEInactivatedVeroCellDerivedVaccineVS.schema.json

#### JSON Schema definition for the enumeration ValueSet-IMMZD2DTJEInactivatedVeroCellDerivedVaccineVS

This endpoint serves the JSON Schema definition for the enumeration ValueSet-IMMZD2DTJEInactivatedVeroCellDerivedVaccineVS.

## Schema Definition

### ValueSet-IMMZD2DTJEInactivatedVeroCellDerivedVaccineVS

**Description:** JSON Schema for IMMZD2DTJEInactivatedVeroCellDerivedVaccine ValueSet for Decision Table ValueSet codes. Generated from FHIR expansions using IRI format.
