# IMMZD18SPolioSequentialIPVbOPV ValueSet for Decision Table - WHO Immunization Implementation Guide v1.0.0
...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/ValueSet/IMMZD18SPolioSequentialIPVbOPVVS | *Version*:1.0.0 |
| Active as of 2026-04-09 | *Computable Name*:IMMZD18SPolioSequentialIPVbOPVVS |
...
##### IMMZD18SPolioSequentialIPVbOPV ValueSet for Decision Table Schema API
...
### GET /ValueSet-IMMZD18SPolioSequentialIPVbOPVVS.schema.json

#### JSON Schema definition for the enumeration ValueSet-IMMZD18SPolioSequentialIPVbOPVVS

This endpoint serves the JSON Schema definition for the enumeration ValueSet-IMMZD18SPolioSequentialIPVbOPVVS.

## Schema Definition

### ValueSet-IMMZD18SPolioSequentialIPVbOPVVS

**Description:** JSON Schema for IMMZD18SPolioSequentialIPVbOPV ValueSet for Decision Table ValueSet codes. Generated from FHIR expansions using IRI format.
