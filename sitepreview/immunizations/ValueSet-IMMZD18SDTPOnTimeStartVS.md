# IMMZD18SDTPOnTimeStart ValueSet for Decision Table - WHO Immunization Implementation Guide v1.0.0
...
| Active as of 2026-04-09 | *Computable Name*:IMMZD18SDTPOnTimeStartVS |
...
##### IMMZD18SDTPOnTimeStart ValueSet for Decision Table Schema API
...
### GET /ValueSet-IMMZD18SDTPOnTimeStartVS.schema.json

#### JSON Schema definition for the enumeration ValueSet-IMMZD18SDTPOnTimeStartVS

This endpoint serves the JSON Schema definition for the enumeration ValueSet-IMMZD18SDTPOnTimeStartVS.

## Schema Definition

### ValueSet-IMMZD18SDTPOnTimeStartVS

**Description:** JSON Schema for IMMZD18SDTPOnTimeStart ValueSet for Decision Table ValueSet codes. Generated from FHIR expansions using IRI format.
