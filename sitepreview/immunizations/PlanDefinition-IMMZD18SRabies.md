# IMMZ.D18.S.Rabies schedule - WHO Immunization Implementation Guide v1.0.0
...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/PlanDefinition/IMMZD18SRabies | *Version*:1.0.0 |
| Draft as of 2026-04-09 | *Computable Name*:IMMZD18SRabies |
...
```json
{
  ...
  "contained" : [{
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD18SRabiesLogic"
      },
      {
        "url" : "name",
        "valueString" : "First rabies dose from the primary series was administered"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Second rabies dose from the primary series was administered. The primary series has been completed"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Rabies dose 1 Create"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Rabies dose 2 Due Date"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Rabies dose 2 Create"
      },
      {
        "url" : "statement",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZD18SRabiesLogic"],
  "action" : [{
    "title" : "Rabies dose 1",
