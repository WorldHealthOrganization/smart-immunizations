# IMMZIND07 - WHO Immunization Implementation Guide v1.0.0
...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/Measure/IMMZIND07 | *Version*:1.0.0 |
| Draft as of 2025-06-11 | *Computable Name*:IMMZIND07 |

 
IMMZ.IND.07 Immunization coverage for oral polio vaccine (OPV), 2nd dose 
...
* Knowledge Artifact Metadata: Initial Population
  * ?: **ID**: IMMZ.IND.07.IP**Description**:Initial Population**Logic Definition**:[Initial Population](#immzind07logic-initial-population)
* Knowledge Artifact Metadata: Denominator
  * ?: **ID**: IMMZ.IND.07.D**Description**:Denominator**Logic Definition**:[Denominator](#immzind07logic-denominator)
* Knowledge Artifact Metadata: Numerator
  * ?: **ID**: IMMZ.IND.07.N**Description**:Numerator**Logic Definition**:[Numerator](#immzind07logic-numerator)
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.07.S1**Code**: By-Administrative Area
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.07.S2**Code**: By-Sex
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.07.S3**Code**: By-Age group
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.07.S4**Code**: By-Age group
...
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**IMMZIND07Logic
* Knowledge Artifact Metadata: ````/* @numerator: Number of OPV doses (2nd dose) administered through routine services during the reporting period @pseudocode: COUNT of immunization events WHERE "Vaccine type" = "Oral polio vaccines" for the 2nd dose in the primary series AND "Date and time of vaccination" is during the reporting period */ define "Numerator": Coalesce( Polio."Polio bOPV Primary Series Doses Administered to Patient".sortedIndex(1).occurrence.toInterval() starts during "Measurement Period", false )````
* Knowledge Artifact Metadata:  Logic Definition
...
```json
{
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZIND07Logic"],
  "scoring" : {
    "coding" : [{
