# IMMZ.D5.DT.JE contraindications - WHO Immunization Implementation Guide v1.0.0
...
## PlanDefinition: IMMZ.D5.DT.JE contraindications 

| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/PlanDefinition/IMMZD5DTJEContraindications | *Version*:1.0.0 |
| Draft as of 2026-04-09 | *Computable Name*:IMMZD5DTJEContraindications |

 
IMMZ.D5.DT.JE contraindications IMMZ.D5.DT.JE contraindications 

* **Actions: **: **Url: **
  * : [IMMZ.D5.DT.JE contraindications](PlanDefinition-IMMZD5DTJEContraindications.md)
* **Actions: **: **Version: **
  * : 1.0.0
* **Actions: **: **Title: **
  * : IMMZ.D5.DT.JE contraindications
...
```json
{
  ...
  "id" : "IMMZD5DTJEContraindications",
  "meta" : {
  ...
  "contained" : [{
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD5DTJEEncounterElements"
      },
      {
        "url" : "name",
        "valueString" : "The client is immunocomprised"
      },
      {
        "url" : "statement",
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD5DTJEContraindicationsLogic"
      },
      {
        "url" : "name",
  ...
  "url" : "http://smart.who.int/immunizations/PlanDefinition/IMMZD5DTJEContraindications",
  "version" : "1.0.0",
  "name" : "IMMZD5DTJEContraindications",
  "title" : "IMMZ.D5.DT.JE contraindications",
  "type" : {
    "coding" : [{
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZD5DTJEContraindicationsLogic"],
  "action" : [{
    "title" : "Check for Guidance for the patient regarding IMMZ.D5.DT.JE contraindications.",
    "description" : "Show Guidance for the patient regarding IMMZ.D5.DT.JE contraindications.",
    "condition" : [{
      "kind" : "applicability",
      "expression" : {
