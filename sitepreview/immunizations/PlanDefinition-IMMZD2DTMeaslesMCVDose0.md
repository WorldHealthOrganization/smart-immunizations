# IMMZ.D2.DT.Measles.MCV dose 0 - WHO Immunization Implementation Guide v1.0.0
...
| Draft as of 2026-04-09 | *Computable Name*:IMMZD2DTMeaslesMCVDose0 |
...
```json
{
  ...
  "contained" : [{
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD2DTMeaslesMCVDose0Logic"
      },
      {
        "url" : "name",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZD2DTMeaslesMCVDose0Logic"],
  "action" : [{
