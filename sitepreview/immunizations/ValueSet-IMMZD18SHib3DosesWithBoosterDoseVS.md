# IMMZD18SHib3DosesWithBoosterDose ValueSet for Decision Table - WHO Immunization Implementation Guide v1.0.0
...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/ValueSet/IMMZD18SHib3DosesWithBoosterDoseVS | *Version*:1.0.0 |
| Active as of 2026-04-09 | *Computable Name*:IMMZD18SHib3DosesWithBoosterDoseVS |
...
##### IMMZD18SHib3DosesWithBoosterDose ValueSet for Decision Table Schema API
...
### GET /ValueSet-IMMZD18SHib3DosesWithBoosterDoseVS.schema.json

#### JSON Schema definition for the enumeration ValueSet-IMMZD18SHib3DosesWithBoosterDoseVS

This endpoint serves the JSON Schema definition for the enumeration ValueSet-IMMZD18SHib3DosesWithBoosterDoseVS.

## Schema Definition

### ValueSet-IMMZD18SHib3DosesWithBoosterDoseVS

**Description:** JSON Schema for IMMZD18SHib3DosesWithBoosterDose ValueSet for Decision Table ValueSet codes. Generated from FHIR expansions using IRI format.
