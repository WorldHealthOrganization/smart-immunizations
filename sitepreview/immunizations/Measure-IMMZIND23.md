# IMMZIND23 - WHO Immunization Implementation Guide v1.0.0
...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/Measure/IMMZIND23 | *Version*:1.0.0 |
...
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**IMMZIND23Logic
* Knowledge Artifact Metadata: ````/* @numerator: Number of tetanus and diphtheria-containing vaccine doses (4th dose) administered through routine services during the reporting period @pseudocode: COUNT of immunization events WHERE "Vaccine type" = "Tetanus and diphtheria-containing vaccines (DT)" for the 4th dose in the primary series AND "Date and time of vaccination" is during the reporting period */ define "Numerator": Coalesce( DTP."Td Doses Administered to Patient".sortedIndex(3).occurrence.toInterval() starts during "Measurement Period", false )````
* Knowledge Artifact Metadata:  Logic Definition
