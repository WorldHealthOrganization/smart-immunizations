# SMART Guidelines Immunizations Caregiver (RelatedPerson) - WHO Immunization Implementation Guide v1.0.0
...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/StructureDefinition/IMMZ.Caregiver | *Version*:1.0.0 |
| Active as of 2024-12-18 | *Computable Name*:IMMZCaregiver |
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Reference",
        "targetProfile" : ["http://smart.who.int/immunizations/StructureDefinition/IMMZ.Patient"]
      }]
    },
    {
