# IMMZIND17 - WHO Immunization Implementation Guide v1.0.0
...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/Measure/IMMZIND17 | *Version*:1.0.0 |
| Draft as of 2025-06-11 | *Computable Name*:IMMZIND17 |

 
IMMZ.IND.17 Immunization coverage for pneumococcal conjugate vaccine, 1st dose 
...
* Knowledge Artifact Metadata: Initial Population
  * ?: **ID**: IMMZ.IND.17.IP**Description**:Initial Population**Logic Definition**:[Initial Population](#immzind17logic-initial-population)
* Knowledge Artifact Metadata: Denominator
  * ?: **ID**: IMMZ.IND.17.D**Description**:Denominator**Logic Definition**:[Denominator](#immzind17logic-denominator)
* Knowledge Artifact Metadata: Numerator
  * ?: **ID**: IMMZ.IND.17.N**Description**:Numerator**Logic Definition**:[Numerator](#immzind17logic-numerator)
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.17.S1**Code**: By-Administrative Area
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.17.S2**Code**: By-Sex
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.17.S3**Code**: By-Age group
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.17.S4**Code**: By-Age group
...
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**IMMZIND17Logic
* Knowledge Artifact Metadata: ````/* @numerator: Number of pneumococcal vaccine doses (1st dose) administered through routine services during the reporting period @pseudocode: COUNT of immunization events WHERE "Vaccine type" = "Pneumococcal vaccines" for the 1st dose in the primary series AND "Date and time of vaccination" is during the reporting period */ define "Numerator": exists( (Pneumococcal."Pneumococcal Primary Series Doses Administered to Patient".getDose('1')) I where I.occurrence.toInterval() starts during "Measurement Period" )````
* Knowledge Artifact Metadata:  Logic Definition
...
```json
{
  ...
  "url" : "http://smart.who.int/immunizations/Measure/IMMZIND17",
  "version" : "1.0.0",
  "name" : "IMMZIND17",
  "title" : "IMMZIND17",
  "status" : "draft",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZIND17Logic"],
  "scoring" : {
    "coding" : [{
