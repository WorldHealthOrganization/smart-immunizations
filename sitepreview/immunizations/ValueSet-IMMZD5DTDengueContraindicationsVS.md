# IMMZD5DTDengueContraindications ValueSet for Decision Table - WHO Immunization Implementation Guide v1.0.0
...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/ValueSet/IMMZD5DTDengueContraindicationsVS | *Version*:1.0.0 |
| Active as of 2026-04-09 | *Computable Name*:IMMZD5DTDengueContraindicationsVS |
...
##### IMMZD5DTDengueContraindications ValueSet for Decision Table Schema API
...
### GET /ValueSet-IMMZD5DTDengueContraindicationsVS.schema.json

#### JSON Schema definition for the enumeration ValueSet-IMMZD5DTDengueContraindicationsVS

This endpoint serves the JSON Schema definition for the enumeration ValueSet-IMMZD5DTDengueContraindicationsVS.

## Schema Definition

### ValueSet-IMMZD5DTDengueContraindicationsVS

**Description:** JSON Schema for IMMZD5DTDengueContraindications ValueSet for Decision Table ValueSet codes. Generated from FHIR expansions using IRI format.
