# IMMZ.D5.DT.Hepatitis A contraindications - WHO Immunization Implementation Guide v1.0.0
...
## PlanDefinition: IMMZ.D5.DT.Hepatitis A contraindications 

| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/PlanDefinition/IMMZD5DTHepatitisAContraindications | *Version*:1.0.0 |
| Draft as of 2026-04-09 | *Computable Name*:IMMZD5DTHepatitisAContraindications |

 
IMMZ.D5.DT.Hepatitis A contraindications IMMZ.D5.DT.Hepatitis A contraindications 

* **Actions: **: **Url: **
  * : [IMMZ.D5.DT.Hepatitis A contraindications](PlanDefinition-IMMZD5DTHepatitisAContraindications.md)
* **Actions: **: **Version: **
  * : 1.0.0
* **Actions: **: **Title: **
  * : IMMZ.D5.DT.Hepatitis A contraindications
...
```json
{
  ...
  "id" : "IMMZD5DTHepatitisAContraindications",
  "meta" : {
  ...
  "contained" : [{
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD5DTHepatitisAEncounterElements"
      },
      {
        "url" : "name",
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD5DTHepatitisAContraindicationsLogic"
      },
      {
        "url" : "name",
        "valueString" : "Live attentuated Hepatitis A-containing vaccine is contraindicated Case 1"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Live attentuated Hepatitis A-containing vaccine is contraindicated Case 2"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Live attentuated Hepatitis A-containing vaccine is contraindicated"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Live attentuated Hepatitis A-containing vaccine is contraindicated Guidance"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Hepatitis A vaccination could be contraindicated. Clinical judgement is required. Create a clinical note"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Hepatitis A vaccination could be contraindicated. Clinical judgement is required. Create a clinical note Guidance"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Draft Medication Request for Hepatitis A dose"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Draft Medication Request ID for Hepatitis A dose"
      },
      {
        "url" : "statement",
  ...
  "url" : "http://smart.who.int/immunizations/PlanDefinition/IMMZD5DTHepatitisAContraindications",
  "version" : "1.0.0",
  "name" : "IMMZD5DTHepatitisAContraindications",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZD5DTHepatitisAContraindicationsLogic"],
  "action" : [{
    "title" : "Check for contraindications before administering the vaccine(s) due",
    "description" : "Contraindication for HepatitisA immunization",
    "condition" : [{
      "kind" : "applicability",
      "expression" : {
        "description" : "Live attentuated Hepatitis A-containing vaccine is contraindicated",
        "language" : "text/cql-identifier",
        "expression" : "Live attentuated Hepatitis A-containing vaccine is contraindicated"
      }
    }],
    "type" : {
      "coding" : [{
    ...
    "dynamicValue" : [{
      "path" : "id",
      "expression" : {
        "description" : "Draft Medication Request ID for Hepatitis A dose",
        "language" : "text/cql-identifier",
        "expression" : "Draft Medication Request ID for Hepatitis A dose"
      }
    },
    {
      "path" : "medication",
  ...
  {
    "title" : "Check for Guidance for the patient regarding IMMZ.D5.DT.Hepatitis A contraindications.",
    "description" : "Show Guidance for the patient regarding IMMZ.D5.DT.Hepatitis A contraindications.",
    "condition" : [{
      "kind" : "applicability",
      "expression" : {
