# IMMZIND26 - WHO Immunization Implementation Guide v1.0.0
...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/Measure/IMMZIND26 | *Version*:1.0.0 |
...
* Knowledge Artifact Metadata: Dependency
  * ?: **Description**: Library Yellowfever**Resource**:[IMMZD2DTYellowfeverElements](Library-IMMZD2DTYellowfeverElements.md)**Canonical URL**:http://smart.who.int/immunizations/Library/IMMZD2DTYellowfeverElements
* Knowledge Artifact Metadata: Dependency
...
* Knowledge Artifact Metadata: Dependency
  * ?: **Description**: Value set Yellow fever vaccines**Resource**:[IMMZ.Z.DE23 ValueSet for Yellow fever vaccines](ValueSet-IMMZ.Z.DE23.md)**Canonical URL**:http://smart.who.int/immunizations/ValueSet/IMMZ.Z.DE23
...
* Knowledge Artifact Metadata: Data Requirement
  * ?: **Type**: Immunization**Profile(s)**:[Immunization](http://hl7.org/fhir/R4/immunization.html)**Must Support Elements**: status, isSubpotent, vaccineCode, occurrence**Code Filter(s)**:**Path**: status**Code**: **Path**: vaccineCode**ValueSet**:[IMMZ.Z.DE23 ValueSet for Yellow fever vaccines](ValueSet-IMMZ.Z.DE23.md)
* Knowledge Artifact Metadata: Data Requirement
...
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**IMMZD2DTYellowfeverElements
* Knowledge Artifact Metadata: ````/* @internal: Yellow fever containing Doses Administered to Patient */ define "Yellow fever Doses Administered to Patient": Elements."Doses Administered to Patient" I where I.vaccineCode in Concepts."Yellow fever vaccines"````
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**IMMZIND26Logic
* Knowledge Artifact Metadata: ````/* @numerator: Number of yellow fever vaccine doses administered through routine services during the reporting period @pseudocode: COUNT of immunization events WHERE "Vaccine type" = "Yellow fever vaccines" AND "Date and time of vaccination" is during the reporting period */ define "Numerator": exists( Yellowfever."Yellow fever Doses Administered to Patient" I where I.occurrence.toInterval() starts during "Measurement Period" )````
* Knowledge Artifact Metadata:  Logic Definition
...
```json
{
  ...
  "contained" : [{
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD2DTYellowfeverElements"
      },
      {
        "url" : "name",
