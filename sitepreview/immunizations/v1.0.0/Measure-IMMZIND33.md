# IMMZIND33 - WHO Immunization Implementation Guide v1.0.0
...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/Measure/IMMZIND33 | *Version*:1.0.0 |
| Draft as of 2025-06-11 | *Computable Name*:IMMZIND33 |

 
IMMZ.IND.33 Immunization coverage for malaria vaccines, 3rd dose 
...
* Knowledge Artifact Metadata: Initial Population
  * ?: **ID**: IMMZ.IND.33.IP**Description**:Initial Population**Logic Definition**:[Initial Population](#immzind33logic-initial-population)
* Knowledge Artifact Metadata: Denominator
  * ?: **ID**: IMMZ.IND.33.D**Description**:Denominator**Logic Definition**:[Denominator](#immzind33logic-denominator)
* Knowledge Artifact Metadata: Numerator
  * ?: **ID**: IMMZ.IND.33.N**Description**:Numerator**Logic Definition**:[Numerator](#immzind33logic-numerator)
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.33.S1**Code**: By-Administrative Area
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.33.S2**Code**: By-Sex
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.33.S3**Code**: By-Age group
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.33.S4**Code**: By-Age group
...
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**IMMZIND33Logic
* Knowledge Artifact Metadata: ````/* @numerator: Number of malaria vaccine doses (3rd dose) administered through routine services during the reporting period @pseudocode: COUNT of immunization events WHERE "Vaccine type" = "Malaria vaccines" for the 3rd dose in the primary series AND "Date and time of vaccination" is during the reporting period */ define "Numerator": exists( (Malaria."Malaria Primary Series Doses Administered to Patient".getDose('3')) I where I.occurrence.toInterval() starts during "Measurement Period" )````
* Knowledge Artifact Metadata:  Logic Definition
...
```json
{
  ...
  "contained" : [{
    ...
    },
    {
      ...
      {
        "url" : "statement",
        "valueString" : "/*\n@numerator: Number of malaria vaccine doses (3rd dose) administered through routine services during the reporting period\n@pseudocode: COUNT of immunization events WHERE \"Vaccine type\" = \"Malaria vaccines\" for the 3rd dose in the primary series AND \"Date and time of vaccination\" is during the reporting period\n*/\ndefine \"Numerator\":\n  exists( (Malaria.\"Malaria Primary Series Doses Administered to Patient\".getDose('3')) I\n    where I.occurrence.toInterval() starts during \"Measurement Period\" )"
      },
      {
        "url" : "displaySequence",
        "valueInteger" : 3
  ...
  "url" : "http://smart.who.int/immunizations/Measure/IMMZIND33",
  "version" : "1.0.0",
  "name" : "IMMZIND33",
  "title" : "IMMZIND33",
  "status" : "draft",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZIND33Logic"],
  "scoring" : {
    "coding" : [{
