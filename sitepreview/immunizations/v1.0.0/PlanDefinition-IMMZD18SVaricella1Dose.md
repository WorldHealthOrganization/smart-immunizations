# IMMZ.D18.S.Varicella.1-dose schedule - WHO Immunization Implementation Guide v1.0.0
...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/PlanDefinition/IMMZD18SVaricella1Dose | *Version*:1.0.0 |
| Draft as of 2026-04-09 | *Computable Name*:IMMZD18SVaricella1Dose |
...
```json
{
  ...
  "contained" : [{
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD18SVaricella1DoseLogic"
      },
      {
        "url" : "name",
        "valueString" : "One varicella dose from primary series was administered. The primary series has been completed"
      },
      {
        "url" : "statement",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZD18SVaricella1DoseLogic"],
  "action" : [{
