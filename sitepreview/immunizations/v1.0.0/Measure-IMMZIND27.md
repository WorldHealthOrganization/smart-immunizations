# IMMZIND27 - WHO Immunization Implementation Guide v1.0.0
...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/Measure/IMMZIND27 | *Version*:1.0.0 |
| Draft as of 2025-06-11 | *Computable Name*:IMMZIND27 |

 
IMMZ.IND.27 Immunization coverage for JE vaccines 
...
* Knowledge Artifact Metadata: Initial Population
  * ?: **ID**: IMMZ.IND.27.IP**Description**:Initial Population**Logic Definition**:[Initial Population](#immzind27logic-initial-population)
* Knowledge Artifact Metadata: Denominator
  * ?: **ID**: IMMZ.IND.27.D**Description**:Denominator**Logic Definition**:[Denominator](#immzind27logic-denominator)
* Knowledge Artifact Metadata: Numerator
  * ?: **ID**: IMMZ.IND.27.N**Description**:Numerator**Logic Definition**:[Numerator](#immzind27logic-numerator)
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.27.S1**Code**: By-Administrative Area
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.27.S2**Code**: By-Sex
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.27.S3**Code**: By-Age group
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.27.S4**Code**: By-Age group
...
* Knowledge Artifact Metadata: Dependency
  * ?: **Description**: Library JE**Resource**:[IMMZD2DTJEElements](Library-IMMZD2DTJEElements.md)**Canonical URL**:http://smart.who.int/immunizations/Library/IMMZD2DTJEElements
* Knowledge Artifact Metadata: Dependency
...
* Knowledge Artifact Metadata: Dependency
  * ?: **Description**: Value set JE vaccines**Resource**:[IMMZ.Z.DE8 ValueSet for JE vaccines](ValueSet-IMMZ.Z.DE8.md)**Canonical URL**:http://smart.who.int/immunizations/ValueSet/IMMZ.Z.DE8
...
* Knowledge Artifact Metadata: Data Requirement
  * ?: **Type**: Immunization**Profile(s)**:[Immunization](http://hl7.org/fhir/R4/immunization.html)**Must Support Elements**: status, isSubpotent, vaccineCode, occurrence**Code Filter(s)**:**Path**: status**Code**: **Path**: vaccineCode**ValueSet**:[IMMZ.Z.DE8 ValueSet for JE vaccines](ValueSet-IMMZ.Z.DE8.md)
* Knowledge Artifact Metadata: Data Requirement
...
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**IMMZD2DTJEElements
* Knowledge Artifact Metadata: ````/* @internal: JE containing Doses Administered to Patient */ define "JE Doses Administered to Patient": Elements."Doses Administered to Patient" I where I.vaccineCode in Concepts."JE vaccines"````
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**IMMZIND27Logic
* Knowledge Artifact Metadata: ````/* @numerator: Number of JE vaccine doses administered through routine services during the reporting period @pseudocode: COUNT of immunization events WHERE "Vaccine type" = "JE vaccines" AND "Date and time of vaccination" is during the reporting period */ define "Numerator": exists( JE."JE Doses Administered to Patient" I where I.occurrence.toInterval() starts during "Measurement Period" )````
* Knowledge Artifact Metadata:  Logic Definition
...
```json
{
  ...
  "contained" : [{
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD2DTJEElements"
      },
      {
        "url" : "name",
    ...
    },
    {
      ...
      {
        "url" : "statement",
        "valueString" : "/*\n@numerator: Number of JE vaccine doses administered through routine services during the reporting period\n@pseudocode: COUNT of immunization events WHERE \"Vaccine type\" = \"JE vaccines\" AND \"Date and time of vaccination\" is during the reporting period\n*/\ndefine \"Numerator\":\n  exists( JE.\"JE Doses Administered to Patient\" I\n    where I.occurrence.toInterval() starts during \"Measurement Period\" )"
      },
      {
        "url" : "displaySequence",
        "valueInteger" : 2
  ...
  "url" : "http://smart.who.int/immunizations/Measure/IMMZIND27",
  "version" : "1.0.0",
  "name" : "IMMZIND27",
  "title" : "IMMZIND27",
  "status" : "draft",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZIND27Logic"],
  "scoring" : {
    "coding" : [{
