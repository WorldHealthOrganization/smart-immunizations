# IMMZ.D2.DT.Seasonal influenza - WHO Immunization Implementation Guide v1.0.0
...
| Draft as of 2026-04-09 | *Computable Name*:IMMZD2DTSeasonalinfluenzaSeasonalInfluenza |
...
```json
{
  ...
  "contained" : [{
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD2DTSeasonalinfluenzaSeasonalInfluenzaLogic"
      },
      {
        "url" : "name",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZD2DTSeasonalinfluenzaSeasonalInfluenzaLogic"],
  "action" : [{
    "extension" : [{
