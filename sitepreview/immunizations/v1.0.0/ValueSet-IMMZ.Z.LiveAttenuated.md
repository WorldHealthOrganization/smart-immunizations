# IMMZ.Z.LiveAttenuated ValueSet for live attenuated vaccines - WHO Immunization Implementation Guide v1.0.0
...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/ValueSet/IMMZ.Z.LiveAttenuated | *Version*:1.0.0 |
| Active as of 2026-04-09 | *Computable Name*:IMMZ_Z_LiveAttenuated |
...
##### IMMZ.Z.LiveAttenuated ValueSet for live attenuated vaccines Schema API
...
### GET /ValueSet-IMMZ.Z.LiveAttenuated.schema.json

#### JSON Schema definition for the enumeration ValueSet-IMMZ.Z.LiveAttenuated

This endpoint serves the JSON Schema definition for the enumeration ValueSet-IMMZ.Z.LiveAttenuated.

## Schema Definition

### ValueSet-IMMZ.Z.LiveAttenuated

**Description:** JSON Schema for IMMZ.Z.LiveAttenuated ValueSet for live attenuated vaccines ValueSet codes. Generated from FHIR expansions using IRI format.
