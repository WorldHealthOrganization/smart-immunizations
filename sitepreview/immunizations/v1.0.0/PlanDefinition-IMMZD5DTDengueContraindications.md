# IMMZ.D5.DT.Dengue contraindications - WHO Immunization Implementation Guide v1.0.0
...
## PlanDefinition: IMMZ.D5.DT.Dengue contraindications 

| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/PlanDefinition/IMMZD5DTDengueContraindications | *Version*:1.0.0 |
| Draft as of 2026-04-09 | *Computable Name*:IMMZD5DTDengueContraindications |

 
IMMZ.D5.DT.Dengue contraindications IMMZ.D5.DT.Dengue contraindications 
...
```json
{
  ...
  "id" : "IMMZD5DTDengueContraindications",
  "meta" : {
  ...
  "contained" : [{
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "CI Immunocompromised Observation"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "CI Immunocompromised Condition"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "The client is immunocompromised"
      },
      {
        "url" : "statement",
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD5DTDengueEncounterElements"
      },
      {
        "url" : "name",
        "valueString" : "The client is immunocompromised"
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD5DTDengueContraindicationsLogic"
      },
      {
        "url" : "name",
        "valueString" : "Dengue vaccination is contraindicated Case 1"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Dengue vaccination is contraindicated Case 2"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Dengue vaccination is contraindicated Case 3"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "CI Breastfeeding Observation"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "CI Breastfeeding Condition"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "The client is lactating"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "The client is currently lactating"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Dengue vaccination is contraindicated Case 4"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Dengue vaccination is contraindicated Case 5"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Dengue vaccination is contraindicated Case 6"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Dengue vaccination is contraindicated Case 7"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Dengue vaccination is contraindicated"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Dengue vaccination is contraindicated Guidance"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Dengue vaccination could be contraindicated. Clinical judgement is required. Create a clinical note. Case 1"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Dengue vaccination could be contraindicated. Clinical judgement is required. Create a clinical note. Case 2"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Dengue vaccination could be contraindicated. Clinical judgement is required. Create a clinical note."
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Dengue vaccination could be contraindicated. Clinical judgement is required. Create a clinical note. Guidance"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Draft Medication Request for Dengue dose"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Draft Medication Request ID for Dengue dose"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      "mustSupport" : ["code", "status", "encounter", "effective"],
      "codeFilter" : [{
        "path" : "code",
        "code" : [{
          "system" : "http://smart.who.int/immunizations/CodeSystem/IMMZ.D",
    ...
    },
    {
      "type" : "Observation",
      "profile" : ["http://hl7.org/fhir/StructureDefinition/Observation"],
      "mustSupport" : ["value", "status", "encounter", "effective"]
    },
    {
      "type" : "Observation",
      "profile" : ["http://hl7.org/fhir/StructureDefinition/Observation"],
    ...
    },
    {
      "type" : "Observation",
      "profile" : ["http://hl7.org/fhir/StructureDefinition/Observation"],
      "mustSupport" : ["code", "value", "status", "encounter", "effective"],
      "codeFilter" : [{
        "path" : "code",
        "code" : [{
          "system" : "http://smart.who.int/immunizations/CodeSystem/IMMZ.D",
  ...
  "url" : "http://smart.who.int/immunizations/PlanDefinition/IMMZD5DTDengueContraindications",
  "version" : "1.0.0",
  "name" : "IMMZD5DTDengueContraindications",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZD5DTDengueContraindicationsLogic"],
  "action" : [{
    "title" : "Check for contraindications before administering the vaccine(s) due",
    "description" : "Contraindication for Dengue immunization",
    "condition" : [{
      "kind" : "applicability",
      "expression" : {
        "description" : "Dengue vaccination is contraindicated",
        "language" : "text/cql-identifier",
        "expression" : "Dengue vaccination is contraindicated"
      }
    }],
    "type" : {
      "coding" : [{
    ...
    "dynamicValue" : [{
      "path" : "id",
      "expression" : {
        "description" : "Draft Medication Request ID for Dengue dose",
        "language" : "text/cql-identifier",
        "expression" : "Draft Medication Request ID for Dengue dose"
      }
    },
    {
      "path" : "medication",
  ...
  {
    "title" : "Check for Guidance for the patient regarding IMMZ.D5.DT.Dengue contraindications.",
    "description" : "Show Guidance for the patient regarding IMMZ.D5.DT.Dengue contraindications.",
    "condition" : [{
      "kind" : "applicability",
      "expression" : {
