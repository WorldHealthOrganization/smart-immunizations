# IMMZD5DTMeaslesContraindications ValueSet for Decision Table - WHO Immunization Implementation Guide v1.0.0
...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/ValueSet/IMMZD5DTMeaslesContraindicationsVS | *Version*:1.0.0 |
| Active as of 2026-04-09 | *Computable Name*:IMMZD5DTMeaslesContraindicationsVS |
...
##### IMMZD5DTMeaslesContraindications ValueSet for Decision Table Schema API
...
### GET /ValueSet-IMMZD5DTMeaslesContraindicationsVS.schema.json

#### JSON Schema definition for the enumeration ValueSet-IMMZD5DTMeaslesContraindicationsVS

This endpoint serves the JSON Schema definition for the enumeration ValueSet-IMMZD5DTMeaslesContraindicationsVS.

## Schema Definition

### ValueSet-IMMZD5DTMeaslesContraindicationsVS

**Description:** JSON Schema for IMMZD5DTMeaslesContraindications ValueSet for Decision Table ValueSet codes. Generated from FHIR expansions using IRI format.
