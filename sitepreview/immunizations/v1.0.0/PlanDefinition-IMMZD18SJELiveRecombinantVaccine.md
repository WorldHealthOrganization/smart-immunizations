# IMMZ.D18.S.JE.Live recombinant vaccination schedule - WHO Immunization Implementation Guide v1.0.0
...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/PlanDefinition/IMMZD18SJELiveRecombinantVaccine | *Version*:1.0.0 |
| Draft as of 2026-04-09 | *Computable Name*:IMMZD18SJELiveRecombinantVaccine |
...
```json
{
  ...
  "contained" : [{
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD18SJELiveRecombinantVaccineLogic"
      },
      {
        "url" : "name",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZD18SJELiveRecombinantVaccineLogic"],
  "action" : [{
