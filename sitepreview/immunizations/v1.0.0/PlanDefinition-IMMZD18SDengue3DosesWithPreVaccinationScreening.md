# IMMZ.D18.S.Dengue schedule - WHO Immunization Implementation Guide v1.0.0
...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/PlanDefinition/IMMZD18SDengue3DosesWithPreVaccinationScreening | *Version*:1.0.0 |
| Draft as of 2026-04-09 | *Computable Name*:IMMZD18SDengue3DosesWithPreVaccinationScreening |
...
```json
{
  ...
  "contained" : [{
    ...
    "extension" : [{
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD18SDengue3DosesWithPreVaccinationScreeningLogic"
      },
      {
        "url" : "name",
        "valueString" : "Dengue dose 2 Expiration"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "First dengue dose from the primary series was administered"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Second dengue dose from the primary series was administered"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Dengue dose 2 Due Date"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Dengue dose 2 Create"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Dengue dose 1 Expiration"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Third dengue dose from the primary series was administered. The primary series has been completed"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Dengue dose 1 Due Date"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Dengue dose 1 Create"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Dengue dose 3 Due Date"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Dengue dose 3 Expiration"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Dengue dose 3 Create"
      },
      {
        "url" : "statement",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZD18SDengue3DosesWithPreVaccinationScreeningLogic"],
  "action" : [{
    "title" : "Dengue dose 1",
