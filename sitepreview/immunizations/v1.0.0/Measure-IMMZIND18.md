# IMMZIND18 - WHO Immunization Implementation Guide v1.0.0
...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/Measure/IMMZIND18 | *Version*:1.0.0 |
| Draft as of 2025-06-11 | *Computable Name*:IMMZIND18 |

 
IMMZ.IND.18 Immunization coverage for pneumococcal conjugate vaccine, 2nd dose 
...
* Knowledge Artifact Metadata: Initial Population
  * ?: **ID**: IMMZ.IND.18.IP**Description**:Initial Population**Logic Definition**:[Initial Population](#immzind18logic-initial-population)
* Knowledge Artifact Metadata: Denominator
  * ?: **ID**: IMMZ.IND.18.D**Description**:Denominator**Logic Definition**:[Denominator](#immzind18logic-denominator)
* Knowledge Artifact Metadata: Numerator
  * ?: **ID**: IMMZ.IND.18.N**Description**:Numerator**Logic Definition**:[Numerator](#immzind18logic-numerator)
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.18.S1**Code**: By-Administrative Area
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.18.S2**Code**: By-Sex
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.18.S3**Code**: By-Age group
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.18.S4**Code**: By-Age group
...
* Knowledge Artifact Metadata: Dependency
  * ?: **Description**: Library Pneumococcal**Resource**:[IMMZD2DTPneumococcalElements](Library-IMMZD2DTPneumococcalElements.md)**Canonical URL**:http://smart.who.int/immunizations/Library/IMMZD2DTPneumococcalElements
* Knowledge Artifact Metadata: Dependency
...
* Knowledge Artifact Metadata: Dependency
  * ?: **Description**: Value set Pneumococcal vaccines**Resource**:[IMMZ.Z.DE13 ValueSet for Pneumococcal vaccines](ValueSet-IMMZ.Z.DE13.md)**Canonical URL**:http://smart.who.int/immunizations/ValueSet/IMMZ.Z.DE13
...
* Knowledge Artifact Metadata: Data Requirement
  * ?: **Type**: Immunization**Profile(s)**:[Immunization](http://hl7.org/fhir/R4/immunization.html)**Must Support Elements**: status, isSubpotent, vaccineCode, protocolApplied**Code Filter(s)**:**Path**: status**Code**: **Path**: vaccineCode**ValueSet**:[IMMZ.Z.DE13 ValueSet for Pneumococcal vaccines](ValueSet-IMMZ.Z.DE13.md)
* Knowledge Artifact Metadata: Data Requirement
...
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**IMMZD2DTPneumococcalElements
* Knowledge Artifact Metadata: ````/* @internal: Pneumococcal containing Doses Administered to Patient */ define "Pneumococcal Doses Administered to Patient": Elements."Doses Administered to Patient" I where I.vaccineCode in Concepts."Pneumococcal vaccines"````
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**IMMZD2DTPneumococcalElements
* Knowledge Artifact Metadata: ````/* @internal: Pneumococcal containing Doses Administered to Patient that are in the Primary series */ define "Pneumococcal Primary Series Doses Administered to Patient": "Pneumococcal Doses Administered to Patient".seriesPrimary()````
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**IMMZIND18Logic
* Knowledge Artifact Metadata: ````/* @numerator: Number of pneumococcal vaccine doses (2nd dose) administered through routine services during the reporting period @pseudocode: COUNT of immunization events WHERE "Vaccine type" = "Pneumococcal vaccines" for the 2nd dose in the primary series AND "Date and time of vaccination" is during the reporting period */ define "Numerator": exists( (Pneumococcal."Pneumococcal Primary Series Doses Administered to Patient".getDose('2')) I where I.occurrence.toInterval() starts during "Measurement Period" )````
* Knowledge Artifact Metadata:  Logic Definition
...
```json
{
  ...
  "contained" : [{
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD2DTPneumococcalElements"
      },
      {
        "url" : "name",
    ...
    },
    {
      ...
      {
        "url" : "statement",
        "valueString" : "/*\n@numerator: Number of pneumococcal vaccine doses (2nd dose) administered through routine services during the reporting period\n@pseudocode: COUNT of immunization events WHERE \"Vaccine type\" = \"Pneumococcal vaccines\" for the 2nd dose in the primary series AND \"Date and time of vaccination\" is during the reporting period\n*/\ndefine \"Numerator\":\n  exists( (Pneumococcal.\"Pneumococcal Primary Series Doses Administered to Patient\".getDose('2')) I\n    where I.occurrence.toInterval() starts during \"Measurement Period\" )"
      },
      {
        "url" : "displaySequence",
        "valueInteger" : 3
  ...
  "url" : "http://smart.who.int/immunizations/Measure/IMMZIND18",
  "version" : "1.0.0",
  "name" : "IMMZIND18",
  "title" : "IMMZIND18",
  "status" : "draft",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZIND18Logic"],
  "scoring" : {
    "coding" : [{
