# IMMZD2DTMeaslesSupplementaryDose ValueSet for Decision Table - WHO Immunization Implementation Guide v1.0.0
...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/ValueSet/IMMZD2DTMeaslesSupplementaryDoseVS | *Version*:1.0.0 |
| Active as of 2026-04-09 | *Computable Name*:IMMZD2DTMeaslesSupplementaryDoseVS |
...
##### IMMZD2DTMeaslesSupplementaryDose ValueSet for Decision Table Schema API
...
### GET /ValueSet-IMMZD2DTMeaslesSupplementaryDoseVS.schema.json

#### JSON Schema definition for the enumeration ValueSet-IMMZD2DTMeaslesSupplementaryDoseVS

This endpoint serves the JSON Schema definition for the enumeration ValueSet-IMMZD2DTMeaslesSupplementaryDoseVS.

## Schema Definition

### ValueSet-IMMZD2DTMeaslesSupplementaryDoseVS

**Description:** JSON Schema for IMMZD2DTMeaslesSupplementaryDose ValueSet for Decision Table ValueSet codes. Generated from FHIR expansions using IRI format.
