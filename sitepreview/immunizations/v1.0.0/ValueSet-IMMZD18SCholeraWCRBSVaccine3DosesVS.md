# IMMZD18SCholeraWCRBSVaccine3Doses ValueSet for Decision Table - WHO Immunization Implementation Guide v1.0.0
...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/ValueSet/IMMZD18SCholeraWCRBSVaccine3DosesVS | *Version*:1.0.0 |
| Active as of 2026-04-09 | *Computable Name*:IMMZD18SCholeraWCRBSVaccine3DosesVS |
...
##### IMMZD18SCholeraWCRBSVaccine3Doses ValueSet for Decision Table Schema API
...
### GET /ValueSet-IMMZD18SCholeraWCRBSVaccine3DosesVS.schema.json

#### JSON Schema definition for the enumeration ValueSet-IMMZD18SCholeraWCRBSVaccine3DosesVS

This endpoint serves the JSON Schema definition for the enumeration ValueSet-IMMZD18SCholeraWCRBSVaccine3DosesVS.

## Schema Definition

### ValueSet-IMMZD18SCholeraWCRBSVaccine3DosesVS

**Description:** JSON Schema for IMMZD18SCholeraWCRBSVaccine3Doses ValueSet for Decision Table ValueSet codes. Generated from FHIR expansions using IRI format.
