# IMMZD18SMeaslesLowTransmission ValueSet for Decision Table - WHO Immunization Implementation Guide v1.0.0
...
| Active as of 2026-04-09 | *Computable Name*:IMMZD18SMeaslesLowTransmissionVS |
...
##### IMMZD18SMeaslesLowTransmission ValueSet for Decision Table Schema API
...
### GET /ValueSet-IMMZD18SMeaslesLowTransmissionVS.schema.json

#### JSON Schema definition for the enumeration ValueSet-IMMZD18SMeaslesLowTransmissionVS

This endpoint serves the JSON Schema definition for the enumeration ValueSet-IMMZD18SMeaslesLowTransmissionVS.

## Schema Definition

### ValueSet-IMMZD18SMeaslesLowTransmissionVS

**Description:** JSON Schema for IMMZD18SMeaslesLowTransmission ValueSet for Decision Table ValueSet codes. Generated from FHIR expansions using IRI format.
