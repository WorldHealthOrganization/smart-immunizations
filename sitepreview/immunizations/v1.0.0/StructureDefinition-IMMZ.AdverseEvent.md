# SMART Guidelines Immunizations AdverseEvent - WHO Immunization Implementation Guide v1.0.0
...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/StructureDefinition/IMMZ.AdverseEvent | *Version*:1.0.0 |
| Active as of 2025-06-25 | *Computable Name*:IMMZAdverseEvent |
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["http://smart.who.int/immunizations/StructureDefinition/IMMZOtherMedicalEvent"]
      }]
    },
    {
