# IMMZD2DTPolioBOPVPlusIPV ValueSet for Decision Table - WHO Immunization Implementation Guide v1.0.0
...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/ValueSet/IMMZD2DTPolioBOPVPlusIPVVS | *Version*:1.0.0 |
| Active as of 2026-04-09 | *Computable Name*:IMMZD2DTPolioBOPVPlusIPVVS |
...
##### IMMZD2DTPolioBOPVPlusIPV ValueSet for Decision Table Schema API
...
### GET /ValueSet-IMMZD2DTPolioBOPVPlusIPVVS.schema.json

#### JSON Schema definition for the enumeration ValueSet-IMMZD2DTPolioBOPVPlusIPVVS

This endpoint serves the JSON Schema definition for the enumeration ValueSet-IMMZD2DTPolioBOPVPlusIPVVS.

## Schema Definition

### ValueSet-IMMZD2DTPolioBOPVPlusIPVVS

**Description:** JSON Schema for IMMZD2DTPolioBOPVPlusIPV ValueSet for Decision Table ValueSet codes. Generated from FHIR expansions using IRI format.
