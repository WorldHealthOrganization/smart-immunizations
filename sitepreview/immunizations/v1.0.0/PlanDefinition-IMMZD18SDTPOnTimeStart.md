# IMMZ.D18.S.DTP.On-time start schedule - WHO Immunization Implementation Guide v1.0.0
...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/PlanDefinition/IMMZD18SDTPOnTimeStart | *Version*:1.0.0 |
| Draft as of 2026-04-09 | *Computable Name*:IMMZD18SDTPOnTimeStart |
...
```json
{
  ...
  "contained" : [{
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD18SDTPOnTimeStartLogic"
      },
      {
        "url" : "name",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZD18SDTPOnTimeStartLogic"],
  "action" : [{
    "title" : "DTP dose 1",
