# IMMZ.D18.S.Polio.bOPV plus IPV schedule - WHO Immunization Implementation Guide v1.0.0
...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/PlanDefinition/IMMZD18SPolioBOPVPlusIPV | *Version*:1.0.0 |
| Draft as of 2026-04-09 | *Computable Name*:IMMZD18SPolioBOPVPlusIPV |
...
```json
{
  ...
  "contained" : [{
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD18SPolioBOPVPlusIPVLogic"
      },
      {
        "url" : "name",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZD18SPolioBOPVPlusIPVLogic"],
  "action" : [{
    "title" : "bOPV dose 1",
