# IMMZ.D5.DT.Seasonal influenza contraindications - WHO Immunization Implementation Guide v1.0.0
...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/PlanDefinition/IMMZD5DTSeasonalInfluenzaContraindications | *Version*:1.0.0 |
| Draft as of 2026-04-09 | *Computable Name*:IMMZD5DTSeasonalInfluenzaContraindications |

 
IMMZ.D5.DT.Seasonal influenza contraindications IMMZ.D5.DT.Seasonal influenza contraindications 

* **Actions: **: **Url: **
  * : [IMMZ.D5.DT.Seasonal influenza contraindications](PlanDefinition-IMMZD5DTSeasonalInfluenzaContraindications.md)
* **Actions: **: **Version: **
  * : 1.0.0
* **Actions: **: **Title: **
  * : IMMZ.D5.DT.Seasonal influenza contraindications
...
```json
{
  ...
  "id" : "IMMZD5DTSeasonalInfluenzaContraindications",
  "meta" : {
  ...
  "contained" : [{
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD5DTSeasonalinfluenzaEncounterElements"
      },
      {
        "url" : "name",
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD5DTSeasonalInfluenzaContraindicationsLogic"
      },
      {
        "url" : "name",
        "valueString" : "Seasonal influenza vaccination could be contraindicated. Clinical judgement is required. Create a clinical note Case 1"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Seasonal influenza vaccination could be contraindicated. Clinical judgement is required. Create a clinical note Case 2"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Seasonal influenza vaccination could be contraindicated. Clinical judgement is required. Create a clinical note"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Seasonal influenza vaccination could be contraindicated. Clinical judgement is required. Create a clinical note Guidance"
      },
      {
        "url" : "statement",
  ...
  "url" : "http://smart.who.int/immunizations/PlanDefinition/IMMZD5DTSeasonalInfluenzaContraindications",
  "version" : "1.0.0",
  "name" : "IMMZD5DTSeasonalInfluenzaContraindications",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZD5DTSeasonalInfluenzaContraindicationsLogic"],
  "action" : [{
