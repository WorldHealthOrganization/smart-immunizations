# IMMZ.Z.DE4 ValueSet for Hib-containing vaccines - WHO Immunization Implementation Guide v1.0.0
...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/ValueSet/IMMZ.Z.DE4 | *Version*:1.0.0 |
| Active as of 2026-04-09 | *Computable Name*:IMMZ_Z_DE4 |
...
##### IMMZ.Z.DE4 ValueSet for Hib-containing vaccines Schema API
...
### GET /ValueSet-IMMZ.Z.DE4.schema.json

#### JSON Schema definition for the enumeration ValueSet-IMMZ.Z.DE4

This endpoint serves the JSON Schema definition for the enumeration ValueSet-IMMZ.Z.DE4.

## Schema Definition

### ValueSet-IMMZ.Z.DE4

**Description:** JSON Schema for IMMZ.Z.DE4 ValueSet for Hib-containing vaccines ValueSet codes. Generated from FHIR expansions using IRI format.
