# IMMZD18SHPVSingleDose ValueSet for Decision Table - WHO Immunization Implementation Guide v1.0.0
...
| Active as of 2026-04-09 | *Computable Name*:IMMZD18SHPVSingleDoseVS |
...
##### IMMZD18SHPVSingleDose ValueSet for Decision Table Schema API
...
### GET /ValueSet-IMMZD18SHPVSingleDoseVS.schema.json

#### JSON Schema definition for the enumeration ValueSet-IMMZD18SHPVSingleDoseVS

This endpoint serves the JSON Schema definition for the enumeration ValueSet-IMMZD18SHPVSingleDoseVS.

## Schema Definition

### ValueSet-IMMZD18SHPVSingleDoseVS

**Description:** JSON Schema for IMMZD18SHPVSingleDose ValueSet for Decision Table ValueSet codes. Generated from FHIR expansions using IRI format.
