# IMMZD18STyphoidViPS ValueSet for Decision Table - WHO Immunization Implementation Guide v1.0.0
...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/ValueSet/IMMZD18STyphoidViPSVS | *Version*:1.0.0 |
| Active as of 2026-04-09 | *Computable Name*:IMMZD18STyphoidViPSVS |
...
##### IMMZD18STyphoidViPS ValueSet for Decision Table Schema API
...
### GET /ValueSet-IMMZD18STyphoidViPSVS.schema.json

#### JSON Schema definition for the enumeration ValueSet-IMMZD18STyphoidViPSVS

This endpoint serves the JSON Schema definition for the enumeration ValueSet-IMMZD18STyphoidViPSVS.

## Schema Definition

### ValueSet-IMMZD18STyphoidViPSVS

**Description:** JSON Schema for IMMZD18STyphoidViPS ValueSet for Decision Table ValueSet codes. Generated from FHIR expansions using IRI format.
