# IMMZD2DTTBEFSMEImmun ValueSet for Decision Table - WHO Immunization Implementation Guide v1.0.0
...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/ValueSet/IMMZD2DTTBEFSMEImmunVS | *Version*:1.0.0 |
| Active as of 2026-04-09 | *Computable Name*:IMMZD2DTTBEFSMEImmunVS |
...
##### IMMZD2DTTBEFSMEImmun ValueSet for Decision Table Schema API
...
### GET /ValueSet-IMMZD2DTTBEFSMEImmunVS.schema.json

#### JSON Schema definition for the enumeration ValueSet-IMMZD2DTTBEFSMEImmunVS

This endpoint serves the JSON Schema definition for the enumeration ValueSet-IMMZD2DTTBEFSMEImmunVS.

## Schema Definition

### ValueSet-IMMZD2DTTBEFSMEImmunVS

**Description:** JSON Schema for IMMZD2DTTBEFSMEImmun ValueSet for Decision Table ValueSet codes. Generated from FHIR expansions using IRI format.
