# IMMZD2DTDTPOnTimeStart ValueSet for Decision Table - WHO Immunization Implementation Guide v1.0.0
...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/ValueSet/IMMZD2DTDTPOnTimeStartVS | *Version*:1.0.0 |
| Active as of 2026-04-09 | *Computable Name*:IMMZD2DTDTPOnTimeStartVS |
...
##### IMMZD2DTDTPOnTimeStart ValueSet for Decision Table Schema API
...
### GET /ValueSet-IMMZD2DTDTPOnTimeStartVS.schema.json

#### JSON Schema definition for the enumeration ValueSet-IMMZD2DTDTPOnTimeStartVS

This endpoint serves the JSON Schema definition for the enumeration ValueSet-IMMZD2DTDTPOnTimeStartVS.

## Schema Definition

### ValueSet-IMMZD2DTDTPOnTimeStartVS

**Description:** JSON Schema for IMMZD2DTDTPOnTimeStart ValueSet for Decision Table ValueSet codes. Generated from FHIR expansions using IRI format.
