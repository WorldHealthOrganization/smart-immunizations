# IMMZD2DTMeningococcalPolysaccharideVaccines ValueSet for Decision Table - WHO Immunization Implementation Guide v1.0.0
...
| Active as of 2026-04-09 | *Computable Name*:IMMZD2DTMeningococcalPolysaccharideVaccinesVS |
...
##### IMMZD2DTMeningococcalPolysaccharideVaccines ValueSet for Decision Table Schema API
...
### GET /ValueSet-IMMZD2DTMeningococcalPolysaccharideVaccinesVS.schema.json

#### JSON Schema definition for the enumeration ValueSet-IMMZD2DTMeningococcalPolysaccharideVaccinesVS

This endpoint serves the JSON Schema definition for the enumeration ValueSet-IMMZD2DTMeningococcalPolysaccharideVaccinesVS.

## Schema Definition

### ValueSet-IMMZD2DTMeningococcalPolysaccharideVaccinesVS

**Description:** JSON Schema for IMMZD2DTMeningococcalPolysaccharideVaccines ValueSet for Decision Table ValueSet codes. Generated from FHIR expansions using IRI format.
