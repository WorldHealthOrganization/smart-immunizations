# IMMZIND10 - WHO Immunization Implementation Guide v1.0.0
...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/Measure/IMMZIND10 | *Version*:1.0.0 |
| Draft as of 2025-06-11 | *Computable Name*:IMMZIND10 |

 
IMMZ.IND.10 Immunization coverage for inactivated polio vaccine (IPV), 2nd dose 
...
* Knowledge Artifact Metadata: Initial Population
  * ?: **ID**: IMMZ.IND.10.IP**Description**:Initial Population**Logic Definition**:[Initial Population](#immzind10logic-initial-population)
* Knowledge Artifact Metadata: Denominator
  * ?: **ID**: IMMZ.IND.10.D**Description**:Denominator**Logic Definition**:[Denominator](#immzind10logic-denominator)
* Knowledge Artifact Metadata: Numerator
  * ?: **ID**: IMMZ.IND.10.N**Description**:Numerator**Logic Definition**:[Numerator](#immzind10logic-numerator)
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.10.S1**Code**: By-Administrative Area
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.10.S2**Code**: By-Sex
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.10.S3**Code**: By-Age group
* Knowledge Artifact Metadata: Stratifier
  * ?: **ID**: IMMZ.IND.10.S4**Code**: By-Age group
...
* Knowledge Artifact Metadata:  Logic Definition
  * ?: **Library Name:**IMMZIND10Logic
* Knowledge Artifact Metadata: ````/* @numerator: Number of IPV doses (2nd dose) administered through routine services during the reporting period @pseudocode: COUNT of immunization events WHERE "Vaccine type" = "Inactivated polio vaccines" for the 2nd dose in the primary series AND "Date and time of vaccination" is during the reporting period */ define "Numerator": Coalesce( Polio."Polio IPV Primary Series Doses Administered to Patient".sortedIndex(1).occurrence.toInterval() starts during "Measurement Period", false )````
* Knowledge Artifact Metadata:  Logic Definition
...
```json
{
  ...
  "contained" : [{
    ...
    },
    {
      ...
      {
        "url" : "statement",
        "valueString" : "/*\n@numerator: Number of IPV doses (2nd dose) administered through routine services during the reporting period\n@pseudocode: COUNT of immunization events WHERE \"Vaccine type\" = \"Inactivated polio vaccines\" for the 2nd dose in the primary series AND \"Date and time of vaccination\" is during the reporting period\n*/\ndefine \"Numerator\":\n  Coalesce( Polio.\"Polio IPV Primary Series Doses Administered to Patient\".sortedIndex(1).occurrence.toInterval() starts during \"Measurement Period\",\n    false )"
      },
      {
        "url" : "displaySequence",
        "valueInteger" : 4
  ...
  "url" : "http://smart.who.int/immunizations/Measure/IMMZIND10",
  "version" : "1.0.0",
  "name" : "IMMZIND10",
  "title" : "IMMZIND10",
  "status" : "draft",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZIND10Logic"],
  "scoring" : {
    "coding" : [{
