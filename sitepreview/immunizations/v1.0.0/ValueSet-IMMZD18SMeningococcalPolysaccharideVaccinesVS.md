# IMMZD18SMeningococcalPolysaccharideVaccines ValueSet for Decision Table - WHO Immunization Implementation Guide v1.0.0
...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/ValueSet/IMMZD18SMeningococcalPolysaccharideVaccinesVS | *Version*:1.0.0 |
| Active as of 2026-04-09 | *Computable Name*:IMMZD18SMeningococcalPolysaccharideVaccinesVS |
...
##### IMMZD18SMeningococcalPolysaccharideVaccines ValueSet for Decision Table Schema API
...
### GET /ValueSet-IMMZD18SMeningococcalPolysaccharideVaccinesVS.schema.json

#### JSON Schema definition for the enumeration ValueSet-IMMZD18SMeningococcalPolysaccharideVaccinesVS

This endpoint serves the JSON Schema definition for the enumeration ValueSet-IMMZD18SMeningococcalPolysaccharideVaccinesVS.

## Schema Definition

### ValueSet-IMMZD18SMeningococcalPolysaccharideVaccinesVS

**Description:** JSON Schema for IMMZD18SMeningococcalPolysaccharideVaccines ValueSet for Decision Table ValueSet codes. Generated from FHIR expansions using IRI format.
