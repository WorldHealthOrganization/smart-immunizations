# IMMZ.D2.DT.DTP.On-time start - WHO Immunization Implementation Guide v1.0.0
...
| Draft as of 2026-04-09 | *Computable Name*:IMMZD2DTDTPOnTimeStart |
...
```json
{
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZD2DTDTPOnTimeStartLogic"],
  "action" : [{
    "extension" : [{
