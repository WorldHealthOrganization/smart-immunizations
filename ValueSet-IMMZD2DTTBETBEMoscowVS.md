# IMMZD2DTTBETBEMoscow ValueSet for Decision Table - WHO Immunization Implementation Guide v0.2.0

* [**Table of Contents**](toc.md)
* [**Indices**](indices.md)
* [**Artifact Index**](artifacts.md)
* **IMMZD2DTTBETBEMoscow ValueSet for Decision Table**

## ValueSet: IMMZD2DTTBETBEMoscow ValueSet for Decision Table 

| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/ValueSet/IMMZD2DTTBETBEMoscowVS | *Version*:0.2.0 |
| Active as of 2026-07-07 | *Computable Name*:IMMZD2DTTBETBEMoscowVS |
...
##### IMMZD2DTTBETBEMoscow ValueSet for Decision Table Schema API
...
### GET /ValueSet-IMMZD2DTTBETBEMoscowVS.schema.json

#### JSON Schema definition for the enumeration ValueSet-IMMZD2DTTBETBEMoscowVS

This endpoint serves the JSON Schema definition for the enumeration ValueSet-IMMZD2DTTBETBEMoscowVS.

## Schema Definition

### ValueSet-IMMZD2DTTBETBEMoscowVS

**Description:** JSON Schema for IMMZD2DTTBETBEMoscow ValueSet for Decision Table ValueSet codes. Generated from FHIR expansions using IRI format.
...
```json
{
  ...
  "id" : "IMMZD2DTTBETBEMoscowVS",
  "url" : "http://smart.who.int/immunizations/ValueSet/IMMZD2DTTBETBEMoscowVS",
  "version" : "0.2.0",
