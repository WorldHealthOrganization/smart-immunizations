...
| Draft as of 2025-11-25 | *Computable Name*:IMMZD5DTPneumococcalEncounterElements |

 
This library defines encounter-based elements for Pneumococcal used throughout the Immunization CPG 

* * **Content:**application/elm+xml: ````Encoded data (17328 characters)````: **Id:**
  * ?: IMMZD5DTPneumococcalEncounterElements
* * **Content:**application/elm+xml: ````Encoded data (17328 characters)````: **Version:**
  * ?: 0.2.0
* * **Content:**application/elm+xml: ````Encoded data (17328 characters)````: **Url:**
  * ?: [IMMZD5DTPneumococcalEncounterElements](Library-IMMZD5DTPneumococcalEncounterElements.md)
* * **Content:**application/elm+xml: ````Encoded data (17328 characters)````: **Status:**
  * ?: draft
* * **Content:**application/elm+xml: ````Encoded data (17328 characters)````: **Date:**
  * ?: 2025-11-25 19:41:02+0000
* * **Content:**application/elm+xml: ````Encoded data (17328 characters)````: **Publisher:**
  * ?: WHO
* * **Content:**application/elm+xml: ````Encoded data (17328 characters)````: **Description:**
  * ?: This library defines encounter-based elements for Pneumococcal used throughout the Immunization CPG
