# IMMZ.D18.S.TBE.Encepur schedule - WHO Immunization Implementation Guide v0.2.0
...
## PlanDefinition: IMMZ.D18.S.TBE.Encepur schedule 

| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/PlanDefinition/IMMZD18STBEEncepur | *Version*:0.2.0 |
| Draft as of 2026-07-07 | *Computable Name*:IMMZD18STBEEncepur |

 
IMMZ.D18.S.TBE.Encepur schedule Encepur, 3-dose schedule 

* **Actions: **: **Url: **
  * : [IMMZ.D18.S.TBE.Encepur schedule](PlanDefinition-IMMZD18STBEEncepur.md)
* **Actions: **: **Version: **
  * : 0.2.0
* **Actions: **: **Title: **
  * : IMMZ.D18.S.TBE.Encepur schedule
...
```json
{
  ...
  "contained" : [{
    ...
    },
    {
      "extension" : [{
        "url" : "libraryName",
        "valueString" : "IMMZD18STBEEncepurLogic"
      },
      {
        "url" : "name",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "TBE Encepur dose 3"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "TBE Encepur dose 2"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Tick-borne encephalitis (TBE) Encepur dose 1"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Tick-borne encephalitis (TBE) Encepur dose 1 Due Date"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "Tick-borne encephalitis (TBE) Encepur dose 1 Create"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "TBE Encepur booster dose"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "TBE Encepur dose 3 Due Date"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "TBE Encepur dose 3 Overdue"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "TBE Encepur dose 3 Create"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "TBE Encepur dose 2 Due Date"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "TBE Encepur dose 2 Overdue"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "TBE Encepur dose 2 Create"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "TBE Encepur booster dose Due Date"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "TBE Encepur booster dose Overdue"
      },
      {
        "url" : "statement",
    ...
    },
    {
      ...
      {
        "url" : "name",
        "valueString" : "TBE Encepur booster dose Create"
      },
      {
        "url" : "statement",
  ...
  "url" : "http://smart.who.int/immunizations/PlanDefinition/IMMZD18STBEEncepur",
  "version" : "0.2.0",
  "name" : "IMMZD18STBEEncepur",
  ...
  "library" : ["http://smart.who.int/immunizations/Library/IMMZD18STBEEncepurLogic"],
  "action" : [{
    "title" : "Tick-borne encephalitis (TBE) Encepur dose 1",
    "description" : "Provision of the TBE Encepur dose 1\nTrigger event: Child's birth\nTrigger pseudo: \nTrigger date: \"Date of birth\"\nCreate condition: The vaccine can be given from > 1 year of age.",
    "condition" : [{
      "kind" : "applicability",
      "expression" : {
        "description" : "Tick-borne encephalitis (TBE) Encepur dose 1",
        "language" : "text/cql-identifier",
        "expression" : "Tick-borne encephalitis (TBE) Encepur dose 1"
      }
    }],
    ...
    },
    {
      ...
      "expression" : {
        "language" : "text/cql-identifier",
        "expression" : "Tick-borne encephalitis (TBE) Encepur dose 1 Create"
      }
    },
    {
  ...
  },
  {
    ...
    "condition" : [{
      "kind" : "applicability",
      "expression" : {
        "description" : "TBE Encepur dose 2",
        "language" : "text/cql-identifier",
        "expression" : "TBE Encepur dose 2"
      }
    }],
    "definitionCanonical" : "http://smart.who.int/immunizations/ActivityDefinition/IMMZD2DTCR",
    "dynamicValue" : [{
    ...
    },
    {
      ...
      "expression" : {
        "language" : "text/cql-identifier",
        "expression" : "TBE Encepur dose 2 Create"
      }
    },
    {
      "path" : "category.coding",
  ...
  },
  {
    ...
    "condition" : [{
      "kind" : "applicability",
      "expression" : {
        "description" : "TBE Encepur dose 3",
        "language" : "text/cql-identifier",
        "expression" : "TBE Encepur dose 3"
      }
    }],
    "definitionCanonical" : "http://smart.who.int/immunizations/ActivityDefinition/IMMZD2DTCR",
    "dynamicValue" : [{
    ...
    },
    {
      ...
      "expression" : {
        "language" : "text/cql-identifier",
        "expression" : "TBE Encepur dose 3 Create"
      }
    },
    {
      "path" : "category.coding",
  ...
  {
    "title" : "TBE Encepur booster dose",
    ...
    "condition" : [{
      "kind" : "applicability",
      "expression" : {
        "description" : "TBE Encepur booster dose",
        "language" : "text/cql-identifier",
        "expression" : "TBE Encepur booster dose"
      }
    }],
    "definitionCanonical" : "http://smart.who.int/immunizations/ActivityDefinition/IMMZD2DTCR",
    "dynamicValue" : [{
    ...
    },
    {
      ...
      "expression" : {
        "language" : "text/cql-identifier",
        "expression" : "TBE Encepur booster dose Create"
      }
    },
    {
      "path" : "category.coding",
