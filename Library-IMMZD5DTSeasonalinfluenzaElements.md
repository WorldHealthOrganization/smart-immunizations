...
| Draft as of 2026-07-07 | *Computable Name*:IMMZD5DTSeasonalinfluenzaElements |

 
This library defines context-independent elements for Seasonal influenza used throughout the Immunization CPG 

* * **Content: **application/elm+xml: ````Encoded data (15596 characters)````: **Id: **
  * ?: IMMZD5DTSeasonalinfluenzaElements
* * **Content: **application/elm+xml: ````Encoded data (15596 characters)````: **Version: **
  * ?: 0.2.0
* * **Content: **application/elm+xml: ````Encoded data (15596 characters)````: **Url: **
  * ?: [IMMZD5DTSeasonalinfluenzaElements](Library-IMMZD5DTSeasonalinfluenzaElements.md)
* * **Content: **application/elm+xml: ````Encoded data (15596 characters)````: **Status: **
  * ?: draft
* * **Content: **application/elm+xml: ````Encoded data (15596 characters)````: **Date: **
  * ?: 2026-07-07 22:08:04+0000
* * **Content: **application/elm+xml: ````Encoded data (15596 characters)````: **Publisher: **
  * ?: WHO
* * **Content: **application/elm+xml: ````Encoded data (15596 characters)````: **Description: **
  * ?: This library defines context-independent elements for Seasonal influenza used throughout the Immunization CPG
