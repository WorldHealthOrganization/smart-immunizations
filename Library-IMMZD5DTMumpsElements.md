...
| Draft as of 2025-11-25 | *Computable Name*:IMMZD5DTMumpsElements |

 
This library defines context-independent elements for Mumps used throughout the Immunization CPG 

* * **Content:**application/elm+xml: ````Encoded data (18444 characters)````: **Id:**
  * ?: IMMZD5DTMumpsElements
* * **Content:**application/elm+xml: ````Encoded data (18444 characters)````: **Version:**
  * ?: 0.2.0
* * **Content:**application/elm+xml: ````Encoded data (18444 characters)````: **Url:**
  * ?: [IMMZD5DTMumpsElements](Library-IMMZD5DTMumpsElements.md)
* * **Content:**application/elm+xml: ````Encoded data (18444 characters)````: **Status:**
  * ?: draft
* * **Content:**application/elm+xml: ````Encoded data (18444 characters)````: **Date:**
  * ?: 2025-11-25 19:41:02+0000
* * **Content:**application/elm+xml: ````Encoded data (18444 characters)````: **Publisher:**
  * ?: WHO
* * **Content:**application/elm+xml: ````Encoded data (18444 characters)````: **Description:**
  * ?: This library defines context-independent elements for Mumps used throughout the Immunization CPG
