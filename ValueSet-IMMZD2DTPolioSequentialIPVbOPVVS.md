# IMMZD2DTPolioSequentialIPVbOPV ValueSet for Decision Table - WHO Immunization Implementation Guide v0.2.0

* [**Table of Contents**](toc.md)
* [**Indices**](indices.md)
* [**Artifact Index**](artifacts.md)
* **IMMZD2DTPolioSequentialIPVbOPV ValueSet for Decision Table**

## ValueSet: IMMZD2DTPolioSequentialIPVbOPV ValueSet for Decision Table 

| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/ValueSet/IMMZD2DTPolioSequentialIPVbOPVVS | *Version*:0.2.0 |
| Active as of 2026-07-07 | *Computable Name*:IMMZD2DTPolioSequentialIPVbOPVVS |
...
##### IMMZD2DTPolioSequentialIPVbOPV ValueSet for Decision Table Schema API
...
### GET /ValueSet-IMMZD2DTPolioSequentialIPVbOPVVS.schema.json

#### JSON Schema definition for the enumeration ValueSet-IMMZD2DTPolioSequentialIPVbOPVVS

This endpoint serves the JSON Schema definition for the enumeration ValueSet-IMMZD2DTPolioSequentialIPVbOPVVS.

## Schema Definition

### ValueSet-IMMZD2DTPolioSequentialIPVbOPVVS

**Description:** JSON Schema for IMMZD2DTPolioSequentialIPVbOPV ValueSet for Decision Table ValueSet codes. Generated from FHIR expansions using IRI format.
...
```json
{
  ...
  "id" : "IMMZD2DTPolioSequentialIPVbOPVVS",
  "url" : "http://smart.who.int/immunizations/ValueSet/IMMZD2DTPolioSequentialIPVbOPVVS",
  "version" : "0.2.0",
