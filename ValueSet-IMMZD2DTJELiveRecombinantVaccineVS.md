# IMMZD2DTJELiveRecombinantVaccine ValueSet for Decision Table - WHO Immunization Implementation Guide v0.2.0

* [**Table of Contents**](toc.md)
* [**Indices**](indices.md)
* [**Artifact Index**](artifacts.md)
* **IMMZD2DTJELiveRecombinantVaccine ValueSet for Decision Table**

## ValueSet: IMMZD2DTJELiveRecombinantVaccine ValueSet for Decision Table 

| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/immunizations/ValueSet/IMMZD2DTJELiveRecombinantVaccineVS | *Version*:0.2.0 |
| Active as of 2026-07-07 | *Computable Name*:IMMZD2DTJELiveRecombinantVaccineVS |
...
##### IMMZD2DTJELiveRecombinantVaccine ValueSet for Decision Table Schema API
...
### GET /ValueSet-IMMZD2DTJELiveRecombinantVaccineVS.schema.json

#### JSON Schema definition for the enumeration ValueSet-IMMZD2DTJELiveRecombinantVaccineVS

This endpoint serves the JSON Schema definition for the enumeration ValueSet-IMMZD2DTJELiveRecombinantVaccineVS.

## Schema Definition

### ValueSet-IMMZD2DTJELiveRecombinantVaccineVS

**Description:** JSON Schema for IMMZD2DTJELiveRecombinantVaccine ValueSet for Decision Table ValueSet codes. Generated from FHIR expansions using IRI format.
...
```json
{
  ...
  "id" : "IMMZD2DTJELiveRecombinantVaccineVS",
  "url" : "http://smart.who.int/immunizations/ValueSet/IMMZD2DTJELiveRecombinantVaccineVS",
  "version" : "0.2.0",
