...
| Draft as of 2025-11-25 | *Computable Name*:IMMZD2DTMeningococcalQuadrivalentConjugateVaccines2Doses |
...
```json
{
  ...
  "library" : [
    "http://smart.who.int/immunizations/Library/IMMZD2DTMeningococcalQuadrivalentConjugateVaccines2DosesLogic"
  ],
  "action" : [
    {
      "extension" : [
